...
- **Agent version.** Agent advertises `X-Gram-Agent-Version` for observability
  and compatibility debugging. The gateway does not auto-update or
  minimum-version gate customer agents.
