...
// per external user.
//
// Note (initial milestones): the externalId suffix is documented here but
// NOT implemented by `urn.SessionSubject` in the initial milestones. It will
// be added back if and when backwards compatibility with the chat-session
// path requires it; the chat-session retirement schedule may make this
// unnecessary.
//
