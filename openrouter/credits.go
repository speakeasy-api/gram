...
func newCredits(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Credits {
	return &Credits{
		rootSDK:          rootSDK,
...
func (s *Credits) GetCredits(ctx context.Context, opts ...operations.Option) (*operations.GetCreditsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/credits")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetCreditsResponseBody
...
func (s *Credits) CreateCoinbaseCharge(ctx context.Context, request components.CreateChargeRequest, security operations.CreateCoinbaseChargeSecurity, opts ...operations.Option) (*operations.CreateCoinbaseChargeResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/credits/coinbase")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CreateCoinbaseChargeResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateCoinbaseChargeResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
