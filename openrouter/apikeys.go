...
func (s *APIKeys) Update(ctx context.Context, hash string, body operations.UpdateKeysRequestBody, opts ...operations.Option) (*operations.UpdateKeysResponse, error) {
