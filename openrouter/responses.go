...
func newResponses(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Responses {
	return &Responses{
		rootSDK:          rootSDK,
...
func (s *Responses) Send(ctx context.Context, request components.OpenResponsesRequest, opts ...operations.Option) (*operations.CreateResponsesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			res.OpenResponsesNonStreamingResponse = &out
	...
	case httpRes.StatusCode == 408:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.RequestTimeoutResponseError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 413:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.PayloadTooLargeResponseError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 422:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.UnprocessableEntityResponseError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
