...
func newOAuth(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OAuth {
	return &OAuth{
		rootSDK:          rootSDK,
...
func (s *OAuth) ExchangeAuthCodeForAPIKey(ctx context.Context, request operations.ExchangeAuthCodeForAPIKeyRequest, opts ...operations.Option) (*operations.ExchangeAuthCodeForAPIKeyResponse, error) {
	...
	res := &operations.ExchangeAuthCodeForAPIKeyResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ExchangeAuthCodeForAPIKeyResponseBody
...
func (s *OAuth) CreateAuthCode(ctx context.Context, request operations.CreateAuthKeysCodeRequest, opts ...operations.Option) (*operations.CreateAuthKeysCodeResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/auth/keys/code")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CreateAuthKeysCodeResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.CreateAuthKeysCodeResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
