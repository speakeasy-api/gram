...
const (
	...
	// GramMeteringV1RiskMeterReading publishes to gram-metering-v1-risk-meter-reading.
	GramMeteringV1RiskMeterReading Topic = "gram.metering.v1.RiskMeterReading"
...
func All() []Topic {
	return []Topic{
		...
		GramMeteringV1RiskMeterReading,
...
func Lookup(name string) (Topic, bool) {
	...
	case GramMeteringV1RiskMeterReading:
		return GramMeteringV1RiskMeterReading, true
...
func newPublisher(ctx context.Context, broker gcp.PublisherBroker, topic Topic, settings *pubsub.PublishSettings) (gcp.EncodedPublisher, error) {
	...
	case GramMeteringV1RiskMeterReading:
		return gcp.PubSubEncodedPublisherForMessage(ctx, broker, &meteringv1.RiskMeterReading{}, gcp.WithEncodedPublishSettings(settings))
	case GramOtelV1InboundLogRecord:
