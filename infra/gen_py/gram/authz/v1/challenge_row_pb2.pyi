...
class ChallengeRow(_message.Message):
    ...
    requested_checks: _containers.RepeatedCompositeFieldContainer[ChallengeRow.RequestedCheck]
    matched_grants: _containers.RepeatedCompositeFieldContainer[ChallengeRow.MatchedGrant]
    evaluated_grant_count: int
    filter_candidate_count: int
    filter_allowed_count: int
    def __init__(self, id: _Optional[str] = ..., timestamp: _Optional[str] = ..., organization_id: _Optional[str] = ..., project_id: _Optional[str] = ..., trace_id: _Optional[str] = ..., span_id: _Optional[str] = ..., request_id: _Optional[str] = ..., principal_urn: _Optional[str] = ..., principal_type: _Optional[str] = ..., user_id: _Optional[str] = ..., user_external_id: _Optional[str] = ..., user_email: _Optional[str] = ..., api_key_id: _Optional[str] = ..., session_id: _Optional[str] = ..., role_slugs: _Optional[_Iterable[str]] = ..., operation: _Optional[str] = ..., outcome: _Optional[str] = ..., reason: _Optional[str] = ..., scope: _Optional[str] = ..., resource_kind: _Optional[str] = ..., resource_id: _Optional[str] = ..., selector: _Optional[str] = ..., expanded_scopes: _Optional[_Iterable[str]] = ..., requested_checks: _Optional[_Iterable[_Union[ChallengeRow.RequestedCheck, _Mapping]]] = ..., matched_grants: _Optional[_Iterable[_Union[ChallengeRow.MatchedGrant, _Mapping]]] = ..., evaluated_grant_count: _Optional[int] = ..., filter_candidate_count: _Optional[int] = ..., filter_allowed_count: _Optional[int] = ...) -> None: ...
