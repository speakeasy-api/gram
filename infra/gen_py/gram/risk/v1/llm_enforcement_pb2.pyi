...
class LLMEnforcement(_message.Message):
    __slots__ = ("request_id", "chat_message_id", "project_id", "organization_id", "risk_policy_id", "risk_policy_version", "created_at", "content", "content_part_id", "chat_id", "parent_chat_message_id", "origin_risk_policy_id", "origin_risk_policy_version", "message_link_reason", "execution_path", "tool_call_id", "tool_name", "hook_source", "user_id", "message_type", "policy_link_reason", "external_conversation_id", "content_truncated", "body", "tool_calls", "organization_slug")
    ...
    body: str
    tool_calls: _containers.RepeatedCompositeFieldContainer[LLMEnforcement.ToolCall]
    organization_slug: str
    def __init__(self, request_id: _Optional[str] = ..., chat_message_id: _Optional[str] = ..., project_id: _Optional[str] = ..., organization_id: _Optional[str] = ..., risk_policy_id: _Optional[str] = ..., risk_policy_version: _Optional[int] = ..., created_at: _Optional[str] = ..., content: _Optional[str] = ..., content_part_id: _Optional[str] = ..., chat_id: _Optional[str] = ..., parent_chat_message_id: _Optional[str] = ..., origin_risk_policy_id: _Optional[str] = ..., origin_risk_policy_version: _Optional[int] = ..., message_link_reason: _Optional[str] = ..., execution_path: _Optional[str] = ..., tool_call_id: _Optional[str] = ..., tool_name: _Optional[str] = ..., hook_source: _Optional[str] = ..., user_id: _Optional[str] = ..., message_type: _Optional[str] = ..., policy_link_reason: _Optional[str] = ..., external_conversation_id: _Optional[str] = ..., content_truncated: _Optional[bool] = ..., body: _Optional[str] = ..., tool_calls: _Optional[_Iterable[_Union[LLMEnforcement.ToolCall, _Mapping]]] = ..., organization_slug: _Optional[str] = ...) -> None: ...
