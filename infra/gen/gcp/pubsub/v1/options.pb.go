...
func (x *TopicOptions) Reset() {
	*x = TopicOptions{}
	mi := &file_gcp_pubsub_v1_options_proto_msgTypes[0]
...
func (x *SubscriptionOptions) Reset() {
	*x = SubscriptionOptions{}
	mi := &file_gcp_pubsub_v1_options_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_gcp_pubsub_v1_options_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MessageOptions)(nil),
		ExtensionType: (*TopicOptions)(nil),
		Field:         50001,
		Name:          "gcp.pubsub.v1.topic",
	...
	},
	{
		...
		Field:         50002,
		Name:          "gcp.pubsub.v1.subscription",
...
var (
	// optional gcp.pubsub.v1.TopicOptions topic = 50001;
...
const file_gcp_pubsub_v1_options_proto_rawDesc = "" +
	"\n" +
	...
	"\x0eretention_hint\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rretentionHint\x12?\n" +
	...
	"\fretry_policy\x18\x06 \x01(\v2\x1a.gcp.pubsub.v1.RetryPolicyR\vretryPolicy\x12F\n" +
	"\x06labels\x18\a \x03(\v2..gcp.pubsub.v1.SubscriptionOptions.LabelsEntryR\x06labels\x12\x16\n" +
...
func file_gcp_pubsub_v1_options_proto_init() {
	if File_gcp_pubsub_v1_options_proto != nil {
		return
	}
	type x struct{}
	...
	File_gcp_pubsub_v1_options_proto = out.File
	file_gcp_pubsub_v1_options_proto_goTypes = nil
	file_gcp_pubsub_v1_options_proto_depIdxs = nil
}
