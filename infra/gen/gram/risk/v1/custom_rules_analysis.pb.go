...
func (x *CustomRulesAnalysis) GetExternalConversationId() string {
	if x != nil {
...
func (x *CustomRulesAnalysis) SetExternalConversationId(v string) {
...
func (x *CustomRulesAnalysis) HasExternalConversationId() bool {
	if x == nil {
		return false
	}
...
func (x *CustomRulesAnalysis) ClearExternalConversationId() {
...
const file_gram_risk_v1_custom_rules_analysis_proto_rawDesc = "" +
	"\n" +
	"(gram/risk/v1/custom_rules_analysis.proto\x12\fgram.risk.v1\x1a\x1bgcp/pubsub/v1/options.proto\"\xa2\b\n" +
	...
	"\x18external_conversation_id\x18\x18 \x01(\tR\x16externalConversationId\x1a<\n" +
	"\bToolCall\x12\x12\n" +
