...
type Client struct {
	...
	ListToolsetsForOrgEndpoint       goa.Endpoint
...
func NewClient(createToolset, listToolsets, listToolsetsForOrg, updateToolset, deleteToolset, getToolset, checkMCPSlugAvailability, cloneToolset, addExternalOAuthServer, removeOAuthServer, addOAuthProxyServer, updateOAuthProxyServer goa.Endpoint) *Client {
	return &Client{
		...
		ListToolsetsForOrgEndpoint:       listToolsetsForOrg,
...
// ListToolsetsForOrg calls the "listToolsetsForOrg" endpoint of the "toolsets"
// service.
// ListToolsetsForOrg may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): unauthorized access
//   - "forbidden" (type *goa.ServiceError): permission denied
//   - "bad_request" (type *goa.ServiceError): request is invalid
//   - "not_found" (type *goa.ServiceError): resource not found
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) ListToolsetsForOrg(ctx context.Context, p *ListToolsetsForOrgPayload) (res *ListToolsetSummariesResult, err error) {
	var ires any
	ires, err = c.ListToolsetsForOrgEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*ListToolsetSummariesResult), nil
}
