...
import (
	...
	telemetry "github.com/speakeasy-api/gram/gen/telemetry"
...
func MountSearchLogsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.searchLogs", f)
}
...
func MountSearchToolCallsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.searchToolCalls", f)
}
...
func MountSearchChatsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.searchChats", f)
}
...
func MountSearchUsersHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.searchUsers", f)
}
...
func MountCaptureEventHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.captureEvent", f)
}
...
func MountGetProjectMetricsSummaryHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.getProjectMetricsSummary", f)
}
...
func MountGetUserMetricsSummaryHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.getUserMetricsSummary", f)
}
...
func MountGetObservabilityOverviewHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.getObservabilityOverview", f)
}
...
// MountGetProjectOverviewHandler configures the mux to serve the "telemetry"
// service "getProjectOverview" endpoint.
func MountGetProjectOverviewHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/telemetry.getProjectOverview", f)
}

// NewGetProjectOverviewHandler creates a HTTP handler which loads the HTTP
// request and calls the "telemetry" service "getProjectOverview" endpoint.
func NewGetProjectOverviewHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeGetProjectOverviewRequest(mux, decoder)
		encodeResponse = EncodeGetProjectOverviewResponse(encoder)
		encodeError    = EncodeGetProjectOverviewError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
...
func MountListFilterOptionsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/telemetry.listFilterOptions", f)
}
...
// MountListAttributeKeysHandler configures the mux to serve the "telemetry"
// service "listAttributeKeys" endpoint.
func MountListAttributeKeysHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/telemetry.listAttributeKeys", f)
}

// NewListAttributeKeysHandler creates a HTTP handler which loads the HTTP
// request and calls the "telemetry" service "listAttributeKeys" endpoint.
func NewListAttributeKeysHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeListAttributeKeysRequest(mux, decoder)
		encodeResponse = EncodeListAttributeKeysResponse(encoder)
		encodeError    = EncodeListAttributeKeysError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
