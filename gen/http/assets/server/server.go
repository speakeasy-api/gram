...
func MountServeImageHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/assets.serveImage", f)
}
...
func MountUploadImageHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/assets.uploadImage", f)
}
...
func MountUploadFunctionsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/assets.uploadFunctions", f)
}
...
func MountFetchOpenAPIv3FromURLHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/assets.fetchOpenAPIv3FromURL", f)
}
...
func MountServeOpenAPIv3Handler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/assets.serveOpenAPIv3", f)
}
...
func MountServeFunctionHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/assets.serveFunction", f)
}
...
func MountListAssetsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/assets.list", f)
}
...
func MountUploadChatAttachmentHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/assets.uploadChatAttachment", f)
}
...
func MountServeChatAttachmentHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/assets.serveChatAttachment", f)
}
...
func MountCreateSignedChatAttachmentURLHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/assets.createSignedChatAttachmentURL", f)
}
...
func MountServeChatAttachmentSignedHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/assets.serveChatAttachmentSigned", f)
}
