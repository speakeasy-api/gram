...
// path set to call the "projects" service "getProject" endpoint
func (c *Client) BuildGetProjectRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: GetProjectProjectsPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("projects", "getProject", u.String(), err)
	}
	if ctx != nil {
...
// EncodeGetProjectRequest returns an encoder for requests sent to the projects
// getProject server.
func EncodeGetProjectRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*projects.GetProjectPayload)
		if !ok {
			return goahttp.ErrInvalidType("projects", "getProject", "*projects.GetProjectPayload", v)
		}
...
// projects getProject endpoint. restoreBody controls whether the response body
