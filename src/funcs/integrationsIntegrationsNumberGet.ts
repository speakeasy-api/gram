...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.IntegrationsNumberGetRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetIntegrationResult$inboundSchema),
    M.jsonErr(
