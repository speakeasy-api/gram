...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAssetsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListAssetsResult$inboundSchema),
    M.jsonErr(
