...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RedeployDeploymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RedeployResult$inboundSchema),
    M.jsonErr(
