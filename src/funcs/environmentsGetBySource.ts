...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSourceEnvironmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/environments.getSourceEnvironment")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Environment$inboundSchema),
    M.jsonErr(
