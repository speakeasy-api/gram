...
export function chatCreditUsage(
  ...
  Result<
    components.CreditUsageResponseBody,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreditUsageRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/rpc/chat.creditUsage")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CreditUsageResponseBody$inboundSchema),
    M.jsonErr(
