 ...
 */
export function chatSessionsRevoke(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RevokeChatSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/chatSessions.revoke")();
