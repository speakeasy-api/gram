...
All configuration methods require the organization's `signals_intelligence` product feature for sessions and API keys. Disabled organizations receive a forbidden response; feature lookup failures fail closed.
