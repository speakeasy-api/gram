...
- New **Chat** entry in the project sidebar (under Home) opening a `/chat` landing: a personalized "Ask anything" composer with a cycling, crossfading placeholder, your recent conversations grouped by time period ("Show all" to expand), and a set of enterprise-focused starter prompts.
