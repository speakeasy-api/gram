...
| Policy Center                                                  | PG `risk_policies` ×8 (OWASP-derived: secrets/PII, customer contact data, prompt injection, destructive commands, shadow MCP, non-corporate accounts, custom CEL, topic guardrail) | `[~]`  |
