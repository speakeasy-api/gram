...
| Org home (activity, facepiles, challenges)                     | PG `audit_logs` (24 rows: 12 general, 1 quarantine, 11 Killswitch lifecycle) + CH `authz_challenges` (13 rows incl. api_key bucket)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `[~]`  |
| Audit logs                                                     | PG `audit_logs`: 11 canonical Killswitch actions (activate ×8, change, deactivate, expire), plus the existing general/quarantine history                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `[~]`  |
| Killswitches (identity Access tab and Fleet)                   | PG `killswitch_prescriptions` ×8 current aggregates: Active ×5, Scheduled ×1, Lifted ×1, Expired ×1; six user restrictions and two agent restrictions, with selected/all scopes and two overlapping principals                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `[~]`  |
| Killswitch record and version history (user and agent targets) | PG `killswitch_prescription_versions` ×10 + complete resource snapshots; changed A/B/C → A, lifted successor, expiry marker, notes, and matching Audit events                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `[~]`  |
...
organization administrators can exercise Kill/Release after `mise run seed`,
without impersonation; the public demo remains read-only. Scope is covered MCP
tools/call across the agent's current and future
