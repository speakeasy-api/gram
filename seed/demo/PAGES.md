...
| Organization setup wizard (`/acme-demo/setup`)                 | PG `organization_setup_tasks`: 13 explicit selections (10 visible, 3 hidden), plus catalog defaults including Verify your domain; the wizard shows 11 tasks with completion projected from organization facts and saved status                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `[~]`  |
...
Onboarding selection: the seed persists 13 explicit task rows, 10 visible, with a customized Security preset. Verify your domain is additionally visible by catalog default, making 11 tasks in the wizard. Distribute servers is included and Anthropic admin controls is deferred. In Admin organization Features, verify "security - customized", apply a preset to a draft, then discard it; saved task status and assignment must remain unchanged.
