...
| Signals Intelligence (`/signals-intelligence`)                 | PG `sigint_custom_signals` ×9 + `sigint_sensors` ×4 + `sigint_sensor_signals` ×9; org `signals_intelligence` feature exposes the configuration page                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `[~]`  |
