...
SELECT
  toUUID(concat(substring(hm, 1, 8), '-', substring(hm, 9, 4), '-', substring(hm, 13, 4), '-',
                substring(hm, 17, 4), '-', substring(hm, 21, 12))),
  ts,
  'org_gram_demo_workspace',
  if(i % 3 = 0, 'dec0de00-0000-4000-a000-000000000002', 'dec0de00-0000-4000-a000-000000000001'),
  concat(substring(hmsg, 1, 8), '-', substring(hmsg, 9, 4), '-', substring(hmsg, 13, 4), '-',
         substring(hmsg, 17, 4), '-', substring(hmsg, 21, 12)),
  concat(substring(hchat, 1, 8), '-', substring(hchat, 9, 4), '-', substring(hchat, 13, 4), '-',
         substring(hchat, 17, 4), '-', substring(hchat, 21, 12)),
