...
// SkillFeedback - skillFeedback hooks
// Records agent-volunteered feedback about a distributed skill.
func (s *Hooks) SkillFeedback(ctx context.Context, request operations.SkillFeedbackRequest, security *operations.SkillFeedbackSecurity, opts ...operations.Option) (*operations.SkillFeedbackResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/rpc/hooks.skillFeedback")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.SkillFeedbackResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// UploadSkillContent - uploadSkillContent hooks
// Uploads skill manifest content requested by the unified hook ingest endpoint.
func (s *Hooks) UploadSkillContent(ctx context.Context, request operations.UploadSkillContentRequest, security *operations.UploadSkillContentSecurity, opts ...operations.Option) (*operations.UploadSkillContentResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/rpc/hooks.uploadSkillContent")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UploadSkillContentResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
