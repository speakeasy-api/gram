...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.924.0
...
type SDKOption func(*SpeakeasyHooks)
...
func New(opts ...SDKOption) *SpeakeasyHooks {
	sdk := &SpeakeasyHooks{
		SDKVersion: "0.1.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.1.0 2.924.0 0.0.1 github.com/speakeasy-api/gram/hooks/sdk",
