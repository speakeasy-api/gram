...
const GROUPS: ReadonlyArray<{
...
}> = [
  {
    title: "Registry",
    items: [
      { to: "/xaa/apps", label: "Apps" },
      { to: "/xaa/resources", label: "Resources" },
    ],
  },
  {
    title: "Policy",
    items: [
      { to: "/xaa/assignments", label: "Assignments" },
      { to: "/xaa/trust-rules", label: "Trust rules" },
    ],
  },
  {
    title: "Exercise",
    items: [
      { to: "/xaa/playground", label: "Playground" },
      { to: "/xaa/issued", label: "Issued grants" },
    ],
  },
];
