...
import { Section } from "@/components/xaa/Section";
import { cn } from "@/lib/utils";
import { useXaaApps, useXaaResources } from "@/hooks/use-xaa";

export const Route = createFileRoute("/xaa/playground")({
...
function PlaygroundPage() {
  ...
  const run = useMutation<ExchangeResult, Error, void>({
    mutationFn: async () => {
      const res = await fetch("/api/xaa-exchange", {
        method: "POST",
