 ...
 */
function useScrollToInferenceCapHash(mounted: boolean): void {
  ...
  useEffect(() => {
    ...
    const frame = window.requestAnimationFrame(() => {
      const element =
        ...
        document.getElementById(INFERENCE_CAPS_ANCHOR);
...
export function InferenceCapsSection(): JSX.Element | null {
  ...
  useScrollToInferenceCapHash(mode !== "hidden");
  ...
  return (
    ...
    <div id={INFERENCE_CAPS_ANCHOR} className="scroll-mt-24">
      <Page.Section>
