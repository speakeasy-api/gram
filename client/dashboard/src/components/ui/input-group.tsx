...
function InputGroup({
  ...
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-neutral-default bg-inset relative flex w-full items-center border transition-colors outline-none",
        ...
        // Focus state.
        "has-[[data-slot=input-group-control]:focus-visible]:border-neutral-active",
