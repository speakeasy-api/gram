import {
  createPersistedFlagStore,
  createScopedStorageStore,
} from "@/hooks/usePersistedFlagStore";

const startedStore = createPersistedFlagStore("gram-project-guide-started");
...
export function useProjectGuideStarted(
  ...
  return startedStore.useFlag(projectGuideScope(orgSlug, projectSlug));
}
