...
import { Network, Plus, Wrench } from "lucide-react";
...
function CollectionServerCards({ registrySlug }: { registrySlug: string }) {
  const client = useSdkClient();

  const { data: serversData } = useQuery({
    queryKey: ["serveMCPRegistry", registrySlug],
    queryFn: () => client.mcpRegistries.serve({ registrySlug }),
