...
// main gates this section behind a rollout hook that reads RBAC through the
// SDK context; this test renders the tab's structure, not that section.
vi.mock("@/hooks/useNetworkIngressRollout", () => ({
  useNetworkIngressRollout: () => ({
    rolloutEnabled: false,
    canManageIngress: false,
    adminRolloutEnabled: false,
  }),
}));
