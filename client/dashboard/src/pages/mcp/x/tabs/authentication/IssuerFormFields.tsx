  ...
  return (
    <Stack gap={4} className="border-t pt-6">
      <Stack gap={1}>
        <Label className="text-sm font-medium">OAuth Client Credentials</Label>
        <Type muted small>
          The platform acts as an OAuth client against the upstream issuer. Register a
  ...
  return (
    <Stack gap={4} className="border-t pt-6">
      <Stack gap={2}>
        ...
        />
        <Type muted small>
          Comma-separated. When provided, the platform requests these scopes during the
      ...
      <Stack gap={2}>
        ...
        />
        <Type muted small>
          When provided, the platform includes this audience in authorize and token
