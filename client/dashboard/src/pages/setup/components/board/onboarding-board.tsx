...
const WORKSTREAM_GRID_CLASS =
  "grid min-h-0 flex-1 grid-cols-1 justify-center gap-4 overflow-y-auto md:auto-rows-[minmax(0,1fr)] md:grid-cols-[repeat(auto-fit,minmax(0,calc((100%_-_1rem)/2)))] xl:grid-cols-[repeat(auto-fit,minmax(0,calc((100%_-_3rem)/4)))] xl:overflow-hidden";
