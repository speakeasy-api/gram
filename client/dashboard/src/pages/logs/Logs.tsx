  ...
  c3d4e5f6789012345678901234567890: [
    {
      id: "log-3-1",
      traceId: "c3d4e5f6789012345678901234567890",
      spanId: "span3456789012cd",
      body: "Sending chat completion request to OpenAI",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 300_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 300_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "openai.model": "gpt-4", "openai.max_tokens": 1024 },
    },
    {
      id: "log-3-2",
      traceId: "c3d4e5f6789012345678901234567890",
      spanId: "span3456789012cd",
      body: "Received streaming response from OpenAI",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 298_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 298_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "openai.tokens_used": 847 },
    },
  ],
  // Postgres query/execute
  e5f6789012345678901234567890efgh: [
    {
      id: "log-5-1",
      traceId: "e5f6789012345678901234567890efgh",
      spanId: "span5678901234ef",
      body: "Executing SQL query: SELECT * FROM users WHERE id = $1",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 600_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 600_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "db.system": "postgresql", "db.name": "production" },
    },
  ],
  // GitHub issues/create
  f67890123456789012345678901234ij: [
    {
      id: "log-6-1",
      traceId: "f67890123456789012345678901234ij",
      spanId: "span6789012345fg",
      body: "Creating new GitHub issue in repo speakeasy-api/gram",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 900_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 900_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-6-2",
      traceId: "f67890123456789012345678901234ij",
      spanId: "span6789012345fg",
      body: "Validating issue title and body",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 899_800_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 899_800_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-6-3",
      traceId: "f67890123456789012345678901234ij",
      spanId: "span6789012345fg",
      body: "Adding labels: bug, priority-high",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 899_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 899_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-6-4",
      traceId: "f67890123456789012345678901234ij",
      spanId: "span6789012345fg",
      body: "Assigning issue to @developer",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 899_200_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 899_200_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-6-5",
      traceId: "f67890123456789012345678901234ij",
      spanId: "span6789012345fg",
      body: "Issue created successfully: #1234",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 899_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 899_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "github.issue_number": 1234 },
    },
    {
      id: "log-6-6",
      traceId: "f67890123456789012345678901234ij",
      spanId: "span6789012345fg",
      body: "Sending Slack notification for new issue",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 898_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 898_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
  ],
  // Anthropic messages/create
  h890123456789012345678901234nopq: [
    {
      id: "log-8-1",
      traceId: "h890123456789012345678901234nopq",
      spanId: "span8901234567hi",
      body: "Sending message to Claude API",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 1500_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 1500_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "anthropic.model": "claude-3-opus-20240229" },
    },
    {
      id: "log-8-2",
      traceId: "h890123456789012345678901234nopq",
      spanId: "span8901234567hi",
      body: "Processing tool use request from Claude",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 1498_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 1498_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-8-3",
      traceId: "h890123456789012345678901234nopq",
      spanId: "span8901234567hi",
      body: "Response received: 2,341 tokens",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 1496_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 1496_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
  ],
  // Linear issues/list
  i90123456789012345678901234rstuv: [
    {
      id: "log-9-1",
      traceId: "i90123456789012345678901234rstuv",
      spanId: "span9012345678ij",
      body: "Fetching issues from Linear workspace",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 1800_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 1800_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-9-2",
      traceId: "i90123456789012345678901234rstuv",
      spanId: "span9012345678ij",
      body: "Retrieved 28 issues matching filter",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 1798_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 1798_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "linear.team": "Engineering", "linear.count": 28 },
    },
  ],
  // Notion pages/create (404 error)
  j0123456789012345678901234wxyz12: [
    {
      id: "log-10-1",
      traceId: "j0123456789012345678901234wxyz12",
      spanId: "spana012345678jk",
      body: "Creating new Notion page in database",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 2100_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2100_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-10-2",
      traceId: "j0123456789012345678901234wxyz12",
      spanId: "spana012345678jk",
      body: "Database not found: abc123-def456-ghi789",
      severityText: "ERROR",
      timeUnixNano: Date.now() * 1_000_000 - 2099_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2099_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "notion.error": "object_not_found" },
    },
    {
      id: "log-10-3",
      traceId: "j0123456789012345678901234wxyz12",
      ...
      severityText: "ERROR",
      timeUnixNano: Date.now() * 1_000_000 - 2099_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2099_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
  ],
  // Stripe payments/process
  k123456789012345678901234567890a: [
    {
      id: "log-11-1",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "Processing payment for order #ORD-2024-1234",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 2400_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2400_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-11-2",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "Validating payment method: pm_card_visa",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 2399_800_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2399_800_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-11-3",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "Creating payment intent: $149.99 USD",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 2399_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2399_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "stripe.amount": 14999, "stripe.currency": "usd" },
    },
    {
      id: "log-11-4",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "3D Secure authentication required",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 2399_200_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2399_200_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-11-5",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "3D Secure authentication successful",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 2398_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2398_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-11-6",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "Payment confirmed: pi_abc123def456",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 2397_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2397_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-11-7",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "Sending payment confirmation email",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 2397_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2397_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
    {
      id: "log-11-8",
      traceId: "k123456789012345678901234567890a",
      spanId: "spanb123456789kl",
      body: "Updating inventory for order items",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 2396_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2396_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
  ],
  // SendGrid emails/send
  l23456789012345678901234567890bc: [
    {
      id: "log-12-1",
      traceId: "l23456789012345678901234567890bc",
      spanId: "spanc234567890lm",
      body: "Sending email via SendGrid",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 2700_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2700_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: {
    ...
    },
    {
      ...
      traceId: "l23456789012345678901234567890bc",
      spanId: "spanc234567890lm",
      body: "Email queued successfully: msg_abc123",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 2699_500_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 2699_500_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
    },
  ],
  // Twilio sms/send
  m3456789012345678901234567890def: [
    {
      id: "log-13-1",
      traceId: "m3456789012345678901234567890def",
      spanId: "spand345678901mn",
      body: "Sending SMS via Twilio to +1234567890",
      severityText: "INFO",
      timeUnixNano: Date.now() * 1_000_000 - 3000_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 3000_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: { "twilio.to": "+1234567890" },
    },
  ],
  // Redis cache/get
  n456789012345678901234567890ghij: [
    {
      id: "log-14-1",
      traceId: "n456789012345678901234567890ghij",
      spanId: "spane456789012no",
      body: "GET user:session:abc123",
      severityText: "DEBUG",
      timeUnixNano: Date.now() * 1_000_000 - 3300_000_000_000,
      observedTimeUnixNano: Date.now() * 1_000_000 - 3300_000_000_000,
      service: { name: "gram-mcp", version: "1.0.0" },
      attributes: {
        "redis.command": "GET",
        "redis.key": "user:session:abc123",
      },
    },
  ],
  // Elasticsearch search/query (error)
