...
export function OnboardingBanner({
  ...
  const body = next
    ...
    : state?.answers
      ? "Your stack is saved. Pick the use case to reach first and get your next step."
      : "Describe your stack and pick a use case; you get the one thing to do first, verified against real traffic.";
