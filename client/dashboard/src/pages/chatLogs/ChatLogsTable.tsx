        ...
        return (
          <button
            ...
            className={cn(
              ...
              "hover:bg-muted/30",
              isSelected && "bg-primary/5 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-primary"
            )}
          >
            <div className="flex items-start gap-3 mb-2">
              ...
              {status === "failure" && (
                <Icon name="x-circle" className="size-4 text-danger" />
              )}
              {status === "unresolved" && (
