      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        {isFunctionsEnabled && (
          <ChoiceCard
            ...
            description="Deploy custom functions using the platform CLI"
          />
        )}
      </div>
    </>
...
const CliSetupStep = ({
  ...
  return (
    <>
      <Stack gap={1}>
        <span className="text-heading-md">Get Started with platform functions</span>
        <span className="text-body-sm">
  ...
  return (
    <>
      <Stack gap={1}>
        ...
        <span className="text-body-sm">
          This MCP server will hold the tools you've added to the platform. We'll make
