...
> = {
  secrets: {
    label: "Secrets",
    title: "API keys, tokens, private keys, credentials",
    icon: "key-round",
  },
  financial: {
    label: "Financial Information",
    title: "Credit cards, bank accounts, routing numbers, IBAN codes",
    icon: "credit-card",
  },
  pii: {
    label: "Personal Identifiable Information",
    title: "Names, addresses, phone numbers, email addresses",
    icon: "user",
  },
  government_ids: {
    label: "Government Identifiers",
    title: "SSNs, passport numbers, driver's licenses, tax IDs",
    icon: "landmark",
  },
  healthcare: {
    label: "Healthcare Information",
    title: "Medical record numbers, patient data, Medicare IDs",
    icon: "heart-pulse",
  },
  prompt_attacks: {
    label: "Prompt Attacks",
    title: "Jailbreak attempts, role overrides, safety bypasses",
    icon: "shield-alert",
  },
  prompt_injection: {
    label: "Prompt Injection",
    title: "Indirect injection via tool outputs, hidden instructions",
    icon: "syringe",
  },
  off_policy: {
  ...
  custom: {
    ...
    title: "Organization-specific data patterns (regex)",
    icon: "regex",
  },
};
...
> = {
  user_messages: {
    label: "User Messages",
    title: "Messages sent by users in chat",
  },
  system_messages: {
    label: "System Messages",
    title: "System prompts and assistant responses",
  },
  llm_responses: {
    label: "LLM Responses",
    title: "Responses generated by the language model",
  },
  tool_arguments: {
    label: "Tool Arguments",
    title: "Arguments passed to tool calls",
  },
  tool_responses: {
    label: "Tool Responses",
    title: "Data returned from tool executions",
  },
};
