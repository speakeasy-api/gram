    ...
    <>
      <WorkbenchLayout>
        <WorkbenchLayout.Header
          eyebrow="Elements"
          title="Chat Elements"
          subtitle="Embeddable AI chat experience for your applications"
          actions={
            <Tabs
              value={installMethod}
        ...
        <WorkbenchLayout.Body
          config={
            <div
              className={cn(
                "flex h-full flex-col space-y-6 overflow-y-auto p-6",
                installMethod !== "manual" && "hidden",
              )}
            >
              {/* Connection */}
              <ConfigSection
                ...
                >
                  <div className="space-y-3">
                    {toolsetsLoading ? (
                      ...
                      <div className="text-muted-foreground text-sm">
                        No MCP servers available. Add a source to create one.
                      </div>
                    ) : (
                      <Select
                        value={config.mcp}
              ...
              >
                <ConfigField label="Variant" description="Layout style">
                  <Select
                    ...
                    onValueChange={(v) => updateConfig("variant", v as Variant)}
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue />
                    </SelectTrigger>
                ...
                <ConfigField label="Density" description="Spacing density">
                  <Select
                    ...
                    onValueChange={(v) => updateConfig("density", v as Density)}
                  >
                    <SelectTrigger className="w-full">
                      <SelectValue />
                    </SelectTrigger>
              ...
              <ConfigSection
                ...
                onToggle={() =>
                  setOpenSection((prev) => (prev === "model" ? null : "model"))
                }
              >
                <SwitchField
              ...
              <ConfigSection
                ...
                onToggle={() =>
                  setOpenSection((prev) => (prev === "tools" ? null : "tools"))
                }
              >
                <SwitchField
