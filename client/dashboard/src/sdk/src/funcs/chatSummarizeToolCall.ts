...
import {
  ...
  SummarizeToolCallResult$inboundSchema,
} from "../models/components/summarizetoolcallresult.js";
...
import {
  ...
  SummarizeToolCallRequest$outboundSchema,
 ...
 */
export function chatSummarizeToolCall(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(SummarizeToolCallRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.SummarizeToolCallRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/chat.summarizeToolCall")();
