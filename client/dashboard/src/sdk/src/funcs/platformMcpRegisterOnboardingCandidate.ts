...
import {
  ...
  RegisterPlatformMCPOnboardingCandidateRequest$outboundSchema,
 ...
 */
export function platformMcpRegisterOnboardingCandidate(
  client: GramCore,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.RegisterOnboardingCandidateRequestBody,
    { explode: true },
  );

  const path = pathToFunc("/rpc/platformMcp.registerOnboardingCandidate")();
  ...
  const context = {
    ...
    operationID: "registerPlatformMCPOnboardingCandidate",
    oAuth2Scopes: null,
