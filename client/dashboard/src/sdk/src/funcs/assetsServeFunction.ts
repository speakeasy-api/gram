...
import {
  ...
  ServeFunctionRequest$outboundSchema,
  ServeFunctionResponse,
  ServeFunctionResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ServeFunctionRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, ServeFunctionResponse$inboundSchema, {
