...
import {
  ...
  ListMcpServersResult$inboundSchema,
} from "../models/components/listmcpserversresult.js";
...
import {
  ...
  ListMcpServersRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(z.optional(ListMcpServersRequest$outboundSchema), value),
  ...
  const query = encodeFormQuery({
    ...
    "unproxied_mcp_server_id": payload?.unproxied_mcp_server_id,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListMcpServersResult$inboundSchema),
