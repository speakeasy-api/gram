...
} from "../models/components/triggerinstance.js";
...
import {
  ...
  CreateTriggerInstanceRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateTriggerInstanceRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateTriggerInstanceForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/triggers.create")();
