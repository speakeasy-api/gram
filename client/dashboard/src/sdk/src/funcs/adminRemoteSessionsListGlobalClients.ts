...
import {
  ...
  ListGlobalRemoteSessionClientsRequest$outboundSchema,
  ListGlobalRemoteSessionClientsResponse,
  ListGlobalRemoteSessionClientsResponse$inboundSchema,
 ...
 */
export function adminRemoteSessionsListGlobalClients(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(ListGlobalRemoteSessionClientsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/adminRemoteSessions.listGlobalClients")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListGlobalRemoteSessionClientsResponse$inboundSchema, {
      key: "Result",
    }),
