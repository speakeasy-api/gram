...
import {
  ...
  ListServersResponseBody$inboundSchema,
} from "../models/components/listserversresponsebody.js";
...
import {
  ...
  ListCollectionServersRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ListCollectionServersRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/collections.listServers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListServersResponseBody$inboundSchema),
