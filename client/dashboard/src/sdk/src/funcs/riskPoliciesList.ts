...
import {
  ...
  ListRiskPoliciesResult$inboundSchema,
} from "../models/components/listriskpoliciesresult.js";
...
import {
  ...
  ListRiskPoliciesRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListRiskPoliciesRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListRiskPoliciesResult$inboundSchema),
