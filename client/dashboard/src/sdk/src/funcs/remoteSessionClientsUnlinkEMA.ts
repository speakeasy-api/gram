...
import {
  UnlinkEMARequest,
  UnlinkEMARequest$outboundSchema,
  UnlinkEMASecurity,
 ...
 */
export function remoteSessionClientsUnlinkEMA(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UnlinkEMARequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UnlinkEMARequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/remoteSessionClients.unlinkEMA")();
