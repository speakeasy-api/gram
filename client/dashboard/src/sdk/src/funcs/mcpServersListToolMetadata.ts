...
import {
  ...
  ListToolMetadataResult$inboundSchema,
} from "../models/components/listtoolmetadataresult.js";
...
import {
  ...
  ListMcpServerToolMetadataRequest$outboundSchema,
 ...
 */
export function mcpServersListToolMetadata(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ListMcpServerToolMetadataRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/mcpServers.listToolMetadata")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListToolMetadataResult$inboundSchema),
