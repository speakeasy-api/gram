...
import {
  GetPluginRequest,
  GetPluginRequest$outboundSchema,
  GetPluginSecurity,
 ...
 */
export function pluginsGetPlugin(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetPluginRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/plugins.getPlugin")();
