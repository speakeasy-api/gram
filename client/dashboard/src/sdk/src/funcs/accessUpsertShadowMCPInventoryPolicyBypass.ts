...
import {
  ...
  UpsertShadowMCPInventoryPolicyBypassRequest$outboundSchema,
 ...
 */
export function accessUpsertShadowMCPInventoryPolicyBypass(
  client: GramCore,
...
> {
  ...
  const body = encodeJSON("body", payload.ShadowMCPInventoryPolicyBypassForm, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "upsertShadowMCPInventoryPolicyBypass",
    oAuth2Scopes: null,
