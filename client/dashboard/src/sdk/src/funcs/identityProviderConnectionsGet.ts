...
import {
  ...
  GetIdentityProviderConnectionResult$inboundSchema,
} from "../models/components/getidentityproviderconnectionresult.js";
...
import {
  ...
  GetIdentityProviderConnectionRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(GetIdentityProviderConnectionRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/identityProviderConnections.get")();
  ...
  const context = {
    ...
    operationID: "getIdentityProviderConnection",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetIdentityProviderConnectionResult$inboundSchema),
