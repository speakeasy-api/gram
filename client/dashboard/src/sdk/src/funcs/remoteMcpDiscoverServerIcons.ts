...
import {
  ...
  DiscoverServerIconsResult$inboundSchema,
} from "../models/components/discoverservericonsresult.js";
...
import {
  ...
  DiscoverRemoteMcpServerIconsRequest$outboundSchema,
 ...
 */
export function remoteMcpDiscoverServerIcons(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(DiscoverRemoteMcpServerIconsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/remoteMcp.discoverServerIcons")();
  ...
  const context = {
    ...
    operationID: "discoverRemoteMcpServerIcons",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DiscoverServerIconsResult$inboundSchema),
