...
import {
  ...
  UpdateShadowMCPInventoryServerNameRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(UpdateShadowMCPInventoryServerNameRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.UpdateShadowMCPInventoryServerNameForm,
    { explode: true },
  );

  const path = pathToFunc("/rpc/access.updateShadowMCPInventoryServerName")();
