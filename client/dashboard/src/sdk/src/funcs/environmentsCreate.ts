...
} from "../models/components/environment.js";
...
import {
  ...
  CreateEnvironmentRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateEnvironmentRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateEnvironmentForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/environments.create")();
