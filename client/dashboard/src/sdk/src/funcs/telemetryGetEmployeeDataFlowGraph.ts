...
import {
  ...
  GetEmployeeDataFlowGraphResult$inboundSchema,
} from "../models/components/getemployeedataflowgraphresult.js";
...
import {
  ...
  GetEmployeeDataFlowGraphRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetEmployeeDataFlowGraphRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetEmployeeDataFlowGraphResult$inboundSchema),
