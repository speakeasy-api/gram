...
import {
  ...
  UploadFunctionsResult$inboundSchema,
} from "../models/components/uploadfunctionsresult.js";
...
import {
  ...
  UploadFunctionsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UploadFunctionsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UploadFunctionsResult$inboundSchema),
