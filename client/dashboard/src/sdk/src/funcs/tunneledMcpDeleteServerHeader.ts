...
import {
  ...
  DeleteTunneledMcpServerHeaderRequest$outboundSchema,
 ...
 */
export function tunneledMcpDeleteServerHeader(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(DeleteTunneledMcpServerHeaderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/tunneledMcp.deleteServerHeader")();
  ...
  const context = {
    ...
    operationID: "deleteTunneledMcpServerHeader",
    oAuth2Scopes: null,
