...
import {
  ...
  RefreshRemoteSessionIssuerMetadataRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(RefreshRemoteSessionIssuerMetadataRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/remoteSessionIssuers.refreshMetadata")();
