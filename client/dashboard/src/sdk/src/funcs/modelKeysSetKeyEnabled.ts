...
import {
  ...
  SetModelProviderKeyEnabledRequest$outboundSchema,
 ...
 */
export function modelKeysSetKeyEnabled(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(SetModelProviderKeyEnabledRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.SetKeyEnabledRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/modelKeys.setKeyEnabled")();
