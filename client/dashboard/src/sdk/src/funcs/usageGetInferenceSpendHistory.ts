...
import {
  ...
  InferenceSpendHistory$inboundSchema,
} from "../models/components/inferencespendhistory.js";
...
import {
  ...
  GetInferenceSpendHistoryRequest$outboundSchema,
 ...
 */
export function usageGetInferenceSpendHistory(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(GetInferenceSpendHistoryRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/usage.getInferenceSpendHistory")();
  ...
  const context = {
    ...
    operationID: "getInferenceSpendHistory",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, InferenceSpendHistory$inboundSchema),
