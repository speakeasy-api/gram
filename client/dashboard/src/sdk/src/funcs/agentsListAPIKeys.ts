...
import {
  ...
  ListAPIKeysResponseBody$inboundSchema,
} from "../models/components/listapikeysresponsebody.js";
...
import {
  ...
  ListAgentAPIKeysRequest$outboundSchema,
 ...
 */
export function agentsListAPIKeys(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ListAgentAPIKeysRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/agents.listAPIKeys")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListAPIKeysResponseBody$inboundSchema),
