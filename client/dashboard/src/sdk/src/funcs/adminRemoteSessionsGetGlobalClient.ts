...
import {
  ...
  GetGlobalRemoteSessionClientRequest$outboundSchema,
 ...
 */
export function adminRemoteSessionsGetGlobalClient(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(GetGlobalRemoteSessionClientRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/adminRemoteSessions.getGlobalClient")();
