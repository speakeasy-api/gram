...
import {
  ...
  DeleteOrganizationRemoteSessionClientRequest$outboundSchema,
 ...
 */
export function organizationRemoteSessionClientsDelete(
  client: GramCore,
...
> {
  ...
  const path = pathToFunc("/rpc/organizationRemoteSessionClients.delete")();
