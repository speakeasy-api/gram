...
import {
  ...
  GramGatewayToolsetReview$inboundSchema,
} from "../models/components/gramgatewaytoolsetreview.js";
...
import {
  ...
  PreviewGatewayToolsetRequest$outboundSchema,
 ...
 */
export function userSessionsPreviewGatewayToolset(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(PreviewGatewayToolsetRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.PreviewGatewayToolsetRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/userSessions.previewGatewayToolset")();
  ...
  const context = {
    ...
    operationID: "previewGatewayToolset",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GramGatewayToolsetReview$inboundSchema),
