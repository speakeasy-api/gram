...
import {
  ...
  RiskUnmaskResultResult$inboundSchema,
} from "../models/components/riskunmaskresultresult.js";
...
import {
  ...
  UnmaskRiskResultRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UnmaskRiskResultRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RiskUnmaskResultResult$inboundSchema),
