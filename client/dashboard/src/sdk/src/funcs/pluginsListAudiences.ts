...
import {
  ListAudiencesResult,
  ListAudiencesResult$inboundSchema,
} from "../models/components/listaudiencesresult.js";
...
import {
  ...
  ListAudiencesRequest$outboundSchema,
 ...
 */
export function pluginsListAudiences(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(z.optional(ListAudiencesRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/plugins.listAudiences")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListAudiencesResult$inboundSchema),
