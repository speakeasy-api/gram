...
import {
  ...
  PublishPluginsResult$inboundSchema,
} from "../models/components/publishpluginsresult.js";
...
import {
  ...
  PublishPluginsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(PublishPluginsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, PublishPluginsResult$inboundSchema),
