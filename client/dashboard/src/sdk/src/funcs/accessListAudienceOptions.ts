...
import {
  ...
  ListAudienceOptionsResult$inboundSchema,
} from "../models/components/listaudienceoptionsresult.js";
...
import {
  ...
  ListAudienceOptionsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListAudienceOptionsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/access.listAudienceOptions")();
  ...
  const context = {
    ...
    operationID: "listAudienceOptions",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListAudienceOptionsResult$inboundSchema),
