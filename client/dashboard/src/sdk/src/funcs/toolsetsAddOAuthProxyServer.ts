...
import {
  ...
  AddOAuthProxyServerRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(AddOAuthProxyServerRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.AddOAuthProxyServerRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/toolsets.addOAuthProxyServer")();
  ...
  const context = {
    ...
    operationID: "addOAuthProxyServer",
    oAuth2Scopes: null,
