...
import {
  ...
  SummarizeToolActivityResult$inboundSchema,
} from "../models/components/summarizetoolactivityresult.js";
...
import {
  ...
  SummarizeToolActivityRequest$outboundSchema,
 ...
 */
export function chatSummarizeToolActivity(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(SummarizeToolActivityRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.SummarizeToolActivityRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/chat.summarizeToolActivity")();
  ...
  const context = {
    ...
    operationID: "summarizeToolActivity",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, SummarizeToolActivityResult$inboundSchema),
