...
import {
  ...
  ListCatalogResponseBody$inboundSchema,
} from "../models/components/listcatalogresponsebody.js";
...
import {
  ...
  ListMCPCatalogRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(z.optional(ListMCPCatalogRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListCatalogResponseBody$inboundSchema),
