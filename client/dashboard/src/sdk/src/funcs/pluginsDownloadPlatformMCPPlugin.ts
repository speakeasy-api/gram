...
import {
  ...
  DownloadPlatformMCPPluginRequest$outboundSchema,
  DownloadPlatformMCPPluginResponse,
  DownloadPlatformMCPPluginResponse$inboundSchema,
 ...
 */
export function pluginsDownloadPlatformMCPPlugin(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(DownloadPlatformMCPPluginRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/plugins.downloadPlatformMCPPlugin")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, DownloadPlatformMCPPluginResponse$inboundSchema, {
