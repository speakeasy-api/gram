...
import {
  ...
  UpdateRemoteMcpServerHeaderRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(UpdateRemoteMcpServerHeaderRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateServerHeaderForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/remoteMcp.updateServerHeader")();
