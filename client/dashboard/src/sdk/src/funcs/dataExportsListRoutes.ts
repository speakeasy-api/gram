...
import {
  ...
  ListDataExportRoutesResult$inboundSchema,
} from "../models/components/listdataexportroutesresult.js";
...
import {
  ...
  ListDataExportRoutesRequest$outboundSchema,
 ...
 */
export function dataExportsListRoutes(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListDataExportRoutesRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/dataExports.listRoutes")();
  ...
  const context = {
    ...
    operationID: "listDataExportRoutes",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListDataExportRoutesResult$inboundSchema),
