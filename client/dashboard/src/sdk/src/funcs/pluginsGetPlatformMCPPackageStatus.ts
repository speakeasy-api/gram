...
import {
  ...
  PlatformMCPPackageStatusResult$inboundSchema,
} from "../models/components/platformmcppackagestatusresult.js";
...
import {
  ...
  GetPlatformMCPPackageStatusRequest$outboundSchema,
 ...
 */
export function pluginsGetPlatformMCPPackageStatus(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(GetPlatformMCPPackageStatusRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/plugins.getPlatformMCPPackageStatus")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, PlatformMCPPackageStatusResult$inboundSchema),
