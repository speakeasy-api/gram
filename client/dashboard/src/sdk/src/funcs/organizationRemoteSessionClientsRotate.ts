...
import {
  ...
  RotateOrganizationRemoteSessionClientRequest$outboundSchema,
 ...
 */
export function organizationRemoteSessionClientsRotate(
  client: GramCore,
...
> {
  ...
  const path = pathToFunc("/rpc/organizationRemoteSessionClients.rotate")();
  ...
  const context = {
    ...
    operationID: "rotateOrganizationRemoteSessionClient",
    oAuth2Scopes: null,
