...
import {
  ...
  ListIdentityProviderApplicationsResult$inboundSchema,
} from "../models/components/listidentityproviderapplicationsresult.js";
...
import {
  ...
  ListIdentityProviderApplicationsRequest$outboundSchema,
 ...
 */
export function identityProvidersListApplications(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(ListIdentityProviderApplicationsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/identityProviders.listApplications")();
  ...
  const context = {
    ...
    operationID: "listIdentityProviderApplications",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListIdentityProviderApplicationsResult$inboundSchema),
