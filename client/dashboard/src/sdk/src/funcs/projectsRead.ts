...
import {
  GetProjectResult,
  GetProjectResult$inboundSchema,
} from "../models/components/getprojectresult.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetProjectRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/projects.get")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetProjectResult$inboundSchema),
