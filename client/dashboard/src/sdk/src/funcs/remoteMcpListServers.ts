...
import {
  ListServersResult,
  ListServersResult$inboundSchema,
} from "../models/components/listserversresult.js";
...
import {
  ...
  ListRemoteMcpServersRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListRemoteMcpServersRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListServersResult$inboundSchema),
