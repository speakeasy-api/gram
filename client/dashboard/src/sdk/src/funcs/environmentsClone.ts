 ...
 */
export function environmentsClone(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CloneEnvironmentRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CloneEnvironmentRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/environments.clone")();
