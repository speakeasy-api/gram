...
import {
  ...
  KillswitchBatchUserBadgesResult$inboundSchema,
} from "../models/components/killswitchbatchuserbadgesresult.js";
...
> {
  ...
  const body = encodeJSON("body", payload.KillswitchBatchUserBadgesRequest, {
    explode: true,
  });

  const path = pathToFunc("/rpc/killswitches.batchUserBadges")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, KillswitchBatchUserBadgesResult$inboundSchema),
