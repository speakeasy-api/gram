...
import {
  ...
  BatchUserBadgesResponseBody$inboundSchema,
} from "../models/components/batchuserbadgesresponsebody.js";
...
> {
  ...
  const body = encodeJSON("body", payload.BatchUserBadgesRequestBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, BatchUserBadgesResponseBody$inboundSchema),
