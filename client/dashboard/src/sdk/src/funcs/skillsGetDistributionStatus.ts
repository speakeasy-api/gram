...
import {
  ...
  SkillDistributionStatus$inboundSchema,
} from "../models/components/skilldistributionstatus.js";
...
import {
  ...
  GetSkillDistributionStatusRequest$outboundSchema,
 ...
 */
export function skillsGetDistributionStatus(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetSkillDistributionStatusRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/skills.getDistributionStatus")();
  ...
  const context = {
    ...
    operationID: "getSkillDistributionStatus",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, SkillDistributionStatus$inboundSchema),
