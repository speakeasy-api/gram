...
import {
  ...
  CreateDeploymentResult$inboundSchema,
} from "../models/components/createdeploymentresult.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateDeploymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/deployments.create")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateDeploymentResult$inboundSchema),
