...
} from "../models/components/shadowmcpapprovalrequest.js";
...
import {
  ...
  CreateShadowMCPApprovalRequestRequest$outboundSchema,
 ...
 */
export function accessCreateShadowMCPApprovalRequest(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CreateShadowMCPApprovalRequestRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/access.createShadowMcpRequest")();
  ...
  const context = {
    ...
    operationID: "createShadowMCPApprovalRequest",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, ShadowMCPApprovalRequest$inboundSchema),
