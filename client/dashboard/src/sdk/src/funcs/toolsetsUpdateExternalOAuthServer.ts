...
} from "../models/components/toolset.js";
...
import {
  ...
  UpdateExternalOAuthServerRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpdateExternalOAuthServerRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.UpdateExternalOAuthServerRequestBody,
    { explode: true },
  );

  const path = pathToFunc("/rpc/toolsets.updateExternalOAuthServer")();
  ...
  const context = {
    ...
    operationID: "updateExternalOAuthServer",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, Toolset$inboundSchema),
