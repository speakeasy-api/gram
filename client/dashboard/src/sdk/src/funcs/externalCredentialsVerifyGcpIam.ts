...
import {
  ...
  VerifyCredentialResult$inboundSchema,
} from "../models/components/verifycredentialresult.js";
...
import {
  ...
  VerifyGcpIamCredentialRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(VerifyGcpIamCredentialRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/externalCredentials.verifyGcpIam")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, VerifyCredentialResult$inboundSchema),
    M.jsonErr(
