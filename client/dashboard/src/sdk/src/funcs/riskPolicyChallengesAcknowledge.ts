...
import {
  ...
  AcknowledgeRiskPolicyChallengeResponseBody$inboundSchema,
} from "../models/components/acknowledgeriskpolicychallengeresponsebody.js";
...
import {
  ...
  AcknowledgeRiskPolicyChallengeRequest$outboundSchema,
 ...
 */
export function riskPolicyChallengesAcknowledge(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(AcknowledgeRiskPolicyChallengeRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.AcknowledgeRiskPolicyChallengeRequestBody,
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, AcknowledgeRiskPolicyChallengeResponseBody$inboundSchema),
