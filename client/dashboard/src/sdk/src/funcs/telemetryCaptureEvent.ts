...
import {
  CaptureEventResult,
  CaptureEventResult$inboundSchema,
} from "../models/components/captureeventresult.js";
...
import {
  CaptureEventRequest,
  CaptureEventRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CaptureEventRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CaptureEventPayload, {
    explode: true,
  });

  const path = pathToFunc("/rpc/telemetry.captureEvent")();
