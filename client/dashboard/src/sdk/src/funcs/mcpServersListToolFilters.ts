...
import {
  ...
  ListMcpServerToolFiltersRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(ListMcpServerToolFiltersRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/mcpServers.listToolFilters")();
