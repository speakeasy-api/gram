...
import {
  RiskExclusion,
  RiskExclusion$inboundSchema,
} from "../models/components/riskexclusion.js";
...
import {
  ...
  CreateRiskExclusionRequest$outboundSchema,
 ...
 */
export function riskExclusionsCreate(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateRiskExclusionRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateRiskExclusionRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/risk.createExclusions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RiskExclusion$inboundSchema),
