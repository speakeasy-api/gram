...
import {
  ...
  RevokeAgentAPIKeyRequest$outboundSchema,
 ...
 */
export function agentsRevokeAPIKey(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(RevokeAgentAPIKeyRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/agents.revokeAPIKey")();
