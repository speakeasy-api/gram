...
import {
  ...
  AgentPolicyGrantForm$inboundSchema,
} from "../models/components/agentpolicygrantform.js";
...
import {
  ...
  ListAgentDelegableGrantsRequest$outboundSchema,
 ...
 */
export function agentsListDelegableGrants(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ListAgentDelegableGrantsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/agents.listDelegableGrants")();
  ...
  const context = {
    ...
    operationID: "listAgentDelegableGrants",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(AgentPolicyGrantForm$inboundSchema)),
