...
import {
  GetAssistantRequest,
  GetAssistantRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetAssistantRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/assistants.get")();
