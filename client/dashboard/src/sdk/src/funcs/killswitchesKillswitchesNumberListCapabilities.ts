...
import {
  ...
  KillswitchesNumberListCapabilitiesRequest$outboundSchema,
 ...
 */
export function killswitchesKillswitchesNumberListCapabilities(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(KillswitchesNumberListCapabilitiesRequest$outboundSchema),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "killswitches#listCapabilities",
    oAuth2Scopes: null,
