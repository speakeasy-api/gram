...
import {
  ...
  CreateTunneledMcpServerHeaderRequest$outboundSchema,
 ...
 */
export function tunneledMcpCreateServerHeader(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CreateTunneledMcpServerHeaderRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateTunneledMcpServerHeaderForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/tunneledMcp.createServerHeader")();
  ...
  const context = {
    ...
    operationID: "createTunneledMcpServerHeader",
    oAuth2Scopes: null,
