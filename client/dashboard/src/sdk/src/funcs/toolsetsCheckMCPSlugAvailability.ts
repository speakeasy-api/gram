...
import {
  ...
  CheckMCPSlugAvailabilityRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CheckMCPSlugAvailabilityRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/toolsets.checkMCPSlugAvailability")();
