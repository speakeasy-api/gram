...
import {
  ...
  ListDirectoryMappingsResult$inboundSchema,
} from "../models/components/listdirectorymappingsresult.js";
...
import {
  ...
  ListDirectoryMappingsRequest$outboundSchema,
 ...
 */
export function accessListDirectoryMappings(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListDirectoryMappingsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/access.listDirectoryMappings")();
  ...
  const context = {
    ...
    operationID: "listDirectoryMappings",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListDirectoryMappingsResult$inboundSchema),
