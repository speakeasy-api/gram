...
import {
  ...
  ShadowMCPInventoryURLState$inboundSchema,
} from "../models/components/shadowmcpinventoryurlstate.js";
...
import {
  ...
  ResolveShadowMCPInventoryRequestRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(ResolveShadowMCPInventoryRequestRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.ResolveShadowMCPInventoryRequestForm,
    { explode: true },
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ShadowMCPInventoryURLState$inboundSchema),
