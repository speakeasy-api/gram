...
import {
  ...
  ListIntegrationsResult$inboundSchema,
} from "../models/components/listintegrationsresult.js";
...
import {
  ...
  ListIntegrationsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListIntegrationsRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListIntegrationsResult$inboundSchema),
