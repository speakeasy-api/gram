...
import {
  ...
  UpdateGcpKmsKeyRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpdateGcpKmsKeyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateGcpKmsKeyRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/externalKeys.updateGcpKms")();
