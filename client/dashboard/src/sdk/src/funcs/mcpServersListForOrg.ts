...
import {
  ...
  ListMcpServersForOrgRequest$outboundSchema,
 ...
 */
export function mcpServersListForOrg(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListMcpServersForOrgRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/mcpServers.listForOrg")();
