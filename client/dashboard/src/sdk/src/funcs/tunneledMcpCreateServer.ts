...
import {
  ...
  CreateTunneledMcpServerResult$inboundSchema,
} from "../models/components/createtunneledmcpserverresult.js";
...
import {
  ...
  CreateTunneledMcpServerRequest$outboundSchema,
 ...
 */
export function tunneledMcpCreateServer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateTunneledMcpServerRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateTunneledMcpServerForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/tunneledMcp.createServer")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateTunneledMcpServerResult$inboundSchema),
