...
} from "../models/components/directorymapping.js";
...
import {
  ...
  UpsertDirectoryMappingRequest$outboundSchema,
 ...
 */
export function accessUpsertDirectoryMapping(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpsertDirectoryMappingRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpsertDirectoryMappingForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/access.upsertDirectoryMapping")();
  ...
  const context = {
    ...
    operationID: "upsertDirectoryMapping",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DirectoryMapping$inboundSchema),
