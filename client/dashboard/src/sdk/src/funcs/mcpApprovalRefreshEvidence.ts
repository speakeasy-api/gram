...
import {
  ...
  RefreshMcpApprovalEvidenceRequest$outboundSchema,
 ...
 */
export function mcpApprovalRefreshEvidence(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(RefreshMcpApprovalEvidenceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/mcpApproval.refreshEvidence")();
