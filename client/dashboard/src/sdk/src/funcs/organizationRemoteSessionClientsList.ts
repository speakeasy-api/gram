...
import {
  ...
  ListOrganizationRemoteSessionClientsRequest$outboundSchema,
  ListOrganizationRemoteSessionClientsResponse,
  ListOrganizationRemoteSessionClientsResponse$inboundSchema,
 ...
 */
export function organizationRemoteSessionClientsList(
  client: GramCore,
...
> {
  ...
  const path = pathToFunc("/rpc/organizationRemoteSessionClients.list")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListOrganizationRemoteSessionClientsResponse$inboundSchema, {
      key: "Result",
    }),
