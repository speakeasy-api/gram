...
import {
  ...
  CreateMcpEndpointRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateMcpEndpointRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateMcpEndpointForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/mcpEndpoints.create")();
