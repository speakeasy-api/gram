...
import {
  ...
  ListCimdClientPresetsResult$inboundSchema,
} from "../models/components/listcimdclientpresetsresult.js";
...
import {
  ...
  ListCimdClientPresetsRequest$outboundSchema,
 ...
 */
export function userSessionIssuersCimdClientsListPresets(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListCimdClientPresetsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/userSessionIssuersCimdClients.listPresets")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListCimdClientPresetsResult$inboundSchema),
