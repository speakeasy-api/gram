...
import {
  ...
  CreateCimdRemoteSessionClientRequest$outboundSchema,
 ...
 */
export function remoteSessionClientsCreateCimd(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CreateCimdRemoteSessionClientRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateCimdForm, { explode: true });

  const path = pathToFunc("/rpc/remoteSessionClients.createCimd")();
