...
import {
  ...
  DisableWebhooksRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(DisableWebhooksRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/organizations.disableWebhooks")();
