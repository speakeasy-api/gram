...
import {
  ...
  ExportOktaResourceConnectionsChecklistRequest$outboundSchema,
  ExportOktaResourceConnectionsChecklistResponse,
  ExportOktaResourceConnectionsChecklistResponse$inboundSchema,
 ...
 */
export function oktaResourceConnectionsExportChecklist(
  client: GramCore,
...
> {
  ...
  const path = pathToFunc("/rpc/oktaResourceConnections.exportChecklist")();
  ...
  const context = {
    ...
    operationID: "exportOktaResourceConnectionsChecklist",
    oAuth2Scopes: null,
  ...
  >(
    M.stream(
      200,
      ExportOktaResourceConnectionsChecklistResponse$inboundSchema,
      { ctype: "text/*", hdrs: true, key: "Result" },
    ),
    M.jsonErr(
