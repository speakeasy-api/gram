...
import {
  ...
  LitellmActingPrincipalResult$inboundSchema,
} from "../models/components/litellmactingprincipalresult.js";
...
import {
  ...
  MintLiteLLMActingPrincipalRequest$outboundSchema,
 ...
 */
export function litellmMintActingPrincipal(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(MintLiteLLMActingPrincipalRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.MintActingPrincipalRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/litellm.mintActingPrincipal")();
  ...
  const context = {
    ...
    operationID: "mintLiteLLMActingPrincipal",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, LitellmActingPrincipalResult$inboundSchema),
