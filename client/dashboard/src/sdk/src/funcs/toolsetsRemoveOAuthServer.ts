...
import {
  ...
  RemoveOAuthServerRequest$outboundSchema,
 ...
 */
export function toolsetsRemoveOAuthServer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(RemoveOAuthServerRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/toolsets.removeOAuthServer")();
