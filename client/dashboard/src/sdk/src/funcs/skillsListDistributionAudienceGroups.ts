...
import {
  ...
  ListSkillDistributionAudienceGroupsResult$inboundSchema,
} from "../models/components/listskilldistributionaudiencegroupsresult.js";
...
import {
  ...
  ListSkillDistributionAudienceGroupsRequest$outboundSchema,
 ...
 */
export function skillsListDistributionAudienceGroups(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(ListSkillDistributionAudienceGroupsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/skills.listDistributionAudienceGroups")();
  ...
  const context = {
    ...
    operationID: "listSkillDistributionAudienceGroups",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListSkillDistributionAudienceGroupsResult$inboundSchema),
