...
import {
  ...
  IdentityProviderReadiness$inboundSchema,
} from "../models/components/identityproviderreadiness.js";
...
import {
  ...
  GetIdentityProviderGuidedReadinessRequest$outboundSchema,
 ...
 */
export function identityProvidersGetGuidedReadiness(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(GetIdentityProviderGuidedReadinessRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/identityProviders.getGuidedReadiness")();
  ...
  const context = {
    ...
    operationID: "getIdentityProviderGuidedReadiness",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, IdentityProviderReadiness$inboundSchema),
