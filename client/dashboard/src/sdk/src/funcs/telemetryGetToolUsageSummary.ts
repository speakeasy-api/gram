...
import {
  ...
  GetToolUsageSummaryResult$inboundSchema,
} from "../models/components/gettoolusagesummaryresult.js";
...
import {
  ...
  GetToolUsageSummaryRequest$outboundSchema,
 ...
 */
export function telemetryGetToolUsageSummary(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetToolUsageSummaryRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/telemetry.getToolUsageSummary")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetToolUsageSummaryResult$inboundSchema),
