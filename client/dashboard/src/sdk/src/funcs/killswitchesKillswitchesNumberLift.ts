...
import {
  ...
  KillswitchesNumberLiftRequest$outboundSchema,
 ...
 * lift killswitches
 */
export function killswitchesKillswitchesNumberLift(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(KillswitchesNumberLiftRequest$outboundSchema, value),
