...
import {
  ...
  GetUserSessionIssuerRequest$outboundSchema,
 ...
 */
export function userSessionIssuersGet(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetUserSessionIssuerRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/userSessionIssuers.get")();
