...
import {
  ...
  FetchSkillsFromGitHubResult$inboundSchema,
} from "../models/components/fetchskillsfromgithubresult.js";
...
import {
  ...
  FetchSkillsFromGitHubRequest$outboundSchema,
 ...
 */
export function skillsFetchFromGitHub(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(FetchSkillsFromGitHubRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.FetchSkillsFromGitHubRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/skills.fetchFromGitHub")();
  ...
  const context = {
    ...
    operationID: "fetchSkillsFromGitHub",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, FetchSkillsFromGitHubResult$inboundSchema),
