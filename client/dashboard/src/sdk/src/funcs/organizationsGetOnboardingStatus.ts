...
import {
  ...
  OnboardingStatusResult$inboundSchema,
} from "../models/components/onboardingstatusresult.js";
...
import {
  ...
  GetOnboardingStatusRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetOnboardingStatusRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/organizations.getOnboardingStatus")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, OnboardingStatusResult$inboundSchema),
