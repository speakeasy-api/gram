...
import {
  EvolveResult,
  EvolveResult$inboundSchema,
} from "../models/components/evolveresult.js";
...
import {
  ...
  EvolveDeploymentRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(EvolveDeploymentRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, EvolveResult$inboundSchema),
