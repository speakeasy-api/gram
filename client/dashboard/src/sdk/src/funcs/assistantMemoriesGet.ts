...
} from "../models/components/assistantmemory.js";
...
import {
  ...
  GetAssistantMemoryRequest$outboundSchema,
 ...
 */
export function assistantMemoriesGet(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetAssistantMemoryRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/assistantMemories.get")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, AssistantMemory$inboundSchema),
