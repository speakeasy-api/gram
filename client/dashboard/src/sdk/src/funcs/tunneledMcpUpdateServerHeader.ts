...
} from "../models/components/tunneledmcpserverheader.js";
...
import {
  ...
  UpdateTunneledMcpServerHeaderRequest$outboundSchema,
 ...
 */
export function tunneledMcpUpdateServerHeader(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(UpdateTunneledMcpServerHeaderRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateTunneledMcpServerHeaderForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/tunneledMcp.updateServerHeader")();
  ...
  const context = {
    ...
    operationID: "updateTunneledMcpServerHeader",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, TunneledMcpServerHeader$inboundSchema),
