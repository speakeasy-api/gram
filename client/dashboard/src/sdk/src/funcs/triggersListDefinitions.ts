...
import {
  ...
  ListTriggerDefinitionsResult$inboundSchema,
} from "../models/components/listtriggerdefinitionsresult.js";
...
import {
  ...
  ListTriggerDefinitionsRequest$outboundSchema,
 ...
 */
export function triggersListDefinitions(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListTriggerDefinitionsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/triggers.listDefinitions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListTriggerDefinitionsResult$inboundSchema),
