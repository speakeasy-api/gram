...
import {
  UpdatePluginRequest,
  UpdatePluginRequest$outboundSchema,
 ...
 */
export function pluginsUpdatePlugin(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpdatePluginRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdatePluginForm, { explode: true });

  const path = pathToFunc("/rpc/plugins.updatePlugin")();
