...
import {
  ...
  KillswitchesNumberCreateRequest$outboundSchema,
 ...
 * create killswitches
 */
export function killswitchesKillswitchesNumberCreate(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(KillswitchesNumberCreateRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/killswitches.create")();
  ...
  const context = {
    ...
    operationID: "killswitches#create",
    oAuth2Scopes: null,
