...
import {
  ...
  ListPersonAccountsResponseBody$inboundSchema,
} from "../models/components/listpersonaccountsresponsebody.js";
...
import {
  ...
  ListSlackPersonAccountsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ListSlackPersonAccountsRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/rpc/slackDirectoryConnections.listPersonAccounts",
  )();
  ...
  const context = {
    ...
    operationID: "listSlackPersonAccounts",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListPersonAccountsResponseBody$inboundSchema),
