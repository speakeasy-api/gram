...
import {
  ...
  DeleteMcpServerToolMetadataRequest$outboundSchema,
 ...
 */
export function mcpServersDeleteToolMetadata(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(DeleteMcpServerToolMetadataRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/mcpServers.deleteToolMetadata")();
