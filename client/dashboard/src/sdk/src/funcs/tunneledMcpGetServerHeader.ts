...
import {
  ...
  GetTunneledMcpServerHeaderRequest$outboundSchema,
 ...
 */
export function tunneledMcpGetServerHeader(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetTunneledMcpServerHeaderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/tunneledMcp.getServerHeader")();
  ...
  const context = {
    ...
    operationID: "getTunneledMcpServerHeader",
    oAuth2Scopes: null,
