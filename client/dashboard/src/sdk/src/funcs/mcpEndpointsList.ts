...
import {
  ...
  ListMcpEndpointsResult$inboundSchema,
} from "../models/components/listmcpendpointsresult.js";
...
import {
  ...
  ListMcpEndpointsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListMcpEndpointsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/mcpEndpoints.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListMcpEndpointsResult$inboundSchema),
