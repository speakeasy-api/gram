...
import {
  ...
  DeleteDirectoryMappingRequest$outboundSchema,
 ...
 */
export function accessDeleteDirectoryMapping(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(DeleteDirectoryMappingRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/access.deleteDirectoryMapping")();
