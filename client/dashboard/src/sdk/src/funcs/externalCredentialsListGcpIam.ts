...
import {
  ...
  ListGcpIamCredentialsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListGcpIamCredentialsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/externalCredentials.listGcpIam")();
