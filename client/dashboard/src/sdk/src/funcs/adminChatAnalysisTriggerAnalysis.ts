...
import {
  ...
  TriggerAnalysisResponseBody$inboundSchema,
} from "../models/components/triggeranalysisresponsebody.js";
...
import {
  ...
  TriggerChatAnalysisRequest$outboundSchema,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, TriggerAnalysisResponseBody$inboundSchema),
