...
import {
  ...
  ReportAgentAIScanRequest$outboundSchema,
 ...
 */
export function agentReportAIScan(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(ReportAgentAIScanRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.ReportAIScanRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/agent.reportAIScan")();
