...
import {
  ...
  GetNetworkIngressRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetNetworkIngressRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/networkIngress.get")();
