...
import {
  ...
  WorkUnitsTrendResult$inboundSchema,
} from "../models/components/workunitstrendresult.js";
...
import {
  ...
  GetWorkUnitsTrendRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetWorkUnitsTrendRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/chat.getWorkUnitsTrend")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, WorkUnitsTrendResult$inboundSchema),
