...
import {
  MeterUsageResponse,
  MeterUsageResponse$inboundSchema,
} from "../models/components/meterusageresponse.js";
...
import {
  ...
  GetMeterUsageRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetMeterUsageRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/usage.getMeterUsage")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, MeterUsageResponse$inboundSchema),
