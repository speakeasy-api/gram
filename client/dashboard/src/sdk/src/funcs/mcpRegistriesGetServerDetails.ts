...
} from "../models/components/externalmcpserver.js";
...
import {
  ...
  GetMCPServerDetailsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetMCPServerDetailsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ExternalMCPServer$inboundSchema),
