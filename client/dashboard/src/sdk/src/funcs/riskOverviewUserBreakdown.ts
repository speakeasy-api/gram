...
import {
  ...
  RiskUserBreakdownResult$inboundSchema,
} from "../models/components/riskuserbreakdownresult.js";
...
import {
  ...
  GetRiskUserBreakdownRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetRiskUserBreakdownRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RiskUserBreakdownResult$inboundSchema),
