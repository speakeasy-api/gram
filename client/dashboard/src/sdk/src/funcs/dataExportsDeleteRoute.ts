...
import {
  ...
  DeleteDataExportRouteRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(DeleteDataExportRouteRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/dataExports.deleteRoute")();
  ...
  const context = {
    ...
    operationID: "deleteDataExportRoute",
    oAuth2Scopes: null,
