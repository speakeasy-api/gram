...
import {
  GcpSetupInfo,
  GcpSetupInfo$inboundSchema,
} from "../models/components/gcpsetupinfo.js";
...
import {
  ...
  GetGcpSetupInfoRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetGcpSetupInfoRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/externalCredentials.getGcpSetupInfo")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GcpSetupInfo$inboundSchema),
