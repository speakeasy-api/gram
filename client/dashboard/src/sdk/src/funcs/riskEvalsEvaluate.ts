...
import {
  ...
  PromptGuardrailEvalResult$inboundSchema,
} from "../models/components/promptguardrailevalresult.js";
...
import {
  ...
  EvaluatePromptGuardrailRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(EvaluatePromptGuardrailRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, PromptGuardrailEvalResult$inboundSchema),
