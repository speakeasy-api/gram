...
import {
  ...
  DetachServerFromCollectionRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(DetachServerFromCollectionRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.AttachServerRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/collections.detachServer")();
