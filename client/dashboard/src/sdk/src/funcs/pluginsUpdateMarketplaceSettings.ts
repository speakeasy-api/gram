...
import {
  ...
  UpdateMarketplaceSettingsResult$inboundSchema,
} from "../models/components/updatemarketplacesettingsresult.js";
...
import {
  ...
  UpdateMarketplaceSettingsRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpdateMarketplaceSettingsRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.UpdateMarketplaceSettingsRequestBody,
    { explode: true },
  );

  const path = pathToFunc("/rpc/plugins.updateMarketplaceSettings")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateMarketplaceSettingsResult$inboundSchema),
