...
import {
  ...
  HooksNumberMetricsRequest$outboundSchema,
 ...
 */
export function hooksHooksNumberMetrics(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(HooksNumberMetricsRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.OTELMetricsPayload, {
    explode: true,
  });

  const path = pathToFunc("/rpc/hooks.otel/v1/metrics")();
