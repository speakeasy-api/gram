...
import {
  ...
  SpendRulesOverviewResult$inboundSchema,
...
import {
  ...
  GetSpendRulesOverviewRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetSpendRulesOverviewRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/spendrules.getOverview")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, SpendRulesOverviewResult$inboundSchema),
