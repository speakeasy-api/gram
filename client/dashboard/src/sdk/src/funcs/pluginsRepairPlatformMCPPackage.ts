...
import {
  ...
  RepairPlatformMCPPackageRequest$outboundSchema,
 ...
 */
export function pluginsRepairPlatformMCPPackage(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(RepairPlatformMCPPackageRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/plugins.repairPlatformMCPPackage")();
