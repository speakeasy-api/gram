...
import {
  ...
  MintFrozenGatewaySessionResponseBody$inboundSchema,
} from "../models/components/mintfrozengatewaysessionresponsebody.js";
...
import {
  ...
  MintFrozenGatewaySessionRequest$outboundSchema,
 ...
 */
export function userSessionsMintFrozenGateway(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(MintFrozenGatewaySessionRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.MintFrozenGatewaySessionRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/userSessions.mintFrozenGateway")();
  ...
  const context = {
    ...
    operationID: "mintFrozenGatewaySession",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, MintFrozenGatewaySessionResponseBody$inboundSchema),
