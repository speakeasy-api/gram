...
import {
  ...
  ListMCPServersResponseBody$inboundSchema,
} from "../models/components/listmcpserversresponsebody.js";
...
import {
  ...
  KillswitchesNumberListMCPServersRequest$outboundSchema,
 ...
 */
export function killswitchesKillswitchesNumberListMCPServers(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(KillswitchesNumberListMCPServersRequest$outboundSchema),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "killswitches#listMCPServers",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListMCPServersResponseBody$inboundSchema),
