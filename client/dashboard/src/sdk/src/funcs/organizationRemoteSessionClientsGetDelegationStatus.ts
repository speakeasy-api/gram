...
import {
  ...
  OrganizationClientDelegationStatus$inboundSchema,
} from "../models/components/organizationclientdelegationstatus.js";
 ...
 */
export function organizationRemoteSessionClientsGetDelegationStatus(
  client: GramCore,
...
> {
  ...
  const path = pathToFunc(
    "/rpc/organizationRemoteSessionClients.getDelegationStatus",
  )();
  ...
  const context = {
    ...
    operationID: "getOrganizationRemoteSessionClientDelegationStatus",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, OrganizationClientDelegationStatus$inboundSchema),
