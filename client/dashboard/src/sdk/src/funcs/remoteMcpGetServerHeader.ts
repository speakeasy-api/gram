...
import {
  ...
  GetRemoteMcpServerHeaderRequest$outboundSchema,
 ...
 */
export function remoteMcpGetServerHeader(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetRemoteMcpServerHeaderRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/remoteMcp.getServerHeader")();
