...
import {
  ...
  FetchImageFromURLRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(FetchImageFromURLRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.FetchImageFromURLForm2, {
    explode: true,
  });

  const path = pathToFunc("/rpc/assets.fetchImageFromURL")();
