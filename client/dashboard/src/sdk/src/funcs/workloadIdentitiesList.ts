...
import {
  ...
  ListWorkloadIdentitiesRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListWorkloadIdentitiesRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/workloadIdentities.list")();
  ...
  const context = {
    ...
    operationID: "listWorkloadIdentities",
    oAuth2Scopes: null,
