...
} from "../models/components/remotemcpserverheader.js";
...
import {
  ...
  CreateRemoteMcpServerHeaderRequest$outboundSchema,
 ...
 */
export function remoteMcpCreateServerHeader(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CreateRemoteMcpServerHeaderRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateServerHeaderForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/remoteMcp.createServerHeader")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RemoteMcpServerHeader$inboundSchema),
