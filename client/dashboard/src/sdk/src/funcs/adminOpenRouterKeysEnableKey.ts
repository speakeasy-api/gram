...
import {
  ...
  EnableAdminOpenRouterKeyRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(EnableAdminOpenRouterKeyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.EnableOpenRouterKeyRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/adminOpenRouterKeys.enableKey")();
