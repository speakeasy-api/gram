...
import {
  ...
  ListUnproxiedMcpServerToolsResult$inboundSchema,
} from "../models/components/listunproxiedmcpservertoolsresult.js";
...
import {
  ...
  ListUnproxiedMcpServerToolsRequest$outboundSchema,
 ...
 */
export function unproxiedMcpListTools(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(ListUnproxiedMcpServerToolsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/unproxiedMcp.listTools")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListUnproxiedMcpServerToolsResult$inboundSchema),
