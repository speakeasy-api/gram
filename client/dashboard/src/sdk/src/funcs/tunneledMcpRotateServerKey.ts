...
import {
  ...
  RotateTunneledMcpServerKeyResult$inboundSchema,
} from "../models/components/rotatetunneledmcpserverkeyresult.js";
...
import {
  ...
  RotateTunneledMcpServerKeyRequest$outboundSchema,
 ...
 */
export function tunneledMcpRotateServerKey(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(RotateTunneledMcpServerKeyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.RotateTunneledMcpServerKeyForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/tunneledMcp.rotateServerKey")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RotateTunneledMcpServerKeyResult$inboundSchema),
