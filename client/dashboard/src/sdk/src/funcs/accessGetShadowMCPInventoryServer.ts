...
import {
  ...
  ShadowMCPInventoryServer$inboundSchema,
} from "../models/components/shadowmcpinventoryserver.js";
...
import {
  ...
  GetShadowMCPInventoryServerRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(GetShadowMCPInventoryServerRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/access.getShadowMCPInventoryServer")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ShadowMCPInventoryServer$inboundSchema),
