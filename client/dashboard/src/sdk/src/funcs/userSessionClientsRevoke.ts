...
import {
  ...
  RevokeUserSessionClientRequest$outboundSchema,
 ...
 */
export function userSessionClientsRevoke(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(RevokeUserSessionClientRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/userSessionClients.revoke")();
