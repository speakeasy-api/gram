...
import {
  ...
  ListTunneledMcpServerHeadersResult$inboundSchema,
} from "../models/components/listtunneledmcpserverheadersresult.js";
...
import {
  ...
  ListTunneledMcpServerHeadersRequest$outboundSchema,
 ...
 */
export function tunneledMcpListServerHeaders(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(ListTunneledMcpServerHeadersRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/tunneledMcp.listServerHeaders")();
  ...
  const context = {
    ...
    operationID: "listTunneledMcpServerHeaders",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListTunneledMcpServerHeadersResult$inboundSchema),
