...
import {
  ...
  OtelForwardingConfig$inboundSchema,
} from "../models/components/otelforwardingconfig.js";
...
import {
  ...
  GetOtelForwardingConfigRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(GetOtelForwardingConfigRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/otelForwarding.getConfig")();
