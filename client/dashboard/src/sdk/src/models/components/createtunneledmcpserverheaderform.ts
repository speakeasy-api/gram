...
/**
 * Form for creating a header on a tunneled MCP server. Exactly one of value or value_from_request_header must be provided.
 */
...
/** @internal */
export type CreateTunneledMcpServerHeaderForm$Outbound = {
  description?: string | undefined;
...
/** @internal */
export const CreateTunneledMcpServerHeaderForm$outboundSchema: z.ZodMiniType<
...
export function createTunneledMcpServerHeaderFormToJSON(
  createTunneledMcpServerHeaderForm: CreateTunneledMcpServerHeaderForm,
): string {
  return JSON.stringify(
    CreateTunneledMcpServerHeaderForm$outboundSchema.parse(
      createTunneledMcpServerHeaderForm,
    ),
  );
}
