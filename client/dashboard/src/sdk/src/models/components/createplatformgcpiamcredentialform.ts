...
/** @internal */
export type CreatePlatformGcpIamCredentialForm$Outbound = {
...
/** @internal */
export const CreatePlatformGcpIamCredentialForm$outboundSchema: z.ZodMiniType<
...
export function createPlatformGcpIamCredentialFormToJSON(
  createPlatformGcpIamCredentialForm: CreatePlatformGcpIamCredentialForm,
): string {
  return JSON.stringify(
    CreatePlatformGcpIamCredentialForm$outboundSchema.parse(
      createPlatformGcpIamCredentialForm,
    ),
  );
}
