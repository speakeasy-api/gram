...
export type UpdateGcpIamPlatformCredentialRequestBody = {
  /**
...
/** @internal */
export type UpdateGcpIamPlatformCredentialRequestBody$Outbound = {
  id: string;
...
/** @internal */
export const UpdateGcpIamPlatformCredentialRequestBody$outboundSchema:
  z.ZodMiniType<
...
export function updateGcpIamPlatformCredentialRequestBodyToJSON(
  updateGcpIamPlatformCredentialRequestBody:
    UpdateGcpIamPlatformCredentialRequestBody,
): string {
  return JSON.stringify(
    UpdateGcpIamPlatformCredentialRequestBody$outboundSchema.parse(
      updateGcpIamPlatformCredentialRequestBody,
    ),
  );
}
