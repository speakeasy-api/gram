...
export function describeToolActivity(
  ...
  // Only scaffolding tools — naming them ("Calling Compose…") says nothing. The
  // describing phrase comes from the summarizer, which writes a short sentence
  // from the request; this stands in until it lands.
