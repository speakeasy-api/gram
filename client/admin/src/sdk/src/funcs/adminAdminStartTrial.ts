...
import {
  ...
  StartTrialRequestBody$outboundSchema,
} from "../models/components/starttrialrequestbody.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(StartTrialRequestBody$outboundSchema, value),
  ...
  const path = pathToFunc("/admin/trial.start")();
