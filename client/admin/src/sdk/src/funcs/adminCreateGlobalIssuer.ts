...
} from "../models/components/createremotesessionissuerform.js";
import {
  RemoteSessionIssuer,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateRemoteSessionIssuerForm$outboundSchema, value),
  ...
  const path = pathToFunc("/admin/remote-session-issuers.createGlobalIssuer")();
  ...
  const context = {
    ...
    operationID: "adminCreateGlobalRemoteSessionIssuer",
    oAuth2Scopes: null,
