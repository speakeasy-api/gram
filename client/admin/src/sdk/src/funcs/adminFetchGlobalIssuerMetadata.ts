...
} from "../models/components/fetchissuermetadatarequestbody.js";
import {
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(FetchIssuerMetadataRequestBody$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/admin/remote-session-issuers.fetchGlobalIssuerMetadata",
  )();
