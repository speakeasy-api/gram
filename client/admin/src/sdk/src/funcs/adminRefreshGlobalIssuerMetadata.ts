...
} from "../models/components/riskidrequestbody.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(RiskIDRequestBody$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/admin/remote-session-issuers.refreshGlobalIssuerMetadata",
  )();
  ...
  const context = {
    ...
    operationID: "adminRefreshGlobalRemoteSessionIssuerMetadata",
    oAuth2Scopes: null,
