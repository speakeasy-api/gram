...
} from "../models/components/createorganizationrequestbody.js";
 ...
 */
export function adminAdminCreateOrganization(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateOrganizationRequestBody$outboundSchema, value),
  ...
  const path = pathToFunc("/admin/organization.create")();
