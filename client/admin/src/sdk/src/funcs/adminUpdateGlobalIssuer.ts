...
} from "../models/components/updateremotesessionissuerform.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpdateRemoteSessionIssuerForm$outboundSchema, value),
  ...
  const path = pathToFunc("/admin/remote-session-issuers.updateGlobalIssuer")();
  ...
  const context = {
    ...
    operationID: "adminUpdateGlobalRemoteSessionIssuer",
    oAuth2Scopes: null,
