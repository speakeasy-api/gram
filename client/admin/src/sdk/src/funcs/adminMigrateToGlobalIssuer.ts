...
} from "../models/components/migrateremotesessionissuerrequestbody.js";
import {
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(MigrateRemoteSessionIssuerRequestBody$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/admin/remote-session-issuers.migrateToGlobalIssuer",
  )();
