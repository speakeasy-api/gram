...
export type AdminSpendBreakdownResponse = {
  /**
...
/** @internal */
export const AdminSpendBreakdownResponse$inboundSchema: z.ZodMiniType<
  AdminSpendBreakdownResponse,
  unknown
> = z.pipe(
  z.object({
...
export function adminSpendBreakdownResponseFromJSON(
  jsonString: string,
): SafeParseResult<AdminSpendBreakdownResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AdminSpendBreakdownResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AdminSpendBreakdownResponse' from JSON`,
  );
}
