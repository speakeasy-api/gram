...
import {
  ...
  GetOrganizationRemoteSessionIssuerRequest$outboundSchema,
 ...
 */
export function organizationRemoteSessionIssuersGetIssuer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(GetOrganizationRemoteSessionIssuerRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/organizationRemoteSessionIssuers.getIssuer")();
