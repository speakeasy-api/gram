 ...
 */
export function toolsetsCreateStaging(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateStagingVersionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/toolsets.createStaging")();
  ...
  const context = {
    ...
    operationID: "createStagingVersion",
    oAuth2Scopes: null,
