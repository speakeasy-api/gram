...
export function mcpEndpointsList(
  ...
  Result<
    components.ListMcpEndpointsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListMcpEndpointsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListMcpEndpointsResult$inboundSchema),
    M.jsonErr(
