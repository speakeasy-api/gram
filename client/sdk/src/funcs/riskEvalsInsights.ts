 ...
 */
export function riskEvalsInsights(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetPolicyEvalRunInsightsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/risk.evals.insights")();
  ...
  const context = {
    ...
    operationID: "getPolicyEvalRunInsights",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PolicyEvalRunInsights$inboundSchema),
    M.jsonErr(
