...
export function telemetryListToolUsageTraces(
  ...
  Result<
    components.ListToolUsageTracesResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListToolUsageTracesRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListToolUsageTracesResult$inboundSchema),
    M.jsonErr(
