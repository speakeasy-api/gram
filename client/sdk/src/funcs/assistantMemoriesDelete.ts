 ...
 */
export function assistantMemoriesDelete(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteAssistantMemoryRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/assistantMemories.delete")();
