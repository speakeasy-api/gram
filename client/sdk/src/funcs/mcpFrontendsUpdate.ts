 ...
 */
export function mcpFrontendsUpdate(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdateMcpFrontendRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateMcpFrontendForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/mcpFrontends.update")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.McpFrontend$inboundSchema),
    M.jsonErr(
