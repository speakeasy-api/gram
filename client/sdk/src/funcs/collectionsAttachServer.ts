...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.AttachServerToCollectionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/collections.attachServer")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MCPCollection$inboundSchema),
    M.jsonErr(
