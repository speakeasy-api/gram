 ...
 */
export function toolsetsGetStaging(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetStagingVersionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/toolsets.getStaging")();
