 ...
 */
export function toolsetsClearUserSessionIssuer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ClearToolsetUserSessionIssuerRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/toolsets.clearUserSessionIssuer")();
