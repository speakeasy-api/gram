...
import {
  ListUsersResult,
  ListUsersResult$inboundSchema,
} from "../models/components/listusersresult.js";
...
import {
  ...
  ListOrganizationUsersRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListOrganizationUsersRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListUsersResult$inboundSchema),
