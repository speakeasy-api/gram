...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DenyShadowMCPApprovalRequestRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/access.shadowMcp.requests.deny")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ShadowMCPApprovalDecisionResult$inboundSchema),
    M.jsonErr(
