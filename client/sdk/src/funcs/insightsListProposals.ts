 ...
 */
export function insightsListProposals(
  client: GramCore,
  ...
  Result<
    components.ListProposalsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListProposalsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/insights.listProposals")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListProposalsResult$inboundSchema),
    M.jsonErr(
