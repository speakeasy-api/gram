 ...
 */
export function featuresSetSessionCaptureExclusions(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetSessionCaptureExclusionsRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "setSessionCaptureExclusions",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SessionCaptureExclusionsResult$inboundSchema),
    M.jsonErr(
