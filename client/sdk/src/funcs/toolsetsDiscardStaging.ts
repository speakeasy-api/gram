 ...
 */
export function toolsetsDiscardStaging(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DiscardStagingVersionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/toolsets.discardStaging")();
  ...
  const context = {
    ...
    operationID: "discardStagingVersion",
    oAuth2Scopes: null,
