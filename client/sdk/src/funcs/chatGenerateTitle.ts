...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GenerateTitleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GenerateTitleResponseBody$inboundSchema),
    M.jsonErr(
