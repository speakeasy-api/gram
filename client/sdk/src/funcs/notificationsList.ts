...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListNotificationsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/rpc/notifications.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListNotificationsResult$inboundSchema),
    M.jsonErr(
