 ...
 */
export function toolsetsSwitchEditingMode(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SwitchEditingModeRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SwitchEditingModeRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/toolsets.switchEditingMode")();
