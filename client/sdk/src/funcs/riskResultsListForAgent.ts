 ...
 */
export function riskResultsListForAgent(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListRiskResultsForAgentRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/risk.results.listForAgent")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListRiskResultsForAgentResult$inboundSchema),
    M.jsonErr(
