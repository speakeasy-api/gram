 ...
 */
export function riskCategoriesList(
  client: GramCore,
  ...
  Result<
    components.RiskCategoriesResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListRiskCategoriesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/risk.listCategories")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskCategoriesResult$inboundSchema),
    M.jsonErr(
