...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteGlobalVariationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DeleteGlobalToolVariationResult$inboundSchema),
    M.jsonErr(
