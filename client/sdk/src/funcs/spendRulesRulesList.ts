 ...
 */
export function spendRulesRulesList(
  client: GramCore,
  ...
  Result<
    components.ListSpendRulesResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListSpendRulesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/spendrules.listRules")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListSpendRulesResult$inboundSchema),
    M.jsonErr(
