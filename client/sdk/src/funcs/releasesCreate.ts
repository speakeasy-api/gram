...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateReleaseRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateReleaseRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/releases.create")();
