 ...
 */
export function slackListSlackApps(
  client: GramCore,
  ...
  Result<
    components.ListSlackAppsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSlackAppsRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/rpc/slack-apps.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListSlackAppsResult$inboundSchema),
    M.jsonErr(
