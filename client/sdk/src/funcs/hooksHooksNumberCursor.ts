 ...
 *
 * @remarks
 * Endpoint for Cursor hook events. Handles beforeSubmitPrompt, stop, preToolUse, postToolUse, and postToolUseFailure.
 */
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CursorHookResult$inboundSchema),
    M.jsonErr(
