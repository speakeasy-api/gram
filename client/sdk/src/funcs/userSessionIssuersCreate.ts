...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateUserSessionIssuerRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UserSessionIssuer$inboundSchema),
    M.jsonErr(
