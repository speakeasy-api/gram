 ...
 */
export function mcpMcpNumberServePublic(
  client: GramCore,
  request: operations.McpNumberServePublicRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.McpNumberServePublicResponse | undefined,
    | errors.ServiceError
    | errors.ServiceError
    | APIError
    | SDKValidationError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.McpNumberServePublicRequest$outboundSchema.parse(value),
  ...
  >(
    M.stream(
      200,
      operations.McpNumberServePublicResponse$inboundSchema.optional(),
