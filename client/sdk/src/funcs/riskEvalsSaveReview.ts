...
export function riskEvalsSaveReview(
  ...
  Result<
    components.RiskPolicyEvalReview,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SaveRiskEvalReviewRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskPolicyEvalReview$inboundSchema),
    M.jsonErr(
