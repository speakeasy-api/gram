...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateShadowMCPApprovalRequestRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/access.shadowMcp.requests.create")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.ShadowMCPApprovalRequest$inboundSchema),
    M.jsonErr(
