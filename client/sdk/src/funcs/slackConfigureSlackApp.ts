 ...
 */
export function slackConfigureSlackApp(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConfigureSlackAppRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ConfigureSlackAppRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/slack-apps.configure")();
