 ...
 */
export function deploymentsDeploymentsNumberListDeployments(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeploymentsNumberListDeploymentsRequest$outboundSchema
  ...
  const path = pathToFunc("/rpc/deployments.list")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ListDeploymentResult$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
