 ...
 */
export function adminRemoteSessionsDeleteGlobalClient(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteGlobalRemoteSessionClientRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/adminRemoteSessions.deleteGlobalClient")();
