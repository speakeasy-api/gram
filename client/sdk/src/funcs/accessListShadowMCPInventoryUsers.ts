...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListShadowMCPInventoryUsersRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/access.shadowMcp.inventory.users.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListShadowMCPInventoryUsersResult$inboundSchema),
    M.jsonErr(
