...
export function triggersList(
  ...
  Result<
    components.ListTriggerInstancesResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListTriggerInstancesRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListTriggerInstancesResult$inboundSchema),
    M.jsonErr(
