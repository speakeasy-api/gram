 ...
 */
export function toolsetsSetIterationMode(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SetIterationModeRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SetIterationModeRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/toolsets.setIterationMode")();
