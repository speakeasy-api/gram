 ...
 */
export function logsListLogsForTrace(
  client: GramCore,
  ...
  Result<
    components.ListLogsForTraceResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListLogsForTraceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListLogsForTraceResult$inboundSchema),
    M.jsonErr(
