 ...
 */
export function mcpRegistriesDeleteCollection(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteMCPCollectionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/mcpRegistries.deleteCollection")();
  ...
  const context = {
    ...
    operationID: "deleteMCPCollection",
    oAuth2Scopes: null,
