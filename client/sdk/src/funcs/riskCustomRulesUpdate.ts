...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateCustomDetectionRuleRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/risk.customRules.update")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskCustomDetectionRule$inboundSchema),
    M.jsonErr(
