...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetPolicyEvalRunRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/risk.evals.get")();
