...
export function templatesGet(
  ...
  Result<
    components.GetPromptTemplateResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTemplateRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetPromptTemplateResult$inboundSchema),
    M.jsonErr(
