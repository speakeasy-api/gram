 ...
 */
export function pluginsGetPluginPackageContents(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetPluginPackageContentsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/plugins.getPluginPackageContents")();
  ...
  const context = {
    ...
    operationID: "getPluginPackageContents",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PluginPackageContentsResult$inboundSchema),
    M.jsonErr(
