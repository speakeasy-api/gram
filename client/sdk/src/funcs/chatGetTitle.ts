...
export function chatGetTitle(
  ...
  Result<
    components.GetTitleResponseBody,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTitleRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/chat.getTitle")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetTitleResponseBody$inboundSchema),
    M.jsonErr(
