 ...
 */
export function featuresListSessionCaptureExclusions(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListSessionCaptureExclusionsRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc(
    "/rpc/productFeatures.listSessionCaptureExclusions",
  )();
  ...
  const context = {
    ...
    operationID: "listSessionCaptureExclusions",
    oAuth2Scopes: null,
