 ...
 */
export function mcpFrontendsDelete(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteMcpFrontendRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/mcpFrontends.delete")();
