 ...
 */
export function organizationsSetAccountType(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SetAccountTypeRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.SetAccountTypeRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/organizations.setAccountType")();
