 ...
 */
export function tunnelledMcpDeleteServer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteTunnelledMcpServerRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/tunnelledMcp.deleteServer")();
  ...
  const context = {
    ...
    operationID: "deleteTunnelledMcpServer",
    oAuth2Scopes: null,
