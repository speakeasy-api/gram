...
export function deploymentsLogs(
  ...
  Result<
    components.GetDeploymentLogsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetDeploymentLogsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetDeploymentLogsResult$inboundSchema),
    M.jsonErr(
