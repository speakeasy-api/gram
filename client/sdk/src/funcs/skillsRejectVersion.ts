 ...
 */
export function skillsRejectVersion(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RejectSkillVersionRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.RejectVersionRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/skills.rejectVersion")();
  ...
  const context = {
    ...
    operationID: "rejectSkillVersion",
    oAuth2Scopes: null,
