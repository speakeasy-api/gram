 ...
 */
export function assetsViewFunctionSource(
  client: GramCore,
  ...
  Result<
    components.ViewFunctionSourceResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ViewFunctionSourceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/assets.viewFunctionSource")();
  ...
  const context = {
    ...
    operationID: "viewFunctionSource",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ViewFunctionSourceResult$inboundSchema),
    M.jsonErr(
