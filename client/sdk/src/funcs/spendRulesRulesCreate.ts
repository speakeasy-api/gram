...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CreateSpendRuleRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateSpendRuleRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/spendrules.createRule")();
