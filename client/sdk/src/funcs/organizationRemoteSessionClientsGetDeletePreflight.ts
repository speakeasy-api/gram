...
import {
  ...
  OrganizationClientDeletePreflight$inboundSchema,
} from "../models/components/organizationclientdeletepreflight.js";
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, OrganizationClientDeletePreflight$inboundSchema),
