...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetDomainRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/rpc/domain.get")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CustomDomain$inboundSchema),
    M.jsonErr(
