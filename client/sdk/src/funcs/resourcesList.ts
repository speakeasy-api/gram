...
export function resourcesList(
  ...
  Result<
    components.ListResourcesResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListResourcesRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListResourcesResult$inboundSchema),
    M.jsonErr(
