...
export function telemetryGetProjectOverview(
  ...
  Result<
    components.GetProjectOverviewResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(components.GetProjectMetricsSummaryPayload$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetProjectOverviewResult$inboundSchema),
    M.jsonErr(
