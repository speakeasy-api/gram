...
export function telemetryListFilterOptions(
  ...
  Result<
    components.ListFilterOptionsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListFilterOptionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListFilterOptionsResult$inboundSchema),
    M.jsonErr(
