...
import {
  DeletePluginRequest,
  DeletePluginRequest$outboundSchema,
 ...
 * Delete a plugin.
 */
export function pluginsDeletePlugin(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(DeletePluginRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/plugins.deletePlugin")();
