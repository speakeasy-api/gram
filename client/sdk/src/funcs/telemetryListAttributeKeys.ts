...
export function telemetryListAttributeKeys(
  ...
  Result<
    components.ListAttributeKeysResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAttributeKeysRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListAttributeKeysResult$inboundSchema),
    M.jsonErr(
