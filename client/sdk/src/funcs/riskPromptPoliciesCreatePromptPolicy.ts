 ...
 */
export function riskPromptPoliciesCreatePromptPolicy(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreatePromptPolicyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreatePromptPolicyRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/risk.promptPolicies.create")();
  ...
  const context = {
    ...
    operationID: "createPromptPolicy",
    oAuth2Scopes: null,
