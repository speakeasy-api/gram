...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpsertGlobalVariationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UpsertGlobalToolVariationResult$inboundSchema),
    M.jsonErr(
