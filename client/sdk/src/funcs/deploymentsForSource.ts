 ...
 */
export function deploymentsForSource(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeploymentsForSourceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/deployments.forSource")();
  ...
  const context = {
    ...
    operationID: "deploymentsForSource",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.DeploymentsForSourceResult$inboundSchema),
    M.jsonErr(
