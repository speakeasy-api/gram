...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UploadChatAttachmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UploadChatAttachmentResult$inboundSchema),
    M.jsonErr(
