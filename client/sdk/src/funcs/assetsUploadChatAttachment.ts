...
import {
  ...
  UploadChatAttachmentResult$inboundSchema,
} from "../models/components/uploadchatattachmentresult.js";
...
import {
  ...
  UploadChatAttachmentRequest$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UploadChatAttachmentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/assets.uploadChatAttachment")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UploadChatAttachmentResult$inboundSchema),
