...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListUserSessionClientsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/userSessionClients.list")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListUserSessionClientsResponse$inboundSchema, {
      key: "Result",
    }),
    M.jsonErr(
