...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListTriggerDefinitionsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/triggers.definitions.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListTriggerDefinitionsResult$inboundSchema),
    M.jsonErr(
