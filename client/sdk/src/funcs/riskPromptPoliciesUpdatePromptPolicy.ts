 ...
 */
export function riskPromptPoliciesUpdatePromptPolicy(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UpdatePromptPolicyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdatePromptPolicyRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/risk.promptPolicies.update")();
  ...
  const context = {
    ...
    operationID: "updatePromptPolicy",
    oAuth2Scopes: null,
