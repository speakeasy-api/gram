...
export function templatesUpdate(
  ...
  Result<
    components.UpdatePromptTemplateResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateTemplateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UpdatePromptTemplateResult$inboundSchema),
    M.jsonErr(
