...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpsertAllowedOriginRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UpsertAllowedOriginResult$inboundSchema),
    M.jsonErr(
