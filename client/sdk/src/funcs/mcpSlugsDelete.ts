 ...
 * Delete an MCP slug
 */
export function mcpSlugsDelete(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteMcpSlugRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/mcpSlugs.delete")();
