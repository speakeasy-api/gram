...
export function templatesRender(
  ...
  Result<
    components.RenderTemplateResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RenderTemplateRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RenderTemplateRequestBody, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RenderTemplateResult$inboundSchema),
    M.jsonErr(
