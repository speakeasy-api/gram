...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ServeChatAttachmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, operations.ServeChatAttachmentResponse$inboundSchema, {
