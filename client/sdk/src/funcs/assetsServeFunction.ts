...
export function assetsServeFunction(
  ...
  Result<
    operations.ServeFunctionResponse,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ServeFunctionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/assets.serveFunction")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, operations.ServeFunctionResponse$inboundSchema, {
