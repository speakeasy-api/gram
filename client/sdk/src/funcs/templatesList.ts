...
export function templatesList(
  ...
  Result<
    components.ListPromptTemplatesResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTemplatesRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListPromptTemplatesResult$inboundSchema),
    M.jsonErr(
