...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListPackagesRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListPackagesResult$inboundSchema),
    M.jsonErr(
