...
export function projectsListAllowedOrigins(
  ...
  Result<
    components.ListAllowedOriginsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAllowedOriginsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListAllowedOriginsResult$inboundSchema),
    M.jsonErr(
