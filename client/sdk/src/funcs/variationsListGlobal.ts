...
export function variationsListGlobal(
  ...
  Result<
    components.ListVariationsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListGlobalVariationsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListVariationsResult$inboundSchema),
    M.jsonErr(
