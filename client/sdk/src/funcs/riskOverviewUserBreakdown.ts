...
export function riskOverviewUserBreakdown(
  ...
  Result<
    components.RiskUserBreakdownResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetRiskUserBreakdownRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskUserBreakdownResult$inboundSchema),
    M.jsonErr(
