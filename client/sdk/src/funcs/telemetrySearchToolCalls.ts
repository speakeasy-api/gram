...
export function telemetrySearchToolCalls(
  ...
  Result<
    components.SearchToolCallsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SearchToolCallsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SearchToolCallsResult$inboundSchema),
    M.jsonErr(
