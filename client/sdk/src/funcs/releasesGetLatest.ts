 ...
 */
export function releasesGetLatest(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLatestReleaseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/releases.getLatest")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ToolsetRelease$inboundSchema),
    M.jsonErr(
