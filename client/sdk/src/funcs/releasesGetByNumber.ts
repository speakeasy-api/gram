 ...
 */
export function releasesGetByNumber(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetReleaseByNumberRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/releases.getByNumber")();
  ...
  const context = {
    ...
    operationID: "getReleaseByNumber",
    oAuth2Scopes: null,
