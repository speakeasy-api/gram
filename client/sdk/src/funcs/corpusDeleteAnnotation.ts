 ...
 */
export function corpusDeleteAnnotation(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteAnnotationRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/corpus.deleteAnnotation")();
