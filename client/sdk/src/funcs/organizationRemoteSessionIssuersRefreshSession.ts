...
import {
  RemoteSession,
  RemoteSession$inboundSchema,
} from "../models/components/remotesession.js";
...
import {
  ...
  RefreshOrganizationRemoteSessionRequest$outboundSchema,
 ...
 */
export function organizationRemoteSessionIssuersRefreshSession(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(RefreshOrganizationRemoteSessionRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/rpc/organizationRemoteSessionIssuers.refreshSession",
  )();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RemoteSession$inboundSchema),
