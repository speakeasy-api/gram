...
export function skillsListVersions(
  ...
  Result<
    components.ListSkillVersionsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListSkillVersionsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/skills.versions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListSkillVersionsResult$inboundSchema),
    M.jsonErr(
