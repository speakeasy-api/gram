 ...
 */
export function adminRemoteSessionsCreateGlobalIssuer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateGlobalRemoteSessionIssuerRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/adminRemoteSessions.createGlobalIssuer")();
