 ...
 */
export function assetsServeSkill(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ServeSkillRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/assets.serveSkill")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, operations.ServeSkillResponse$inboundSchema, {
