...
export function telemetryGetToolUsageSummary(
  ...
  Result<
    components.GetToolUsageSummaryResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetToolUsageSummaryRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetToolUsageSummaryResult$inboundSchema),
    M.jsonErr(
