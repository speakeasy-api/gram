...
export function projectsSetLogo(
  ...
  Result<
    components.SetProjectLogoResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SetProjectLogoRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SetProjectLogoResult$inboundSchema),
    M.jsonErr(
