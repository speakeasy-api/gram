 ...
 */
export function userSessionsRoast(
  client: GramCore,
  ...
  Result<
    components.RoastUserSessionResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RoastUserSessionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/userSessions.roast")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RoastUserSessionResult$inboundSchema),
    M.jsonErr(
