...
export function riskEvalsListReviews(
  ...
  Result<
    components.ListRiskEvalReviewsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListRiskEvalReviewsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListRiskEvalReviewsResult$inboundSchema),
    M.jsonErr(
