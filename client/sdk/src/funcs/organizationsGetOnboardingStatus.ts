...
export function organizationsGetOnboardingStatus(
  ...
  Result<
    components.OnboardingStatusResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetOnboardingStatusRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.OnboardingStatusResult$inboundSchema),
    M.jsonErr(
