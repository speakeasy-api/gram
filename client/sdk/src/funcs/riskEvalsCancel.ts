 ...
 */
export function riskEvalsCancel(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CancelPolicyEvalRunRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/risk.evals.cancel")();
  ...
  const context = {
    ...
    operationID: "cancelPolicyEvalRun",
    oAuth2Scopes: null,
