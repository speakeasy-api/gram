 ...
 */
export function slackDeleteSlackConnection(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteSlackConnectionRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/rpc/slack.deleteConnection")();
