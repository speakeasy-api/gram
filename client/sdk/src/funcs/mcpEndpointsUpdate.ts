...
import {
  McpEndpoint,
  McpEndpoint$inboundSchema,
} from "../models/components/mcpendpoint.js";
...
import {
  ...
  UpdateMcpEndpointRequest$outboundSchema,
 ...
 */
export function mcpEndpointsUpdate(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(UpdateMcpEndpointRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateMcpEndpointForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/mcpEndpoints.update")();
