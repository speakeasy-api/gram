...
export function assetsUploadFunctions(
  ...
  Result<
    components.UploadFunctionsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UploadFunctionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UploadFunctionsResult$inboundSchema),
    M.jsonErr(
