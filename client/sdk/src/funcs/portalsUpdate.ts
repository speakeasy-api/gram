...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UpdatePortalRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdatePortalForm, { explode: true });

  const path = pathToFunc("/rpc/portals.update")();
