 ...
 */
export function aiIntegrationsGetConfig(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetAIIntegrationConfigRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AIIntegrationConfig$inboundSchema),
    M.jsonErr(
