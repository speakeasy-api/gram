...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateShadowMCPAccessRuleRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/rpc/access.shadowMcp.rules.update")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ShadowMCPAccessRule$inboundSchema),
    M.jsonErr(
