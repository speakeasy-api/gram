...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListPolicyEvalRunsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/risk.evals.list")();
  ...
  const context = {
    ...
    operationID: "listPolicyEvalRuns",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListPolicyEvalRunsResult$inboundSchema),
    M.jsonErr(
