 ...
 */
export function riskOverviewRules(
  client: GramCore,
  ...
  Result<
    components.RiskRuleBreakdownResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetRiskRuleBreakdownRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskRuleBreakdownResult$inboundSchema),
    M.jsonErr(
