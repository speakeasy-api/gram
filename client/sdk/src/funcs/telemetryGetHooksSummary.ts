...
export function telemetryGetHooksSummary(
  ...
  Result<
    components.GetHooksSummaryResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetHooksSummaryRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/telemetry.getHooksSummary")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetHooksSummaryResult$inboundSchema),
    M.jsonErr(
