 ...
 */
export function releasesRollback(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RollbackToReleaseRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RollbackToReleaseRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/releases.rollback")();
