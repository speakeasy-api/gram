...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListReleasesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rpc/releases.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListReleasesResult$inboundSchema),
    M.jsonErr(
