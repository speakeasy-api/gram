 ...
 */
export function projectsCreateDeploymentTag(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateDeploymentTagRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.CreateDeploymentTagForm, {
    explode: true,
  });

  const path = pathToFunc("/rpc/projects.createDeploymentTag")();
  ...
  const context = {
    ...
    operationID: "createDeploymentTag",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CreateDeploymentTagResult$inboundSchema),
    M.jsonErr(
