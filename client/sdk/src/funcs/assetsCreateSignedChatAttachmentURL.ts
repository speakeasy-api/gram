...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateSignedChatAttachmentURLRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CreateSignedChatAttachmentURLResult$inboundSchema),
    M.jsonErr(
