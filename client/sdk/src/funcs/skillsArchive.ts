...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ArchiveSkillRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.ArchiveRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/skills.archive")();
