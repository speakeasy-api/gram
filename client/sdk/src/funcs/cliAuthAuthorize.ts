...
export function cliAuthAuthorize(
  ...
  Result<
    components.AuthorizeResponseBody,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CliAuthAuthorizeRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AuthorizeResponseBody$inboundSchema),
    M.jsonErr(
