...
export function riskResultsUnmask(
  ...
  Result<
    components.RiskUnmaskResultResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.UnmaskRiskResultRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskUnmaskResultResult$inboundSchema),
    M.jsonErr(
