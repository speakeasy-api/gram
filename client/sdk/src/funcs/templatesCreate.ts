...
export function templatesCreate(
  ...
  Result<
    components.CreatePromptTemplateResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateTemplateRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CreatePromptTemplateResult$inboundSchema),
    M.jsonErr(
