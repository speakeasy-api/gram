 ...
 */
export function riskOverviewGet(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetRiskOverviewRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/risk.overview.get")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RiskOverviewResult$inboundSchema),
    M.jsonErr(
