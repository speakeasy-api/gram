...
export function riskExclusionsList(
  ...
  Result<
    components.ListRiskExclusionsResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListRiskExclusionsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListRiskExclusionsResult$inboundSchema),
    M.jsonErr(
