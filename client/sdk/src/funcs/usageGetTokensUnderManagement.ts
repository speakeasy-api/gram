...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetTokensUnderManagementRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/usage.getTokensUnderManagement")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.TokensUnderManagement$inboundSchema),
    M.jsonErr(
