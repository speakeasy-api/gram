...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListSpendRuleEventsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/rpc/spendrules.listEvents")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListSpendRuleEventsResult$inboundSchema),
    M.jsonErr(
