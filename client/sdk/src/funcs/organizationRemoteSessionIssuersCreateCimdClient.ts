...
import {
  ...
  CreateCimdOrganizationRemoteSessionClientRequest$outboundSchema,
 ...
 */
export function organizationRemoteSessionIssuersCreateCimdClient(
  client: GramCore,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.CreateCimdOrganizationRemoteSessionClientForm,
    { explode: true },
  );

  const path = pathToFunc(
    "/rpc/organizationRemoteSessionIssuers.createCimdClient",
  )();
