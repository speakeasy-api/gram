 ...
 */
export function organizationsListAll(
  client: GramCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListAllOrganizationsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListAllOrganizationsResult$inboundSchema),
    M.jsonErr(
