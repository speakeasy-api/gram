...
export function spendRulesOverviewGet(
  ...
  Result<
    components.SpendRulesOverviewResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetSpendRulesOverviewRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SpendRulesOverviewResult$inboundSchema),
    M.jsonErr(
