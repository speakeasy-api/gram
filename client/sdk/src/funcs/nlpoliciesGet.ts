...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetNLPolicyRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/nlpolicies.get")();
