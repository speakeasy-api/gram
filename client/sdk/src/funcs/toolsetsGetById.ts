 ...
 */
export function toolsetsGetById(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ToolsetsNumberGetToolsetDetailsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/rpc/toolsets.get/{slug}")(pathParams);
