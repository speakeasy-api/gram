 ...
 */
export function riskCelCompile(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.CompileCelRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/rpc/risk.compileCel")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CelCompileResult$inboundSchema),
    M.jsonErr(
