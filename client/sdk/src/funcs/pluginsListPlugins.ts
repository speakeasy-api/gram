...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListPluginsRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListPluginsResult$inboundSchema),
    M.jsonErr(
