...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ArchiveNotificationRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ArchiveNotificationRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/notifications.archive")();
