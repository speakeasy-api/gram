...
export function packagesCreate(
  ...
  Result<
    components.CreatePackageResult,
    | errors.ServiceError
    | GramError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreatePackageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.CreatePackageResult$inboundSchema),
    M.jsonErr(
