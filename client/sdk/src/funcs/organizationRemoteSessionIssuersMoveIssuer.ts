...
import {
  ...
  MoveOrganizationRemoteSessionIssuerRequest$outboundSchema,
 ...
 */
export function organizationRemoteSessionIssuersMoveIssuer(
  client: GramCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(MoveOrganizationRemoteSessionIssuerRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.MoveIssuerRequestBody, {
    explode: true,
  });

  const path = pathToFunc("/rpc/organizationRemoteSessionIssuers.moveIssuer")();
