...
export function setRiskRuleBreakdownData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      category: string;
  ...
  return client.setQueryData<RiskRuleBreakdownQueryData>(key, data);
}

export function invalidateRiskRuleBreakdown(
  client: QueryClient,
...
export function invalidateAllRiskRuleBreakdown(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void> {
  return client.invalidateQueries({
