...
export type ApproveRiskPolicyBypassRequestRequest = {
  ...
  riskPolicyBypassRequestApprovalBody:
    components.RiskPolicyBypassRequestApprovalBody;
};
...
export type ApproveRiskPolicyBypassRequestRequest$Outbound = {
  ...
  RiskPolicyBypassRequestApprovalBody:
    components.RiskPolicyBypassRequestApprovalBody$Outbound;
};
...
export const ApproveRiskPolicyBypassRequestRequest$outboundSchema:
  ...
  > = z.pipe(
    z.object({
      ...
      riskPolicyBypassRequestApprovalBody:
        components.RiskPolicyBypassRequestApprovalBody$outboundSchema,
    }),
    z.transform((v) => {
      return remap$(v, {
        gramKey: "Gram-Key",
