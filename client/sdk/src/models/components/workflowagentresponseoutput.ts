...
/** @internal */
export const WorkflowAgentResponseOutputStatus$inboundSchema: z.ZodMiniEnum<
  typeof WorkflowAgentResponseOutputStatus
> = z.enum(WorkflowAgentResponseOutputStatus);

/** @internal */
export const WorkflowAgentResponseOutput$inboundSchema: z.ZodMiniType<
