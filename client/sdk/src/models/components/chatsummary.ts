...
/** @internal */
export const ChatSummaryStatus$inboundSchema: z.ZodMiniEnum<
  typeof ChatSummaryStatus
> = z.enum(ChatSummaryStatus);

/** @internal */
export const ChatSummary$inboundSchema: z.ZodMiniType<ChatSummary, unknown> = z
  .pipe(
    z.object({
