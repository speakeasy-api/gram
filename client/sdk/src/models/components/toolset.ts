...
export type Toolset = {
   ...
   */
  draftResourceUrns?: Array<string> | undefined;
  /**
   * Tool URNs in the draft (only populated when viewing draft)
   */
  draftToolUrns?: Array<string> | undefined;
...
export const Toolset$inboundSchema: z.ZodType<Toolset, z.ZodTypeDef, unknown> =
  z.object({
    ...
    draft_resource_urns: z.array(z.string()).optional(),
    draft_tool_urns: z.array(z.string()).optional(),
    ...
    return remap$(v, {
      ...
      "draft_resource_urns": "draftResourceUrns",
      "draft_tool_urns": "draftToolUrns",
...
export type Toolset$Outbound = {
  ...
  description?: string | undefined;
  draft_resource_urns?: Array<string> | undefined;
  draft_tool_urns?: Array<string> | undefined;
...
> = z.object({
  ...
  description: z.string().optional(),
  draftResourceUrns: z.array(z.string()).optional(),
  draftToolUrns: z.array(z.string()).optional(),
  ...
  return remap$(v, {
    ...
    draftResourceUrns: "draft_resource_urns",
    draftToolUrns: "draft_tool_urns",
