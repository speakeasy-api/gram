 ...
 */
export function remoteSessionClientsCloneClientFromOAuthProxyProvider(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CloneClientFromOAuthProxyProviderRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.CloneClientFromOAuthProxyProviderForm,
    { explode: true },
  );
  const path = pathToFunc(
    "/rpc/remoteSessionClients.cloneClientFromOAuthProxyProvider",
  )();
