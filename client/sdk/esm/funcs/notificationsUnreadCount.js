 ...
 */
export function notificationsUnreadCount(client, request, security, options) {
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetUnreadCountRequest$outboundSchema.optional().parse(value),
  ...
  const body = null;
  const path = pathToFunc("/rpc/notifications.unreadCount")();
  ...
  const [result] = await M.match(
    M.json(200, components.UnreadCountResult$inboundSchema),
    M.jsonErr(
