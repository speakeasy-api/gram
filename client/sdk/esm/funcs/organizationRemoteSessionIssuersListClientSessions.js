...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListOrganizationRemoteSessionClientSessionsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/rpc/organizationRemoteSessionIssuers.listClientSessions",
  )();
  ...
  const [result, raw] = await M.match(
    M.json(
      200,
      operations.ListOrganizationRemoteSessionClientSessionsResponse$inboundSchema,
      { key: "Result" },
    ),
    M.jsonErr(
