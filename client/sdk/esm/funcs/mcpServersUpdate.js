...
import { UpdateMcpServerRequest$outboundSchema, } from "../models/operations/updatemcpserver.js";
 ...
 */
export function mcpServersUpdate(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(UpdateMcpServerRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [parsed, { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = encodeJSON("body", payload.UpdateMcpServerForm, {
        explode: true,
    });
    const path = pathToFunc("/rpc/mcpServers.update")();
...
//# sourceMappingURL=mcpServersUpdate.js.map