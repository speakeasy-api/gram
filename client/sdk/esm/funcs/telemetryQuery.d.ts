 ...
 */
export declare function telemetryQuery(client: GramCore, request: QueryRequest, security?: QuerySecurity | undefined, options?: RequestOptions): APIPromise<Result<QueryResult, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
