...
import { RevokeRemoteSessionRequest$outboundSchema, } from "../models/operations/revokeremotesession.js";
 ...
 */
export function remoteSessionsRevoke(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(RevokeRemoteSessionRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=remoteSessionsRevoke.js.map