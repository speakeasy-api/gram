 ...
 */
export declare function environmentsClone(client: GramCore, request: CloneEnvironmentRequest, security?: CloneEnvironmentSecurity | undefined, options?: RequestOptions): APIPromise<Result<Environment, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
