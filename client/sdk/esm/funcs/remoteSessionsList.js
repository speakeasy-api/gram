...
import {
  ListRemoteSessionsRequest$outboundSchema,
  ListRemoteSessionsResponse$inboundSchema,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListRemoteSessionsRequest$outboundSchema), value),
  ...
  const [result, raw] = await M.match(
    M.json(200, ListRemoteSessionsResponse$inboundSchema, { key: "Result" }),
