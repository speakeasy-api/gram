 ...
 */
export function teamsRemoveMember(client, request, security, options) {
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RemoveTeamMemberRequest$outboundSchema, value),
  ...
  const body = null;
  const path = pathToFunc("/rpc/teams.removeMember")();
...
//# sourceMappingURL=teamsRemoveMember.js.map
