...
import { DeleteUserSessionIssuerRequest$outboundSchema, } from "../models/operations/deleteusersessionissuer.js";
 ...
 */
export function userSessionIssuersDelete(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(DeleteUserSessionIssuerRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [parsed, { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = pathToFunc("/rpc/userSessionIssuers.delete")();
...
//# sourceMappingURL=userSessionIssuersDelete.js.map