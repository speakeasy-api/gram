...
import { GetMcpServerRequest$outboundSchema, } from "../models/operations/getmcpserver.js";
 ...
 */
export function mcpServersGet(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(z.optional(GetMcpServerRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=mcpServersGet.js.map