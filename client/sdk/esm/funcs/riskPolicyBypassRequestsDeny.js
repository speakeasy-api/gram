...
import { DenyRiskPolicyBypassRequestRequest$outboundSchema, } from "../models/operations/denyriskpolicybypassrequest.js";
 ...
 */
export function riskPolicyBypassRequestsDeny(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(DenyRiskPolicyBypassRequestRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=riskPolicyBypassRequestsDeny.js.map