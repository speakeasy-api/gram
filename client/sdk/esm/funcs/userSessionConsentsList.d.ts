 ...
 */
export declare function userSessionConsentsList(client: GramCore, request?: ListUserSessionConsentsRequest | undefined, security?: ListUserSessionConsentsSecurity | undefined, options?: RequestOptions): APIPromise<PageIterator<Result<ListUserSessionConsentsResponse, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>, {
    cursor: string;
}>>;
