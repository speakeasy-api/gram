...
import { ListUserSessionConsentsRequest$outboundSchema, ListUserSessionConsentsResponse$inboundSchema, } from "../models/operations/listusersessionconsents.js";
 ...
 */
export function userSessionConsentsList(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(z.optional(ListUserSessionConsentsRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, ListUserSessionConsentsResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => userSessionConsentsList(client, {
            ...request,
            cursor: nextCursor,
        }, security, options);
...
//# sourceMappingURL=userSessionConsentsList.js.map