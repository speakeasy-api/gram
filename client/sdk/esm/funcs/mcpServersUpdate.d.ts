 ...
 */
export declare function mcpServersUpdate(client: GramCore, request: UpdateMcpServerRequest, security?: UpdateMcpServerSecurity | undefined, options?: RequestOptions): APIPromise<Result<McpServer, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
