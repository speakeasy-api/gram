 ...
 */
export declare function chatGenerateTitle(client: GramCore, request: GenerateTitleRequest, security?: GenerateTitleSecurity | undefined, options?: RequestOptions): APIPromise<Result<GenerateTitleResponseBody, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
