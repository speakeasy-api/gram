 ...
 */
export function otelForwardingUpdateDestination(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateOtelForwardingDestinationRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match(
    M.json(200, components.OtelForwardingDestination$inboundSchema),
    M.jsonErr(
