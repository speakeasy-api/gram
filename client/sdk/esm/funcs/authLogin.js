...
import {
  AuthLoginRequest$outboundSchema,
  AuthLoginResponse$inboundSchema,
...
async function $do(client, request, options) {
  const parsed = safeParse(
    request,
    (value) => z.parse(z.optional(AuthLoginRequest$outboundSchema), value),
  ...
  const [result] = await M.match(
    M.nil(307, z.optional(AuthLoginResponse$inboundSchema), { hdrs: true }),
