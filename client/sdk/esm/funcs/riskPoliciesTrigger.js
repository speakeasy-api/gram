...
import { TriggerRiskAnalysisRequest$outboundSchema, } from "../models/operations/triggerriskanalysis.js";
 ...
 */
export function riskPoliciesTrigger(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(TriggerRiskAnalysisRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
