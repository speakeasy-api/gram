...
import { ServeOpenAPIv3Request$outboundSchema, ServeOpenAPIv3Response$inboundSchema, } from "../models/operations/serveopenapiv3.js";
 ...
 */
export function assetsServeOpenAPIv3(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(ServeOpenAPIv3Request$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.stream(200, ServeOpenAPIv3Response$inboundSchema, {
        ctype: "*/*",
        hdrs: true,
        key: "Result",
...
//# sourceMappingURL=assetsServeOpenAPIv3.js.map