...
import { CreateEnvironmentRequest$outboundSchema, } from "../models/operations/createenvironment.js";
 ...
 */
export function environmentsCreate(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(CreateEnvironmentRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=environmentsCreate.js.map