 ...
 */
export declare function telemetryListSessions(client: GramCore, request: ListSessionsRequest, security?: ListSessionsSecurity | undefined, options?: RequestOptions): APIPromise<Result<ListSessionsResult, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
