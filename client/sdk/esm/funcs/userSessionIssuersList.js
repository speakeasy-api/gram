...
import { ListUserSessionIssuersRequest$outboundSchema, ListUserSessionIssuersResponse$inboundSchema, } from "../models/operations/listusersessionissuers.js";
 ...
 */
export function userSessionIssuersList(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(z.optional(ListUserSessionIssuersRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, ListUserSessionIssuersResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => userSessionIssuersList(client, {
            ...request,
            cursor: nextCursor,
        }, security, options);
...
//# sourceMappingURL=userSessionIssuersList.js.map