 ...
 */
export declare function organizationRemoteSessionIssuersMoveIssuer(client: GramCore, request: operations.MoveOrganizationRemoteSessionIssuerRequest, security?: operations.MoveOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): APIPromise<Result<components.RemoteSessionIssuer, errors.ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
