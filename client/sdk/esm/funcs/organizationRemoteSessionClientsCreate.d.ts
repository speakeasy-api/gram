 ...
 */
export declare function organizationRemoteSessionClientsCreate(client: GramCore, request: CreateOrganizationRemoteSessionClientRequest, security?: CreateOrganizationRemoteSessionClientSecurity | undefined, options?: RequestOptions): APIPromise<Result<RemoteSessionClient, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=organizationRemoteSessionClientsCreate.d.ts.map