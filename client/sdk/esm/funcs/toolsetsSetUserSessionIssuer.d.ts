 ...
 */
export declare function toolsetsSetUserSessionIssuer(client: GramCore, request: SetToolsetUserSessionIssuerRequest, security?: SetToolsetUserSessionIssuerSecurity | undefined, options?: RequestOptions): APIPromise<Result<Toolset, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
