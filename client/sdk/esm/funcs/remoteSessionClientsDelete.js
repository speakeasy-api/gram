...
import { DeleteRemoteSessionClientRequest$outboundSchema, } from "../models/operations/deleteremotesessionclient.js";
 ...
 */
export function remoteSessionClientsDelete(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(DeleteRemoteSessionClientRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=remoteSessionClientsDelete.js.map