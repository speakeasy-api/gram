...
import { ListMcpServerToolFiltersRequest$outboundSchema, } from "../models/operations/listmcpservertoolfilters.js";
 ...
 */
export function mcpServersListToolFilters(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(z.optional(ListMcpServerToolFiltersRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=mcpServersListToolFilters.js.map