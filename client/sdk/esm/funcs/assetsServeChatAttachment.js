...
import {
  ServeChatAttachmentRequest$outboundSchema,
  ServeChatAttachmentResponse$inboundSchema,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) => z.parse(ServeChatAttachmentRequest$outboundSchema, value),
  ...
  const [result] = await M.match(
    M.stream(200, ServeChatAttachmentResponse$inboundSchema, {
