 ...
 */
export declare function organizationRemoteSessionIssuersRefreshSession(client: GramCore, request: operations.RefreshOrganizationRemoteSessionRequest, security?: operations.RefreshOrganizationRemoteSessionSecurity | undefined, options?: RequestOptions): APIPromise<Result<components.RemoteSession, errors.ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
