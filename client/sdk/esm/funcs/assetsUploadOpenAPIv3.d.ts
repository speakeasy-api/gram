 ...
 */
export declare function assetsUploadOpenAPIv3(client: GramCore, request: UploadOpenAPIv3AssetRequest, security?: UploadOpenAPIv3AssetSecurity | undefined, options?: RequestOptions): APIPromise<Result<UploadOpenAPIv3Result, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
