...
import { DeleteRiskExclusionRequest$outboundSchema, } from "../models/operations/deleteriskexclusion.js";
 ...
 */
export function riskExclusionsDelete(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(DeleteRiskExclusionRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=riskExclusionsDelete.js.map