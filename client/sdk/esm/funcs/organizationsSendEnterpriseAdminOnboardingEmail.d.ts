 ...
 */
export declare function organizationsSendEnterpriseAdminOnboardingEmail(client: GramCore, request: SendEnterpriseAdminOnboardingEmailRequest, security?: SendEnterpriseAdminOnboardingEmailSecurity | undefined, options?: RequestOptions): APIPromise<Result<SendEnterpriseAdminOnboardingEmailResult, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
