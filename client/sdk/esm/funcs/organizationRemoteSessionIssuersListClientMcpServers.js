 ...
 */
export function organizationRemoteSessionIssuersListClientMcpServers(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListOrganizationRemoteSessionClientMcpServersRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/rpc/organizationRemoteSessionIssuers.listClientMcpServers",
  )();
  ...
  const [result] = await M.match(
    M.json(200, components.ListOrganizationMcpServersResult$inboundSchema),
    M.jsonErr(
