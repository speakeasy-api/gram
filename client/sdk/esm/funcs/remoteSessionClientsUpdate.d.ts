 ...
 */
export declare function remoteSessionClientsUpdate(client: GramCore, request: UpdateRemoteSessionClientRequest, security?: UpdateRemoteSessionClientSecurity | undefined, options?: RequestOptions): APIPromise<Result<RemoteSessionClient, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
