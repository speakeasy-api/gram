 ...
 */
export declare function riskExclusionsCreate(client: GramCore, request: CreateRiskExclusionRequest, security?: CreateRiskExclusionSecurity | undefined, options?: RequestOptions): APIPromise<Result<RiskExclusion, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
