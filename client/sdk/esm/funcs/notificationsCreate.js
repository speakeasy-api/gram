 ...
 */
export function notificationsCreate(client, request, security, options) {
  return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) => operations.CreateNotificationRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateNotificationForm, {
    explode: true,
  });
  const path = pathToFunc("/rpc/notifications.create")();
...
//# sourceMappingURL=notificationsCreate.js.map
