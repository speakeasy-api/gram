...
import { DeleteRemoteSessionIssuerRequest$outboundSchema, } from "../models/operations/deleteremotesessionissuer.js";
 ...
 */
export function remoteSessionIssuersDelete(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(DeleteRemoteSessionIssuerRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=remoteSessionIssuersDelete.js.map