 ...
 */
export declare function riskPoliciesCreate(client: GramCore, request: CreateRiskPolicyRequest, security?: CreateRiskPolicySecurity | undefined, options?: RequestOptions): APIPromise<Result<RiskPolicy, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
