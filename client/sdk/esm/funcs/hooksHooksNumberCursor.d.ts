 ...
 */
export declare function hooksHooksNumberCursor(client: GramCore, request: HooksNumberCursorRequest, security?: HooksNumberCursorSecurity | undefined, options?: RequestOptions): APIPromise<Result<CursorHookResult, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
