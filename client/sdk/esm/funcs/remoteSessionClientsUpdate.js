...
import { UpdateRemoteSessionClientRequest$outboundSchema, } from "../models/operations/updateremotesessionclient.js";
 ...
 */
export function remoteSessionClientsUpdate(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(UpdateRemoteSessionClientRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=remoteSessionClientsUpdate.js.map