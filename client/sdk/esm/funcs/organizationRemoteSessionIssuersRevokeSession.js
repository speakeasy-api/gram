 ...
 */
export function organizationRemoteSessionIssuersRevokeSession(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.RevokeOrganizationRemoteSessionRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc(
    "/rpc/organizationRemoteSessionIssuers.revokeSession",
  )();
