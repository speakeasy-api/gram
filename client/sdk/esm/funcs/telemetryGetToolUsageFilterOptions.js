 ...
 */
export function telemetryGetToolUsageFilterOptions(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) => z.parse(GetToolUsageFilterOptionsRequest$outboundSchema, value),
  ...
  const [result] = await M.match(
    M.json(200, GetToolUsageFilterOptionsResult$inboundSchema),
