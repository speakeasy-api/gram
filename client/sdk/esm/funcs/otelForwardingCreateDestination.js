 ...
 */
export function otelForwardingCreateDestination(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateOtelForwardingDestinationRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match(
    M.json(201, components.OtelForwardingDestination$inboundSchema),
    M.jsonErr(
