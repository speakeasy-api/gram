 ...
 */
export function externalCredentialsCreateGcpIam(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateGcpIamCredentialRequest$outboundSchema, value),
  ...
  const [result] = await M.match(
    M.json(200, GcpIamCredential$inboundSchema),
