 ...
 */
export declare function remoteSessionClientsCreateCimd(client: GramCore, request: CreateCimdRemoteSessionClientRequest, security?: CreateCimdRemoteSessionClientSecurity | undefined, options?: RequestOptions): APIPromise<Result<RemoteSessionClient, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
