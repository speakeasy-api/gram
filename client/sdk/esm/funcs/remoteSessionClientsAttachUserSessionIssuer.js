...
import { AttachUserSessionIssuerRequest$outboundSchema, } from "../models/operations/attachusersessionissuer.js";
 ...
 */
export function remoteSessionClientsAttachUserSessionIssuer(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(AttachUserSessionIssuerRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = pathToFunc("/rpc/remoteSessionClients.attachUserSessionIssuer")();
...
//# sourceMappingURL=remoteSessionClientsAttachUserSessionIssuer.js.map