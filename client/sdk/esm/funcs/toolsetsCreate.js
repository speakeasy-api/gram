...
import { CreateToolsetRequest$outboundSchema, } from "../models/operations/createtoolset.js";
 ...
 */
export function toolsetsCreate(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(CreateToolsetRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=toolsetsCreate.js.map