...
import { CreateRiskPolicyRequest$outboundSchema, } from "../models/operations/createriskpolicy.js";
 ...
 */
export function riskPoliciesCreate(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(CreateRiskPolicyRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=riskPoliciesCreate.js.map