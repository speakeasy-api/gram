 ...
 */
export declare function environmentsGetBySource(client: GramCore, request: GetSourceEnvironmentRequest, security?: GetSourceEnvironmentSecurity | undefined, options?: RequestOptions): APIPromise<Result<Environment, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
