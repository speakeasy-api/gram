 ...
 */
export declare function organizationRemoteSessionIssuersGetDeletePreflight(client: GramCore, request: GetOrganizationRemoteSessionIssuerDeletePreflightRequest, security?: GetOrganizationRemoteSessionIssuerDeletePreflightSecurity | undefined, options?: RequestOptions): APIPromise<Result<OrganizationIssuerDeletePreflight, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
