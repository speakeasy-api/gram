 ...
 */
export function otelForwardingListDestinations(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListOtelForwardingDestinationsRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const [result] = await M.match(
    M.json(200, components.OtelForwardingDestinationList$inboundSchema),
    M.jsonErr(
