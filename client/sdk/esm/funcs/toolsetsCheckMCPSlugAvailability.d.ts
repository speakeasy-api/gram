 ...
 */
export declare function toolsetsCheckMCPSlugAvailability(client: GramCore, request: CheckMCPSlugAvailabilityRequest, security?: CheckMCPSlugAvailabilitySecurity | undefined, options?: RequestOptions): APIPromise<Result<boolean, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
