...
import { GetSourceEnvironmentRequest$outboundSchema, } from "../models/operations/getsourceenvironment.js";
 ...
 */
export function environmentsGetBySource(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(GetSourceEnvironmentRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=environmentsGetBySource.js.map