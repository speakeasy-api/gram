 ...
 */
export function agentsDelete(client, request, security, options) {
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAgentResponseRequest$outboundSchema.parse(value),
  ...
  const body = null;
  const path = pathToFunc("/rpc/agents.response")();
  ...
  const context = {
    ...
    operationID: "deleteAgentResponse",
    oAuth2Scopes: null,
