 ...
 */
export declare function userSessionIssuersMigrateLegacyGramRegistrations(client: GramCore, request: MigrateLegacyGramRegistrationsRequest, security?: MigrateLegacyGramRegistrationsSecurity | undefined, options?: RequestOptions): APIPromise<Result<MigrateLegacyGramRegistrationsResult, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
