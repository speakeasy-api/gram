...
import { FetchOpenAPIv3FromURLRequest$outboundSchema, } from "../models/operations/fetchopenapiv3fromurl.js";
 ...
 */
export function assetsFetchOpenAPIv3FromURL(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(FetchOpenAPIv3FromURLRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=assetsFetchOpenAPIv3FromURL.js.map