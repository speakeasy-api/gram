...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateExternalOAuthServerRequest$outboundSchema.parse(value),
...
//# sourceMappingURL=toolsetsUpdateExternalOAuthServer.js.map
