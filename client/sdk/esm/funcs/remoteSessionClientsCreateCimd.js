...
import { CreateCimdRemoteSessionClientRequest$outboundSchema, } from "../models/operations/createcimdremotesessionclient.js";
 ...
 */
export function remoteSessionClientsCreateCimd(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(CreateCimdRemoteSessionClientRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=remoteSessionClientsCreateCimd.js.map