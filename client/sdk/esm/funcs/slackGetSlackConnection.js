 ...
 */
export function slackGetSlackConnection(client, request, security, options) {
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSlackConnectionRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const body = null;
  const path = pathToFunc("/rpc/slack.getConnection")();
...
//# sourceMappingURL=slackGetSlackConnection.js.map
