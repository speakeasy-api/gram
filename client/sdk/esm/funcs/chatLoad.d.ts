 ...
 */
export declare function chatLoad(client: GramCore, request: LoadChatRequest, security?: LoadChatSecurity | undefined, options?: RequestOptions): APIPromise<Result<Chat, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
