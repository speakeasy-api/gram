 ...
 */
export function riskApprovalsDelete(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(operations.RevokeShadowMCPApprovalRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
