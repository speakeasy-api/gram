 ...
 */
export function logsList(client, request, security, options) {
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListToolLogsRequest$outboundSchema.optional().parse(value),
  ...
  const body = null;
  const path = pathToFunc("/rpc/logs.list")();
  ...
  const [result] = await M.match(
    M.json(200, components.ListToolLogResponse$inboundSchema),
    M.jsonErr(
...
//# sourceMappingURL=logsList.js.map
