 ...
 */
export declare function cliAuthAuthorize(client: GramCore, request: CliAuthAuthorizeRequest, security?: CliAuthAuthorizeSecurity | undefined, options?: RequestOptions): APIPromise<Result<AuthorizeResponseBody, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
