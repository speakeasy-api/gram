...
import { DeleteCustomDetectionRuleRequest$outboundSchema, } from "../models/operations/deletecustomdetectionrule.js";
 ...
 */
export function riskCustomRulesDelete(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(DeleteCustomDetectionRuleRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=riskCustomRulesDelete.js.map