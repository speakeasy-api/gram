 ...
 */
export declare function userSessionsMint(client: GramCore, request: MintUserSessionRequest, security?: MintUserSessionSecurity | undefined, options?: RequestOptions): APIPromise<Result<MintUserSessionResponseBody, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
