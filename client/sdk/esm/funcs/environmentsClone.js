...
import { CloneEnvironmentRequest$outboundSchema, } from "../models/operations/cloneenvironment.js";
 ...
 */
export function environmentsClone(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(CloneEnvironmentRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=environmentsClone.js.map