...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(MigrateLegacyGramRegistrationsRequest$outboundSchema, value),
  ...
  const path = pathToFunc(
    "/rpc/userSessionIssuers.migrateLegacyGramRegistrations",
  )();
  ...
  const [result] = await M.match(
    M.json(200, MigrateLegacyGramRegistrationsResult$inboundSchema),
