 ...
 */
export function toolsetsPromoteDraft(client, request, security, options) {
  return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) => operations.PromoteDraftRequest$outboundSchema.parse(value),
  ...
  const body = null;
  const path = pathToFunc("/rpc/toolsets.promoteDraft")();
...
//# sourceMappingURL=toolsetsPromoteDraft.js.map
