...
import { GetToolsetRequest$outboundSchema, } from "../models/operations/gettoolset.js";
 ...
 */
export function toolsetsGetBySlug(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(GetToolsetRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=toolsetsGetBySlug.js.map