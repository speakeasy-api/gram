 ...
 */
export declare function remoteSessionIssuersRegister(client: GramCore, request: operations.RegisterRemoteSessionIssuerRequest, security?: operations.RegisterRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): APIPromise<Result<components.RemoteSessionClient, errors.ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
