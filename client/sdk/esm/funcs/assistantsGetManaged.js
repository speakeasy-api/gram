...
import { GetManagedAssistantRequest$outboundSchema, } from "../models/operations/getmanagedassistant.js";
 ...
 */
export function assistantsGetManaged(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(z.optional(GetManagedAssistantRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
