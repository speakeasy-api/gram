...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) => z.parse(CreateCustomDetectionRuleRequest$outboundSchema, value),
  ...
  const body = encodeJSON(
    "body",
    payload.CreateCustomDetectionRuleRequestBody,
    { explode: true },
  );
  ...
  const [result] = await M.match(
    M.json(200, RiskCustomDetectionRule$inboundSchema),
