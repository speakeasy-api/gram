...
import { ListOrganizationRemoteSessionClientsRequest$outboundSchema, ListOrganizationRemoteSessionClientsResponse$inboundSchema, } from "../models/operations/listorganizationremotesessionclients.js";
 ...
 */
export function organizationRemoteSessionClientsList(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(ListOrganizationRemoteSessionClientsRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, ListOrganizationRemoteSessionClientsResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => organizationRemoteSessionClientsList(client, {
            ...request,
            cursor: nextCursor,
        }, security, options);
...
//# sourceMappingURL=organizationRemoteSessionClientsList.js.map