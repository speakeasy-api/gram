...
import {
  ListRemoteSessionIssuersRequest$outboundSchema,
  ListRemoteSessionIssuersResponse$inboundSchema,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(ListRemoteSessionIssuersRequest$outboundSchema),
        value,
      ),
  ...
  const [result, raw] = await M.match(
    M.json(200, ListRemoteSessionIssuersResponse$inboundSchema, {
      key: "Result",
    }),
