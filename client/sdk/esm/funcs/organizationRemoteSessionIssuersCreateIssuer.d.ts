 ...
 */
export declare function organizationRemoteSessionIssuersCreateIssuer(client: GramCore, request: operations.CreateOrganizationRemoteSessionIssuerRequest, security?: operations.CreateOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): APIPromise<Result<components.RemoteSessionIssuer, errors.ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
