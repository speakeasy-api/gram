 ...
 */
export declare function mcpEndpointsUpdate(client: GramCore, request: UpdateMcpEndpointRequest, security?: UpdateMcpEndpointSecurity | undefined, options?: RequestOptions): APIPromise<Result<McpEndpoint, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
