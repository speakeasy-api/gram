...
import {
  ListUserSessionClientsRequest$outboundSchema,
  ListUserSessionClientsResponse$inboundSchema,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(ListUserSessionClientsRequest$outboundSchema), value),
  ...
  const [result, raw] = await M.match(
    M.json(200, ListUserSessionClientsResponse$inboundSchema, {
      key: "Result",
    }),
