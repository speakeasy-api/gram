...
import { ListUserSessionClientsRequest$outboundSchema, ListUserSessionClientsResponse$inboundSchema, } from "../models/operations/listusersessionclients.js";
 ...
 */
export function userSessionClientsList(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(z.optional(ListUserSessionClientsRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, ListUserSessionClientsResponse$inboundSchema, {
        key: "Result",
    ...
    const nextFunc = (responseData) => {
        ...
        const nextVal = () => userSessionClientsList(client, {
            ...request,
            cursor: nextCursor,
        }, security, options);
...
//# sourceMappingURL=userSessionClientsList.js.map