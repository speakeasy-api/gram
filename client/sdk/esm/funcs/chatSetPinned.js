...
import { SetChatPinnedRequest$outboundSchema, } from "../models/operations/setchatpinned.js";
 ...
 */
export function chatSetPinned(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(SetChatPinnedRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
