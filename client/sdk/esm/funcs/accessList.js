 ...
 */
export function accessList(client, request, security, options) {
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.ListGrantsRequest$outboundSchema), value),
  ...
  const body = null;
  const path = pathToFunc("/rpc/access.listGrants")();
  ...
  const [result] = await M.match(
    M.json(200, components.ListGrantsResult$inboundSchema),
    M.jsonErr(
