 ...
 */
export declare function hooksHooksNumberClaude(client: GramCore, request: HooksNumberClaudeRequest, options?: RequestOptions): APIPromise<Result<ClaudeHookResult, ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
