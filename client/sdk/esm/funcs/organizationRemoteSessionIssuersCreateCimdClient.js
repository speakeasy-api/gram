 ...
 */
export function organizationRemoteSessionIssuersCreateCimdClient(client, request, security, options) {
...
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(operations
        .CreateCimdOrganizationRemoteSessionClientRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
        return [parsed, { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = encodeJSON("body", payload.CreateCimdOrganizationRemoteSessionClientForm, { explode: true });
    const path = pathToFunc("/rpc/organizationRemoteSessionIssuers.createCimdClient")();
...
//# sourceMappingURL=organizationRemoteSessionIssuersCreateCimdClient.js.map