 ...
 */
export function organizationRemoteSessionIssuersCreateClient(
  client,
  request,
  security,
  options,
...
async function $do(client, request, security, options) {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreateOrganizationRemoteSessionClientRequest$outboundSchema,
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.CreateOrganizationRemoteSessionClientForm,
    { explode: true },
  );
  const path = pathToFunc(
    "/rpc/organizationRemoteSessionIssuers.createClient",
  )();
