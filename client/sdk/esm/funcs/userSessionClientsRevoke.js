...
import { RevokeUserSessionClientRequest$outboundSchema, } from "../models/operations/revokeusersessionclient.js";
 ...
 */
export function userSessionClientsRevoke(client, request, security, options) {
    return new APIPromise($do(client, request, security, options));
}
async function $do(client, request, security, options) {
    const parsed = safeParse(request, (value) => z.parse(RevokeUserSessionClientRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
...
//# sourceMappingURL=userSessionClientsRevoke.js.map