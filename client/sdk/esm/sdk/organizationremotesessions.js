...
export class OrganizationRemoteSessions extends ClientSDK {
  ...
  async list(request, security, options) {
    return unwrapResultIterator(
      organizationRemoteSessionsList(this, request, security, options),
    );
  }
  /**
  ...
  async refresh(request, security, options) {
    return unwrapAsync(
      organizationRemoteSessionsRefresh(this, request, security, options),
    );
  }
  /**
  ...
  async revoke(request, security, options) {
    return unwrapAsync(
      organizationRemoteSessionsRevoke(this, request, security, options),
    );
  }
  /**
  ...
  async revokeAll(request, security, options) {
    return unwrapAsync(
      organizationRemoteSessionsRevokeAll(this, request, security, options),
    );
  }
}
