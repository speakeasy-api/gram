...
import { LoadChatRequest, LoadChatSecurity } from "../models/operations/loadchat.js";
...
export declare class Chat extends ClientSDK {
     ...
     */
    creditUsage(request?: CreditUsageRequest | undefined, security?: CreditUsageSecurity | undefined, options?: RequestOptions): Promise<CreditUsageResponseBody>;
    /**
     * deleteChat chat
     *
     * @remarks
     ...
     */
    delete(request: DeleteChatRequest, security?: DeleteChatSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     * generateTitle chat
     *
     * @remarks
     ...
     */
    generateTitle(request: GenerateTitleRequest, security?: GenerateTitleSecurity | undefined, options?: RequestOptions): Promise<GenerateTitleResponseBody>;
    /**
     * listChats chat
     *
     * @remarks
     ...
     */
    list(request?: ListChatsRequest | undefined, security?: ListChatsSecurity | undefined, options?: RequestOptions): Promise<ListChatsResult>;
    /**
     * listSources chat
     *
     * @remarks
     ...
     */
    listSources(request?: ListChatSourcesRequest | undefined, security?: ListChatSourcesSecurity | undefined, options?: RequestOptions): Promise<ListSourcesResult>;
    /**
     * loadChat chat
     *
     * @remarks
     ...
     */
    load(request: LoadChatRequest, security?: LoadChatSecurity | undefined, options?: RequestOptions): Promise<Chat$Model>;
    /**
     * setPinned chat
     *
     * @remarks
     ...
     */
    setPinned(request: SetChatPinnedRequest, security?: SetChatPinnedSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     * submitFeedback chat
     *
     * @remarks
     ...
     */
    submitFeedback(request: SubmitFeedbackRequest, security?: SubmitFeedbackSecurity | undefined, options?: RequestOptions): Promise<CaptureEventResult>;
}
