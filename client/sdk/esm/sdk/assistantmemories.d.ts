...
export declare class AssistantMemories extends ClientSDK {
     ...
     */
    delete(request: DeleteAssistantMemoryRequest, security?: DeleteAssistantMemorySecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    get(request: GetAssistantMemoryRequest, security?: GetAssistantMemorySecurity | undefined, options?: RequestOptions): Promise<AssistantMemory>;
    /**
     ...
     */
    list(request: ListAssistantMemoriesRequest, security?: ListAssistantMemoriesSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListAssistantMemoriesResponse, {
        cursor: string;
    }>>;
}
