...
export declare class ExternalCredentials extends ClientSDK {
     ...
     */
    createAwsIam(request: CreateAwsIamCredentialRequest, security?: CreateAwsIamCredentialSecurity | undefined, options?: RequestOptions): Promise<AwsIamCredential>;
    /**
     ...
     */
    createGcpIam(request: CreateGcpIamCredentialRequest, security?: CreateGcpIamCredentialSecurity | undefined, options?: RequestOptions): Promise<GcpIamCredential>;
    /**
     ...
     */
    deleteAwsIam(request: DeleteAwsIamCredentialRequest, security?: DeleteAwsIamCredentialSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    deleteGcpIam(request: DeleteGcpIamCredentialRequest, security?: DeleteGcpIamCredentialSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    getAwsIam(request: GetAwsIamCredentialRequest, security?: GetAwsIamCredentialSecurity | undefined, options?: RequestOptions): Promise<AwsIamCredential>;
    /**
     ...
     */
    getGcpIam(request: GetGcpIamCredentialRequest, security?: GetGcpIamCredentialSecurity | undefined, options?: RequestOptions): Promise<GcpIamCredential>;
    /**
     ...
     */
    list(request?: ListExternalCredentialsRequest | undefined, security?: ListExternalCredentialsSecurity | undefined, options?: RequestOptions): Promise<ListExternalCredentialsResult>;
    /**
     ...
     */
    listAwsIam(request?: ListAwsIamCredentialsRequest | undefined, security?: ListAwsIamCredentialsSecurity | undefined, options?: RequestOptions): Promise<ListExternalCredentialsResult>;
    /**
     ...
     */
    listGcpIam(request?: ListGcpIamCredentialsRequest | undefined, security?: ListGcpIamCredentialsSecurity | undefined, options?: RequestOptions): Promise<ListExternalCredentialsResult>;
    /**
     ...
     */
    updateAwsIam(request: UpdateAwsIamCredentialRequest, security?: UpdateAwsIamCredentialSecurity | undefined, options?: RequestOptions): Promise<AwsIamCredential>;
    /**
     ...
     */
    updateGcpIam(request: UpdateGcpIamCredentialRequest, security?: UpdateGcpIamCredentialSecurity | undefined, options?: RequestOptions): Promise<GcpIamCredential>;
}
