...
export declare class UserSessionIssuers extends ClientSDK {
     ...
     */
    create(request: CreateUserSessionIssuerRequest, security?: CreateUserSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<UserSessionIssuer>;
    /**
     ...
     */
    delete(request: DeleteUserSessionIssuerRequest, security?: DeleteUserSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    get(request?: GetUserSessionIssuerRequest | undefined, security?: GetUserSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<UserSessionIssuer>;
    /**
     ...
     */
    list(request?: ListUserSessionIssuersRequest | undefined, security?: ListUserSessionIssuersSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListUserSessionIssuersResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    migrateLegacyGramRegistrations(request: MigrateLegacyGramRegistrationsRequest, security?: MigrateLegacyGramRegistrationsSecurity | undefined, options?: RequestOptions): Promise<MigrateLegacyGramRegistrationsResult>;
    /**
     ...
     */
    update(request: UpdateUserSessionIssuerRequest, security?: UpdateUserSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<UserSessionIssuer>;
}
