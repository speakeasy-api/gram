...
export declare class Overview extends ClientSDK {
     ...
     */
    get(request?: GetRiskOverviewRequest | undefined, security?: GetRiskOverviewSecurity | undefined, options?: RequestOptions): Promise<RiskOverviewResult>;
    /**
     ...
     */
    rules(request: GetRiskRuleBreakdownRequest, security?: GetRiskRuleBreakdownSecurity | undefined, options?: RequestOptions): Promise<RiskRuleBreakdownResult>;
    /**
     ...
     */
    userBreakdown(request: GetRiskUserBreakdownRequest, security?: GetRiskUserBreakdownSecurity | undefined, options?: RequestOptions): Promise<RiskUserBreakdownResult>;
}
