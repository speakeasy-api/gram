...
export declare class CliAuth extends ClientSDK {
     ...
     */
    authorize(request: CliAuthAuthorizeRequest, security?: CliAuthAuthorizeSecurity | undefined, options?: RequestOptions): Promise<AuthorizeResponseBody>;
    /**
     * redeem cliAuth
     *
     * @remarks
     ...
     */
    redeem(request: RedeemRequestBody, options?: RequestOptions): Promise<RedeemResponseBody>;
}
