...
export declare class AdminRemoteSessions extends ClientSDK {
     ...
     */
    createGlobalClient(request: CreateGlobalRemoteSessionClientRequest, security?: CreateGlobalRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
    /**
     ...
     */
    createGlobalIssuer(request: CreateGlobalRemoteSessionIssuerRequest, security?: CreateGlobalRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
    /**
     ...
     */
    deleteGlobalClient(request: DeleteGlobalRemoteSessionClientRequest, security?: DeleteGlobalRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    deleteGlobalIssuer(request: DeleteGlobalRemoteSessionIssuerRequest, security?: DeleteGlobalRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    getGlobalClient(request: GetGlobalRemoteSessionClientRequest, security?: GetGlobalRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
    /**
     ...
     */
    getGlobalIssuer(request: GetGlobalRemoteSessionIssuerRequest, security?: GetGlobalRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
    /**
     ...
     */
    listGlobalClients(request: ListGlobalRemoteSessionClientsRequest, security?: ListGlobalRemoteSessionClientsSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListGlobalRemoteSessionClientsResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    listGlobalIssuers(request?: ListGlobalRemoteSessionIssuersRequest | undefined, security?: ListGlobalRemoteSessionIssuersSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListGlobalRemoteSessionIssuersResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    updateGlobalClient(request: UpdateGlobalRemoteSessionClientRequest, security?: UpdateGlobalRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
    /**
     ...
     */
    updateGlobalIssuer(request: UpdateGlobalRemoteSessionIssuerRequest, security?: UpdateGlobalRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
}
