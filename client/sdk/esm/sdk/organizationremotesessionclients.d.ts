...
import { GetOrganizationRemoteSessionClientRequest, GetOrganizationRemoteSessionClientSecurity } from "../models/operations/getorganizationremotesessionclient.js";
...
import { ListOrganizationRemoteSessionClientsRequest, ListOrganizationRemoteSessionClientsResponse, ListOrganizationRemoteSessionClientsSecurity } from "../models/operations/listorganizationremotesessionclients.js";
...
export declare class OrganizationRemoteSessionClients extends ClientSDK {
     ...
     */
    create(request: CreateOrganizationRemoteSessionClientRequest, security?: CreateOrganizationRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
    /**
     ...
     */
    createCimd(request: CreateCimdOrganizationRemoteSessionClientRequest, security?: CreateCimdOrganizationRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
    /**
     ...
     */
    delete(request: DeleteOrganizationRemoteSessionClientRequest, security?: DeleteOrganizationRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    get(request: GetOrganizationRemoteSessionClientRequest, security?: GetOrganizationRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
    /**
     ...
     */
    getDeletePreflight(request: GetOrganizationRemoteSessionClientDeletePreflightRequest, security?: GetOrganizationRemoteSessionClientDeletePreflightSecurity | undefined, options?: RequestOptions): Promise<OrganizationClientDeletePreflight>;
    /**
     ...
     */
    list(request: ListOrganizationRemoteSessionClientsRequest, security?: ListOrganizationRemoteSessionClientsSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListOrganizationRemoteSessionClientsResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    listMcpServers(request: ListOrganizationRemoteSessionClientMcpServersRequest, security?: ListOrganizationRemoteSessionClientMcpServersSecurity | undefined, options?: RequestOptions): Promise<ListOrganizationMcpServersResult>;
    /**
     ...
     */
    removeFromMcpServer(request: RemoveOrganizationRemoteSessionClientFromMcpServerRequest, security?: RemoveOrganizationRemoteSessionClientFromMcpServerSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    update(request: UpdateOrganizationRemoteSessionClientRequest, security?: UpdateOrganizationRemoteSessionClientSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionClient>;
}
