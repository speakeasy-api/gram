...
export declare class Blocks extends ClientSDK {
     ...
     */
    get(request: GetRiskBlockRequest, security?: GetRiskBlockSecurity | undefined, options?: RequestOptions): Promise<RiskBlock>;
    /**
     ...
     */
    submitFeedback(request: SubmitRiskBlockFeedbackRequest, security?: SubmitRiskBlockFeedbackSecurity | undefined, options?: RequestOptions): Promise<RiskBlock>;
}
