...
import { VerifyRemoteMcpURLRequest, VerifyRemoteMcpURLSecurity } from "../models/operations/verifyremotemcpurl.js";
export declare class RemoteMcp extends ClientSDK {
     ...
     */
    createServer(request: CreateRemoteMcpServerRequest, security?: CreateRemoteMcpServerSecurity | undefined, options?: RequestOptions): Promise<RemoteMcpServer>;
    /**
     ...
     */
    deleteServer(request: DeleteRemoteMcpServerRequest, security?: DeleteRemoteMcpServerSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    discoverProtectedResourceMetadata(request: DiscoverRemoteMcpProtectedResourceMetadataRequest, security?: DiscoverRemoteMcpProtectedResourceMetadataSecurity | undefined, options?: RequestOptions): Promise<ProtectedResourceMetadataDiscovery>;
    /**
     * getServer remoteMcp
     *
     * @remarks
     ...
     */
    getServer(request?: GetRemoteMcpServerRequest | undefined, security?: GetRemoteMcpServerSecurity | undefined, options?: RequestOptions): Promise<RemoteMcpServer>;
    /**
     ...
     */
    listServers(request?: ListRemoteMcpServersRequest | undefined, security?: ListRemoteMcpServersSecurity | undefined, options?: RequestOptions): Promise<ListServersResult>;
    /**
     ...
     */
    updateServer(request: UpdateRemoteMcpServerRequest, security?: UpdateRemoteMcpServerSecurity | undefined, options?: RequestOptions): Promise<RemoteMcpServer>;
    /**
     * verifyURL remoteMcp
     *
     * @remarks
     ...
     */
    verifyURL(request: VerifyRemoteMcpURLRequest, security?: VerifyRemoteMcpURLSecurity | undefined, options?: RequestOptions): Promise<VerifyURLResult>;
}
