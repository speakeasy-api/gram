...
import { ListRiskPolicyBypassRequestsRequest, ListRiskPolicyBypassRequestsSecurity } from "../models/operations/listriskpolicybypassrequests.js";
...
export declare class PolicyBypassRequests extends ClientSDK {
     ...
     */
    approve(request: ApproveRiskPolicyBypassRequestRequest, security?: ApproveRiskPolicyBypassRequestSecurity | undefined, options?: RequestOptions): Promise<RiskPolicyBypassRequest>;
    /**
     ...
     */
    create(request: CreateRiskPolicyBypassRequestRequest, security?: CreateRiskPolicyBypassRequestSecurity | undefined, options?: RequestOptions): Promise<RiskPolicyBypassRequest>;
    /**
     ...
     */
    deny(request: DenyRiskPolicyBypassRequestRequest, security?: DenyRiskPolicyBypassRequestSecurity | undefined, options?: RequestOptions): Promise<RiskPolicyBypassRequest>;
    /**
     ...
     */
    list(request?: ListRiskPolicyBypassRequestsRequest | undefined, security?: ListRiskPolicyBypassRequestsSecurity | undefined, options?: RequestOptions): Promise<ListRiskPolicyBypassRequestsResult>;
    /**
     ...
     */
    revoke(request: RevokeRiskPolicyBypassRequestRequest, security?: RevokeRiskPolicyBypassRequestSecurity | undefined, options?: RequestOptions): Promise<RiskPolicyBypassRequest>;
}
