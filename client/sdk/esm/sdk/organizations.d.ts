...
import { EnableWebhooksRequest, EnableWebhooksSecurity } from "../models/operations/enablewebhooks.js";
...
import { ListInvitesRequest, ListInvitesSecurity } from "../models/operations/listinvites.js";
...
import { UpdateInviteRoleRequest, UpdateInviteRoleSecurity } from "../models/operations/updateinviterole.js";
...
export declare class Organizations extends ClientSDK {
     ...
     */
    createPortalSession(request?: CreatePortalSessionRequest | undefined, security?: CreatePortalSessionSecurity | undefined, options?: RequestOptions): Promise<CreatePortalSessionResult>;
    /**
     ...
     */
    disableWebhooks(request?: DisableWebhooksRequest | undefined, security?: DisableWebhooksSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    enableWebhooks(request?: EnableWebhooksRequest | undefined, security?: EnableWebhooksSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    generateWorkOSAdminPortalLink(request: GenerateWorkOSAdminPortalLinkRequest, security?: GenerateWorkOSAdminPortalLinkSecurity | undefined, options?: RequestOptions): Promise<GenerateWorkOSAdminPortalLinkResult>;
    /**
     * get organizations
     *
     * @remarks
     ...
     */
    get(request?: GetOrganizationRequest | undefined, security?: GetOrganizationSecurity | undefined, options?: RequestOptions): Promise<Organization>;
    /**
     ...
     */
    getOnboardingStatus(request?: GetOnboardingStatusRequest | undefined, security?: GetOnboardingStatusSecurity | undefined, options?: RequestOptions): Promise<OnboardingStatusResult>;
    /**
     ...
     */
    listInvites(request?: ListInvitesRequest | undefined, security?: ListInvitesSecurity | undefined, options?: RequestOptions): Promise<ListInvitesResult>;
    /**
     ...
     */
    listUsers(request?: ListOrganizationUsersRequest | undefined, security?: ListOrganizationUsersSecurity | undefined, options?: RequestOptions): Promise<ListUsersResult>;
    /**
     ...
     */
    removeUser(request: RemoveOrganizationUserRequest, security?: RemoveOrganizationUserSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    revokeInvite(request: RevokeInviteRequest, security?: RevokeInviteSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    sendEnterpriseAdminOnboardingEmail(request: SendEnterpriseAdminOnboardingEmailRequest, security?: SendEnterpriseAdminOnboardingEmailSecurity | undefined, options?: RequestOptions): Promise<SendEnterpriseAdminOnboardingEmailResult>;
    /**
     ...
     */
    sendInvite(request: SendInviteRequest, security?: SendInviteSecurity | undefined, options?: RequestOptions): Promise<OrganizationInvitation>;
    /**
     ...
     */
    updateInviteRole(request: UpdateInviteRoleRequest, security?: UpdateInviteRoleSecurity | undefined, options?: RequestOptions): Promise<OrganizationInvitation>;
    /**
     ...
     */
    verifyOnboardingHooksSetup(request?: VerifyOnboardingHooksSetupRequest | undefined, security?: VerifyOnboardingHooksSetupSecurity | undefined, options?: RequestOptions): Promise<VerifyOnboardingHooksSetupResult>;
}
