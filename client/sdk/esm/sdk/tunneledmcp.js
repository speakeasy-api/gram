...
export class TunneledMcp extends ClientSDK {
  ...
  async createServer(request, security, options) {
    return unwrapAsync(
      tunneledMcpCreateServer(this, request, security, options),
    );
  }
  /**
  ...
  async deleteServer(request, security, options) {
    return unwrapAsync(
      tunneledMcpDeleteServer(this, request, security, options),
    );
  }
  /**
  ...
  async listServerConnections(request, security, options) {
    return unwrapAsync(
      tunneledMcpListServerConnections(this, request, security, options),
    );
  }
  /**
  ...
  async listServers(request, security, options) {
    return unwrapAsync(
      tunneledMcpListServers(this, request, security, options),
    );
  }
  /**
  ...
  async rotateServerKey(request, security, options) {
    return unwrapAsync(
      tunneledMcpRotateServerKey(this, request, security, options),
    );
  }
  /**
  ...
  async updateServer(request, security, options) {
    return unwrapAsync(
      tunneledMcpUpdateServer(this, request, security, options),
    );
  }
}
