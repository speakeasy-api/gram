...
import { UpdateMcpServerRequest, UpdateMcpServerSecurity } from "../models/operations/updatemcpserver.js";
export declare class McpServers extends ClientSDK {
     ...
     */
    create(request: CreateMcpServerRequest, security?: CreateMcpServerSecurity | undefined, options?: RequestOptions): Promise<McpServer>;
    /**
     ...
     */
    delete(request: DeleteMcpServerRequest, security?: DeleteMcpServerSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    get(request?: GetMcpServerRequest | undefined, security?: GetMcpServerSecurity | undefined, options?: RequestOptions): Promise<McpServer>;
    /**
     ...
     */
    list(request?: ListMcpServersRequest | undefined, security?: ListMcpServersSecurity | undefined, options?: RequestOptions): Promise<ListMcpServersResult>;
    /**
     ...
     */
    listToolFilters(request?: ListMcpServerToolFiltersRequest | undefined, security?: ListMcpServerToolFiltersSecurity | undefined, options?: RequestOptions): Promise<ListToolFiltersResult>;
    /**
     ...
     */
    update(request: UpdateMcpServerRequest, security?: UpdateMcpServerSecurity | undefined, options?: RequestOptions): Promise<McpServer>;
}
