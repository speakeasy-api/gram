...
export declare class OrganizationRemoteSessions extends ClientSDK {
     ...
     */
    list(request: ListOrganizationRemoteSessionClientSessionsRequest, security?: ListOrganizationRemoteSessionClientSessionsSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListOrganizationRemoteSessionClientSessionsResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    refresh(request: RefreshOrganizationRemoteSessionRequest, security?: RefreshOrganizationRemoteSessionSecurity | undefined, options?: RequestOptions): Promise<RemoteSession>;
    /**
     ...
     */
    revoke(request: RevokeOrganizationRemoteSessionRequest, security?: RevokeOrganizationRemoteSessionSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    revokeAll(request: RevokeAllOrganizationRemoteSessionClientSessionsRequest, security?: RevokeAllOrganizationRemoteSessionClientSessionsSecurity | undefined, options?: RequestOptions): Promise<RevokeAllRemoteSessionsResult>;
}
