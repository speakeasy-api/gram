...
export declare class Domains extends ClientSDK {
     ...
     */
    deleteDomain(request?: DeleteDomainRequest | undefined, security?: DeleteDomainSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     * getDomain domains
     *
     * @remarks
     ...
     */
    getDomain(request?: GetDomainRequest | undefined, security?: GetDomainSecurity | undefined, options?: RequestOptions): Promise<CustomDomain>;
    /**
     ...
     */
    listMcpEndpoints(request?: ListCustomDomainMcpEndpointsRequest | undefined, security?: ListCustomDomainMcpEndpointsSecurity | undefined, options?: RequestOptions): Promise<ListCustomDomainMcpEndpointsResult>;
    /**
     ...
     */
    registerDomain(request: RegisterDomainRequest, security?: RegisterDomainSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    updateDomain(request: UpdateDomainRequest, security?: UpdateDomainSecurity | undefined, options?: RequestOptions): Promise<CustomDomain>;
}
