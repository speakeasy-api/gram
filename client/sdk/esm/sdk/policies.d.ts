...
export declare class Policies extends ClientSDK {
     ...
     */
    create(request: CreateRiskPolicyRequest, security?: CreateRiskPolicySecurity | undefined, options?: RequestOptions): Promise<RiskPolicy>;
    /**
     ...
     */
    delete(request: DeleteRiskPolicyRequest, security?: DeleteRiskPolicySecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     * getRiskPolicy risk
     *
     * @remarks
     ...
     */
    get(request: GetRiskPolicyRequest, security?: GetRiskPolicySecurity | undefined, options?: RequestOptions): Promise<RiskPolicy>;
    /**
     ...
     */
    status(request: GetRiskPolicyStatusRequest, security?: GetRiskPolicyStatusSecurity | undefined, options?: RequestOptions): Promise<RiskPolicyStatus>;
    /**
     ...
     */
    list(request?: ListRiskPoliciesRequest | undefined, security?: ListRiskPoliciesSecurity | undefined, options?: RequestOptions): Promise<ListRiskPoliciesResult>;
    /**
     ...
     */
    trigger(request: TriggerRiskAnalysisRequest, security?: TriggerRiskAnalysisSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    update(request: UpdateRiskPolicyRequest, security?: UpdateRiskPolicySecurity | undefined, options?: RequestOptions): Promise<RiskPolicy>;
}
