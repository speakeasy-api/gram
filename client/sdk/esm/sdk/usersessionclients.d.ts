...
export declare class UserSessionClients extends ClientSDK {
     ...
     */
    get(request: GetUserSessionClientRequest, security?: GetUserSessionClientSecurity | undefined, options?: RequestOptions): Promise<UserSessionClient>;
    /**
     ...
     */
    list(request?: ListUserSessionClientsRequest | undefined, security?: ListUserSessionClientsSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListUserSessionClientsResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    revoke(request: RevokeUserSessionClientRequest, security?: RevokeUserSessionClientSecurity | undefined, options?: RequestOptions): Promise<void>;
}
