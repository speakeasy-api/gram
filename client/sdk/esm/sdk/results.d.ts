...
export declare class Results extends ClientSDK {
     ...
     */
    list(request?: ListRiskResultsRequest | undefined, security?: ListRiskResultsSecurity | undefined, options?: RequestOptions): Promise<ListRiskResultsResult>;
    /**
     ...
     */
    byChat(request?: ListRiskResultsByChatRequest | undefined, security?: ListRiskResultsByChatSecurity | undefined, options?: RequestOptions): Promise<ListRiskResultsByChatResult>;
    /**
     ...
     */
    listForAgent(request?: ListRiskResultsForAgentRequest | undefined, security?: ListRiskResultsForAgentSecurity | undefined, options?: RequestOptions): Promise<ListRiskResultsForAgentResult>;
    /**
     ...
     */
    unmask(request: UnmaskRiskResultRequest, security?: UnmaskRiskResultSecurity | undefined, options?: RequestOptions): Promise<RiskUnmaskResultResult>;
}
