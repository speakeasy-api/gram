...
export declare class Projects extends ClientSDK {
     ...
     */
    create(request: CreateProjectRequest, security?: CreateProjectSecurity | undefined, options?: RequestOptions): Promise<CreateProjectResult>;
    /**
     ...
     */
    deleteById(request: DeleteProjectRequest, security?: DeleteProjectSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     * getProject projects
     *
     * @remarks
     ...
     */
    read(request: GetProjectRequest, security?: GetProjectSecurity | undefined, options?: RequestOptions): Promise<GetProjectResult>;
    /**
     ...
     */
    list(request: ListProjectsRequest, security?: ListProjectsSecurity | undefined, options?: RequestOptions): Promise<ListProjectsResult>;
    /**
     ...
     */
    listAllowedOrigins(request?: ListAllowedOriginsRequest | undefined, security?: ListAllowedOriginsSecurity | undefined, options?: RequestOptions): Promise<ListAllowedOriginsResult>;
    /**
     * setLogo projects
     *
     * @remarks
     ...
     */
    setLogo(request: SetProjectLogoRequest, security?: SetProjectLogoSecurity | undefined, options?: RequestOptions): Promise<SetProjectLogoResult>;
    /**
     ...
     */
    setOrganizationWhitelist(request: SetOrganizationWhitelistRequest, security?: SetOrganizationWhitelistSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    upsertAllowedOrigin(request: UpsertAllowedOriginRequest, security?: UpsertAllowedOriginSecurity | undefined, options?: RequestOptions): Promise<UpsertAllowedOriginResult>;
}
