...
export class Collections extends ClientSDK {
  ...
  async attachServer(request, security, options) {
    return unwrapAsync(
      collectionsAttachServer(this, request, security, options),
    );
  }
  /**
   * create collections
  ...
  async detachServer(request, security, options) {
    return unwrapAsync(
      collectionsDetachServer(this, request, security, options),
    );
  }
  /**
   * list collections
  ...
  async listServers(request, security, options) {
    return unwrapAsync(
      collectionsListServers(this, request, security, options),
    );
  }
  /**
   * update collections
