...
export class Environments extends ClientSDK {
  ...
  async deleteBySlug(request, security, options) {
    return unwrapAsync(
      environmentsDeleteBySlug(this, request, security, options),
    );
  }
  /**
  ...
  async deleteSourceLink(request, security, options) {
    return unwrapAsync(
      environmentsDeleteSourceLink(this, request, security, options),
    );
  }
  /**
  ...
  async deleteToolsetLink(request, security, options) {
    return unwrapAsync(
      environmentsDeleteToolsetLink(this, request, security, options),
    );
  }
  /**
  ...
  async getBySource(request, security, options) {
    return unwrapAsync(
      environmentsGetBySource(this, request, security, options),
    );
  }
  /**
  ...
  async getByToolset(request, security, options) {
    return unwrapAsync(
      environmentsGetByToolset(this, request, security, options),
    );
  }
  /**
  ...
  async setSourceLink(request, security, options) {
    return unwrapAsync(
      environmentsSetSourceLink(this, request, security, options),
    );
  }
  /**
  ...
  async setToolsetLink(request, security, options) {
    return unwrapAsync(
      environmentsSetToolsetLink(this, request, security, options),
    );
  }
  /**
  ...
  async updateBySlug(request, security, options) {
    return unwrapAsync(
      environmentsUpdateBySlug(this, request, security, options),
    );
  }
}
