...
import { UpdatePackageRequest, UpdatePackageResponse, UpdatePackageSecurity } from "../models/operations/updatepackage.js";
export declare class Packages extends ClientSDK {
     ...
     */
    create(request: CreatePackageRequest, security?: CreatePackageSecurity | undefined, options?: RequestOptions): Promise<CreatePackageResult>;
    /**
     ...
     */
    list(request?: ListPackagesRequest | undefined, security?: ListPackagesSecurity | undefined, options?: RequestOptions): Promise<ListPackagesResult>;
    /**
     ...
     */
    listVersions(request: ListVersionsRequest, security?: ListVersionsSecurity | undefined, options?: RequestOptions): Promise<ListVersionsResult>;
    /**
     * publish packages
     *
     * @remarks
     ...
     */
    publish(request: PublishRequest, security?: PublishSecurity | undefined, options?: RequestOptions): Promise<PublishPackageResult>;
    /**
     ...
     */
    update(request: UpdatePackageRequest, security?: UpdatePackageSecurity | undefined, options?: RequestOptions): Promise<UpdatePackageResponse>;
}
