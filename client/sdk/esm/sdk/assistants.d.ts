...
export declare class Assistants extends ClientSDK {
     ...
     * Create an assistant.
     */
    create(request: CreateAssistantRequest, security?: CreateAssistantSecurity | undefined, options?: RequestOptions): Promise<Assistant>;
    /**
     ...
     * Delete an assistant.
     */
    delete(request: DeleteAssistantRequest, security?: DeleteAssistantSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    ensureManaged(request?: EnsureManagedAssistantRequest | undefined, security?: EnsureManagedAssistantSecurity | undefined, options?: RequestOptions): Promise<Assistant>;
    /**
     ...
     */
    get(request: GetAssistantRequest, security?: GetAssistantSecurity | undefined, options?: RequestOptions): Promise<Assistant>;
    /**
     ...
     */
    getManaged(request?: GetManagedAssistantRequest | undefined, security?: GetManagedAssistantSecurity | undefined, options?: RequestOptions): Promise<Assistant>;
    /**
     ...
     */
    list(request?: ListAssistantsRequest | undefined, security?: ListAssistantsSecurity | undefined, options?: RequestOptions): Promise<ListAssistantsResult>;
    /**
     ...
     */
    sendMessage(request: SendAssistantMessageRequest, security?: SendAssistantMessageSecurity | undefined, options?: RequestOptions): Promise<SendMessageResult>;
    /**
     ...
     * Update an assistant.
     */
    update(request: UpdateAssistantRequest, security?: UpdateAssistantSecurity | undefined, options?: RequestOptions): Promise<Assistant>;
}
