...
import { DeleteOrganizationRemoteSessionIssuerRequest, DeleteOrganizationRemoteSessionIssuerSecurity } from "../models/operations/deleteorganizationremotesessionissuer.js";
...
import { UpdateOrganizationRemoteSessionIssuerRequest, UpdateOrganizationRemoteSessionIssuerSecurity } from "../models/operations/updateorganizationremotesessionissuer.js";
...
export declare class OrganizationRemoteSessionIssuers extends ClientSDK {
     ...
     */
    create(request: CreateOrganizationRemoteSessionIssuerRequest, security?: CreateOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
    /**
     ...
     */
    delete(request: DeleteOrganizationRemoteSessionIssuerRequest, security?: DeleteOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    get(request: GetOrganizationRemoteSessionIssuerRequest, security?: GetOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
    /**
     ...
     */
    getDeletePreflight(request: GetOrganizationRemoteSessionIssuerDeletePreflightRequest, security?: GetOrganizationRemoteSessionIssuerDeletePreflightSecurity | undefined, options?: RequestOptions): Promise<OrganizationIssuerDeletePreflight>;
    /**
     ...
     */
    list(request?: ListOrganizationRemoteSessionIssuersRequest | undefined, security?: ListOrganizationRemoteSessionIssuersSecurity | undefined, options?: RequestOptions): Promise<PageIterator<ListOrganizationRemoteSessionIssuersResponse, {
        cursor: string;
    }>>;
    /**
     ...
     */
    move(request: MoveOrganizationRemoteSessionIssuerRequest, security?: MoveOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
    /**
     ...
     */
    update(request: UpdateOrganizationRemoteSessionIssuerRequest, security?: UpdateOrganizationRemoteSessionIssuerSecurity | undefined, options?: RequestOptions): Promise<RemoteSessionIssuer>;
}
