...
export type ChatSetPinnedMutationError =
  | ServiceError
  | GramError
 ...
 */
export declare function useChatSetPinnedMutation(
  options?: MutationHookOptions<
    ChatSetPinnedMutationData,
    ChatSetPinnedMutationError,
    ChatSetPinnedMutationVariables
  >,
): UseMutationResult<
  ChatSetPinnedMutationData,
  ChatSetPinnedMutationError,
...
export declare function buildChatSetPinnedMutation(
  client$: GramCore,
  hookOptions?: RequestOptions,
): {
  mutationKey: MutationKey;
  mutationFn: (
    variables: ChatSetPinnedMutationVariables,
  ) => Promise<ChatSetPinnedMutationData>;
};
