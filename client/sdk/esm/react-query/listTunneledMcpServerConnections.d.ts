 ...
 * List live tunnel connections for a tunneled MCP server
 */
export declare function useListTunneledMcpServerConnectionsSuspense(
  request: ListTunneledMcpServerConnectionsRequest,
  security?: ListTunneledMcpServerConnectionsSecurity | undefined,
  ...
  ListTunneledMcpServerConnectionsQueryError
>;
export declare function setListTunneledMcpServerConnectionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateListTunneledMcpServerConnections(
  client: QueryClient,
...
export declare function invalidateAllListTunneledMcpServerConnections(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
