 ...
 */
export declare function useRemoveOrganizationRemoteSessionClientFromMcpServerMutation(
...
export declare function buildRemoveOrganizationRemoteSessionClientFromMcpServerMutation(
  client$: GramCore,
  hookOptions?: RequestOptions,
): {
  mutationKey: MutationKey;
  mutationFn: (
    variables: RemoveOrganizationRemoteSessionClientFromMcpServerMutationVariables,
