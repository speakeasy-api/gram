 ...
 */
export declare function useListToolsetsForOrg(
...
export declare function useListToolsetsForOrgSuspense(
  ...
  ListToolsetsForOrgQueryError
>;
export declare function setListToolsetsForOrgData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListToolsetsForOrg(
  client: QueryClient,
...
export declare function invalidateAllListToolsetsForOrg(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
