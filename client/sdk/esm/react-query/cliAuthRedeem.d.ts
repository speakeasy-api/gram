...
export type CliAuthRedeemMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * redeem cliAuth
 *
 * @remarks
 ...
 */
export declare function useCliAuthRedeemMutation(options?: MutationHookOptions<CliAuthRedeemMutationData, CliAuthRedeemMutationError, CliAuthRedeemMutationVariables>): UseMutationResult<CliAuthRedeemMutationData, CliAuthRedeemMutationError, CliAuthRedeemMutationVariables>;
export declare function mutationKeyCliAuthRedeem(): MutationKey;
export declare function buildCliAuthRedeemMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: CliAuthRedeemMutationVariables) => Promise<CliAuthRedeemMutationData>;
};
