...
export declare function useListToolsetToolFiltersSuspense(
  ...
  ListToolsetToolFiltersQueryError
>;
export declare function setListToolsetToolFiltersData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      slug: string;
...
export declare function invalidateListToolsetToolFilters(
  client: QueryClient,
...
export declare function invalidateAllListToolsetToolFilters(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
