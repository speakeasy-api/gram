 ...
 */
export declare function useListAwsIamCredentials(
 ...
 * List the organization's AWS IAM external credentials. Requires org:read.
 */
export declare function useListAwsIamCredentialsSuspense(
  request?: ListAwsIamCredentialsRequest | undefined,
  security?: ListAwsIamCredentialsSecurity | undefined,
  ...
  ListAwsIamCredentialsQueryError
>;
export declare function setListAwsIamCredentialsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListAwsIamCredentials(
  client: QueryClient,
...
export declare function invalidateAllListAwsIamCredentials(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
