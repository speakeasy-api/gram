 ...
 */
export declare function useListAssets(
 ...
 * List all assets for a project.
 */
export declare function useListAssetsSuspense(
  request?: ListAssetsRequest | undefined,
  security?: ListAssetsSecurity | undefined,
...
export declare function setListAssetsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListAssets(
  client: QueryClient,
...
export declare function invalidateAllListAssets(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
