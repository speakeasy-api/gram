 ...
 */
export declare function useIntegrationsIntegrationsNumberGet(
 ...
 * Get a third-party integration by ID or name.
 */
export declare function useIntegrationsIntegrationsNumberGetSuspense(
  request?: IntegrationsNumberGetRequest | undefined,
  security?: IntegrationsNumberGetSecurity | undefined,
  ...
  IntegrationsIntegrationsNumberGetQueryError
>;
export declare function setIntegrationsIntegrationsNumberGetData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id?: string | undefined;
...
export declare function invalidateIntegrationsIntegrationsNumberGet(
  client: QueryClient,
...
export declare function invalidateAllIntegrationsIntegrationsNumberGet(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
