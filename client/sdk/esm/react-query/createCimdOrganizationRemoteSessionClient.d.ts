 ...
 */
export declare function useCreateCimdOrganizationRemoteSessionClientMutation(
...
export declare function buildCreateCimdOrganizationRemoteSessionClientMutation(
  client$: GramCore,
