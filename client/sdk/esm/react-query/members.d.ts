 ...
 * List all team members with their role assignments.
 */
export declare function useMembersSuspense(
  request?: ListMembersRequest | undefined,
  security?: ListMembersSecurity | undefined,
...
export declare function setMembersData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateMembers(
  client: QueryClient,
...
export declare function invalidateAllMembers(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
