 ...
 */
export declare function useGetPeriodUsage(
 ...
 * Get the usage for an organization for a given period
 */
export declare function useGetPeriodUsageSuspense(
  request?: GetPeriodUsageRequest | undefined,
  security?: GetPeriodUsageSecurity | undefined,
...
export declare function setGetPeriodUsageData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateGetPeriodUsage(
  client: QueryClient,
...
export declare function invalidateAllGetPeriodUsage(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
