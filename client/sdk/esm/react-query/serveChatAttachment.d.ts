 ...
 */
export declare function useServeChatAttachment(
 ...
 * Serve a chat attachment from Gram.
 */
export declare function useServeChatAttachmentSuspense(
  request: ServeChatAttachmentRequest,
  security?: ServeChatAttachmentSecurity | undefined,
  ...
  ServeChatAttachmentQueryError
>;
export declare function setServeChatAttachmentData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateServeChatAttachment(
  client: QueryClient,
...
export declare function invalidateAllServeChatAttachment(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
