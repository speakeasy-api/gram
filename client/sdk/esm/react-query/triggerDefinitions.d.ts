 ...
 */
export declare function useTriggerDefinitions(
...
export declare function useTriggerDefinitionsSuspense(
  ...
  TriggerDefinitionsQueryError
>;
export declare function setTriggerDefinitionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateTriggerDefinitions(
  client: QueryClient,
...
export declare function invalidateAllTriggerDefinitions(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
