 ...
 */
export declare function useListOrganizationUsers(
 ...
 * List users in the active organization from Gram organization_user_relationships.
 */
export declare function useListOrganizationUsersSuspense(
  request?: ListOrganizationUsersRequest | undefined,
  security?: ListOrganizationUsersSecurity | undefined,
  ...
  ListOrganizationUsersQueryError
>;
export declare function setListOrganizationUsersData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListOrganizationUsers(
  client: QueryClient,
...
export declare function invalidateAllListOrganizationUsers(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
