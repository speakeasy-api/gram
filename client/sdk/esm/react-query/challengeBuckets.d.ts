 ...
 */
export declare function useChallengeBuckets(
 ...
 * List authz challenges grouped into time-based burst buckets. Consecutive challenges with the same dimensions within a 10-minute window are collapsed into a single bucket.
 */
export declare function useChallengeBucketsSuspense(
  request?: ListChallengeBucketsRequest | undefined,
  security?: ListChallengeBucketsSecurity | undefined,
  ...
  ChallengeBucketsQueryError
>;
export declare function setChallengeBucketsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateChallengeBuckets(
  client: QueryClient,
...
export declare function invalidateAllChallengeBuckets(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
