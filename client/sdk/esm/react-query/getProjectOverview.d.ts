 ...
 */
export declare function useGetProjectOverview(
 ...
 * Get project-level overview including total chats, tool calls, active servers/users, and top lists
 */
export declare function useGetProjectOverviewSuspense(
  request: GetProjectOverviewRequest,
  security?: GetProjectOverviewSecurity | undefined,
  ...
  GetProjectOverviewQueryError
>;
export declare function setGetProjectOverviewData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateGetProjectOverview(
  client: QueryClient,
...
export declare function invalidateAllGetProjectOverview(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
