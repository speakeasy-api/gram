...
export type DenyShadowMCPApprovalRequestMutationData =
  ShadowMCPApprovalDecisionResult;
export type DenyShadowMCPApprovalRequestMutationError =
  | ServiceError
  | GramError
...
export declare function useDenyShadowMCPApprovalRequestMutation(
  options?: MutationHookOptions<
    DenyShadowMCPApprovalRequestMutationData,
...
export declare function buildDenyShadowMCPApprovalRequestMutation(
  client$: GramCore,
  hookOptions?: RequestOptions,
): {
  mutationKey: MutationKey;
  mutationFn: (
    variables: DenyShadowMCPApprovalRequestMutationVariables,
  ) => Promise<DenyShadowMCPApprovalRequestMutationData>;
};
