 ...
 */
export declare function useListIntegrations(
 ...
 * List available third-party integrations.
 */
export declare function useListIntegrationsSuspense(
  request?: ListIntegrationsRequest | undefined,
  security?: ListIntegrationsSecurity | undefined,
  ...
  ListIntegrationsQueryError
>;
export declare function setListIntegrationsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListIntegrations(
  client: QueryClient,
...
export declare function invalidateAllListIntegrations(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
