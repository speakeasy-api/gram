 ...
 */
export declare function useGetGcpIamCredential(
...
export declare function useGetGcpIamCredentialSuspense(
  ...
  GetGcpIamCredentialQueryError
>;
export declare function setGetGcpIamCredentialData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateGetGcpIamCredential(
  client: QueryClient,
...
export declare function invalidateAllGetGcpIamCredential(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
