 ...
 */
export declare function useRemoteSessions(
 ...
 * List remote_sessions in the caller's project. access_token_encrypted and refresh_token_encrypted are never returned — only metadata (access_expires_at, refresh_expires_at, scopes).
 */
export declare function useRemoteSessionsSuspense(
  request?: ListRemoteSessionsRequest | undefined,
  security?: ListRemoteSessionsSecurity | undefined,
 ...
 * List remote_sessions in the caller's project. access_token_encrypted and refresh_token_encrypted are never returned — only metadata (access_expires_at, refresh_expires_at, scopes).
 */
export declare function useRemoteSessionsInfinite(
  request?: ListRemoteSessionsRequest | undefined,
  security?: ListRemoteSessionsSecurity | undefined,
...
export declare function useRemoteSessionsInfiniteSuspense(
  ...
  RemoteSessionsQueryError
>;
export declare function setRemoteSessionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateRemoteSessions(
  client: QueryClient,
...
export declare function invalidateAllRemoteSessions(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
