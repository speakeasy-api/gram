 ...
 * Get a deployment by its ID.
 */
export declare function useDeploymentSuspense(
  request: GetDeploymentRequest,
  security?: GetDeploymentSecurity | undefined,
...
export declare function setDeploymentData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateDeployment(
  client: QueryClient,
...
export declare function invalidateAllDeployment(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
