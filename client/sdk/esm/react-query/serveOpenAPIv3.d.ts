 ...
 */
export declare function useServeOpenAPIv3(
 ...
 * Serve an OpenAPIv3 asset from Gram.
 */
export declare function useServeOpenAPIv3Suspense(
  request: ServeOpenAPIv3Request,
  security?: ServeOpenAPIv3Security | undefined,
...
export declare function setServeOpenAPIv3Data(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateServeOpenAPIv3(
  client: QueryClient,
...
export declare function invalidateAllServeOpenAPIv3(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
