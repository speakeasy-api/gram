 ...
 */
export declare function useListEnvironments(
 ...
 * List all environments for an organization
 */
export declare function useListEnvironmentsSuspense(
  request?: ListEnvironmentsRequest | undefined,
  security?: ListEnvironmentsSecurity | undefined,
  ...
  ListEnvironmentsQueryError
>;
export declare function setListEnvironmentsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListEnvironments(
  client: QueryClient,
...
export declare function invalidateAllListEnvironments(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
