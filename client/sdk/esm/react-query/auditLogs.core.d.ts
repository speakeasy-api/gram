...
>["~next"];
export declare function prefetchAuditLogs(
...
export declare function prefetchAuditLogsInfinite(
  queryClient: QueryClient,
  client$: GramCore,
  request?: ListAuditLogsRequest | undefined,
  security?: ListAuditLogsSecurity | undefined,
...
export declare function buildAuditLogsQuery(
  client$: GramCore,
  request?: ListAuditLogsRequest | undefined,
  security?: ListAuditLogsSecurity | undefined,
  options?: RequestOptions,
...
export declare function buildAuditLogsInfiniteQuery(
  client$: GramCore,
  request?: ListAuditLogsRequest | undefined,
  security?: ListAuditLogsSecurity | undefined,
  options?: RequestOptions,
