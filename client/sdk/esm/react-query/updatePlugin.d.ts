...
export type UpdatePluginMutationError =
  | ServiceError
  | GramError
 ...
 */
export declare function useUpdatePluginMutation(
  options?: MutationHookOptions<
    UpdatePluginMutationData,
    UpdatePluginMutationError,
    UpdatePluginMutationVariables
  >,
): UseMutationResult<
  UpdatePluginMutationData,
  UpdatePluginMutationError,
...
export declare function buildUpdatePluginMutation(
  client$: GramCore,
  hookOptions?: RequestOptions,
): {
  mutationKey: MutationKey;
  mutationFn: (
    variables: UpdatePluginMutationVariables,
  ) => Promise<UpdatePluginMutationData>;
};
