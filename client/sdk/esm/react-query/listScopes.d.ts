 ...
 */
export declare function useListScopes(
 ...
 * List all available scopes and their resource types.
 */
export declare function useListScopesSuspense(
  request?: ListScopesRequest | undefined,
  security?: ListScopesSecurity | undefined,
...
export declare function setListScopesData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListScopes(
  client: QueryClient,
...
export declare function invalidateAllListScopes(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
