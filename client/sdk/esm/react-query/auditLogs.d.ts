 ...
 */
export declare function useAuditLogs(
 ...
 * List audit logs across organization and projects.
 */
export declare function useAuditLogsSuspense(
  request?: ListAuditLogsRequest | undefined,
  security?: ListAuditLogsSecurity | undefined,
 ...
 * List audit logs across organization and projects.
 */
export declare function useAuditLogsInfinite(
  request?: ListAuditLogsRequest | undefined,
  security?: ListAuditLogsSecurity | undefined,
 ...
 * List audit logs across organization and projects.
 */
export declare function useAuditLogsInfiniteSuspense(
  request?: ListAuditLogsRequest | undefined,
  security?: ListAuditLogsSecurity | undefined,
  ...
  AuditLogsQueryError
>;
export declare function setAuditLogsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateAuditLogs(
  client: QueryClient,
...
export declare function invalidateAllAuditLogs(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
