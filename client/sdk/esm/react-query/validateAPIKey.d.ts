 ...
 * Verify an api key
 */
export declare function useValidateAPIKey(
 ...
 * Verify an api key
 */
export declare function useValidateAPIKeySuspense(
  request?: ValidateAPIKeyRequest | undefined,
  security?: ValidateAPIKeySecurity | undefined,
...
export declare function setValidateAPIKeyData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateValidateAPIKey(
  client: QueryClient,
...
export declare function invalidateAllValidateAPIKey(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
