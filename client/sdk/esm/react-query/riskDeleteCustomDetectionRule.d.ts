...
export type RiskDeleteCustomDetectionRuleMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useRiskDeleteCustomDetectionRuleMutation(options?: MutationHookOptions<RiskDeleteCustomDetectionRuleMutationData, RiskDeleteCustomDetectionRuleMutationError, RiskDeleteCustomDetectionRuleMutationVariables>): UseMutationResult<RiskDeleteCustomDetectionRuleMutationData, RiskDeleteCustomDetectionRuleMutationError, RiskDeleteCustomDetectionRuleMutationVariables>;
export declare function mutationKeyRiskDeleteCustomDetectionRule(): MutationKey;
export declare function buildRiskDeleteCustomDetectionRuleMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: RiskDeleteCustomDetectionRuleMutationVariables) => Promise<RiskDeleteCustomDetectionRuleMutationData>;
};
