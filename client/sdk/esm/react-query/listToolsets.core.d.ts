...
export declare function prefetchListToolsets(queryClient: QueryClient, client$: GramCore, request?: ListToolsetsRequest | undefined, security?: ListToolsetsSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildListToolsetsQuery(client$: GramCore, request?: ListToolsetsRequest | undefined, security?: ListToolsetsSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
