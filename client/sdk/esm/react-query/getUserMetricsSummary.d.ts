 ...
 */
export declare function useGetUserMetricsSummary(
 ...
 * Get aggregated metrics summary grouped by user
 */
export declare function useGetUserMetricsSummarySuspense(
  request: GetUserMetricsSummaryRequest,
  security?: GetUserMetricsSummarySecurity | undefined,
  ...
  GetUserMetricsSummaryQueryError
>;
export declare function setGetUserMetricsSummaryData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateGetUserMetricsSummary(
  client: QueryClient,
...
export declare function invalidateAllGetUserMetricsSummary(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
