...
export declare function prefetchDeployment(queryClient: QueryClient, client$: GramCore, request: GetDeploymentRequest, security?: GetDeploymentSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildDeploymentQuery(client$: GramCore, request: GetDeploymentRequest, security?: GetDeploymentSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
