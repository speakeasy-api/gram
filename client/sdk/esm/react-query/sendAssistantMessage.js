...
export function buildSendAssistantMessageMutation(client$, hookOptions) {
    return {
        ...
        mutationFn: function sendAssistantMessageMutationFn({ request, security, options, }) {
            const mergedOptions = {
                ...hookOptions,
                ...options,
                fetchOptions: {
            ...
            return unwrapAsync(assistantsSendMessage(client$, request, security, mergedOptions));
        },
    };
}
