...
export declare function useAgentworkflowsGetResponseSuspense(
  ...
  AgentworkflowsGetResponseQueryError
>;
export declare function setAgentworkflowsGetResponseData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      responseId: string;
...
export declare function invalidateAgentworkflowsGetResponse(
  client: QueryClient,
...
export declare function invalidateAllAgentworkflowsGetResponse(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
