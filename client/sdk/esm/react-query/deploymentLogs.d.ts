 ...
 */
export declare function useDeploymentLogs(
 ...
 * Get logs for a deployment.
 */
export declare function useDeploymentLogsSuspense(
  request: GetDeploymentLogsRequest,
  security?: GetDeploymentLogsSecurity | undefined,
...
export declare function setDeploymentLogsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      deploymentId: string;
...
export declare function invalidateDeploymentLogs(
  client: QueryClient,
...
export declare function invalidateAllDeploymentLogs(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
