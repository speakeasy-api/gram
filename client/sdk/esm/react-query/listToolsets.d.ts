 ...
 */
export declare function useListToolsets(
 ...
 * List all toolsets for a project
 */
export declare function useListToolsetsSuspense(
  request?: ListToolsetsRequest | undefined,
  security?: ListToolsetsSecurity | undefined,
...
export declare function setListToolsetsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListToolsets(
  client: QueryClient,
...
export declare function invalidateAllListToolsets(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
