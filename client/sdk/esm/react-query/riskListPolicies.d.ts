 ...
 */
export declare function useRiskListPolicies(
 ...
 * List all risk analysis policies for the current project.
 */
export declare function useRiskListPoliciesSuspense(
  request?: ListRiskPoliciesRequest | undefined,
  security?: ListRiskPoliciesSecurity | undefined,
  ...
  RiskListPoliciesQueryError
>;
export declare function setRiskListPoliciesData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateRiskListPolicies(
  client: QueryClient,
...
export declare function invalidateAllRiskListPolicies(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
