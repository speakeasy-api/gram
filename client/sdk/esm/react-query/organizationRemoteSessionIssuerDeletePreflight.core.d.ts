...
export declare function prefetchOrganizationRemoteSessionIssuerDeletePreflight(
...
export declare function buildOrganizationRemoteSessionIssuerDeletePreflightQuery(
  client$: GramCore,
  request: GetOrganizationRemoteSessionIssuerDeletePreflightRequest,
  security?:
    | GetOrganizationRemoteSessionIssuerDeletePreflightSecurity
