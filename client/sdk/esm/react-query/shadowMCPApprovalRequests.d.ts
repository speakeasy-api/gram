 ...
 */
export declare function useShadowMCPApprovalRequests(
 ...
 * List Shadow MCP approval requests for the current organization. Requires organization admin access because requests include requester and block details.
 */
export declare function useShadowMCPApprovalRequestsSuspense(
  request?: ListShadowMCPApprovalRequestsRequest | undefined,
  security?: ListShadowMCPApprovalRequestsSecurity | undefined,
  ...
  ShadowMCPApprovalRequestsQueryError
>;
export declare function setShadowMCPApprovalRequestsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateShadowMCPApprovalRequests(
  client: QueryClient,
...
export declare function invalidateAllShadowMCPApprovalRequests(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
