...
export type DiscoverRemoteSessionIssuerMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useDiscoverRemoteSessionIssuerMutation(options?: MutationHookOptions<DiscoverRemoteSessionIssuerMutationData, DiscoverRemoteSessionIssuerMutationError, DiscoverRemoteSessionIssuerMutationVariables>): UseMutationResult<DiscoverRemoteSessionIssuerMutationData, DiscoverRemoteSessionIssuerMutationError, DiscoverRemoteSessionIssuerMutationVariables>;
export declare function mutationKeyDiscoverRemoteSessionIssuer(): MutationKey;
export declare function buildDiscoverRemoteSessionIssuerMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: DiscoverRemoteSessionIssuerMutationVariables) => Promise<DiscoverRemoteSessionIssuerMutationData>;
};
