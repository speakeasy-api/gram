 ...
 */
export declare function useMarketplaceSettings(
...
export declare function useMarketplaceSettingsSuspense(
  ...
  MarketplaceSettingsQueryError
>;
export declare function setMarketplaceSettingsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateMarketplaceSettings(
  client: QueryClient,
...
export declare function invalidateAllMarketplaceSettings(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
