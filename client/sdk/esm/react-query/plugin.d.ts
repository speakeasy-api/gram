 ...
 */
export declare function usePlugin(
...
export declare function invalidatePlugin(
  client: QueryClient,
...
export declare function invalidateAllPlugin(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
