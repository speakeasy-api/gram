 ...
 */
export declare function useListAPIKeys(
 ...
 * List all api keys for an organization
 */
export declare function useListAPIKeysSuspense(
  request?: ListAPIKeysRequest | undefined,
  security?: ListAPIKeysSecurity | undefined,
...
export declare function setListAPIKeysData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListAPIKeys(
  client: QueryClient,
...
export declare function invalidateAllListAPIKeys(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
