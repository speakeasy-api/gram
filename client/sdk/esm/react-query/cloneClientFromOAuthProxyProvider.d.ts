...
export type CloneClientFromOAuthProxyProviderMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useCloneClientFromOAuthProxyProviderMutation(options?: MutationHookOptions<CloneClientFromOAuthProxyProviderMutationData, CloneClientFromOAuthProxyProviderMutationError, CloneClientFromOAuthProxyProviderMutationVariables>): UseMutationResult<CloneClientFromOAuthProxyProviderMutationData, CloneClientFromOAuthProxyProviderMutationError, CloneClientFromOAuthProxyProviderMutationVariables>;
export declare function mutationKeyCloneClientFromOAuthProxyProvider(): MutationKey;
export declare function buildCloneClientFromOAuthProxyProviderMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: CloneClientFromOAuthProxyProviderMutationVariables) => Promise<CloneClientFromOAuthProxyProviderMutationData>;
};
