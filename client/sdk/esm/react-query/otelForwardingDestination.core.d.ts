...
export type OtelForwardingDestinationQueryData =
  components.OtelForwardingDestination;
export declare function prefetchOtelForwardingDestination(
...
export declare function buildOtelForwardingDestinationQuery(
  client$: GramCore,
  request: operations.GetOtelForwardingDestinationRequest,
  security?: operations.GetOtelForwardingDestinationSecurity | undefined,
  options?: RequestOptions,
  ...
  ) => Promise<OtelForwardingDestinationQueryData>;
};
