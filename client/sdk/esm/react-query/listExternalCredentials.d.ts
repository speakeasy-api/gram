 ...
 * List the organization's external credentials (provider-independent summary). Optionally filter by provider. Requires org:read.
 */
export declare function useListExternalCredentialsSuspense(
  request?: ListExternalCredentialsRequest | undefined,
  security?: ListExternalCredentialsSecurity | undefined,
  ...
  ListExternalCredentialsQueryError
>;
export declare function setListExternalCredentialsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListExternalCredentials(
  client: QueryClient,
...
export declare function invalidateAllListExternalCredentials(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
