...
export declare function prefetchGetMcpEndpoint(queryClient: QueryClient, client$: GramCore, request?: GetMcpEndpointRequest | undefined, security?: GetMcpEndpointSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildGetMcpEndpointQuery(client$: GramCore, request?: GetMcpEndpointRequest | undefined, security?: GetMcpEndpointSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
