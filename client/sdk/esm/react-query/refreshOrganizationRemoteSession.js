...
export function buildRefreshOrganizationRemoteSessionMutation(client$, hookOptions) {
    return {
        mutationKey: mutationKeyRefreshOrganizationRemoteSession(),
        mutationFn: function refreshOrganizationRemoteSessionMutationFn({ request, security, options, }) {
            const mergedOptions = {
                ...hookOptions,
                ...options,
                fetchOptions: {
            ...
            return unwrapAsync(organizationRemoteSessionsRefresh(client$, request, security, mergedOptions));
        },
    };
}
