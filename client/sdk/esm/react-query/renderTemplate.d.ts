 ...
 */
export declare function useRenderTemplate(
 ...
 * Render a prompt template directly with all template fields provided.
 */
export declare function useRenderTemplateSuspense(
  request: RenderTemplateRequest,
  security?: RenderTemplateSecurity | undefined,
...
export declare function setRenderTemplateData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateRenderTemplate(
  client: QueryClient,
...
export declare function invalidateAllRenderTemplate(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
