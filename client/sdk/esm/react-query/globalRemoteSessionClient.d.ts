 ...
 * Get a global remote_session_client by id. Requires platform admin.
 */
export declare function useGlobalRemoteSessionClientSuspense(
  request: GetGlobalRemoteSessionClientRequest,
  security?: GetGlobalRemoteSessionClientSecurity | undefined,
  ...
  GlobalRemoteSessionClientQueryError
>;
export declare function setGlobalRemoteSessionClientData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateGlobalRemoteSessionClient(
  client: QueryClient,
...
export declare function invalidateAllGlobalRemoteSessionClient(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
