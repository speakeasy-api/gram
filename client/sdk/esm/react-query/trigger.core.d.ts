...
export declare function prefetchTrigger(queryClient: QueryClient, client$: GramCore, request: GetTriggerInstanceRequest, security?: GetTriggerInstanceSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildTriggerQuery(client$: GramCore, request: GetTriggerInstanceRequest, security?: GetTriggerInstanceSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
