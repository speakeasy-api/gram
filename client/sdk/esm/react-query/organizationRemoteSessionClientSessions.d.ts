 ...
 * List the remote_sessions minted against a remote_session_client in the caller's organization. access_token_encrypted and refresh_token_encrypted are never returned. Requires org:read.
 */
export declare function useOrganizationRemoteSessionClientSessionsSuspense(
  request: ListOrganizationRemoteSessionClientSessionsRequest,
  security?: ListOrganizationRemoteSessionClientSessionsSecurity | undefined,
 ...
 * List the remote_sessions minted against a remote_session_client in the caller's organization. access_token_encrypted and refresh_token_encrypted are never returned. Requires org:read.
 */
export declare function useOrganizationRemoteSessionClientSessionsInfiniteSuspense(
  request: ListOrganizationRemoteSessionClientSessionsRequest,
  security?: ListOrganizationRemoteSessionClientSessionsSecurity | undefined,
  ...
  OrganizationRemoteSessionClientSessionsQueryError
>;
export declare function setOrganizationRemoteSessionClientSessionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      clientId: string;
...
export declare function invalidateOrganizationRemoteSessionClientSessions(
  client: QueryClient,
...
export declare function invalidateAllOrganizationRemoteSessionClientSessions(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
