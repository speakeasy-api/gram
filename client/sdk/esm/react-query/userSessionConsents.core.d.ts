...
>["~next"];
export declare function prefetchUserSessionConsents(
...
export declare function prefetchUserSessionConsentsInfinite(
  queryClient: QueryClient,
  client$: GramCore,
  request?: ListUserSessionConsentsRequest | undefined,
  security?: ListUserSessionConsentsSecurity | undefined,
...
export declare function buildUserSessionConsentsQuery(
  client$: GramCore,
  request?: ListUserSessionConsentsRequest | undefined,
  security?: ListUserSessionConsentsSecurity | undefined,
  options?: RequestOptions,
...
export declare function buildUserSessionConsentsInfiniteQuery(
  client$: GramCore,
  request?: ListUserSessionConsentsRequest | undefined,
  security?: ListUserSessionConsentsSecurity | undefined,
  options?: RequestOptions,
