...
export declare function prefetchSearchUsers(queryClient: QueryClient, client$: GramCore, request: SearchUsersRequest, security?: SearchUsersSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildSearchUsersQuery(client$: GramCore, request: SearchUsersRequest, security?: SearchUsersSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
