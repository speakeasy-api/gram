 ...
 */
export declare function useGetProjectMetricsSummary(
 ...
 * Get aggregated metrics summary for an entire project
 */
export declare function useGetProjectMetricsSummarySuspense(
  request: GetProjectMetricsSummaryRequest,
  security?: GetProjectMetricsSummarySecurity | undefined,
  ...
  GetProjectMetricsSummaryQueryError
>;
export declare function setGetProjectMetricsSummaryData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateGetProjectMetricsSummary(
  client: QueryClient,
...
export declare function invalidateAllGetProjectMetricsSummary(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
