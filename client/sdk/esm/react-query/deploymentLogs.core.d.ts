...
export declare function prefetchDeploymentLogs(queryClient: QueryClient, client$: GramCore, request: GetDeploymentLogsRequest, security?: GetDeploymentLogsSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildDeploymentLogsQuery(client$: GramCore, request: GetDeploymentLogsRequest, security?: GetDeploymentLogsSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
