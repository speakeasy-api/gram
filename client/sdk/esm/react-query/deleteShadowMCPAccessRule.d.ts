...
export type DeleteShadowMCPAccessRuleMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useDeleteShadowMCPAccessRuleMutation(options?: MutationHookOptions<DeleteShadowMCPAccessRuleMutationData, DeleteShadowMCPAccessRuleMutationError, DeleteShadowMCPAccessRuleMutationVariables>): UseMutationResult<DeleteShadowMCPAccessRuleMutationData, DeleteShadowMCPAccessRuleMutationError, DeleteShadowMCPAccessRuleMutationVariables>;
export declare function mutationKeyDeleteShadowMCPAccessRule(): MutationKey;
export declare function buildDeleteShadowMCPAccessRuleMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: DeleteShadowMCPAccessRuleMutationVariables) => Promise<DeleteShadowMCPAccessRuleMutationData>;
};
