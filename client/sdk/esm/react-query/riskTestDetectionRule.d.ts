...
export type RiskTestDetectionRuleMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useRiskTestDetectionRuleMutation(options?: MutationHookOptions<RiskTestDetectionRuleMutationData, RiskTestDetectionRuleMutationError, RiskTestDetectionRuleMutationVariables>): UseMutationResult<RiskTestDetectionRuleMutationData, RiskTestDetectionRuleMutationError, RiskTestDetectionRuleMutationVariables>;
export declare function mutationKeyRiskTestDetectionRule(): MutationKey;
export declare function buildRiskTestDetectionRuleMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: RiskTestDetectionRuleMutationVariables) => Promise<RiskTestDetectionRuleMutationData>;
};
