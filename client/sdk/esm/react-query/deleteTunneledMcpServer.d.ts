...
export type DeleteTunneledMcpServerMutationError =
  | ServiceError
  | GramError
 ...
 */
export declare function useDeleteTunneledMcpServerMutation(
  options?: MutationHookOptions<
    DeleteTunneledMcpServerMutationData,
    DeleteTunneledMcpServerMutationError,
    DeleteTunneledMcpServerMutationVariables
  >,
): UseMutationResult<
  DeleteTunneledMcpServerMutationData,
  DeleteTunneledMcpServerMutationError,
...
export declare function buildDeleteTunneledMcpServerMutation(
  client$: GramCore,
  hookOptions?: RequestOptions,
): {
  mutationKey: MutationKey;
  mutationFn: (
    variables: DeleteTunneledMcpServerMutationVariables,
  ) => Promise<DeleteTunneledMcpServerMutationData>;
};
