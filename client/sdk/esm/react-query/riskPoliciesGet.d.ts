 ...
 */
export declare function useRiskPoliciesGet(
 ...
 * Get a risk analysis policy by ID.
 */
export declare function useRiskPoliciesGetSuspense(
  request: GetRiskPolicyRequest,
  security?: GetRiskPolicySecurity | undefined,
...
export declare function setRiskPoliciesGetData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateRiskPoliciesGet(
  client: QueryClient,
...
export declare function invalidateAllRiskPoliciesGet(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
