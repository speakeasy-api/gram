...
export declare function prefetchListScopes(queryClient: QueryClient, client$: GramCore, request?: ListScopesRequest | undefined, security?: ListScopesSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildListScopesQuery(client$: GramCore, request?: ListScopesRequest | undefined, security?: ListScopesSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
