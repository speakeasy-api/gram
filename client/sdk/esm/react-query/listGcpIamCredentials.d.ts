 ...
 * List the organization's GCP IAM external credentials. Requires org:read.
 */
export declare function useListGcpIamCredentialsSuspense(
  request?: ListGcpIamCredentialsRequest | undefined,
  security?: ListGcpIamCredentialsSecurity | undefined,
  ...
  ListGcpIamCredentialsQueryError
>;
export declare function setListGcpIamCredentialsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListGcpIamCredentials(
  client: QueryClient,
...
export declare function invalidateAllListGcpIamCredentials(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
