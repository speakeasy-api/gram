 ...
 */
export declare function useOtelForwardingConfig(
...
export declare function useOtelForwardingConfigSuspense(
  ...
  OtelForwardingConfigQueryError
>;
export declare function setOtelForwardingConfigData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateOtelForwardingConfig(
  client: QueryClient,
...
export declare function invalidateAllOtelForwardingConfig(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
