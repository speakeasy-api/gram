...
export declare function prefetchListCollections(queryClient: QueryClient, client$: GramCore, request?: ListCollectionsRequest | undefined, security?: ListCollectionsSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildListCollectionsQuery(client$: GramCore, request?: ListCollectionsRequest | undefined, security?: ListCollectionsSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
