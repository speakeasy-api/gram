 ...
 * Get prompt template by its ID or name.
 */
export declare function useTemplateSuspense(
  request?: GetTemplateRequest | undefined,
  security?: GetTemplateSecurity | undefined,
...
export declare function setTemplateData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id?: string | undefined;
...
export declare function invalidateTemplate(
  client: QueryClient,
...
export declare function invalidateAllTemplate(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
