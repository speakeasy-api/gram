 ...
 */
export declare function useBuiltinExclusions(
 ...
 * List the built-in exclusion library (known-safe values suppressed before they reach exclusions), grouped by category.
 */
export declare function useBuiltinExclusionsSuspense(
  request?: ListBuiltinExclusionsRequest | undefined,
  security?: ListBuiltinExclusionsSecurity | undefined,
  ...
  BuiltinExclusionsQueryError
>;
export declare function setBuiltinExclusionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateBuiltinExclusions(
  client: QueryClient,
...
export declare function invalidateAllBuiltinExclusions(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
