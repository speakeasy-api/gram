 ...
 */
export declare function useListSessions(
 ...
 * Org-scoped list of individual chat sessions for a slice of usage, filtered by the same allowlisted dimensions as telemetry.query. Returns per-session cost, token, and tool metrics with cursor pagination.
 */
export declare function useListSessionsSuspense(
  request: ListSessionsRequest,
  security?: ListSessionsSecurity | undefined,
...
export declare function setListSessionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListSessions(
  client: QueryClient,
...
export declare function invalidateAllListSessions(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
