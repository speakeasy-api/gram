...
export function buildCreateOrganizationRemoteSessionClientMutation(client$, hookOptions) {
    return {
        mutationKey: mutationKeyCreateOrganizationRemoteSessionClient(),
        mutationFn: function createOrganizationRemoteSessionClientMutationFn({ request, security, options, }) {
            const mergedOptions = {
                ...hookOptions,
                ...options,
                fetchOptions: {
            ...
            return unwrapAsync(organizationRemoteSessionClientsCreate(client$, request, security, mergedOptions));
        },
    };
}
