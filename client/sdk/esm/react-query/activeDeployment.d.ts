 ...
 */
export declare function useActiveDeployment(
...
export declare function useActiveDeploymentSuspense(
  ...
  ActiveDeploymentQueryError
>;
export declare function setActiveDeploymentData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateActiveDeployment(
  client: QueryClient,
...
export declare function invalidateAllActiveDeployment(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
