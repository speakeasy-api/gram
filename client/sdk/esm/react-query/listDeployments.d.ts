 ...
 */
export declare function useListDeployments(
 ...
 * List all deployments in descending order of creation.
 */
export declare function useListDeploymentsSuspense(
  request?: ListDeploymentsRequest | undefined,
  security?: ListDeploymentsSecurity | undefined,
...
export declare function setListDeploymentsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListDeployments(
  client: QueryClient,
...
export declare function invalidateAllListDeployments(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
