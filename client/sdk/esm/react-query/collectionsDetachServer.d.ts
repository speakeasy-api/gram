...
export type CollectionsDetachServerMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useCollectionsDetachServerMutation(options?: MutationHookOptions<CollectionsDetachServerMutationData, CollectionsDetachServerMutationError, CollectionsDetachServerMutationVariables>): UseMutationResult<CollectionsDetachServerMutationData, CollectionsDetachServerMutationError, CollectionsDetachServerMutationVariables>;
export declare function mutationKeyCollectionsDetachServer(): MutationKey;
export declare function buildCollectionsDetachServerMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: CollectionsDetachServerMutationVariables) => Promise<CollectionsDetachServerMutationData>;
};
