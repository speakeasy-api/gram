...
export declare function prefetchTemplate(queryClient: QueryClient, client$: GramCore, request?: GetTemplateRequest | undefined, security?: GetTemplateSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildTemplateQuery(client$: GramCore, request?: GetTemplateRequest | undefined, security?: GetTemplateSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
