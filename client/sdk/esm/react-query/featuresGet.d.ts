 ...
 */
export declare function useFeaturesGet(
 ...
 * Get the current state of all product feature flags.
 */
export declare function useFeaturesGetSuspense(
  request?: operations.GetProductFeaturesRequest | undefined,
  security?: operations.GetProductFeaturesSecurity | undefined,
...
export declare function setFeaturesGetData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateFeaturesGet(
  client: QueryClient,
...
export declare function invalidateAllFeaturesGet(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
