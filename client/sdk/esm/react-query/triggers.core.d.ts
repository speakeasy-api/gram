...
export declare function prefetchTriggers(queryClient: QueryClient, client$: GramCore, request?: ListTriggerInstancesRequest | undefined, security?: ListTriggerInstancesSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildTriggersQuery(client$: GramCore, request?: ListTriggerInstancesRequest | undefined, security?: ListTriggerInstancesSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
