 ...
 */
export declare function useAssistantsGetManaged(
 ...
 * Get the project's built-in Project Assistant if it exists. Returns 404 when no managed assistant has been provisioned yet — call ensureManagedAssistant to create one.
 */
export declare function useAssistantsGetManagedSuspense(
  request?: GetManagedAssistantRequest | undefined,
  security?: GetManagedAssistantSecurity | undefined,
  ...
  AssistantsGetManagedQueryError
>;
export declare function setAssistantsGetManagedData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateAssistantsGetManaged(
  client: QueryClient,
...
export declare function invalidateAllAssistantsGetManaged(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
