 ...
 */
export declare function useRiskCapabilities(
 ...
 * Get server-side risk analysis capabilities for the current project.
 */
export declare function useRiskCapabilitiesSuspense(
  request?: operations.GetRiskCapabilitiesRequest | undefined,
  security?: operations.GetRiskCapabilitiesSecurity | undefined,
  ...
  RiskCapabilitiesQueryError
>;
export declare function setRiskCapabilitiesData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateRiskCapabilities(
  client: QueryClient,
...
export declare function invalidateAllRiskCapabilities(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
