 ...
 */
export declare function useAssistantsList(
 ...
 * List assistants for the current project.
 */
export declare function useAssistantsListSuspense(
  request?: ListAssistantsRequest | undefined,
  security?: ListAssistantsSecurity | undefined,
...
export declare function setAssistantsListData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateAssistantsList(
  client: QueryClient,
...
export declare function invalidateAllAssistantsList(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
