 ...
 */
export declare function useListPackages(
 ...
 * List all packages for a project.
 */
export declare function useListPackagesSuspense(
  request?: ListPackagesRequest | undefined,
  security?: ListPackagesSecurity | undefined,
...
export declare function setListPackagesData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateListPackages(
  client: QueryClient,
...
export declare function invalidateAllListPackages(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
