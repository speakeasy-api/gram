 ...
 */
export declare function usePluginsDownloadPluginPackage(
...
export declare function usePluginsDownloadPluginPackageSuspense(
  ...
  PluginsDownloadPluginPackageQueryError
>;
export declare function setPluginsDownloadPluginPackageData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      pluginId: string;
...
export declare function invalidatePluginsDownloadPluginPackage(
  client: QueryClient,
...
export declare function invalidateAllPluginsDownloadPluginPackage(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
