...
export type UpdateRemoteSessionClientMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useUpdateRemoteSessionClientMutation(options?: MutationHookOptions<UpdateRemoteSessionClientMutationData, UpdateRemoteSessionClientMutationError, UpdateRemoteSessionClientMutationVariables>): UseMutationResult<UpdateRemoteSessionClientMutationData, UpdateRemoteSessionClientMutationError, UpdateRemoteSessionClientMutationVariables>;
export declare function mutationKeyUpdateRemoteSessionClient(): MutationKey;
export declare function buildUpdateRemoteSessionClientMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: UpdateRemoteSessionClientMutationVariables) => Promise<UpdateRemoteSessionClientMutationData>;
};
