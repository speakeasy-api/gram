...
export declare function prefetchTelemetryQuery(queryClient: QueryClient, client$: GramCore, request: QueryRequest, security?: QuerySecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildTelemetryQueryQuery(client$: GramCore, request: QueryRequest, security?: QuerySecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
