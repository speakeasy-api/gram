...
export declare function prefetchMcpServers(queryClient: QueryClient, client$: GramCore, request?: ListMcpServersRequest | undefined, security?: ListMcpServersSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildMcpServersQuery(client$: GramCore, request?: ListMcpServersRequest | undefined, security?: ListMcpServersSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
