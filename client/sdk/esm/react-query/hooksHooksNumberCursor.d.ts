...
export type HooksHooksNumberCursorMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 * cursor hooks
 *
 * @remarks
 ...
 */
export declare function useHooksHooksNumberCursorMutation(options?: MutationHookOptions<HooksHooksNumberCursorMutationData, HooksHooksNumberCursorMutationError, HooksHooksNumberCursorMutationVariables>): UseMutationResult<HooksHooksNumberCursorMutationData, HooksHooksNumberCursorMutationError, HooksHooksNumberCursorMutationVariables>;
export declare function mutationKeyHooksHooksNumberCursor(): MutationKey;
export declare function buildHooksHooksNumberCursorMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: HooksHooksNumberCursorMutationVariables) => Promise<HooksHooksNumberCursorMutationData>;
};
