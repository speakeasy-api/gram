...
export declare function prefetchListHooksTraces(queryClient: QueryClient, client$: GramCore, request: ListHooksTracesRequest, security?: ListHooksTracesSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildListHooksTracesQuery(client$: GramCore, request: ListHooksTracesRequest, security?: ListHooksTracesSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
