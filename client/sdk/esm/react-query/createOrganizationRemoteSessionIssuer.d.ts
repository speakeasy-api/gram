...
export type CreateOrganizationRemoteSessionIssuerMutationData = RemoteSessionIssuer;
export type CreateOrganizationRemoteSessionIssuerMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useCreateOrganizationRemoteSessionIssuerMutation(options?: MutationHookOptions<CreateOrganizationRemoteSessionIssuerMutationData, CreateOrganizationRemoteSessionIssuerMutationError, CreateOrganizationRemoteSessionIssuerMutationVariables>): UseMutationResult<CreateOrganizationRemoteSessionIssuerMutationData, CreateOrganizationRemoteSessionIssuerMutationError, CreateOrganizationRemoteSessionIssuerMutationVariables>;
export declare function mutationKeyCreateOrganizationRemoteSessionIssuer(): MutationKey;
export declare function buildCreateOrganizationRemoteSessionIssuerMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: CreateOrganizationRemoteSessionIssuerMutationVariables) => Promise<CreateOrganizationRemoteSessionIssuerMutationData>;
};
