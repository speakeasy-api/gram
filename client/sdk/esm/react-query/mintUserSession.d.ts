...
export type MintUserSessionMutationError = ServiceError | GramError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError;
/**
 ...
 */
export declare function useMintUserSessionMutation(options?: MutationHookOptions<MintUserSessionMutationData, MintUserSessionMutationError, MintUserSessionMutationVariables>): UseMutationResult<MintUserSessionMutationData, MintUserSessionMutationError, MintUserSessionMutationVariables>;
export declare function mutationKeyMintUserSession(): MutationKey;
export declare function buildMintUserSessionMutation(client$: GramCore, hookOptions?: RequestOptions): {
    mutationKey: MutationKey;
    mutationFn: (variables: MintUserSessionMutationVariables) => Promise<MintUserSessionMutationData>;
};
