...
export declare function useRemoveOrganizationUserMutation(
  options?: MutationHookOptions<
    RemoveOrganizationUserMutationData,
    RemoveOrganizationUserMutationError,
...
export declare function buildRemoveOrganizationUserMutation(
  client$: GramCore,
  ...
  ) => Promise<RemoveOrganizationUserMutationData>;
};
