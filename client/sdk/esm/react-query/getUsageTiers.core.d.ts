...
export declare function prefetchGetUsageTiers(queryClient: QueryClient, client$: GramCore, options?: RequestOptions): Promise<void>;
export declare function buildGetUsageTiersQuery(client$: GramCore, options?: RequestOptions): {
    queryKey: QueryKey;
