 ...
 */
export declare function useMcpRegistriesGetServerDetails(
 ...
 * Get detailed information about an MCP server including remotes
 */
export declare function useMcpRegistriesGetServerDetailsSuspense(
  request: GetMCPServerDetailsRequest,
  security?: GetMCPServerDetailsSecurity | undefined,
  ...
  McpRegistriesGetServerDetailsQueryError
>;
export declare function setMcpRegistriesGetServerDetailsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      registryId: string;
...
export declare function invalidateMcpRegistriesGetServerDetails(
  client: QueryClient,
...
export declare function invalidateAllMcpRegistriesGetServerDetails(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
