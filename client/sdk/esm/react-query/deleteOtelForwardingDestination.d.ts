...
export type DeleteOtelForwardingDestinationMutationError =
  | errors.ServiceError
  | GramError
...
export declare function useDeleteOtelForwardingDestinationMutation(
  options?: MutationHookOptions<
    DeleteOtelForwardingDestinationMutationData,
    DeleteOtelForwardingDestinationMutationError,
    DeleteOtelForwardingDestinationMutationVariables
  >,
): UseMutationResult<
  DeleteOtelForwardingDestinationMutationData,
  DeleteOtelForwardingDestinationMutationError,
...
export declare function buildDeleteOtelForwardingDestinationMutation(
  client$: GramCore,
  hookOptions?: RequestOptions,
): {
  mutationKey: MutationKey;
  mutationFn: (
    variables: DeleteOtelForwardingDestinationMutationVariables,
  ) => Promise<DeleteOtelForwardingDestinationMutationData>;
};
