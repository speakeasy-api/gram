...
export function buildCreateCimdRemoteSessionClientMutation(client$, hookOptions) {
    return {
        mutationKey: mutationKeyCreateCimdRemoteSessionClient(),
        mutationFn: function createCimdRemoteSessionClientMutationFn({ request, security, options, }) {
            const mergedOptions = {
                ...hookOptions,
                ...options,
                fetchOptions: {
            ...
            return unwrapAsync(remoteSessionClientsCreateCimd(client$, request, security, mergedOptions));
        },
    };
}
