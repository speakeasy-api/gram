 ...
 */
export declare function useOrganizationRemoteSessionIssuerDeletePreflight(
 ...
 * Authoritative impact summary for deleting a remote_session_issuer: associated client count and affected MCP server names. Requires org:read.
 */
export declare function useOrganizationRemoteSessionIssuerDeletePreflightSuspense(
  request: GetOrganizationRemoteSessionIssuerDeletePreflightRequest,
  security?:
    | GetOrganizationRemoteSessionIssuerDeletePreflightSecurity
    | undefined,
  ...
  OrganizationRemoteSessionIssuerDeletePreflightQueryError
>;
export declare function setOrganizationRemoteSessionIssuerDeletePreflightData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id: string;
...
export declare function invalidateOrganizationRemoteSessionIssuerDeletePreflight(
  client: QueryClient,
...
export declare function invalidateAllOrganizationRemoteSessionIssuerDeletePreflight(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
