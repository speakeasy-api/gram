 ...
 */
export declare function useAuditLogFacets(
 ...
 * List available audit log facet values across organization and projects.
 */
export declare function useAuditLogFacetsSuspense(
  request?: ListAuditLogFacetsRequest | undefined,
  security?: ListAuditLogFacetsSecurity | undefined,
...
export declare function setAuditLogFacetsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
...
export declare function invalidateAuditLogFacets(
  client: QueryClient,
...
export declare function invalidateAllAuditLogFacets(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
