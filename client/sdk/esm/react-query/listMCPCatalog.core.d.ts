...
export declare function prefetchListMCPCatalog(queryClient: QueryClient, client$: GramCore, request?: ListMCPCatalogRequest | undefined, security?: ListMCPCatalogSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildListMCPCatalogQuery(client$: GramCore, request?: ListMCPCatalogRequest | undefined, security?: ListMCPCatalogSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
