 ...
 */
export declare function useRiskListEvalReviews(
...
export declare function useRiskListEvalReviewsSuspense(
  ...
  RiskListEvalReviewsQueryError
>;
export declare function setRiskListEvalReviewsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      policyId: string;
...
export declare function invalidateRiskListEvalReviews(
  client: QueryClient,
...
export declare function invalidateAllRiskListEvalReviews(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
