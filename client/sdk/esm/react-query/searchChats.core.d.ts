...
export declare function prefetchSearchChats(queryClient: QueryClient, client$: GramCore, request: SearchChatsRequest, security?: SearchChatsSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildSearchChatsQuery(client$: GramCore, request: SearchChatsRequest, security?: SearchChatsSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
