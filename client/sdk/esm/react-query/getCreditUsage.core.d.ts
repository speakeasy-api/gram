...
export declare function prefetchGetCreditUsage(queryClient: QueryClient, client$: GramCore, request?: CreditUsageRequest | undefined, security?: CreditUsageSecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildGetCreditUsageQuery(client$: GramCore, request?: CreditUsageRequest | undefined, security?: CreditUsageSecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
