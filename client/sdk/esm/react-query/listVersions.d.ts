 ...
 */
export declare function useListVersions(
 ...
 * List published versions of a package.
 */
export declare function useListVersionsSuspense(
  request: ListVersionsRequest,
  security?: ListVersionsSecurity | undefined,
...
export declare function setListVersionsData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      name: string;
...
export declare function invalidateListVersions(
  client: QueryClient,
...
export declare function invalidateAllListVersions(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
