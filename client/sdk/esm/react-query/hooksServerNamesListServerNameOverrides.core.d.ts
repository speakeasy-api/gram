...
export type HooksServerNamesListServerNameOverridesQueryData =
  Array<ServerNameOverride>;
export declare function prefetchHooksServerNamesListServerNameOverrides(
...
export declare function buildHooksServerNamesListServerNameOverridesQuery(
  client$: GramCore,
  request?: ListServerNameOverridesRequest | undefined,
  security?: ListServerNameOverridesSecurity | undefined,
  options?: RequestOptions,
