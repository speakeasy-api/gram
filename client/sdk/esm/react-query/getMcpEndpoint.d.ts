 ...
 */
export declare function useGetMcpEndpoint(
 ...
 * Get an MCP endpoint by id or by (custom_domain_id, slug). Provide either id, or slug with an optional custom_domain_id — not both.
 */
export declare function useGetMcpEndpointSuspense(
  request?: GetMcpEndpointRequest | undefined,
  security?: GetMcpEndpointSecurity | undefined,
...
export declare function setGetMcpEndpointData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      id?: string | undefined;
...
export declare function invalidateGetMcpEndpoint(
  client: QueryClient,
...
export declare function invalidateAllGetMcpEndpoint(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
