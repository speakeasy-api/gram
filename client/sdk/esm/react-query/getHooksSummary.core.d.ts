...
export declare function prefetchGetHooksSummary(queryClient: QueryClient, client$: GramCore, request: GetHooksSummaryRequest, security?: GetHooksSummarySecurity | undefined, options?: RequestOptions): Promise<void>;
export declare function buildGetHooksSummaryQuery(client$: GramCore, request: GetHooksSummaryRequest, security?: GetHooksSummarySecurity | undefined, options?: RequestOptions): {
    queryKey: QueryKey;
