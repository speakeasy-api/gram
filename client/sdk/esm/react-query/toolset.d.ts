 ...
 */
export declare function useToolset(
 ...
 * Get detailed information about a toolset including full HTTP tool definitions
 */
export declare function useToolsetSuspense(
  request: GetToolsetRequest,
  security?: GetToolsetSecurity | undefined,
...
export declare function setToolsetData(
  client: QueryClient,
  queryKeyBase: [
    parameters: {
      slug: string;
...
export declare function invalidateToolset(
  client: QueryClient,
...
export declare function invalidateAllToolset(
  client: QueryClient,
  filters?: Omit<InvalidateQueryFilters, "queryKey" | "predicate" | "exact">,
): Promise<void>;
