...
/** @internal */
export declare const VerifyURLResult$inboundSchema: z.ZodMiniType<VerifyURLResult, unknown>;
export declare function verifyURLResultFromJSON(jsonString: string): SafeParseResult<VerifyURLResult, SDKValidationError>;
