...
/** @internal */
export declare const CloneClientFromOAuthProxyProviderFormTokenEndpointAuthMethod$outboundSchema: z.ZodMiniEnum<
  typeof CloneClientFromOAuthProxyProviderFormTokenEndpointAuthMethod
>;
/** @internal */
...
/** @internal */
export declare const CloneClientFromOAuthProxyProviderForm$outboundSchema: z.ZodMiniType<
  CloneClientFromOAuthProxyProviderForm$Outbound,
  CloneClientFromOAuthProxyProviderForm
>;
export declare function cloneClientFromOAuthProxyProviderFormToJSON(
