...
/** @internal */
export declare const CreateEnvironmentForm$outboundSchema: z.ZodMiniType<CreateEnvironmentForm$Outbound, CreateEnvironmentForm>;
export declare function createEnvironmentFormToJSON(createEnvironmentForm: CreateEnvironmentForm): string;
