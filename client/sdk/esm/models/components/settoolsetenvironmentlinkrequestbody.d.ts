...
/** @internal */
export declare const SetToolsetEnvironmentLinkRequestBody$outboundSchema: z.ZodMiniType<
  SetToolsetEnvironmentLinkRequestBody$Outbound,
  SetToolsetEnvironmentLinkRequestBody
>;
export declare function setToolsetEnvironmentLinkRequestBodyToJSON(
