...
/** @internal */
export declare const RemoveClientFromMcpServerRequestBody$outboundSchema: z.ZodMiniType<
  RemoveClientFromMcpServerRequestBody$Outbound,
  RemoveClientFromMcpServerRequestBody
>;
export declare function removeClientFromMcpServerRequestBodyToJSON(
