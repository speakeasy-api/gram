...
/** @internal */
export declare const RiskSpanRedacted$inboundSchema: z.ZodMiniType<RiskSpanRedacted, unknown>;
export declare function riskSpanRedactedFromJSON(jsonString: string): SafeParseResult<RiskSpanRedacted, SDKValidationError>;
