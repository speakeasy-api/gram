...
/** @internal */
export declare const ProtectedResourceMetadataUnavailable$inboundSchema: z.ZodMiniType<ProtectedResourceMetadataUnavailable, unknown>;
export declare function protectedResourceMetadataUnavailableFromJSON(jsonString: string): SafeParseResult<ProtectedResourceMetadataUnavailable, SDKValidationError>;
