...
/** @internal */
export declare const OAuthProxyServerFormProviderType$outboundSchema: z.ZodMiniEnum<
  typeof OAuthProxyServerFormProviderType
>;
/** @internal */
...
/** @internal */
export declare const OAuthProxyServerForm$outboundSchema: z.ZodMiniType<
  OAuthProxyServerForm$Outbound,
  OAuthProxyServerForm
>;
export declare function oAuthProxyServerFormToJSON(
