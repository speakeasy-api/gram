...
/** @internal */
export declare const McpEnvironmentConfigInput$outboundSchema: z.ZodMiniType<McpEnvironmentConfigInput$Outbound, McpEnvironmentConfigInput>;
export declare function mcpEnvironmentConfigInputToJSON(mcpEnvironmentConfigInput: McpEnvironmentConfigInput): string;
