...
/** @internal */
export declare const HooksTimeSeriesPoint$inboundSchema: z.ZodMiniType<HooksTimeSeriesPoint, unknown>;
export declare function hooksTimeSeriesPointFromJSON(jsonString: string): SafeParseResult<HooksTimeSeriesPoint, SDKValidationError>;
