...
/** @internal */
export declare const SetOrganizationWhitelistRequestBody$outboundSchema: z.ZodMiniType<
  SetOrganizationWhitelistRequestBody$Outbound,
  SetOrganizationWhitelistRequestBody
>;
export declare function setOrganizationWhitelistRequestBodyToJSON(
