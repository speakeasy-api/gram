...
/** @internal */
export declare const SecurityVariable$inboundSchema: z.ZodMiniType<SecurityVariable, unknown>;
export declare function securityVariableFromJSON(jsonString: string): SafeParseResult<SecurityVariable, SDKValidationError>;
