...
/** @internal */
export declare const UpdateRiskExclusionRequestBodyMatchType$outboundSchema: z.ZodMiniEnum<
  typeof UpdateRiskExclusionRequestBodyMatchType
>;
/** @internal */
...
/** @internal */
export declare const UpdateRiskExclusionRequestBody$outboundSchema: z.ZodMiniType<
  UpdateRiskExclusionRequestBody$Outbound,
  UpdateRiskExclusionRequestBody
>;
export declare function updateRiskExclusionRequestBodyToJSON(
