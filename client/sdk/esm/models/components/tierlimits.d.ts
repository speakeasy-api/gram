...
/** @internal */
export declare const TierLimits$inboundSchema: z.ZodMiniType<TierLimits, unknown>;
export declare function tierLimitsFromJSON(jsonString: string): SafeParseResult<TierLimits, SDKValidationError>;
