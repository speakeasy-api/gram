...
/** @internal */
export declare const TriggerRiskAnalysisRequestBody$outboundSchema: z.ZodMiniType<TriggerRiskAnalysisRequestBody$Outbound, TriggerRiskAnalysisRequestBody>;
export declare function triggerRiskAnalysisRequestBodyToJSON(triggerRiskAnalysisRequestBody: TriggerRiskAnalysisRequestBody): string;
