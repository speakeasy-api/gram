...
/** @internal */
export declare const WorkflowStatus$inboundSchema: z.ZodMiniEnum<typeof WorkflowStatus>;
/** @internal */
export declare const RiskPolicyStatus$inboundSchema: z.ZodMiniType<RiskPolicyStatus, unknown>;
export declare function riskPolicyStatusFromJSON(jsonString: string): SafeParseResult<RiskPolicyStatus, SDKValidationError>;
