...
/** @internal */
export declare const TriggerDefinitionKind$inboundSchema: z.ZodMiniEnum<
  typeof TriggerDefinitionKind
>;
/** @internal */
export declare const TriggerDefinition$inboundSchema: z.ZodMiniType<
  TriggerDefinition,
  unknown
>;
export declare function triggerDefinitionFromJSON(
  jsonString: string,
