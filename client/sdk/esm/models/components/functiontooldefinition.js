...
/** @internal */
export const FunctionToolDefinition$inboundSchema = z.pipe(z.object({
...
export function functionToolDefinitionFromJSON(jsonString) {
    return safeParse(jsonString, (x) => FunctionToolDefinition$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'FunctionToolDefinition' from JSON`);
}
