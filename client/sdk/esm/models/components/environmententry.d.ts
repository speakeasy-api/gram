...
/** @internal */
export declare const EnvironmentEntry$inboundSchema: z.ZodMiniType<EnvironmentEntry, unknown>;
export declare function environmentEntryFromJSON(jsonString: string): SafeParseResult<EnvironmentEntry, SDKValidationError>;
