...
/** @internal */
export declare const OtelForwardingDestination$inboundSchema: z.ZodMiniType<
  OtelForwardingDestination,
  unknown
>;
export declare function otelForwardingDestinationFromJSON(
  jsonString: string,
): SafeParseResult<OtelForwardingDestination, SDKValidationError>;
