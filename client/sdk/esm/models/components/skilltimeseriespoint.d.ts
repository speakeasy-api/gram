...
/** @internal */
export declare const SkillTimeSeriesPoint$inboundSchema: z.ZodMiniType<SkillTimeSeriesPoint, unknown>;
export declare function skillTimeSeriesPointFromJSON(jsonString: string): SafeParseResult<SkillTimeSeriesPoint, SDKValidationError>;
