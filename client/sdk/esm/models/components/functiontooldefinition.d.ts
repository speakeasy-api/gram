...
/** @internal */
export declare const FunctionToolDefinition$inboundSchema: z.ZodMiniType<FunctionToolDefinition, unknown>;
export declare function functionToolDefinitionFromJSON(jsonString: string): SafeParseResult<FunctionToolDefinition, SDKValidationError>;
