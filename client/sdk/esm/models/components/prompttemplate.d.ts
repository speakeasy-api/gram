...
/** @internal */
export declare const PromptTemplateKind$inboundSchema: z.ZodMiniEnum<
  typeof PromptTemplateKind
>;
/** @internal */
export declare const PromptTemplate$inboundSchema: z.ZodMiniType<
  PromptTemplate,
  unknown
>;
export declare function promptTemplateFromJSON(
  jsonString: string,
