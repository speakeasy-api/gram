...
/** @internal */
export declare const ToolUsageTraceLogGroupKind$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTraceLogGroupKind
>;
/** @internal */
export declare const ToolUsageTraceLogGroup$inboundSchema: z.ZodMiniType<
  ToolUsageTraceLogGroup,
  unknown
>;
export declare function toolUsageTraceLogGroupFromJSON(
  jsonString: string,
