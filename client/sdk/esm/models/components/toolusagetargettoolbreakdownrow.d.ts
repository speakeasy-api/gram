...
/** @internal */
export declare const ToolUsageTargetToolBreakdownRowTargetKind$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTargetToolBreakdownRowTargetKind
>;
/** @internal */
export declare const ToolUsageTargetToolBreakdownRowTargetType$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTargetToolBreakdownRowTargetType
>;
/** @internal */
export declare const ToolUsageTargetToolBreakdownRow$inboundSchema: z.ZodMiniType<
  ToolUsageTargetToolBreakdownRow,
  unknown
>;
export declare function toolUsageTargetToolBreakdownRowFromJSON(
  jsonString: string,
