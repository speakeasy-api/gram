...
/** @internal */
export declare const RiskResult$inboundSchema: z.ZodMiniType<RiskResult, unknown>;
export declare function riskResultFromJSON(jsonString: string): SafeParseResult<RiskResult, SDKValidationError>;
