...
/** @internal */
export declare const TransportType$inboundSchema: z.ZodMiniEnum<typeof TransportType>;
/** @internal */
export declare const ExternalMCPRemote$inboundSchema: z.ZodMiniType<ExternalMCPRemote, unknown>;
export declare function externalMCPRemoteFromJSON(jsonString: string): SafeParseResult<ExternalMCPRemote, SDKValidationError>;
