...
/** @internal */
export declare const ListOrganizationRemoteSessionIssuersResult$inboundSchema: z.ZodMiniType<ListOrganizationRemoteSessionIssuersResult, unknown>;
export declare function listOrganizationRemoteSessionIssuersResultFromJSON(jsonString: string): SafeParseResult<ListOrganizationRemoteSessionIssuersResult, SDKValidationError>;
