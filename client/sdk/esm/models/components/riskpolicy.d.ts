...
/** @internal */
export declare const RiskPolicyAction$inboundSchema: z.ZodMiniEnum<typeof RiskPolicyAction>;
/** @internal */
export declare const RiskPolicyAudienceType$inboundSchema: z.ZodMiniEnum<typeof RiskPolicyAudienceType>;
/** @internal */
export declare const RiskPolicyPolicyType$inboundSchema: z.ZodMiniEnum<typeof RiskPolicyPolicyType>;
/** @internal */
export declare const RiskPolicy$inboundSchema: z.ZodMiniType<RiskPolicy, unknown>;
export declare function riskPolicyFromJSON(jsonString: string): SafeParseResult<RiskPolicy, SDKValidationError>;
