...
/** @internal */
export declare const ConnectionStatus$inboundSchema: z.ZodMiniEnum<
  typeof ConnectionStatus
>;
/** @internal */
export declare const TunneledMcpServerStatus$inboundSchema: z.ZodMiniEnum<
  typeof TunneledMcpServerStatus
>;
/** @internal */
export declare const TunneledMcpServer$inboundSchema: z.ZodMiniType<
  TunneledMcpServer,
  unknown
>;
export declare function tunneledMcpServerFromJSON(
  jsonString: string,
