...
/** @internal */
export declare const FeatureName$outboundSchema: z.ZodMiniEnum<
  typeof FeatureName
>;
/** @internal */
...
/** @internal */
export declare const SetProductFeatureRequestBody$outboundSchema: z.ZodMiniType<
  SetProductFeatureRequestBody$Outbound,
  SetProductFeatureRequestBody
>;
export declare function setProductFeatureRequestBodyToJSON(
