 ...
 * Severity level for findings produced by this rule.
 */
export type RiskCustomDetectionRuleSeverity = ClosedEnum<typeof RiskCustomDetectionRuleSeverity>;
...
/** @internal */
export declare const RiskCustomDetectionRuleSeverity$inboundSchema: z.ZodMiniEnum<typeof RiskCustomDetectionRuleSeverity>;
/** @internal */
export declare const RiskCustomDetectionRule$inboundSchema: z.ZodMiniType<RiskCustomDetectionRule, unknown>;
export declare function riskCustomDetectionRuleFromJSON(jsonString: string): SafeParseResult<RiskCustomDetectionRule, SDKValidationError>;
