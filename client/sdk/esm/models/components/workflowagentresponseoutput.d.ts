 ...
 * Status of the response
 */
export type WorkflowAgentResponseOutputStatus = ClosedEnum<typeof WorkflowAgentResponseOutputStatus>;
/**
...
/** @internal */
export declare const WorkflowAgentResponseOutputStatus$inboundSchema: z.ZodMiniEnum<typeof WorkflowAgentResponseOutputStatus>;
/** @internal */
export declare const WorkflowAgentResponseOutput$inboundSchema: z.ZodMiniType<WorkflowAgentResponseOutput, unknown>;
export declare function workflowAgentResponseOutputFromJSON(jsonString: string): SafeParseResult<WorkflowAgentResponseOutput, SDKValidationError>;
