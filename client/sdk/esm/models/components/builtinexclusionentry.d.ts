...
/** @internal */
export declare const BuiltinExclusionEntry$inboundSchema: z.ZodMiniType<BuiltinExclusionEntry, unknown>;
export declare function builtinExclusionEntryFromJSON(jsonString: string): SafeParseResult<BuiltinExclusionEntry, SDKValidationError>;
