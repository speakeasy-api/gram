...
/** @internal */
export declare const UpsertConfigRequestBody2$outboundSchema: z.ZodMiniType<UpsertConfigRequestBody2$Outbound, UpsertConfigRequestBody2>;
export declare function upsertConfigRequestBody2ToJSON(upsertConfigRequestBody2: UpsertConfigRequestBody2): string;
