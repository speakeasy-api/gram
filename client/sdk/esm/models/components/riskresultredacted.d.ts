...
/** @internal */
export declare const RiskResultRedacted$inboundSchema: z.ZodMiniType<RiskResultRedacted, unknown>;
export declare function riskResultRedactedFromJSON(jsonString: string): SafeParseResult<RiskResultRedacted, SDKValidationError>;
