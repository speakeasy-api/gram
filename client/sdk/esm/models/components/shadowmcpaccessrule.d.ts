...
/** @internal */
export declare const ShadowMCPAccessRuleAccessScope$inboundSchema: z.ZodMiniEnum<
  typeof ShadowMCPAccessRuleAccessScope
>;
/** @internal */
export declare const Disposition$inboundSchema: z.ZodMiniEnum<
  typeof Disposition
>;
/** @internal */
export declare const ShadowMCPAccessRuleMatchBreadth$inboundSchema: z.ZodMiniEnum<
  typeof ShadowMCPAccessRuleMatchBreadth
>;
/** @internal */
export declare const ShadowMCPAccessRule$inboundSchema: z.ZodMiniType<
  ShadowMCPAccessRule,
  unknown
>;
export declare function shadowMCPAccessRuleFromJSON(
  jsonString: string,
