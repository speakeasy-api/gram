...
/** @internal */
export declare const SubmitFeedbackRequestBody$outboundSchema: z.ZodMiniType<SubmitFeedbackRequestBody$Outbound, SubmitFeedbackRequestBody>;
export declare function submitFeedbackRequestBodyToJSON(submitFeedbackRequestBody: SubmitFeedbackRequestBody): string;
