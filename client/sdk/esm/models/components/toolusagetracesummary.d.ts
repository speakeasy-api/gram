...
/** @internal */
export declare const ToolUsageTraceSummaryHookStatus$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTraceSummaryHookStatus
>;
/** @internal */
export declare const ToolUsageTraceSummaryTargetKind$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTraceSummaryTargetKind
>;
/** @internal */
export declare const ToolUsageTraceSummaryTargetType$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTraceSummaryTargetType
>;
/** @internal */
export declare const ToolUsageTraceSummaryUserKind$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTraceSummaryUserKind
>;
/** @internal */
export declare const ToolUsageTraceSummary$inboundSchema: z.ZodMiniType<
  ToolUsageTraceSummary,
  unknown
>;
export declare function toolUsageTraceSummaryFromJSON(
  jsonString: string,
