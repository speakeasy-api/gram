...
/** @internal */
export declare const TraceSummaryRecord$inboundSchema: z.ZodMiniType<TraceSummaryRecord, unknown>;
export declare function traceSummaryRecordFromJSON(jsonString: string): SafeParseResult<TraceSummaryRecord, SDKValidationError>;
