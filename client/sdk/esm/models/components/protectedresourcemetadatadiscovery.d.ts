...
/** @internal */
export declare const ProtectedResourceMetadataDiscovery$inboundSchema: z.ZodMiniType<ProtectedResourceMetadataDiscovery, unknown>;
export declare function protectedResourceMetadataDiscoveryFromJSON(jsonString: string): SafeParseResult<ProtectedResourceMetadataDiscovery, SDKValidationError>;
