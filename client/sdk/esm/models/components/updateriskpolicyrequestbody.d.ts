 ...
 * Policy action: flag or block.
 */
export type UpdateRiskPolicyRequestBodyAction = ClosedEnum<typeof UpdateRiskPolicyRequestBodyAction>;
/**
 ...
 * Policy audience type: everyone or targeted. Omit to preserve the current audience type.
 */
export type UpdateRiskPolicyRequestBodyAudienceType = ClosedEnum<typeof UpdateRiskPolicyRequestBodyAudienceType>;
...
/** @internal */
export declare const UpdateRiskPolicyRequestBodyAction$outboundSchema: z.ZodMiniEnum<typeof UpdateRiskPolicyRequestBodyAction>;
/** @internal */
export declare const UpdateRiskPolicyRequestBodyAudienceType$outboundSchema: z.ZodMiniEnum<typeof UpdateRiskPolicyRequestBodyAudienceType>;
/** @internal */
...
/** @internal */
export declare const UpdateRiskPolicyRequestBody$outboundSchema: z.ZodMiniType<UpdateRiskPolicyRequestBody$Outbound, UpdateRiskPolicyRequestBody>;
export declare function updateRiskPolicyRequestBodyToJSON(updateRiskPolicyRequestBody: UpdateRiskPolicyRequestBody): string;
