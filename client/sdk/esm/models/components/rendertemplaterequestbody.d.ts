...
/** @internal */
export declare const RenderTemplateRequestBodyEngine$outboundSchema: z.ZodMiniEnum<
  typeof RenderTemplateRequestBodyEngine
>;
/** @internal */
export declare const RenderTemplateRequestBodyKind$outboundSchema: z.ZodMiniEnum<
  typeof RenderTemplateRequestBodyKind
>;
/** @internal */
...
/** @internal */
export declare const RenderTemplateRequestBody$outboundSchema: z.ZodMiniType<
  RenderTemplateRequestBody$Outbound,
  RenderTemplateRequestBody
>;
export declare function renderTemplateRequestBodyToJSON(
