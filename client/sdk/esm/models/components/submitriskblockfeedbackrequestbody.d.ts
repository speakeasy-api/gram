...
/** @internal */
export declare const SubmitRiskBlockFeedbackRequestBody$outboundSchema: z.ZodMiniType<SubmitRiskBlockFeedbackRequestBody$Outbound, SubmitRiskBlockFeedbackRequestBody>;
export declare function submitRiskBlockFeedbackRequestBodyToJSON(submitRiskBlockFeedbackRequestBody: SubmitRiskBlockFeedbackRequestBody): string;
