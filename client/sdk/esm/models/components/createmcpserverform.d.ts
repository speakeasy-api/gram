...
/** @internal */
export declare const CreateMcpServerFormVisibility$outboundSchema: z.ZodMiniEnum<
  typeof CreateMcpServerFormVisibility
>;
/** @internal */
...
/** @internal */
export declare const CreateMcpServerForm$outboundSchema: z.ZodMiniType<
  CreateMcpServerForm$Outbound,
  CreateMcpServerForm
>;
export declare function createMcpServerFormToJSON(
