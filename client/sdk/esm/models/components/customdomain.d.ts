...
/** @internal */
export declare const CustomDomain$inboundSchema: z.ZodMiniType<CustomDomain, unknown>;
export declare function customDomainFromJSON(jsonString: string): SafeParseResult<CustomDomain, SDKValidationError>;
