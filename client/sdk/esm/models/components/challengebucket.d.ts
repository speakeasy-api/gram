...
/** @internal */
export declare const PrincipalType$inboundSchema: z.ZodMiniEnum<typeof PrincipalType>;
/** @internal */
export declare const Reason$inboundSchema: z.ZodMiniEnum<typeof Reason>;
/** @internal */
export declare const ResolutionType$inboundSchema: z.ZodMiniEnum<typeof ResolutionType>;
/** @internal */
export declare const ChallengeBucket$inboundSchema: z.ZodMiniType<ChallengeBucket, unknown>;
export declare function challengeBucketFromJSON(jsonString: string): SafeParseResult<ChallengeBucket, SDKValidationError>;
