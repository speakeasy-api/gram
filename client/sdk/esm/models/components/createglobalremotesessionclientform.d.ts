...
/** @internal */
export declare const TokenEndpointAuthMethod$outboundSchema: z.ZodMiniEnum<
  typeof TokenEndpointAuthMethod
>;
/** @internal */
...
/** @internal */
export declare const CreateGlobalRemoteSessionClientForm$outboundSchema: z.ZodMiniType<
  CreateGlobalRemoteSessionClientForm$Outbound,
  CreateGlobalRemoteSessionClientForm
>;
export declare function createGlobalRemoteSessionClientFormToJSON(
