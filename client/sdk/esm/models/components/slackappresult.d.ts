...
/** @internal */
export declare const SlackAppResult$inboundSchema: z.ZodMiniType<SlackAppResult, unknown>;
export declare function slackAppResultFromJSON(jsonString: string): SafeParseResult<SlackAppResult, SDKValidationError>;
