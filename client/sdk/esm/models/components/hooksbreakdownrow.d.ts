...
/** @internal */
export declare const HooksBreakdownRow$inboundSchema: z.ZodMiniType<HooksBreakdownRow, unknown>;
export declare function hooksBreakdownRowFromJSON(jsonString: string): SafeParseResult<HooksBreakdownRow, SDKValidationError>;
