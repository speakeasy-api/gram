...
/** @internal */
export declare const TriggerInstanceStatus$inboundSchema: z.ZodMiniEnum<
  typeof TriggerInstanceStatus
>;
/** @internal */
export declare const TriggerInstance$inboundSchema: z.ZodMiniType<
  TriggerInstance,
  unknown
>;
export declare function triggerInstanceFromJSON(
  jsonString: string,
