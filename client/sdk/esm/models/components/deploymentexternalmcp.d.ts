...
/** @internal */
export declare const DeploymentExternalMCP$inboundSchema: z.ZodMiniType<DeploymentExternalMCP, unknown>;
export declare function deploymentExternalMCPFromJSON(jsonString: string): SafeParseResult<DeploymentExternalMCP, SDKValidationError>;
