...
/** @internal */
export declare const ListToolUsageTracesPayloadSort$outboundSchema: z.ZodMiniEnum<
  typeof ListToolUsageTracesPayloadSort
>;
/** @internal */
export declare const ListToolUsageTracesPayloadTargetTypes$outboundSchema: z.ZodMiniEnum<
  typeof ListToolUsageTracesPayloadTargetTypes
>;
/** @internal */
...
/** @internal */
export declare const ListToolUsageTracesPayload$outboundSchema: z.ZodMiniType<
  ListToolUsageTracesPayload$Outbound,
  ListToolUsageTracesPayload
>;
export declare function listToolUsageTracesPayloadToJSON(
