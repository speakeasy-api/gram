...
export const AccessScope$outboundSchema = z
    .enum(AccessScope);
/** @internal */
export const MatchBreadth$outboundSchema = z
    .enum(MatchBreadth);
/** @internal */
export const ApproveShadowMCPApprovalRequestForm$outboundSchema = z.pipe(z.object({
...
export function approveShadowMCPApprovalRequestFormToJSON(approveShadowMCPApprovalRequestForm) {
    return JSON.stringify(ApproveShadowMCPApprovalRequestForm$outboundSchema.parse(approveShadowMCPApprovalRequestForm));
}
