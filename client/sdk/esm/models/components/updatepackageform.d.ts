...
/** @internal */
export declare const UpdatePackageForm$outboundSchema: z.ZodMiniType<UpdatePackageForm$Outbound, UpdatePackageForm>;
export declare function updatePackageFormToJSON(updatePackageForm: UpdatePackageForm): string;
