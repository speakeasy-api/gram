...
/** @internal */
export declare const RotateTunneledMcpServerKeyResult$inboundSchema: z.ZodMiniType<RotateTunneledMcpServerKeyResult, unknown>;
export declare function rotateTunneledMcpServerKeyResultFromJSON(jsonString: string): SafeParseResult<RotateTunneledMcpServerKeyResult, SDKValidationError>;
