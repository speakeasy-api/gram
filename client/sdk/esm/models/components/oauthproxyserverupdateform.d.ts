...
/** @internal */
export declare const OAuthProxyServerUpdateForm$outboundSchema: z.ZodMiniType<OAuthProxyServerUpdateForm$Outbound, OAuthProxyServerUpdateForm>;
export declare function oAuthProxyServerUpdateFormToJSON(oAuthProxyServerUpdateForm: OAuthProxyServerUpdateForm): string;
