...
/** @internal */
export declare const ListCustomDomainMcpEndpointsResult$inboundSchema: z.ZodMiniType<ListCustomDomainMcpEndpointsResult, unknown>;
export declare function listCustomDomainMcpEndpointsResultFromJSON(jsonString: string): SafeParseResult<ListCustomDomainMcpEndpointsResult, SDKValidationError>;
