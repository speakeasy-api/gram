...
/** @internal */
export declare const ToolCallSummary$inboundSchema: z.ZodMiniType<ToolCallSummary, unknown>;
export declare function toolCallSummaryFromJSON(jsonString: string): SafeParseResult<ToolCallSummary, SDKValidationError>;
