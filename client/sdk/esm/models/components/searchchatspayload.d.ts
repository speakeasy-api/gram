...
import { SearchChatsFilter, SearchChatsFilter$Outbound } from "./searchchatsfilter.js";
/**
 * Sort order
 */
...
/** @internal */
export declare const SearchChatsPayloadSort$outboundSchema: z.ZodMiniEnum<typeof SearchChatsPayloadSort>;
/** @internal */
...
/** @internal */
export declare const SearchChatsPayload$outboundSchema: z.ZodMiniType<SearchChatsPayload$Outbound, SearchChatsPayload>;
export declare function searchChatsPayloadToJSON(searchChatsPayload: SearchChatsPayload): string;
