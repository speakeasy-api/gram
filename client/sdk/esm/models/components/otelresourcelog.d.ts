...
/** @internal */
export declare const OTELResourceLog$outboundSchema: z.ZodMiniType<OTELResourceLog$Outbound, OTELResourceLog>;
export declare function otelResourceLogToJSON(otelResourceLog: OTELResourceLog): string;
