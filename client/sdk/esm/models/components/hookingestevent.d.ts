...
/** @internal */
export declare const HookIngestEventType$outboundSchema: z.ZodMiniEnum<
...
/** @internal */
export declare const HookIngestEvent$outboundSchema: z.ZodMiniType<
  HookIngestEvent$Outbound,
  HookIngestEvent
>;
export declare function hookIngestEventToJSON(
