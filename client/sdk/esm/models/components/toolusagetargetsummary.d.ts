...
/** @internal */
export declare const ToolUsageTargetSummaryTargetKind$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTargetSummaryTargetKind
>;
/** @internal */
export declare const ToolUsageTargetSummaryTargetType$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageTargetSummaryTargetType
>;
/** @internal */
export declare const ToolUsageTargetSummary$inboundSchema: z.ZodMiniType<
  ToolUsageTargetSummary,
  unknown
>;
export declare function toolUsageTargetSummaryFromJSON(
  jsonString: string,
