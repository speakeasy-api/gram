...
import { OTELNumberDataPoint, OTELNumberDataPoint$Outbound } from "./otelnumberdatapoint.js";
/**
 * OTEL sum metric
 */
export type OTELSum = {
...
/** @internal */
export declare const OTELSum$outboundSchema: z.ZodMiniType<OTELSum$Outbound, OTELSum>;
