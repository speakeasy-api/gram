...
/** @internal */
export declare const VerifyOnboardingHooksSetupResult$inboundSchema: z.ZodMiniType<VerifyOnboardingHooksSetupResult, unknown>;
export declare function verifyOnboardingHooksSetupResultFromJSON(jsonString: string): SafeParseResult<VerifyOnboardingHooksSetupResult, SDKValidationError>;
