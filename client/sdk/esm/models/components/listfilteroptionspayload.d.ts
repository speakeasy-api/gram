...
/** @internal */
export declare const FilterType$outboundSchema: z.ZodMiniEnum<
  typeof FilterType
>;
/** @internal */
...
/** @internal */
export declare const ListFilterOptionsPayload$outboundSchema: z.ZodMiniType<
  ListFilterOptionsPayload$Outbound,
  ListFilterOptionsPayload
>;
export declare function listFilterOptionsPayloadToJSON(
