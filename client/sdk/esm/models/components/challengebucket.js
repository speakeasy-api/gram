...
/** @internal */
export const ChallengeBucket$inboundSchema = z.pipe(z.object({
...
export function challengeBucketFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ChallengeBucket$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ChallengeBucket' from JSON`);
}
