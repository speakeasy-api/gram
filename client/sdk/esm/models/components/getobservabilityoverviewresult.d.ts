...
/** @internal */
export declare const GetObservabilityOverviewResult$inboundSchema: z.ZodMiniType<GetObservabilityOverviewResult, unknown>;
export declare function getObservabilityOverviewResultFromJSON(jsonString: string): SafeParseResult<GetObservabilityOverviewResult, SDKValidationError>;
