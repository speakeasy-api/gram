...
/** @internal */
export declare const ListBuiltinExclusionsResult$inboundSchema: z.ZodMiniType<ListBuiltinExclusionsResult, unknown>;
export declare function listBuiltinExclusionsResultFromJSON(jsonString: string): SafeParseResult<ListBuiltinExclusionsResult, SDKValidationError>;
