...
/** @internal */
export declare const CreateAssistantFormStatus$outboundSchema: z.ZodMiniEnum<
  typeof CreateAssistantFormStatus
>;
/** @internal */
...
/** @internal */
export declare const CreateAssistantForm$outboundSchema: z.ZodMiniType<
  CreateAssistantForm$Outbound,
  CreateAssistantForm
>;
export declare function createAssistantFormToJSON(
