...
/** @internal */
export declare const RiskPolicyBypassRequestStatus$inboundSchema: z.ZodMiniEnum<
  typeof RiskPolicyBypassRequestStatus
>;
/** @internal */
export declare const RiskPolicyBypassRequest$inboundSchema: z.ZodMiniType<
  RiskPolicyBypassRequest,
  unknown
>;
export declare function riskPolicyBypassRequestFromJSON(
  jsonString: string,
