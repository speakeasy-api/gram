...
/** @internal */
export declare const SessionSummaryStatus$inboundSchema: z.ZodMiniEnum<typeof SessionSummaryStatus>;
/** @internal */
export declare const SessionSummary$inboundSchema: z.ZodMiniType<SessionSummary, unknown>;
export declare function sessionSummaryFromJSON(jsonString: string): SafeParseResult<SessionSummary, SDKValidationError>;
