...
/** @internal */
export declare const RiskPolicyBypassApprovalRequestBody$outboundSchema: z.ZodMiniType<
  RiskPolicyBypassApprovalRequestBody$Outbound,
  RiskPolicyBypassApprovalRequestBody
>;
export declare function riskPolicyBypassApprovalRequestBodyToJSON(
