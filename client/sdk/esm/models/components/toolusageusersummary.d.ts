 ...
 * Tool usage user identity kind
 */
export type ToolUsageUserSummaryUserKind = ClosedEnum<typeof ToolUsageUserSummaryUserKind>;
/**
...
/** @internal */
export declare const ToolUsageUserSummaryUserKind$inboundSchema: z.ZodMiniEnum<typeof ToolUsageUserSummaryUserKind>;
/** @internal */
export declare const ToolUsageUserSummary$inboundSchema: z.ZodMiniType<ToolUsageUserSummary, unknown>;
export declare function toolUsageUserSummaryFromJSON(jsonString: string): SafeParseResult<ToolUsageUserSummary, SDKValidationError>;
