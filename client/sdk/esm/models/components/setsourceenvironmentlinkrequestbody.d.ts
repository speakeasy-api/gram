...
/** @internal */
export declare const SetSourceEnvironmentLinkRequestBody$outboundSchema: z.ZodMiniType<
  SetSourceEnvironmentLinkRequestBody$Outbound,
  SetSourceEnvironmentLinkRequestBody
>;
export declare function setSourceEnvironmentLinkRequestBodyToJSON(
