...
/** @internal */
export declare const CodeChallengeMethod$outboundSchema: z.ZodMiniEnum<typeof CodeChallengeMethod>;
/** @internal */
...
/** @internal */
export declare const AuthorizeRequestBody$outboundSchema: z.ZodMiniType<AuthorizeRequestBody$Outbound, AuthorizeRequestBody>;
export declare function authorizeRequestBodyToJSON(authorizeRequestBody: AuthorizeRequestBody): string;
