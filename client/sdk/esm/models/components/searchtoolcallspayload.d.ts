...
/** @internal */
export declare const SearchToolCallsPayloadSort$outboundSchema: z.ZodMiniEnum<
  typeof SearchToolCallsPayloadSort
>;
/** @internal */
...
/** @internal */
export declare const SearchToolCallsPayload$outboundSchema: z.ZodMiniType<
  SearchToolCallsPayload$Outbound,
  SearchToolCallsPayload
>;
export declare function searchToolCallsPayloadToJSON(
