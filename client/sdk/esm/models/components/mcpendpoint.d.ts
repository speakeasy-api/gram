...
/** @internal */
export declare const McpEndpoint$inboundSchema: z.ZodMiniType<McpEndpoint, unknown>;
export declare function mcpEndpointFromJSON(jsonString: string): SafeParseResult<McpEndpoint, SDKValidationError>;
