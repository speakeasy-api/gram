...
/** @internal */
export declare const RemoteMcpServerHeader$inboundSchema: z.ZodMiniType<RemoteMcpServerHeader, unknown>;
export declare function remoteMcpServerHeaderFromJSON(jsonString: string): SafeParseResult<RemoteMcpServerHeader, SDKValidationError>;
