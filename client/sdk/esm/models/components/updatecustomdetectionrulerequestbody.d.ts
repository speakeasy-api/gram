...
/** @internal */
export declare const UpdateCustomDetectionRuleRequestBodySeverity$outboundSchema: z.ZodMiniEnum<
  typeof UpdateCustomDetectionRuleRequestBodySeverity
>;
/** @internal */
...
/** @internal */
export declare const UpdateCustomDetectionRuleRequestBody$outboundSchema: z.ZodMiniType<
  UpdateCustomDetectionRuleRequestBody$Outbound,
  UpdateCustomDetectionRuleRequestBody
>;
export declare function updateCustomDetectionRuleRequestBodyToJSON(
