...
/** @internal */
export declare const ProjectOverviewSummary$inboundSchema: z.ZodMiniType<ProjectOverviewSummary, unknown>;
export declare function projectOverviewSummaryFromJSON(jsonString: string): SafeParseResult<ProjectOverviewSummary, SDKValidationError>;
