...
/** @internal */
export declare const OnboardingStatusResult$inboundSchema: z.ZodMiniType<OnboardingStatusResult, unknown>;
export declare function onboardingStatusResultFromJSON(jsonString: string): SafeParseResult<OnboardingStatusResult, SDKValidationError>;
