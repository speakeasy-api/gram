...
/** @internal */
export declare const ListShadowMCPApprovalRequestsResult$inboundSchema: z.ZodMiniType<
  ListShadowMCPApprovalRequestsResult,
  unknown
>;
export declare function listShadowMCPApprovalRequestsResultFromJSON(
  jsonString: string,
