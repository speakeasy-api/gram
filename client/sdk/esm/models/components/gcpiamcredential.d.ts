...
/** @internal */
export declare const GcpIamCredentialProvider$inboundSchema: z.ZodMiniEnum<
  typeof GcpIamCredentialProvider
>;
/** @internal */
export declare const GcpIamCredential$inboundSchema: z.ZodMiniType<
  GcpIamCredential,
  unknown
>;
export declare function gcpIamCredentialFromJSON(
  jsonString: string,
