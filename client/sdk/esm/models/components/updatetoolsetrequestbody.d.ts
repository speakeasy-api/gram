...
/** @internal */
export declare const UpdateToolsetRequestBody$outboundSchema: z.ZodMiniType<UpdateToolsetRequestBody$Outbound, UpdateToolsetRequestBody>;
export declare function updateToolsetRequestBodyToJSON(updateToolsetRequestBody: UpdateToolsetRequestBody): string;
