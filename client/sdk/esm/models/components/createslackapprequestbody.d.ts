...
/** @internal */
export declare const CreateSlackAppRequestBody$outboundSchema: z.ZodMiniType<CreateSlackAppRequestBody$Outbound, CreateSlackAppRequestBody>;
export declare function createSlackAppRequestBodyToJSON(createSlackAppRequestBody: CreateSlackAppRequestBody): string;
