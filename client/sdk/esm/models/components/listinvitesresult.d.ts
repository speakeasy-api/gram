...
/** @internal */
export declare const ListInvitesResult$inboundSchema: z.ZodMiniType<ListInvitesResult, unknown>;
export declare function listInvitesResultFromJSON(jsonString: string): SafeParseResult<ListInvitesResult, SDKValidationError>;
