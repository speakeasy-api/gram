...
/** @internal */
export declare const PluginServerPolicy$inboundSchema: z.ZodMiniEnum<typeof PluginServerPolicy>;
/** @internal */
export declare const PluginServer$inboundSchema: z.ZodMiniType<PluginServer, unknown>;
export declare function pluginServerFromJSON(jsonString: string): SafeParseResult<PluginServer, SDKValidationError>;
