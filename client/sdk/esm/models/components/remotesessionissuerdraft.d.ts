...
/** @internal */
export declare const RemoteSessionIssuerDraft$inboundSchema: z.ZodMiniType<RemoteSessionIssuerDraft, unknown>;
export declare function remoteSessionIssuerDraftFromJSON(jsonString: string): SafeParseResult<RemoteSessionIssuerDraft, SDKValidationError>;
