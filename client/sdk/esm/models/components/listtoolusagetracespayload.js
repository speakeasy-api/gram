...
/** @internal */
export const ListToolUsageTracesPayloadSort$outboundSchema = z.enum(ListToolUsageTracesPayloadSort);
/** @internal */
export const ListToolUsageTracesPayloadTargetTypes$outboundSchema = z.enum(ListToolUsageTracesPayloadTargetTypes);
/** @internal */
export const ListToolUsageTracesPayload$outboundSchema = z.pipe(z.object({
    ...
    targetTypes: z.optional(z.array(ListToolUsageTracesPayloadTargetTypes$outboundSchema)),
...
export function listToolUsageTracesPayloadToJSON(listToolUsageTracesPayload) {
    return JSON.stringify(ListToolUsageTracesPayload$outboundSchema.parse(listToolUsageTracesPayload));
}
