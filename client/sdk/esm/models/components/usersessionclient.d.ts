...
/** @internal */
export declare const UserSessionClient$inboundSchema: z.ZodMiniType<UserSessionClient, unknown>;
export declare function userSessionClientFromJSON(jsonString: string): SafeParseResult<UserSessionClient, SDKValidationError>;
