...
/** @internal */
export declare const ListHooksTracesPayloadTypesToInclude$outboundSchema: z.ZodMiniEnum<
  typeof ListHooksTracesPayloadTypesToInclude
>;
/** @internal */
...
/** @internal */
export declare const ListHooksTracesPayload$outboundSchema: z.ZodMiniType<
  ListHooksTracesPayload$Outbound,
  ListHooksTracesPayload
>;
export declare function listHooksTracesPayloadToJSON(
