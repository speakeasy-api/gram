...
/** @internal */
export declare const CreateMcpEndpointForm$outboundSchema: z.ZodMiniType<CreateMcpEndpointForm$Outbound, CreateMcpEndpointForm>;
export declare function createMcpEndpointFormToJSON(createMcpEndpointForm: CreateMcpEndpointForm): string;
