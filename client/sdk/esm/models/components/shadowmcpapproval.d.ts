...
/** @internal */
export declare const ShadowMCPApproval$inboundSchema: z.ZodMiniType<ShadowMCPApproval, unknown>;
export declare function shadowMCPApprovalFromJSON(jsonString: string): SafeParseResult<ShadowMCPApproval, SDKValidationError>;
