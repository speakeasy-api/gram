...
/** @internal */
export const McpEndpoint$inboundSchema = z
    .pipe(z.object({
...
export function mcpEndpointFromJSON(jsonString) {
    return safeParse(jsonString, (x) => McpEndpoint$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'McpEndpoint' from JSON`);
}
