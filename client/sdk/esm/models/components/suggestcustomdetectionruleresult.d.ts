...
/** @internal */
export declare const SuggestCustomDetectionRuleResultSeverity$inboundSchema: z.ZodMiniEnum<
  typeof SuggestCustomDetectionRuleResultSeverity
>;
/** @internal */
export declare const SuggestCustomDetectionRuleResult$inboundSchema: z.ZodMiniType<
  SuggestCustomDetectionRuleResult,
  unknown
>;
export declare function suggestCustomDetectionRuleResultFromJSON(
  jsonString: string,
