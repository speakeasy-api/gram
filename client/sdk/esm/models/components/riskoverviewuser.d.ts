...
/** @internal */
export declare const RiskOverviewUser$inboundSchema: z.ZodMiniType<RiskOverviewUser, unknown>;
export declare function riskOverviewUserFromJSON(jsonString: string): SafeParseResult<RiskOverviewUser, SDKValidationError>;
