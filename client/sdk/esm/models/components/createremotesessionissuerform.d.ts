...
/** @internal */
export declare const CreateRemoteSessionIssuerForm$outboundSchema: z.ZodMiniType<CreateRemoteSessionIssuerForm$Outbound, CreateRemoteSessionIssuerForm>;
export declare function createRemoteSessionIssuerFormToJSON(createRemoteSessionIssuerForm: CreateRemoteSessionIssuerForm): string;
