...
/** @internal */
export declare const MigrateLegacyGramRegistrationsForm$outboundSchema: z.ZodMiniType<MigrateLegacyGramRegistrationsForm$Outbound, MigrateLegacyGramRegistrationsForm>;
export declare function migrateLegacyGramRegistrationsFormToJSON(migrateLegacyGramRegistrationsForm: MigrateLegacyGramRegistrationsForm): string;
