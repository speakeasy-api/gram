...
/** @internal */
export declare const CreateShadowMCPAccessRuleFormAccessScope$outboundSchema: z.ZodMiniEnum<
  typeof CreateShadowMCPAccessRuleFormAccessScope
>;
/** @internal */
export declare const CreateShadowMCPAccessRuleFormDisposition$outboundSchema: z.ZodMiniEnum<
  typeof CreateShadowMCPAccessRuleFormDisposition
>;
/** @internal */
export declare const CreateShadowMCPAccessRuleFormMatchBreadth$outboundSchema: z.ZodMiniEnum<
  typeof CreateShadowMCPAccessRuleFormMatchBreadth
>;
/** @internal */
...
/** @internal */
export declare const CreateShadowMCPAccessRuleForm$outboundSchema: z.ZodMiniType<
  CreateShadowMCPAccessRuleForm$Outbound,
  CreateShadowMCPAccessRuleForm
>;
export declare function createShadowMCPAccessRuleFormToJSON(
