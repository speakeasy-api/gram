...
/** @internal */
export declare const CreateCustomDetectionRuleRequestBody$outboundSchema: z.ZodMiniType<CreateCustomDetectionRuleRequestBody$Outbound, CreateCustomDetectionRuleRequestBody>;
export declare function createCustomDetectionRuleRequestBodyToJSON(createCustomDetectionRuleRequestBody: CreateCustomDetectionRuleRequestBody): string;
