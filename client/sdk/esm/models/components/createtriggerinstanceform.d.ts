...
/** @internal */
export declare const CreateTriggerInstanceFormStatus$outboundSchema: z.ZodMiniEnum<
  typeof CreateTriggerInstanceFormStatus
>;
/** @internal */
export declare const CreateTriggerInstanceFormTargetKind$outboundSchema: z.ZodMiniEnum<
  typeof CreateTriggerInstanceFormTargetKind
>;
/** @internal */
...
/** @internal */
export declare const CreateTriggerInstanceForm$outboundSchema: z.ZodMiniType<
  CreateTriggerInstanceForm$Outbound,
  CreateTriggerInstanceForm
>;
export declare function createTriggerInstanceFormToJSON(
