...
/** @internal */
export declare const UpdateMcpServerFormVisibility$outboundSchema: z.ZodMiniEnum<
  typeof UpdateMcpServerFormVisibility
>;
/** @internal */
...
/** @internal */
export declare const UpdateMcpServerForm$outboundSchema: z.ZodMiniType<
  UpdateMcpServerForm$Outbound,
  UpdateMcpServerForm
>;
export declare function updateMcpServerFormToJSON(
