...
/** @internal */
export declare const RiskPolicyModelConfig$inboundSchema: z.ZodMiniType<RiskPolicyModelConfig, unknown>;
/** @internal */
...
/** @internal */
export declare const RiskPolicyModelConfig$outboundSchema: z.ZodMiniType<RiskPolicyModelConfig$Outbound, RiskPolicyModelConfig>;
export declare function riskPolicyModelConfigToJSON(riskPolicyModelConfig: RiskPolicyModelConfig): string;
export declare function riskPolicyModelConfigFromJSON(jsonString: string): SafeParseResult<RiskPolicyModelConfig, SDKValidationError>;
