...
/** @internal */
export declare const LLMClientUsage$inboundSchema: z.ZodMiniType<LLMClientUsage, unknown>;
export declare function llmClientUsageFromJSON(jsonString: string): SafeParseResult<LLMClientUsage, SDKValidationError>;
