...
/** @internal */
export declare const UpdateMarketplaceSettingsResult$inboundSchema: z.ZodMiniType<UpdateMarketplaceSettingsResult, unknown>;
export declare function updateMarketplaceSettingsResultFromJSON(jsonString: string): SafeParseResult<UpdateMarketplaceSettingsResult, SDKValidationError>;
