...
/** @internal */
export declare const CreateToolsetRequestBody$outboundSchema: z.ZodMiniType<CreateToolsetRequestBody$Outbound, CreateToolsetRequestBody>;
export declare function createToolsetRequestBodyToJSON(createToolsetRequestBody: CreateToolsetRequestBody): string;
