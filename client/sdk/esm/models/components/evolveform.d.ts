...
import { AddExternalMCPForm, AddExternalMCPForm$Outbound } from "./addexternalmcpform.js";
import { AddFunctionsForm, AddFunctionsForm$Outbound } from "./addfunctionsform.js";
import { AddOpenAPIv3DeploymentAssetForm, AddOpenAPIv3DeploymentAssetForm$Outbound } from "./addopenapiv3deploymentassetform.js";
...
export type EvolveForm$Outbound = {
    ...
    upsert_openapiv3_assets?: Array<AddOpenAPIv3DeploymentAssetForm$Outbound> | undefined;
    upsert_packages?: Array<AddPackageForm$Outbound> | undefined;
};
/** @internal */
export declare const EvolveForm$outboundSchema: z.ZodMiniType<EvolveForm$Outbound, EvolveForm>;
