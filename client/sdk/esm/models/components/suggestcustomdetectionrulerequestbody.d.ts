...
/** @internal */
export declare const SuggestCustomDetectionRuleRequestBody$outboundSchema: z.ZodMiniType<
  SuggestCustomDetectionRuleRequestBody$Outbound,
  SuggestCustomDetectionRuleRequestBody
>;
export declare function suggestCustomDetectionRuleRequestBodyToJSON(
