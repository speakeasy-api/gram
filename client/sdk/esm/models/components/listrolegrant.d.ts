...
/** @internal */
export declare const ListRoleGrantScope$inboundSchema: z.ZodMiniEnum<
  typeof ListRoleGrantScope
>;
/** @internal */
export declare const SubScopes$inboundSchema: z.ZodMiniEnum<typeof SubScopes>;
/** @internal */
export declare const ListRoleGrant$inboundSchema: z.ZodMiniType<
  ListRoleGrant,
  unknown
>;
export declare function listRoleGrantFromJSON(
  jsonString: string,
