...
/** @internal */
export declare const TokensUnderManagement$inboundSchema: z.ZodMiniType<TokensUnderManagement, unknown>;
export declare function tokensUnderManagementFromJSON(jsonString: string): SafeParseResult<TokensUnderManagement, SDKValidationError>;
