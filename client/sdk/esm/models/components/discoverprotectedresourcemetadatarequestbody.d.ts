...
/** @internal */
export declare const DiscoverProtectedResourceMetadataRequestBody$outboundSchema: z.ZodMiniType<
  DiscoverProtectedResourceMetadataRequestBody$Outbound,
  DiscoverProtectedResourceMetadataRequestBody
>;
export declare function discoverProtectedResourceMetadataRequestBodyToJSON(
