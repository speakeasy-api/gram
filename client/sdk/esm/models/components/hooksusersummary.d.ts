...
/** @internal */
export declare const HooksUserSummary$inboundSchema: z.ZodMiniType<HooksUserSummary, unknown>;
export declare function hooksUserSummaryFromJSON(jsonString: string): SafeParseResult<HooksUserSummary, SDKValidationError>;
