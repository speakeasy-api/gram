...
/** @internal */
export declare const OTELLogRecord$outboundSchema: z.ZodMiniType<OTELLogRecord$Outbound, OTELLogRecord>;
export declare function otelLogRecordToJSON(otelLogRecord: OTELLogRecord): string;
