...
/** @internal */
export declare const CreateRiskExclusionRequestBody$outboundSchema: z.ZodMiniType<CreateRiskExclusionRequestBody$Outbound, CreateRiskExclusionRequestBody>;
export declare function createRiskExclusionRequestBodyToJSON(createRiskExclusionRequestBody: CreateRiskExclusionRequestBody): string;
