...
/** @internal */
export declare const HookIngestSession$outboundSchema: z.ZodMiniType<HookIngestSession$Outbound, HookIngestSession>;
export declare function hookIngestSessionToJSON(hookIngestSession: HookIngestSession): string;
