...
/** @internal */
export declare const FunctionResourceDefinition$inboundSchema: z.ZodMiniType<FunctionResourceDefinition, unknown>;
export declare function functionResourceDefinitionFromJSON(jsonString: string): SafeParseResult<FunctionResourceDefinition, SDKValidationError>;
