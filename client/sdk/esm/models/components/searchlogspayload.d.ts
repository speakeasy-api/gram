...
import { SearchLogsFilter, SearchLogsFilter$Outbound } from "./searchlogsfilter.js";
/**
 * Sort order
 */
...
/** @internal */
export declare const SearchLogsPayloadSort$outboundSchema: z.ZodMiniEnum<typeof SearchLogsPayloadSort>;
/** @internal */
...
/** @internal */
export declare const SearchLogsPayload$outboundSchema: z.ZodMiniType<SearchLogsPayload$Outbound, SearchLogsPayload>;
export declare function searchLogsPayloadToJSON(searchLogsPayload: SearchLogsPayload): string;
