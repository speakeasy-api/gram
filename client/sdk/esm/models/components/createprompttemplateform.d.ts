...
/** @internal */
export declare const CreatePromptTemplateFormEngine$outboundSchema: z.ZodMiniEnum<
  typeof CreatePromptTemplateFormEngine
>;
/** @internal */
export declare const CreatePromptTemplateFormKind$outboundSchema: z.ZodMiniEnum<
  typeof CreatePromptTemplateFormKind
>;
/** @internal */
...
/** @internal */
export declare const CreatePromptTemplateForm$outboundSchema: z.ZodMiniType<
  CreatePromptTemplateForm$Outbound,
  CreatePromptTemplateForm
>;
export declare function createPromptTemplateFormToJSON(
