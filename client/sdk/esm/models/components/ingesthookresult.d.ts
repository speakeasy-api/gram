...
/** @internal */
export declare const IngestHookResult$inboundSchema: z.ZodMiniType<IngestHookResult, unknown>;
export declare function ingestHookResultFromJSON(jsonString: string): SafeParseResult<IngestHookResult, SDKValidationError>;
