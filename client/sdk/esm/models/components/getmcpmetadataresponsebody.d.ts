...
/** @internal */
export declare const GetMcpMetadataResponseBody$inboundSchema: z.ZodMiniType<GetMcpMetadataResponseBody, unknown>;
export declare function getMcpMetadataResponseBodyFromJSON(jsonString: string): SafeParseResult<GetMcpMetadataResponseBody, SDKValidationError>;
