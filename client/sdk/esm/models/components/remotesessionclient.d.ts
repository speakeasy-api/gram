...
/** @internal */
export declare const RemoteSessionClientTokenEndpointAuthMethod$inboundSchema: z.ZodMiniEnum<
  typeof RemoteSessionClientTokenEndpointAuthMethod
>;
/** @internal */
export declare const RemoteSessionClient$inboundSchema: z.ZodMiniType<
  RemoteSessionClient,
  unknown
>;
export declare function remoteSessionClientFromJSON(
  jsonString: string,
