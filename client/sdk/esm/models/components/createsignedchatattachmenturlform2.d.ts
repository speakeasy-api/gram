...
/** @internal */
export declare const CreateSignedChatAttachmentURLForm2$outboundSchema: z.ZodMiniType<CreateSignedChatAttachmentURLForm2$Outbound, CreateSignedChatAttachmentURLForm2>;
export declare function createSignedChatAttachmentURLForm2ToJSON(createSignedChatAttachmentURLForm2: CreateSignedChatAttachmentURLForm2): string;
