...
/** @internal */
export declare const CreateGcpIamCredentialForm$outboundSchema: z.ZodMiniType<CreateGcpIamCredentialForm$Outbound, CreateGcpIamCredentialForm>;
export declare function createGcpIamCredentialFormToJSON(createGcpIamCredentialForm: CreateGcpIamCredentialForm): string;
//# sourceMappingURL=creategcpiamcredentialform.d.ts.map