...
/** @internal */
export declare const OTELAttribute$outboundSchema: z.ZodMiniType<OTELAttribute$Outbound, OTELAttribute>;
export declare function otelAttributeToJSON(otelAttribute: OTELAttribute): string;
