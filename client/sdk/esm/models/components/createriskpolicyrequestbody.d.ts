...
/** @internal */
export declare const AudienceType$outboundSchema: z.ZodMiniEnum<
  typeof AudienceType
>;
/** @internal */
export declare const PolicyType$outboundSchema: z.ZodMiniEnum<
  typeof PolicyType
>;
/** @internal */
...
/** @internal */
export declare const CreateRiskPolicyRequestBody$outboundSchema: z.ZodMiniType<
  CreateRiskPolicyRequestBody$Outbound,
  CreateRiskPolicyRequestBody
>;
export declare function createRiskPolicyRequestBodyToJSON(
