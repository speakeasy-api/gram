...
/** @internal */
export declare const CursorHookPayload$outboundSchema: z.ZodMiniType<CursorHookPayload$Outbound, CursorHookPayload>;
export declare function cursorHookPayloadToJSON(cursorHookPayload: CursorHookPayload): string;
