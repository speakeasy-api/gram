...
/** @internal */
export declare const ProviderType$inboundSchema: z.ZodMiniEnum<typeof ProviderType>;
/** @internal */
export declare const OAuthProxyProvider$inboundSchema: z.ZodMiniType<OAuthProxyProvider, unknown>;
export declare function oAuthProxyProviderFromJSON(jsonString: string): SafeParseResult<OAuthProxyProvider, SDKValidationError>;
