...
/** @internal */
export const UpdateRemoteSessionIssuerForm$outboundSchema = z.pipe(z.object({
...
export function updateRemoteSessionIssuerFormToJSON(updateRemoteSessionIssuerForm) {
    return JSON.stringify(UpdateRemoteSessionIssuerForm$outboundSchema.parse(updateRemoteSessionIssuerForm));
}
//# sourceMappingURL=updateremotesessionissuerform.js.map