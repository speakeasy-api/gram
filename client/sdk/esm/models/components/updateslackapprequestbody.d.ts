...
/** @internal */
export declare const UpdateSlackAppRequestBody$outboundSchema: z.ZodMiniType<UpdateSlackAppRequestBody$Outbound, UpdateSlackAppRequestBody>;
export declare function updateSlackAppRequestBodyToJSON(updateSlackAppRequestBody: UpdateSlackAppRequestBody): string;
