...
/** @internal */
export declare const ListAssistantMemoriesResult$inboundSchema: z.ZodMiniType<ListAssistantMemoriesResult, unknown>;
export declare function listAssistantMemoriesResultFromJSON(jsonString: string): SafeParseResult<ListAssistantMemoriesResult, SDKValidationError>;
