 ...
 * How the challenge is being resolved.
 */
export type ResolveChallengeFormResolutionType = ClosedEnum<typeof ResolveChallengeFormResolutionType>;
...
/** @internal */
export declare const ResolveChallengeFormResolutionType$outboundSchema: z.ZodMiniEnum<typeof ResolveChallengeFormResolutionType>;
/** @internal */
...
/** @internal */
export declare const ResolveChallengeForm$outboundSchema: z.ZodMiniType<ResolveChallengeForm$Outbound, ResolveChallengeForm>;
export declare function resolveChallengeFormToJSON(resolveChallengeForm: ResolveChallengeForm): string;
