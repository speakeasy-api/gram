...
/** @internal */
export declare const CanonicalToolAttributes$inboundSchema: z.ZodMiniType<CanonicalToolAttributes, unknown>;
export declare function canonicalToolAttributesFromJSON(jsonString: string): SafeParseResult<CanonicalToolAttributes, SDKValidationError>;
