...
/** @internal */
export declare const ToolUsageUserTimeSeriesPointUserKind$inboundSchema: z.ZodMiniEnum<
  typeof ToolUsageUserTimeSeriesPointUserKind
>;
/** @internal */
export declare const ToolUsageUserTimeSeriesPoint$inboundSchema: z.ZodMiniType<
  ToolUsageUserTimeSeriesPoint,
  unknown
>;
export declare function toolUsageUserTimeSeriesPointFromJSON(
  jsonString: string,
