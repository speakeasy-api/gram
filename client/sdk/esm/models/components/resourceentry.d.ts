...
/** @internal */
export declare const ResourceEntryType$inboundSchema: z.ZodMiniEnum<
  typeof ResourceEntryType
>;
/** @internal */
export declare const ResourceEntry$inboundSchema: z.ZodMiniType<
  ResourceEntry,
  unknown
>;
export declare function resourceEntryFromJSON(
  jsonString: string,
