...
/** @internal */
export declare const MetricsMode$inboundSchema: z.ZodMiniEnum<
  typeof MetricsMode
>;
/** @internal */
export declare const GetProjectOverviewResult$inboundSchema: z.ZodMiniType<
  GetProjectOverviewResult,
  unknown
>;
export declare function getProjectOverviewResultFromJSON(
  jsonString: string,
