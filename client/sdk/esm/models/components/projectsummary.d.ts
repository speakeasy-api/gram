...
/** @internal */
export declare const ProjectSummary$inboundSchema: z.ZodMiniType<ProjectSummary, unknown>;
export declare function projectSummaryFromJSON(jsonString: string): SafeParseResult<ProjectSummary, SDKValidationError>;
