...
/** @internal */
export declare const WorkOSSSOIntentOptions$outboundSchema: z.ZodMiniType<WorkOSSSOIntentOptions$Outbound, WorkOSSSOIntentOptions>;
export declare function workOSSSOIntentOptionsToJSON(workOSSSOIntentOptions: WorkOSSSOIntentOptions): string;
