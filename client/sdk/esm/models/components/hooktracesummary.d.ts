...
/** @internal */
export declare const HookTraceSummary$inboundSchema: z.ZodMiniType<HookTraceSummary, unknown>;
export declare function hookTraceSummaryFromJSON(jsonString: string): SafeParseResult<HookTraceSummary, SDKValidationError>;
