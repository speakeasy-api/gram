...
/** @internal */
export declare const TargetTypes$outboundSchema: z.ZodMiniEnum<
  typeof TargetTypes
>;
/** @internal */
...
/** @internal */
export declare const GetToolUsageSummaryPayload$outboundSchema: z.ZodMiniType<
  GetToolUsageSummaryPayload$Outbound,
  GetToolUsageSummaryPayload
>;
export declare function getToolUsageSummaryPayloadToJSON(
