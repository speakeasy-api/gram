...
/** @internal */
export declare const ExclusionScope$inboundSchema: z.ZodMiniEnum<typeof ExclusionScope>;
/** @internal */
export declare const ResourceType$inboundSchema: z.ZodMiniEnum<typeof ResourceType>;
/** @internal */
...
/** @internal */
export declare const ScopeDefinition$inboundSchema: z.ZodMiniType<ScopeDefinition, unknown>;
export declare function scopeDefinitionFromJSON(jsonString: string): SafeParseResult<ScopeDefinition, SDKValidationError>;
