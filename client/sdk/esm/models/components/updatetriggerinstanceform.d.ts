...
/** @internal */
export declare const UpdateTriggerInstanceFormStatus$outboundSchema: z.ZodMiniEnum<
  typeof UpdateTriggerInstanceFormStatus
>;
/** @internal */
export declare const UpdateTriggerInstanceFormTargetKind$outboundSchema: z.ZodMiniEnum<
  typeof UpdateTriggerInstanceFormTargetKind
>;
/** @internal */
...
/** @internal */
export declare const UpdateTriggerInstanceForm$outboundSchema: z.ZodMiniType<
  UpdateTriggerInstanceForm$Outbound,
  UpdateTriggerInstanceForm
>;
export declare function updateTriggerInstanceFormToJSON(
