...
/** @internal */
export declare const WorkflowAgentToolset$outboundSchema: z.ZodMiniType<WorkflowAgentToolset$Outbound, WorkflowAgentToolset>;
export declare function workflowAgentToolsetToJSON(workflowAgentToolset: WorkflowAgentToolset): string;
