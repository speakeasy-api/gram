...
/** @internal */
export declare const RedeemResponseBody$inboundSchema: z.ZodMiniType<RedeemResponseBody, unknown>;
export declare function redeemResponseBodyFromJSON(jsonString: string): SafeParseResult<RedeemResponseBody, SDKValidationError>;
