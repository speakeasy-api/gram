 ...
 * The type of hook event
 */
export type CodexHookPayloadHookEventName = ClosedEnum<typeof CodexHookPayloadHookEventName>;
/**
...
/** @internal */
export declare const CodexHookPayloadHookEventName$outboundSchema: z.ZodMiniEnum<typeof CodexHookPayloadHookEventName>;
/** @internal */
...
/** @internal */
export declare const CodexHookPayload$outboundSchema: z.ZodMiniType<CodexHookPayload$Outbound, CodexHookPayload>;
export declare function codexHookPayloadToJSON(codexHookPayload: CodexHookPayload): string;
