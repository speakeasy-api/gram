...
/** @internal */
export declare const AllowedOriginStatus$inboundSchema: z.ZodMiniEnum<
  typeof AllowedOriginStatus
>;
/** @internal */
export declare const AllowedOrigin$inboundSchema: z.ZodMiniType<
  AllowedOrigin,
  unknown
>;
export declare function allowedOriginFromJSON(
  jsonString: string,
