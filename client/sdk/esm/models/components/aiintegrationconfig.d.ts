...
/** @internal */
export declare const LastPollStatus$inboundSchema: z.ZodMiniEnum<
  typeof LastPollStatus
>;
/** @internal */
export declare const AIIntegrationConfig$inboundSchema: z.ZodMiniType<
  AIIntegrationConfig,
  unknown
>;
export declare function aiIntegrationConfigFromJSON(
  jsonString: string,
