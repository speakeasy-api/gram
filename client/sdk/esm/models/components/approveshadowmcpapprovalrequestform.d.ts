...
/** @internal */
export declare const AccessScope$outboundSchema: z.ZodMiniEnum<
  typeof AccessScope
>;
/** @internal */
export declare const MatchBreadth$outboundSchema: z.ZodMiniEnum<
  typeof MatchBreadth
>;
/** @internal */
...
/** @internal */
export declare const ApproveShadowMCPApprovalRequestForm$outboundSchema: z.ZodMiniType<
  ApproveShadowMCPApprovalRequestForm$Outbound,
  ApproveShadowMCPApprovalRequestForm
>;
export declare function approveShadowMCPApprovalRequestFormToJSON(
