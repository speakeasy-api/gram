...
/** @internal */
export declare const RiskUserBreakdownResult$inboundSchema: z.ZodMiniType<RiskUserBreakdownResult, unknown>;
export declare function riskUserBreakdownResultFromJSON(jsonString: string): SafeParseResult<RiskUserBreakdownResult, SDKValidationError>;
