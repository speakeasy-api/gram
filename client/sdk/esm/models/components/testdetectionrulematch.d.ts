...
/** @internal */
export declare const TestDetectionRuleMatch$inboundSchema: z.ZodMiniType<TestDetectionRuleMatch, unknown>;
export declare function testDetectionRuleMatchFromJSON(jsonString: string): SafeParseResult<TestDetectionRuleMatch, SDKValidationError>;
