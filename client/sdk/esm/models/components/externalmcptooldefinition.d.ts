...
/** @internal */
export declare const ExternalMCPToolDefinitionTransportType$inboundSchema: z.ZodMiniEnum<
  typeof ExternalMCPToolDefinitionTransportType
>;
/** @internal */
export declare const ExternalMCPToolDefinition$inboundSchema: z.ZodMiniType<
  ExternalMCPToolDefinition,
  unknown
>;
export declare function externalMCPToolDefinitionFromJSON(
  jsonString: string,
