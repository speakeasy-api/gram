...
/** @internal */
export declare const ChatSummaryStatus$inboundSchema: z.ZodMiniEnum<
  typeof ChatSummaryStatus
>;
/** @internal */
export declare const ChatSummary$inboundSchema: z.ZodMiniType<
  ChatSummary,
  unknown
>;
export declare function chatSummaryFromJSON(
  jsonString: string,
