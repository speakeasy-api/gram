...
/** @internal */
export const TumDetailsTotals$inboundSchema = z.pipe(z.object({
    active_users: z.int(),
...
export function tumDetailsTotalsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => TumDetailsTotals$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'TumDetailsTotals' from JSON`);
}
//# sourceMappingURL=tumdetailstotals.js.map