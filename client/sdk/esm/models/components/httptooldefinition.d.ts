...
/** @internal */
export declare const HTTPToolDefinition$inboundSchema: z.ZodMiniType<HTTPToolDefinition, unknown>;
export declare function httpToolDefinitionFromJSON(jsonString: string): SafeParseResult<HTTPToolDefinition, SDKValidationError>;
