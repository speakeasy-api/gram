...
/** @internal */
export declare const AddFunctionsForm$outboundSchema: z.ZodMiniType<AddFunctionsForm$Outbound, AddFunctionsForm>;
export declare function addFunctionsFormToJSON(addFunctionsForm: AddFunctionsForm): string;
