...
/** @internal */
export declare const RiskExclusionMatchType$inboundSchema: z.ZodMiniEnum<typeof RiskExclusionMatchType>;
/** @internal */
export declare const RiskExclusion$inboundSchema: z.ZodMiniType<RiskExclusion, unknown>;
export declare function riskExclusionFromJSON(jsonString: string): SafeParseResult<RiskExclusion, SDKValidationError>;
