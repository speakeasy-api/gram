...
/** @internal */
export const GetInstanceResult$inboundSchema = z.pipe(z.object({
...
export function getInstanceResultFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetInstanceResult$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetInstanceResult' from JSON`);
}
