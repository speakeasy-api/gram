...
/** @internal */
export declare const TypesToInclude$outboundSchema: z.ZodMiniEnum<
...
/** @internal */
export declare const GetHooksSummaryPayload$outboundSchema: z.ZodMiniType<
  GetHooksSummaryPayload$Outbound,
  GetHooksSummaryPayload
>;
export declare function getHooksSummaryPayloadToJSON(
