...
/** @internal */
export declare const RiskCategoryDefinition$inboundSchema: z.ZodMiniType<RiskCategoryDefinition, unknown>;
export declare function riskCategoryDefinitionFromJSON(jsonString: string): SafeParseResult<RiskCategoryDefinition, SDKValidationError>;
