...
export type AuthzChallengeOperation = ClosedEnum<typeof AuthzChallengeOperation>;
 ...
 * Kind of principal.
 */
export type AuthzChallengePrincipalType = ClosedEnum<typeof AuthzChallengePrincipalType>;
 ...
 * How the challenge was resolved.
 */
export type AuthzChallengeResolutionType = ClosedEnum<typeof AuthzChallengeResolutionType>;
...
/** @internal */
export declare const AuthzChallengeOperation$inboundSchema: z.ZodMiniEnum<typeof AuthzChallengeOperation>;
/** @internal */
export declare const AuthzChallengeOutcome$inboundSchema: z.ZodMiniEnum<typeof AuthzChallengeOutcome>;
/** @internal */
export declare const AuthzChallengePrincipalType$inboundSchema: z.ZodMiniEnum<typeof AuthzChallengePrincipalType>;
/** @internal */
export declare const AuthzChallengeReason$inboundSchema: z.ZodMiniEnum<typeof AuthzChallengeReason>;
/** @internal */
export declare const AuthzChallengeResolutionType$inboundSchema: z.ZodMiniEnum<typeof AuthzChallengeResolutionType>;
/** @internal */
export declare const AuthzChallenge$inboundSchema: z.ZodMiniType<AuthzChallenge, unknown>;
export declare function authzChallengeFromJSON(jsonString: string): SafeParseResult<AuthzChallenge, SDKValidationError>;
