...
/** @internal */
export declare const HookEventName$outboundSchema: z.ZodMiniEnum<typeof HookEventName>;
/** @internal */
...
/** @internal */
export declare const ClaudeHookPayload$outboundSchema: z.ZodMiniType<ClaudeHookPayload$Outbound, ClaudeHookPayload>;
export declare function claudeHookPayloadToJSON(claudeHookPayload: ClaudeHookPayload): string;
