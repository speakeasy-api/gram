...
/** @internal */
export declare const SearchUsersResult$inboundSchema: z.ZodMiniType<SearchUsersResult, unknown>;
export declare function searchUsersResultFromJSON(jsonString: string): SafeParseResult<SearchUsersResult, SDKValidationError>;
