...
/** @internal */
export declare const CreateServerForm$outboundSchema: z.ZodMiniType<CreateServerForm$Outbound, CreateServerForm>;
export declare function createServerFormToJSON(createServerForm: CreateServerForm): string;
