...
/** @internal */
export declare const RiskOverviewResult$inboundSchema: z.ZodMiniType<RiskOverviewResult, unknown>;
export declare function riskOverviewResultFromJSON(jsonString: string): SafeParseResult<RiskOverviewResult, SDKValidationError>;
