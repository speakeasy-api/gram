 ...
 * Change how the client authenticates at the issuer's token endpoint.
 */
export type UpdateRemoteSessionClientFormTokenEndpointAuthMethod = ClosedEnum<typeof UpdateRemoteSessionClientFormTokenEndpointAuthMethod>;
/**
...
export type UpdateRemoteSessionClientForm = {
     ...
     * Change how the client authenticates at the issuer's token endpoint.
     */
    tokenEndpointAuthMethod?: UpdateRemoteSessionClientFormTokenEndpointAuthMethod | undefined;
};
/** @internal */
export declare const UpdateRemoteSessionClientFormTokenEndpointAuthMethod$outboundSchema: z.ZodMiniEnum<typeof UpdateRemoteSessionClientFormTokenEndpointAuthMethod>;
/** @internal */
...
/** @internal */
export declare const UpdateRemoteSessionClientForm$outboundSchema: z.ZodMiniType<UpdateRemoteSessionClientForm$Outbound, UpdateRemoteSessionClientForm>;
export declare function updateRemoteSessionClientFormToJSON(updateRemoteSessionClientForm: UpdateRemoteSessionClientForm): string;
