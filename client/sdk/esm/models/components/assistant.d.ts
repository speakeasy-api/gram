...
/** @internal */
export declare const AssistantStatus$inboundSchema: z.ZodMiniEnum<typeof AssistantStatus>;
/** @internal */
export declare const Assistant$inboundSchema: z.ZodMiniType<Assistant, unknown>;
export declare function assistantFromJSON(jsonString: string): SafeParseResult<Assistant, SDKValidationError>;
