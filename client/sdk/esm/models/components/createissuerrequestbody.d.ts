...
/** @internal */
export declare const CreateIssuerRequestBody$outboundSchema: z.ZodMiniType<CreateIssuerRequestBody$Outbound, CreateIssuerRequestBody>;
export declare function createIssuerRequestBodyToJSON(createIssuerRequestBody: CreateIssuerRequestBody): string;
