...
/** @internal */
export declare const RoleSummary$inboundSchema: z.ZodMiniType<RoleSummary, unknown>;
export declare function roleSummaryFromJSON(jsonString: string): SafeParseResult<RoleSummary, SDKValidationError>;
