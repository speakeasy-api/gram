...
/** @internal */
export declare const UserSummary$inboundSchema: z.ZodMiniType<UserSummary, unknown>;
export declare function userSummaryFromJSON(jsonString: string): SafeParseResult<UserSummary, SDKValidationError>;
