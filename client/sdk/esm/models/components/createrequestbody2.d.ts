...
/** @internal */
export declare const CreateRequestBody2Visibility$outboundSchema: z.ZodMiniEnum<
  typeof CreateRequestBody2Visibility
>;
/** @internal */
...
/** @internal */
export declare const CreateRequestBody2$outboundSchema: z.ZodMiniType<
  CreateRequestBody2$Outbound,
  CreateRequestBody2
>;
export declare function createRequestBody2ToJSON(
