...
/** @internal */
export declare const OptionTypes$outboundSchema: z.ZodMiniEnum<typeof OptionTypes>;
/** @internal */
...
/** @internal */
export declare const GetToolUsageFilterOptionsPayload$outboundSchema: z.ZodMiniType<GetToolUsageFilterOptionsPayload$Outbound, GetToolUsageFilterOptionsPayload>;
export declare function getToolUsageFilterOptionsPayloadToJSON(getToolUsageFilterOptionsPayload: GetToolUsageFilterOptionsPayload): string;
