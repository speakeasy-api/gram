...
/** @internal */
export declare const UpdateAssistantFormStatus$outboundSchema: z.ZodMiniEnum<
  typeof UpdateAssistantFormStatus
>;
/** @internal */
...
/** @internal */
export declare const UpdateAssistantForm$outboundSchema: z.ZodMiniType<
  UpdateAssistantForm$Outbound,
  UpdateAssistantForm
>;
export declare function updateAssistantFormToJSON(
