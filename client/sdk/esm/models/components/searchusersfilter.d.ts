...
/** @internal */
export declare const SearchUsersFilter$outboundSchema: z.ZodMiniType<SearchUsersFilter$Outbound, SearchUsersFilter>;
export declare function searchUsersFilterToJSON(searchUsersFilter: SearchUsersFilter): string;
