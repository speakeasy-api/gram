...
/** @internal */
export declare const SaveRiskEvalReviewRequestBodyVerdict$outboundSchema: z.ZodMiniEnum<
  typeof SaveRiskEvalReviewRequestBodyVerdict
>;
/** @internal */
...
/** @internal */
export declare const SaveRiskEvalReviewRequestBody$outboundSchema: z.ZodMiniType<
  SaveRiskEvalReviewRequestBody$Outbound,
  SaveRiskEvalReviewRequestBody
>;
export declare function saveRiskEvalReviewRequestBodyToJSON(
