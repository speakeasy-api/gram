...
/** @internal */
export declare const ToolUsageTargetTimeSeriesPoint$inboundSchema: z.ZodMiniType<ToolUsageTargetTimeSeriesPoint, unknown>;
export declare function toolUsageTargetTimeSeriesPointFromJSON(jsonString: string): SafeParseResult<ToolUsageTargetTimeSeriesPoint, SDKValidationError>;
