...
/** @internal */
export declare const UpdateRoleForm$outboundSchema: z.ZodMiniType<UpdateRoleForm$Outbound, UpdateRoleForm>;
export declare function updateRoleFormToJSON(updateRoleForm: UpdateRoleForm): string;
