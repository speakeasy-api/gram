...
/** @internal */
export declare const SetBillingMetadataRequestBody$outboundSchema: z.ZodMiniType<SetBillingMetadataRequestBody$Outbound, SetBillingMetadataRequestBody>;
export declare function setBillingMetadataRequestBodyToJSON(setBillingMetadataRequestBody: SetBillingMetadataRequestBody): string;
