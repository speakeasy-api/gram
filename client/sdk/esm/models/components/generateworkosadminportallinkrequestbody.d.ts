...
/** @internal */
export declare const GenerateWorkOSAdminPortalLinkRequestBody$outboundSchema: z.ZodMiniType<
  GenerateWorkOSAdminPortalLinkRequestBody$Outbound,
  GenerateWorkOSAdminPortalLinkRequestBody
>;
export declare function generateWorkOSAdminPortalLinkRequestBodyToJSON(
