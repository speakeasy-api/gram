...
/** @internal */
export declare const ListOrganizationRemoteSessionsResult$inboundSchema: z.ZodMiniType<
  ListOrganizationRemoteSessionsResult,
  unknown
>;
export declare function listOrganizationRemoteSessionsResultFromJSON(
  jsonString: string,
