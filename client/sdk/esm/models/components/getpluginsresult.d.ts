...
/** @internal */
export declare const GetPluginsResult$inboundSchema: z.ZodMiniType<GetPluginsResult, unknown>;
export declare function getPluginsResultFromJSON(jsonString: string): SafeParseResult<GetPluginsResult, SDKValidationError>;
