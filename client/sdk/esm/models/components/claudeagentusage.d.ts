...
/** @internal */
export declare const ClaudeAgentUsage$inboundSchema: z.ZodMiniType<ClaudeAgentUsage, unknown>;
export declare function claudeAgentUsageFromJSON(jsonString: string): SafeParseResult<ClaudeAgentUsage, SDKValidationError>;
