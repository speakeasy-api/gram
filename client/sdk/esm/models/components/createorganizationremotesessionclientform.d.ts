 ...
 * How the client authenticates at the issuer's token endpoint. Omit to default to client_secret_basic.
 */
export type CreateOrganizationRemoteSessionClientFormTokenEndpointAuthMethod = ClosedEnum<typeof CreateOrganizationRemoteSessionClientFormTokenEndpointAuthMethod>;
/**
...
export type CreateOrganizationRemoteSessionClientForm = {
     ...
     * How the client authenticates at the issuer's token endpoint. Omit to default to client_secret_basic.
     */
    tokenEndpointAuthMethod?: CreateOrganizationRemoteSessionClientFormTokenEndpointAuthMethod | undefined;
};
/** @internal */
export declare const CreateOrganizationRemoteSessionClientFormTokenEndpointAuthMethod$outboundSchema: z.ZodMiniEnum<typeof CreateOrganizationRemoteSessionClientFormTokenEndpointAuthMethod>;
/** @internal */
...
/** @internal */
export declare const CreateOrganizationRemoteSessionClientForm$outboundSchema: z.ZodMiniType<CreateOrganizationRemoteSessionClientForm$Outbound, CreateOrganizationRemoteSessionClientForm>;
export declare function createOrganizationRemoteSessionClientFormToJSON(createOrganizationRemoteSessionClientForm: CreateOrganizationRemoteSessionClientForm): string;
