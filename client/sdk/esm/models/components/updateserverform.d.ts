...
/** @internal */
export declare const UpdateServerForm$outboundSchema: z.ZodMiniType<UpdateServerForm$Outbound, UpdateServerForm>;
export declare function updateServerFormToJSON(updateServerForm: UpdateServerForm): string;
//# sourceMappingURL=updateserverform.d.ts.map