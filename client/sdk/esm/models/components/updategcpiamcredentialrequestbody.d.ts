...
/** @internal */
export declare const UpdateGcpIamCredentialRequestBody$outboundSchema: z.ZodMiniType<UpdateGcpIamCredentialRequestBody$Outbound, UpdateGcpIamCredentialRequestBody>;
export declare function updateGcpIamCredentialRequestBodyToJSON(updateGcpIamCredentialRequestBody: UpdateGcpIamCredentialRequestBody): string;
