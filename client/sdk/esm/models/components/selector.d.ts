...
/** @internal */
export declare const SelectorDisposition$inboundSchema: z.ZodMiniEnum<typeof SelectorDisposition>;
/** @internal */
export declare const SelectorDisposition$outboundSchema: z.ZodMiniEnum<typeof SelectorDisposition>;
/** @internal */
export declare const ResourceKind$inboundSchema: z.ZodMiniEnum<typeof ResourceKind>;
/** @internal */
export declare const ResourceKind$outboundSchema: z.ZodMiniEnum<typeof ResourceKind>;
/** @internal */
...
/** @internal */
export declare const Selector$outboundSchema: z.ZodMiniType<Selector$Outbound, Selector>;
export declare function selectorToJSON(selector: Selector): string;
export declare function selectorFromJSON(jsonString: string): SafeParseResult<Selector, SDKValidationError>;
