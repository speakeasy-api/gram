 ...
 * How the client authenticates at the issuer's token endpoint. Omit to default to client_secret_basic.
 */
export type CreateRemoteSessionClientFormTokenEndpointAuthMethod = ClosedEnum<typeof CreateRemoteSessionClientFormTokenEndpointAuthMethod>;
/**
...
export type CreateRemoteSessionClientForm = {
     ...
     * How the client authenticates at the issuer's token endpoint. Omit to default to client_secret_basic.
     */
    tokenEndpointAuthMethod?: CreateRemoteSessionClientFormTokenEndpointAuthMethod | undefined;
    /**
...
/** @internal */
export declare const CreateRemoteSessionClientFormTokenEndpointAuthMethod$outboundSchema: z.ZodMiniEnum<typeof CreateRemoteSessionClientFormTokenEndpointAuthMethod>;
/** @internal */
...
/** @internal */
export declare const CreateRemoteSessionClientForm$outboundSchema: z.ZodMiniType<CreateRemoteSessionClientForm$Outbound, CreateRemoteSessionClientForm>;
export declare function createRemoteSessionClientFormToJSON(createRemoteSessionClientForm: CreateRemoteSessionClientForm): string;
