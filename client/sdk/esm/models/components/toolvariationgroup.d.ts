...
/** @internal */
export declare const ToolVariationGroup$inboundSchema: z.ZodMiniType<ToolVariationGroup, unknown>;
export declare function toolVariationGroupFromJSON(jsonString: string): SafeParseResult<ToolVariationGroup, SDKValidationError>;
