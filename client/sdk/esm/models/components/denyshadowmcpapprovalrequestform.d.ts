...
/** @internal */
export declare const DenyShadowMCPApprovalRequestFormMatchBreadth$outboundSchema: z.ZodMiniEnum<
  typeof DenyShadowMCPApprovalRequestFormMatchBreadth
>;
/** @internal */
...
/** @internal */
export declare const DenyShadowMCPApprovalRequestForm$outboundSchema: z.ZodMiniType<
  DenyShadowMCPApprovalRequestForm$Outbound,
  DenyShadowMCPApprovalRequestForm
>;
export declare function denyShadowMCPApprovalRequestFormToJSON(
