...
/** @internal */
export const ShadowMCPApprovalRequest$inboundSchema = z.pipe(z.object({
    ...
    first_blocked_at: z.optional(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    id: z.string(),
    last_blocked_at: z.optional(z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v)))),
    ...
    project_id: z.string(),
    requested_at: z.pipe(z.iso.datetime({ offset: true }), z.transform(v => new Date(v))),
...
export function shadowMCPApprovalRequestFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ShadowMCPApprovalRequest$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ShadowMCPApprovalRequest' from JSON`);
}
