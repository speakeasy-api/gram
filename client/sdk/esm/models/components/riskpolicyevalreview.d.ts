...
/** @internal */
export declare const RiskPolicyEvalReview$inboundSchema: z.ZodMiniType<RiskPolicyEvalReview, unknown>;
export declare function riskPolicyEvalReviewFromJSON(jsonString: string): SafeParseResult<RiskPolicyEvalReview, SDKValidationError>;
