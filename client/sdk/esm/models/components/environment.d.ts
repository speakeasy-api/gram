...
/** @internal */
export declare const Environment$inboundSchema: z.ZodMiniType<Environment, unknown>;
export declare function environmentFromJSON(jsonString: string): SafeParseResult<Environment, SDKValidationError>;
