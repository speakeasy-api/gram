...
/** @internal */
export declare const ListUserSessionFacetsResult$inboundSchema: z.ZodMiniType<ListUserSessionFacetsResult, unknown>;
export declare function listUserSessionFacetsResultFromJSON(jsonString: string): SafeParseResult<ListUserSessionFacetsResult, SDKValidationError>;
