...
/** @internal */
export declare const EvaluatePromptGuardrailRequestBody$outboundSchema: z.ZodMiniType<EvaluatePromptGuardrailRequestBody$Outbound, EvaluatePromptGuardrailRequestBody>;
export declare function evaluatePromptGuardrailRequestBodyToJSON(evaluatePromptGuardrailRequestBody: EvaluatePromptGuardrailRequestBody): string;
