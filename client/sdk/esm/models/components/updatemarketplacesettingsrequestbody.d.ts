...
/** @internal */
export declare const UpdateMarketplaceSettingsRequestBody$outboundSchema: z.ZodMiniType<UpdateMarketplaceSettingsRequestBody$Outbound, UpdateMarketplaceSettingsRequestBody>;
export declare function updateMarketplaceSettingsRequestBodyToJSON(updateMarketplaceSettingsRequestBody: UpdateMarketplaceSettingsRequestBody): string;
