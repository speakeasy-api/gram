...
/** @internal */
export declare const DeploymentLogEvent$inboundSchema: z.ZodMiniType<DeploymentLogEvent, unknown>;
export declare function deploymentLogEventFromJSON(jsonString: string): SafeParseResult<DeploymentLogEvent, SDKValidationError>;
