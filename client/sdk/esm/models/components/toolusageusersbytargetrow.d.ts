 ...
 * Tool usage aggregation target kind
 */
export type ToolUsageUsersByTargetRowTargetKind = ClosedEnum<typeof ToolUsageUsersByTargetRowTargetKind>;
/**
 ...
 * Tool usage target type
 */
export type ToolUsageUsersByTargetRowTargetType = ClosedEnum<typeof ToolUsageUsersByTargetRowTargetType>;
/**
 ...
 * Tool usage user identity kind
 */
export type ToolUsageUsersByTargetRowUserKind = ClosedEnum<typeof ToolUsageUsersByTargetRowUserKind>;
/**
...
/** @internal */
export declare const ToolUsageUsersByTargetRowTargetKind$inboundSchema: z.ZodMiniEnum<typeof ToolUsageUsersByTargetRowTargetKind>;
/** @internal */
export declare const ToolUsageUsersByTargetRowTargetType$inboundSchema: z.ZodMiniEnum<typeof ToolUsageUsersByTargetRowTargetType>;
/** @internal */
export declare const ToolUsageUsersByTargetRowUserKind$inboundSchema: z.ZodMiniEnum<typeof ToolUsageUsersByTargetRowUserKind>;
/** @internal */
export declare const ToolUsageUsersByTargetRow$inboundSchema: z.ZodMiniType<ToolUsageUsersByTargetRow, unknown>;
export declare function toolUsageUsersByTargetRowFromJSON(jsonString: string): SafeParseResult<ToolUsageUsersByTargetRow, SDKValidationError>;
