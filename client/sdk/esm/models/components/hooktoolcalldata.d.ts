...
/** @internal */
export declare const HookToolCallData$outboundSchema: z.ZodMiniType<HookToolCallData$Outbound, HookToolCallData>;
export declare function hookToolCallDataToJSON(hookToolCallData: HookToolCallData): string;
