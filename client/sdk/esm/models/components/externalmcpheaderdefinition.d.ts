...
/** @internal */
export declare const ExternalMCPHeaderDefinition$inboundSchema: z.ZodMiniType<ExternalMCPHeaderDefinition, unknown>;
export declare function externalMCPHeaderDefinitionFromJSON(jsonString: string): SafeParseResult<ExternalMCPHeaderDefinition, SDKValidationError>;
