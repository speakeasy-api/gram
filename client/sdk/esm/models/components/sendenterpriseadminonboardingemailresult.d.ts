...
/** @internal */
export declare const SendEnterpriseAdminOnboardingEmailResult$inboundSchema: z.ZodMiniType<
  SendEnterpriseAdminOnboardingEmailResult,
  unknown
>;
export declare function sendEnterpriseAdminOnboardingEmailResultFromJSON(
  jsonString: string,
): SafeParseResult<
  SendEnterpriseAdminOnboardingEmailResult,
  SDKValidationError
