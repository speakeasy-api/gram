...
/** @internal */
export declare const AgentMarketplace$inboundSchema: z.ZodMiniType<AgentMarketplace, unknown>;
export declare function agentMarketplaceFromJSON(jsonString: string): SafeParseResult<AgentMarketplace, SDKValidationError>;
