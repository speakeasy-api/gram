...
/** @internal */
export declare const OrganizationRemoteSessionIssuer$inboundSchema: z.ZodMiniType<OrganizationRemoteSessionIssuer, unknown>;
export declare function organizationRemoteSessionIssuerFromJSON(jsonString: string): SafeParseResult<OrganizationRemoteSessionIssuer, SDKValidationError>;
