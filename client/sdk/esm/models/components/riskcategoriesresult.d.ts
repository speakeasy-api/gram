...
/** @internal */
export declare const RiskCategoriesResult$inboundSchema: z.ZodMiniType<RiskCategoriesResult, unknown>;
export declare function riskCategoriesResultFromJSON(jsonString: string): SafeParseResult<RiskCategoriesResult, SDKValidationError>;
