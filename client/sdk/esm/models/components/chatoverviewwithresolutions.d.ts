...
/** @internal */
export declare const ChatOverviewWithResolutions$inboundSchema: z.ZodMiniType<ChatOverviewWithResolutions, unknown>;
export declare function chatOverviewWithResolutionsFromJSON(jsonString: string): SafeParseResult<ChatOverviewWithResolutions, SDKValidationError>;
