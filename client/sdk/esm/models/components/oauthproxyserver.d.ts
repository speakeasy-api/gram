...
/** @internal */
export declare const OAuthProxyServer$inboundSchema: z.ZodMiniType<OAuthProxyServer, unknown>;
export declare function oAuthProxyServerFromJSON(jsonString: string): SafeParseResult<OAuthProxyServer, SDKValidationError>;
