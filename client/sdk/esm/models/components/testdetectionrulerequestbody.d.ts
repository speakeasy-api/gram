...
/** @internal */
export declare const TestDetectionRuleRequestBody$outboundSchema: z.ZodMiniType<TestDetectionRuleRequestBody$Outbound, TestDetectionRuleRequestBody>;
export declare function testDetectionRuleRequestBodyToJSON(testDetectionRuleRequestBody: TestDetectionRuleRequestBody): string;
