...
/** @internal */
export declare const WorkOSDomainVerificationIntentOptions$outboundSchema: z.ZodMiniType<
  WorkOSDomainVerificationIntentOptions$Outbound,
  WorkOSDomainVerificationIntentOptions
>;
export declare function workOSDomainVerificationIntentOptionsToJSON(
