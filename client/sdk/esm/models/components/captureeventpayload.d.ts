...
/** @internal */
export declare const CaptureEventPayload$outboundSchema: z.ZodMiniType<CaptureEventPayload$Outbound, CaptureEventPayload>;
export declare function captureEventPayloadToJSON(captureEventPayload: CaptureEventPayload): string;
