...
/** @internal */
export declare const GetObservabilityOverviewPayload$outboundSchema: z.ZodMiniType<GetObservabilityOverviewPayload$Outbound, GetObservabilityOverviewPayload>;
export declare function getObservabilityOverviewPayloadToJSON(getObservabilityOverviewPayload: GetObservabilityOverviewPayload): string;
