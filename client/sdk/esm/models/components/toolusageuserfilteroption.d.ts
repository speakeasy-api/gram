...
/** @internal */
export declare const ToolUsageUserFilterOption$inboundSchema: z.ZodMiniType<ToolUsageUserFilterOption, unknown>;
export declare function toolUsageUserFilterOptionFromJSON(jsonString: string): SafeParseResult<ToolUsageUserFilterOption, SDKValidationError>;
