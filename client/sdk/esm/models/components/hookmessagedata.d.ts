...
/** @internal */
export declare const HookMessageData$outboundSchema: z.ZodMiniType<HookMessageData$Outbound, HookMessageData>;
export declare function hookMessageDataToJSON(hookMessageData: HookMessageData): string;
