...
/** @internal */
export declare const RiskRuleBreakdownEntry$inboundSchema: z.ZodMiniType<RiskRuleBreakdownEntry, unknown>;
export declare function riskRuleBreakdownEntryFromJSON(jsonString: string): SafeParseResult<RiskRuleBreakdownEntry, SDKValidationError>;
