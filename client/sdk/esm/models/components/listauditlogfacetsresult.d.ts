...
/** @internal */
export declare const ListAuditLogFacetsResult$inboundSchema: z.ZodMiniType<ListAuditLogFacetsResult, unknown>;
export declare function listAuditLogFacetsResultFromJSON(jsonString: string): SafeParseResult<ListAuditLogFacetsResult, SDKValidationError>;
