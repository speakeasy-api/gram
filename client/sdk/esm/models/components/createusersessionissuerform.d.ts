...
/** @internal */
export declare const AuthnChallengeMode$outboundSchema: z.ZodMiniEnum<typeof AuthnChallengeMode>;
/** @internal */
...
/** @internal */
export declare const CreateUserSessionIssuerForm$outboundSchema: z.ZodMiniType<CreateUserSessionIssuerForm$Outbound, CreateUserSessionIssuerForm>;
export declare function createUserSessionIssuerFormToJSON(createUserSessionIssuerForm: CreateUserSessionIssuerForm): string;
