...
/** @internal */
export declare const PromptGuardrailEvalResult$inboundSchema: z.ZodMiniType<PromptGuardrailEvalResult, unknown>;
export declare function promptGuardrailEvalResultFromJSON(jsonString: string): SafeParseResult<PromptGuardrailEvalResult, SDKValidationError>;
