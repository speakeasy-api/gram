...
/** @internal */
export declare const UpdatePromptTemplateFormEngine$outboundSchema: z.ZodMiniEnum<
  typeof UpdatePromptTemplateFormEngine
>;
/** @internal */
export declare const UpdatePromptTemplateFormKind$outboundSchema: z.ZodMiniEnum<
  typeof UpdatePromptTemplateFormKind
>;
/** @internal */
...
/** @internal */
export declare const UpdatePromptTemplateForm$outboundSchema: z.ZodMiniType<
  UpdatePromptTemplateForm$Outbound,
  UpdatePromptTemplateForm
>;
export declare function updatePromptTemplateFormToJSON(
