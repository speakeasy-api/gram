...
/** @internal */
export declare const GetInstanceResult$inboundSchema: z.ZodMiniType<GetInstanceResult, unknown>;
export declare function getInstanceResultFromJSON(jsonString: string): SafeParseResult<GetInstanceResult, SDKValidationError>;
