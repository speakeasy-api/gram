...
/** @internal */
export declare const ServerClass$inboundSchema: z.ZodMiniEnum<typeof ServerClass>;
/** @internal */
export declare const Tier$inboundSchema: z.ZodMiniEnum<typeof Tier>;
/** @internal */
export declare const EmployeeDataFlowNode$inboundSchema: z.ZodMiniType<EmployeeDataFlowNode, unknown>;
export declare function employeeDataFlowNodeFromJSON(jsonString: string): SafeParseResult<EmployeeDataFlowNode, SDKValidationError>;
