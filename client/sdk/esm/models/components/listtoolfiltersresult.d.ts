...
/** @internal */
export declare const ListToolFiltersResult$inboundSchema: z.ZodMiniType<ListToolFiltersResult, unknown>;
export declare function listToolFiltersResultFromJSON(jsonString: string): SafeParseResult<ListToolFiltersResult, SDKValidationError>;
