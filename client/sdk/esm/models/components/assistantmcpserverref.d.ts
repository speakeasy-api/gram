...
/** @internal */
export declare const AssistantMCPServerRef$inboundSchema: z.ZodMiniType<AssistantMCPServerRef, unknown>;
/** @internal */
...
/** @internal */
export declare const AssistantMCPServerRef$outboundSchema: z.ZodMiniType<AssistantMCPServerRef$Outbound, AssistantMCPServerRef>;
export declare function assistantMCPServerRefToJSON(assistantMCPServerRef: AssistantMCPServerRef): string;
export declare function assistantMCPServerRefFromJSON(jsonString: string): SafeParseResult<AssistantMCPServerRef, SDKValidationError>;
