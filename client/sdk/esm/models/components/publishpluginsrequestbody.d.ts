...
/** @internal */
export declare const PublishPluginsRequestBody$outboundSchema: z.ZodMiniType<PublishPluginsRequestBody$Outbound, PublishPluginsRequestBody>;
export declare function publishPluginsRequestBodyToJSON(publishPluginsRequestBody: PublishPluginsRequestBody): string;
