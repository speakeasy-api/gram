...
/** @internal */
export declare const DeploymentFunctions$inboundSchema: z.ZodMiniType<DeploymentFunctions, unknown>;
export declare function deploymentFunctionsFromJSON(jsonString: string): SafeParseResult<DeploymentFunctions, SDKValidationError>;
