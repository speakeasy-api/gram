...
/** @internal */
export declare const AddExternalMCPForm$outboundSchema: z.ZodMiniType<AddExternalMCPForm$Outbound, AddExternalMCPForm>;
export declare function addExternalMCPFormToJSON(addExternalMCPForm: AddExternalMCPForm): string;
