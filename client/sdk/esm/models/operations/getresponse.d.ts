...
/** @internal */
export declare const GetResponseSecurity$outboundSchema: z.ZodMiniType<
  GetResponseSecurity$Outbound,
  GetResponseSecurity
>;
export declare function getResponseSecurityToJSON(
...
/** @internal */
export declare const GetResponseRequest$outboundSchema: z.ZodMiniType<
  GetResponseRequest$Outbound,
  GetResponseRequest
>;
export declare function getResponseRequestToJSON(
