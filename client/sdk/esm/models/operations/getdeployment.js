...
/** @internal */
export const GetDeploymentSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const GetDeploymentSecurityOption2$outboundSchema = z.pipe(
  z.object({
    projectSlugHeaderGramProject: z.string(),
...
/** @internal */
export const GetDeploymentSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const GetDeploymentRequest$outboundSchema = z.pipe(
  z.object({
    id: z.string(),
