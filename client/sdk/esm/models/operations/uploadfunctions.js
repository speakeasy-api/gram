...
/** @internal */
export const UploadFunctionsSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const UploadFunctionsSecurityOption2$outboundSchema = z.pipe(
  z.object({
    projectSlugHeaderGramProject: z.string(),
...
/** @internal */
export const UploadFunctionsSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const UploadFunctionsRequest$outboundSchema = z.pipe(
  z.object({
    contentLength: z.int(),
