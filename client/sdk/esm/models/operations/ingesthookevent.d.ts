...
/** @internal */
export declare const IngestHookEventSecurity$outboundSchema: z.ZodMiniType<
  IngestHookEventSecurity$Outbound,
  IngestHookEventSecurity
>;
export declare function ingestHookEventSecurityToJSON(
...
/** @internal */
export declare const IngestHookEventRequest$outboundSchema: z.ZodMiniType<
  IngestHookEventRequest$Outbound,
  IngestHookEventRequest
>;
export declare function ingestHookEventRequestToJSON(
