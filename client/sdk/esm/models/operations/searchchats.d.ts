...
/** @internal */
export declare const SearchChatsSecurityOption1$outboundSchema: z.ZodMiniType<
  SearchChatsSecurityOption1$Outbound,
  SearchChatsSecurityOption1
>;
export declare function searchChatsSecurityOption1ToJSON(
...
/** @internal */
export declare const SearchChatsSecurityOption2$outboundSchema: z.ZodMiniType<
  SearchChatsSecurityOption2$Outbound,
  SearchChatsSecurityOption2
>;
export declare function searchChatsSecurityOption2ToJSON(
...
/** @internal */
export declare const SearchChatsSecurity$outboundSchema: z.ZodMiniType<
  SearchChatsSecurity$Outbound,
  SearchChatsSecurity
>;
export declare function searchChatsSecurityToJSON(
...
/** @internal */
export declare const SearchChatsRequest$outboundSchema: z.ZodMiniType<
  SearchChatsRequest$Outbound,
  SearchChatsRequest
>;
export declare function searchChatsRequestToJSON(
