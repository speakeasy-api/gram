...
/** @internal */
export declare const ListServerNameOverridesSecurityOption1$outboundSchema: z.ZodMiniType<
  ListServerNameOverridesSecurityOption1$Outbound,
  ListServerNameOverridesSecurityOption1
>;
export declare function listServerNameOverridesSecurityOption1ToJSON(
  listServerNameOverridesSecurityOption1: ListServerNameOverridesSecurityOption1,
): string;
/** @internal */
...
/** @internal */
export declare const ListServerNameOverridesSecurityOption2$outboundSchema: z.ZodMiniType<
  ListServerNameOverridesSecurityOption2$Outbound,
  ListServerNameOverridesSecurityOption2
>;
export declare function listServerNameOverridesSecurityOption2ToJSON(
  listServerNameOverridesSecurityOption2: ListServerNameOverridesSecurityOption2,
): string;
/** @internal */
...
/** @internal */
export declare const ListServerNameOverridesSecurity$outboundSchema: z.ZodMiniType<
  ListServerNameOverridesSecurity$Outbound,
  ListServerNameOverridesSecurity
>;
export declare function listServerNameOverridesSecurityToJSON(
...
/** @internal */
export declare const ListServerNameOverridesRequest$outboundSchema: z.ZodMiniType<
  ListServerNameOverridesRequest$Outbound,
  ListServerNameOverridesRequest
>;
export declare function listServerNameOverridesRequestToJSON(
