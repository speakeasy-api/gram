...
/** @internal */
export declare const GenerateWorkOSAdminPortalLinkSecurity$outboundSchema: z.ZodMiniType<
  GenerateWorkOSAdminPortalLinkSecurity$Outbound,
  GenerateWorkOSAdminPortalLinkSecurity
>;
export declare function generateWorkOSAdminPortalLinkSecurityToJSON(
...
/** @internal */
export declare const GenerateWorkOSAdminPortalLinkRequest$outboundSchema: z.ZodMiniType<
  GenerateWorkOSAdminPortalLinkRequest$Outbound,
  GenerateWorkOSAdminPortalLinkRequest
>;
export declare function generateWorkOSAdminPortalLinkRequestToJSON(
