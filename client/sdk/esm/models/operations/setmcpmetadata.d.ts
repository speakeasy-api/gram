...
/** @internal */
export declare const SetMcpMetadataSecurityOption1$outboundSchema: z.ZodMiniType<
  SetMcpMetadataSecurityOption1$Outbound,
  SetMcpMetadataSecurityOption1
>;
export declare function setMcpMetadataSecurityOption1ToJSON(
...
/** @internal */
export declare const SetMcpMetadataSecurityOption2$outboundSchema: z.ZodMiniType<
  SetMcpMetadataSecurityOption2$Outbound,
  SetMcpMetadataSecurityOption2
>;
export declare function setMcpMetadataSecurityOption2ToJSON(
...
/** @internal */
export declare const SetMcpMetadataSecurity$outboundSchema: z.ZodMiniType<
  SetMcpMetadataSecurity$Outbound,
  SetMcpMetadataSecurity
>;
export declare function setMcpMetadataSecurityToJSON(
...
/** @internal */
export declare const SetMcpMetadataRequest$outboundSchema: z.ZodMiniType<
  SetMcpMetadataRequest$Outbound,
  SetMcpMetadataRequest
>;
export declare function setMcpMetadataRequestToJSON(
