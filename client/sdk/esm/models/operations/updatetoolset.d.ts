...
/** @internal */
export declare const UpdateToolsetSecurityOption1$outboundSchema: z.ZodMiniType<
  UpdateToolsetSecurityOption1$Outbound,
  UpdateToolsetSecurityOption1
>;
export declare function updateToolsetSecurityOption1ToJSON(
...
/** @internal */
export declare const UpdateToolsetSecurityOption2$outboundSchema: z.ZodMiniType<
  UpdateToolsetSecurityOption2$Outbound,
  UpdateToolsetSecurityOption2
>;
export declare function updateToolsetSecurityOption2ToJSON(
...
/** @internal */
export declare const UpdateToolsetSecurity$outboundSchema: z.ZodMiniType<
  UpdateToolsetSecurity$Outbound,
  UpdateToolsetSecurity
>;
export declare function updateToolsetSecurityToJSON(
...
/** @internal */
export declare const UpdateToolsetRequest$outboundSchema: z.ZodMiniType<
  UpdateToolsetRequest$Outbound,
  UpdateToolsetRequest
>;
export declare function updateToolsetRequestToJSON(
