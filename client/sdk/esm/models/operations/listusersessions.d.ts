...
/** @internal */
export declare const ListUserSessionsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListUserSessionsSecurityOption1$Outbound,
  ListUserSessionsSecurityOption1
>;
export declare function listUserSessionsSecurityOption1ToJSON(
...
/** @internal */
export declare const ListUserSessionsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListUserSessionsSecurityOption2$Outbound,
  ListUserSessionsSecurityOption2
>;
export declare function listUserSessionsSecurityOption2ToJSON(
...
/** @internal */
export declare const ListUserSessionsSecurity$outboundSchema: z.ZodMiniType<
  ListUserSessionsSecurity$Outbound,
  ListUserSessionsSecurity
>;
export declare function listUserSessionsSecurityToJSON(
  listUserSessionsSecurity: ListUserSessionsSecurity,
): string;
/** @internal */
export declare const ListUserSessionsQueryParamStatus$outboundSchema: z.ZodMiniEnum<
  typeof ListUserSessionsQueryParamStatus
>;
/** @internal */
...
/** @internal */
export declare const ListUserSessionsRequest$outboundSchema: z.ZodMiniType<
  ListUserSessionsRequest$Outbound,
  ListUserSessionsRequest
>;
export declare function listUserSessionsRequestToJSON(
  listUserSessionsRequest: ListUserSessionsRequest,
): string;
/** @internal */
export declare const ListUserSessionsResponse$inboundSchema: z.ZodMiniType<
  ListUserSessionsResponse,
  unknown
>;
export declare function listUserSessionsResponseFromJSON(
  jsonString: string,
