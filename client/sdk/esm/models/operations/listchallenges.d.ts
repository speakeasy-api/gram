...
/** @internal */
export declare const ListChallengesSecurity$outboundSchema: z.ZodMiniType<ListChallengesSecurity$Outbound, ListChallengesSecurity>;
export declare function listChallengesSecurityToJSON(listChallengesSecurity: ListChallengesSecurity): string;
/** @internal */
export declare const QueryParamOutcome$outboundSchema: z.ZodMiniEnum<typeof QueryParamOutcome>;
/** @internal */
...
/** @internal */
export declare const ListChallengesRequest$outboundSchema: z.ZodMiniType<ListChallengesRequest$Outbound, ListChallengesRequest>;
export declare function listChallengesRequestToJSON(listChallengesRequest: ListChallengesRequest): string;
