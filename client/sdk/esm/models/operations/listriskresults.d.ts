...
/** @internal */
export declare const ListRiskResultsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListRiskResultsSecurityOption1$Outbound,
  ListRiskResultsSecurityOption1
>;
export declare function listRiskResultsSecurityOption1ToJSON(
...
/** @internal */
export declare const ListRiskResultsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListRiskResultsSecurityOption2$Outbound,
  ListRiskResultsSecurityOption2
>;
export declare function listRiskResultsSecurityOption2ToJSON(
...
/** @internal */
export declare const ListRiskResultsSecurity$outboundSchema: z.ZodMiniType<
  ListRiskResultsSecurity$Outbound,
  ListRiskResultsSecurity
>;
export declare function listRiskResultsSecurityToJSON(
...
/** @internal */
export declare const ListRiskResultsRequest$outboundSchema: z.ZodMiniType<
  ListRiskResultsRequest$Outbound,
  ListRiskResultsRequest
>;
export declare function listRiskResultsRequestToJSON(
