...
/** @internal */
export const CheckMCPSlugAvailabilitySecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const CheckMCPSlugAvailabilitySecurityOption2$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const CheckMCPSlugAvailabilitySecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const CheckMCPSlugAvailabilityRequest$outboundSchema = z.pipe(
  z.object({
    slug: z.string(),
