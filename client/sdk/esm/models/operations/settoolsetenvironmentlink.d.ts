...
/** @internal */
export declare const SetToolsetEnvironmentLinkSecurity$outboundSchema: z.ZodMiniType<
  SetToolsetEnvironmentLinkSecurity$Outbound,
  SetToolsetEnvironmentLinkSecurity
>;
export declare function setToolsetEnvironmentLinkSecurityToJSON(
...
/** @internal */
export declare const SetToolsetEnvironmentLinkRequest$outboundSchema: z.ZodMiniType<
  SetToolsetEnvironmentLinkRequest$Outbound,
  SetToolsetEnvironmentLinkRequest
>;
export declare function setToolsetEnvironmentLinkRequestToJSON(
