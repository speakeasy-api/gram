...
/** @internal */
export declare const CreateProjectSecurity$outboundSchema: z.ZodMiniType<
  CreateProjectSecurity$Outbound,
  CreateProjectSecurity
>;
export declare function createProjectSecurityToJSON(
...
/** @internal */
export declare const CreateProjectRequest$outboundSchema: z.ZodMiniType<
  CreateProjectRequest$Outbound,
  CreateProjectRequest
>;
export declare function createProjectRequestToJSON(
