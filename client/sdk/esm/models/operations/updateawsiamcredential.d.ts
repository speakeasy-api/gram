...
/** @internal */
export declare const UpdateAwsIamCredentialSecurity$outboundSchema: z.ZodMiniType<
  UpdateAwsIamCredentialSecurity$Outbound,
  UpdateAwsIamCredentialSecurity
>;
export declare function updateAwsIamCredentialSecurityToJSON(
...
/** @internal */
export declare const UpdateAwsIamCredentialRequest$outboundSchema: z.ZodMiniType<
  UpdateAwsIamCredentialRequest$Outbound,
  UpdateAwsIamCredentialRequest
>;
export declare function updateAwsIamCredentialRequestToJSON(
