...
/** @internal */
export declare const AddExternalOAuthServerSecurityOption1$outboundSchema: z.ZodMiniType<
  AddExternalOAuthServerSecurityOption1$Outbound,
  AddExternalOAuthServerSecurityOption1
>;
export declare function addExternalOAuthServerSecurityOption1ToJSON(
...
/** @internal */
export declare const AddExternalOAuthServerSecurityOption2$outboundSchema: z.ZodMiniType<
  AddExternalOAuthServerSecurityOption2$Outbound,
  AddExternalOAuthServerSecurityOption2
>;
export declare function addExternalOAuthServerSecurityOption2ToJSON(
...
/** @internal */
export declare const AddExternalOAuthServerSecurity$outboundSchema: z.ZodMiniType<
  AddExternalOAuthServerSecurity$Outbound,
  AddExternalOAuthServerSecurity
>;
export declare function addExternalOAuthServerSecurityToJSON(
...
/** @internal */
export declare const AddExternalOAuthServerRequest$outboundSchema: z.ZodMiniType<
  AddExternalOAuthServerRequest$Outbound,
  AddExternalOAuthServerRequest
>;
export declare function addExternalOAuthServerRequestToJSON(
