...
/** @internal */
export declare const GetProjectOverviewSecurityOption1$outboundSchema: z.ZodMiniType<
  GetProjectOverviewSecurityOption1$Outbound,
  GetProjectOverviewSecurityOption1
>;
export declare function getProjectOverviewSecurityOption1ToJSON(
...
/** @internal */
export declare const GetProjectOverviewSecurityOption2$outboundSchema: z.ZodMiniType<
  GetProjectOverviewSecurityOption2$Outbound,
  GetProjectOverviewSecurityOption2
>;
export declare function getProjectOverviewSecurityOption2ToJSON(
...
/** @internal */
export declare const GetProjectOverviewSecurity$outboundSchema: z.ZodMiniType<
  GetProjectOverviewSecurity$Outbound,
  GetProjectOverviewSecurity
>;
export declare function getProjectOverviewSecurityToJSON(
...
/** @internal */
export declare const GetProjectOverviewRequest$outboundSchema: z.ZodMiniType<
  GetProjectOverviewRequest$Outbound,
  GetProjectOverviewRequest
>;
export declare function getProjectOverviewRequestToJSON(
