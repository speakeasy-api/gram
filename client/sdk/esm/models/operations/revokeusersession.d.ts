...
/** @internal */
export declare const RevokeUserSessionSecurityOption1$outboundSchema: z.ZodMiniType<
  RevokeUserSessionSecurityOption1$Outbound,
  RevokeUserSessionSecurityOption1
>;
export declare function revokeUserSessionSecurityOption1ToJSON(
...
/** @internal */
export declare const RevokeUserSessionSecurityOption2$outboundSchema: z.ZodMiniType<
  RevokeUserSessionSecurityOption2$Outbound,
  RevokeUserSessionSecurityOption2
>;
export declare function revokeUserSessionSecurityOption2ToJSON(
...
/** @internal */
export declare const RevokeUserSessionSecurity$outboundSchema: z.ZodMiniType<
  RevokeUserSessionSecurity$Outbound,
  RevokeUserSessionSecurity
>;
export declare function revokeUserSessionSecurityToJSON(
...
/** @internal */
export declare const RevokeUserSessionRequest$outboundSchema: z.ZodMiniType<
  RevokeUserSessionRequest$Outbound,
  RevokeUserSessionRequest
>;
export declare function revokeUserSessionRequestToJSON(
