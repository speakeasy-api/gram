...
/** @internal */
export declare const ListTelemetryLogsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListTelemetryLogsSecurityOption1$Outbound,
  ListTelemetryLogsSecurityOption1
>;
export declare function listTelemetryLogsSecurityOption1ToJSON(
...
/** @internal */
export declare const ListTelemetryLogsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListTelemetryLogsSecurityOption2$Outbound,
  ListTelemetryLogsSecurityOption2
>;
export declare function listTelemetryLogsSecurityOption2ToJSON(
...
/** @internal */
export declare const ListTelemetryLogsSecurityOption3$outboundSchema: z.ZodMiniType<
  ListTelemetryLogsSecurityOption3$Outbound,
  ListTelemetryLogsSecurityOption3
>;
export declare function listTelemetryLogsSecurityOption3ToJSON(
...
/** @internal */
export declare const ListTelemetryLogsSecurityOption4$outboundSchema: z.ZodMiniType<
  ListTelemetryLogsSecurityOption4$Outbound,
  ListTelemetryLogsSecurityOption4
>;
export declare function listTelemetryLogsSecurityOption4ToJSON(
...
/** @internal */
export declare const ListTelemetryLogsSecurity$outboundSchema: z.ZodMiniType<
  ListTelemetryLogsSecurity$Outbound,
  ListTelemetryLogsSecurity
>;
export declare function listTelemetryLogsSecurityToJSON(
  listTelemetryLogsSecurity: ListTelemetryLogsSecurity,
): string;
/** @internal */
export declare const SeverityText$outboundSchema: z.ZodMiniEnum<
  typeof SeverityText
>;
/** @internal */
export declare const HttpMethod$outboundSchema: z.ZodMiniEnum<
  typeof HttpMethod
>;
/** @internal */
export declare const QueryParamSort$outboundSchema: z.ZodMiniEnum<
...
/** @internal */
export declare const ListTelemetryLogsRequest$outboundSchema: z.ZodMiniType<
  ListTelemetryLogsRequest$Outbound,
  ListTelemetryLogsRequest
>;
export declare function listTelemetryLogsRequestToJSON(
