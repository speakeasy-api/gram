...
/** @internal */
export declare const SearchLogsSecurityOption1$outboundSchema: z.ZodMiniType<
  SearchLogsSecurityOption1$Outbound,
  SearchLogsSecurityOption1
>;
export declare function searchLogsSecurityOption1ToJSON(
...
/** @internal */
export declare const SearchLogsSecurityOption2$outboundSchema: z.ZodMiniType<
  SearchLogsSecurityOption2$Outbound,
  SearchLogsSecurityOption2
>;
export declare function searchLogsSecurityOption2ToJSON(
...
/** @internal */
export declare const SearchLogsSecurity$outboundSchema: z.ZodMiniType<
  SearchLogsSecurity$Outbound,
  SearchLogsSecurity
>;
export declare function searchLogsSecurityToJSON(
...
/** @internal */
export declare const SearchLogsRequest$outboundSchema: z.ZodMiniType<
  SearchLogsRequest$Outbound,
  SearchLogsRequest
>;
export declare function searchLogsRequestToJSON(
