...
/** @internal */
export declare const DeleteTriggerInstanceSecurity$outboundSchema: z.ZodMiniType<
  DeleteTriggerInstanceSecurity$Outbound,
  DeleteTriggerInstanceSecurity
>;
export declare function deleteTriggerInstanceSecurityToJSON(
...
/** @internal */
export declare const DeleteTriggerInstanceRequest$outboundSchema: z.ZodMiniType<
  DeleteTriggerInstanceRequest$Outbound,
  DeleteTriggerInstanceRequest
>;
export declare function deleteTriggerInstanceRequestToJSON(
