...
/** @internal */
export declare const UpdateRiskPolicySecurityOption1$outboundSchema: z.ZodMiniType<
  UpdateRiskPolicySecurityOption1$Outbound,
  UpdateRiskPolicySecurityOption1
>;
export declare function updateRiskPolicySecurityOption1ToJSON(
...
/** @internal */
export declare const UpdateRiskPolicySecurityOption2$outboundSchema: z.ZodMiniType<
  UpdateRiskPolicySecurityOption2$Outbound,
  UpdateRiskPolicySecurityOption2
>;
export declare function updateRiskPolicySecurityOption2ToJSON(
...
/** @internal */
export declare const UpdateRiskPolicySecurity$outboundSchema: z.ZodMiniType<
  UpdateRiskPolicySecurity$Outbound,
  UpdateRiskPolicySecurity
>;
export declare function updateRiskPolicySecurityToJSON(
...
/** @internal */
export declare const UpdateRiskPolicyRequest$outboundSchema: z.ZodMiniType<
  UpdateRiskPolicyRequest$Outbound,
  UpdateRiskPolicyRequest
>;
export declare function updateRiskPolicyRequestToJSON(
