...
/** @internal */
export declare const ListTriggerDefinitionsSecurity$outboundSchema: z.ZodMiniType<
  ListTriggerDefinitionsSecurity$Outbound,
  ListTriggerDefinitionsSecurity
>;
export declare function listTriggerDefinitionsSecurityToJSON(
...
/** @internal */
export declare const ListTriggerDefinitionsRequest$outboundSchema: z.ZodMiniType<
  ListTriggerDefinitionsRequest$Outbound,
  ListTriggerDefinitionsRequest
>;
export declare function listTriggerDefinitionsRequestToJSON(
