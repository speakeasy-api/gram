...
/** @internal */
export declare const ListDeploymentsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListDeploymentsSecurityOption1$Outbound,
  ListDeploymentsSecurityOption1
>;
export declare function listDeploymentsSecurityOption1ToJSON(
...
/** @internal */
export declare const ListDeploymentsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListDeploymentsSecurityOption2$Outbound,
  ListDeploymentsSecurityOption2
>;
export declare function listDeploymentsSecurityOption2ToJSON(
...
/** @internal */
export declare const ListDeploymentsSecurity$outboundSchema: z.ZodMiniType<
  ListDeploymentsSecurity$Outbound,
  ListDeploymentsSecurity
>;
export declare function listDeploymentsSecurityToJSON(
...
/** @internal */
export declare const ListDeploymentsRequest$outboundSchema: z.ZodMiniType<
  ListDeploymentsRequest$Outbound,
  ListDeploymentsRequest
>;
export declare function listDeploymentsRequestToJSON(
