...
/** @internal */
export declare const ListChatsWithResolutionsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListChatsWithResolutionsSecurityOption1$Outbound,
  ListChatsWithResolutionsSecurityOption1
>;
export declare function listChatsWithResolutionsSecurityOption1ToJSON(
  listChatsWithResolutionsSecurityOption1: ListChatsWithResolutionsSecurityOption1,
): string;
/** @internal */
...
/** @internal */
export declare const ListChatsWithResolutionsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListChatsWithResolutionsSecurityOption2$Outbound,
  ListChatsWithResolutionsSecurityOption2
>;
export declare function listChatsWithResolutionsSecurityOption2ToJSON(
  listChatsWithResolutionsSecurityOption2: ListChatsWithResolutionsSecurityOption2,
): string;
/** @internal */
...
/** @internal */
export declare const ListChatsWithResolutionsSecurity$outboundSchema: z.ZodMiniType<
  ListChatsWithResolutionsSecurity$Outbound,
  ListChatsWithResolutionsSecurity
>;
export declare function listChatsWithResolutionsSecurityToJSON(
...
/** @internal */
export declare const ListChatsWithResolutionsRequest$outboundSchema: z.ZodMiniType<
  ListChatsWithResolutionsRequest$Outbound,
  ListChatsWithResolutionsRequest
>;
export declare function listChatsWithResolutionsRequestToJSON(
