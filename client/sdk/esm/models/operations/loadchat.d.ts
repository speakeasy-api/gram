...
/** @internal */
export declare const LoadChatSecurityOption1$outboundSchema: z.ZodMiniType<
  LoadChatSecurityOption1$Outbound,
  LoadChatSecurityOption1
>;
export declare function loadChatSecurityOption1ToJSON(
...
/** @internal */
export declare const LoadChatSecurityOption2$outboundSchema: z.ZodMiniType<
  LoadChatSecurityOption2$Outbound,
  LoadChatSecurityOption2
>;
export declare function loadChatSecurityOption2ToJSON(
...
/** @internal */
export declare const LoadChatSecurity$outboundSchema: z.ZodMiniType<
  LoadChatSecurity$Outbound,
  LoadChatSecurity
>;
export declare function loadChatSecurityToJSON(
...
/** @internal */
export declare const LoadChatRequest$outboundSchema: z.ZodMiniType<
  LoadChatRequest$Outbound,
  LoadChatRequest
>;
export declare function loadChatRequestToJSON(
