...
/** @internal */
export declare const CreateChatSessionSecurityOption1$outboundSchema: z.ZodMiniType<
  CreateChatSessionSecurityOption1$Outbound,
  CreateChatSessionSecurityOption1
>;
export declare function createChatSessionSecurityOption1ToJSON(
...
/** @internal */
export declare const CreateChatSessionSecurityOption2$outboundSchema: z.ZodMiniType<
  CreateChatSessionSecurityOption2$Outbound,
  CreateChatSessionSecurityOption2
>;
export declare function createChatSessionSecurityOption2ToJSON(
...
/** @internal */
export declare const CreateChatSessionSecurity$outboundSchema: z.ZodMiniType<
  CreateChatSessionSecurity$Outbound,
  CreateChatSessionSecurity
>;
export declare function createChatSessionSecurityToJSON(
...
/** @internal */
export declare const CreateChatSessionRequest$outboundSchema: z.ZodMiniType<
  CreateChatSessionRequest$Outbound,
  CreateChatSessionRequest
>;
export declare function createChatSessionRequestToJSON(
