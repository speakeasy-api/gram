...
/** @internal */
export declare const ListIntegrationsSecurity$outboundSchema: z.ZodMiniType<
  ListIntegrationsSecurity$Outbound,
  ListIntegrationsSecurity
>;
export declare function listIntegrationsSecurityToJSON(
...
/** @internal */
export declare const ListIntegrationsRequest$outboundSchema: z.ZodMiniType<
  ListIntegrationsRequest$Outbound,
  ListIntegrationsRequest
>;
export declare function listIntegrationsRequestToJSON(
