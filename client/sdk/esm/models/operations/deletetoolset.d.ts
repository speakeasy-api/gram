...
/** @internal */
export declare const DeleteToolsetSecurityOption1$outboundSchema: z.ZodMiniType<
  DeleteToolsetSecurityOption1$Outbound,
  DeleteToolsetSecurityOption1
>;
export declare function deleteToolsetSecurityOption1ToJSON(
...
/** @internal */
export declare const DeleteToolsetSecurityOption2$outboundSchema: z.ZodMiniType<
  DeleteToolsetSecurityOption2$Outbound,
  DeleteToolsetSecurityOption2
>;
export declare function deleteToolsetSecurityOption2ToJSON(
...
/** @internal */
export declare const DeleteToolsetSecurity$outboundSchema: z.ZodMiniType<
  DeleteToolsetSecurity$Outbound,
  DeleteToolsetSecurity
>;
export declare function deleteToolsetSecurityToJSON(
...
/** @internal */
export declare const DeleteToolsetRequest$outboundSchema: z.ZodMiniType<
  DeleteToolsetRequest$Outbound,
  DeleteToolsetRequest
>;
export declare function deleteToolsetRequestToJSON(
