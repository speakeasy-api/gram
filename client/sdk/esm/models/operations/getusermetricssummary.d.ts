...
/** @internal */
export declare const GetUserMetricsSummarySecurityOption1$outboundSchema: z.ZodMiniType<
  GetUserMetricsSummarySecurityOption1$Outbound,
  GetUserMetricsSummarySecurityOption1
>;
export declare function getUserMetricsSummarySecurityOption1ToJSON(
...
/** @internal */
export declare const GetUserMetricsSummarySecurityOption2$outboundSchema: z.ZodMiniType<
  GetUserMetricsSummarySecurityOption2$Outbound,
  GetUserMetricsSummarySecurityOption2
>;
export declare function getUserMetricsSummarySecurityOption2ToJSON(
...
/** @internal */
export declare const GetUserMetricsSummarySecurity$outboundSchema: z.ZodMiniType<
  GetUserMetricsSummarySecurity$Outbound,
  GetUserMetricsSummarySecurity
>;
export declare function getUserMetricsSummarySecurityToJSON(
...
/** @internal */
export declare const GetUserMetricsSummaryRequest$outboundSchema: z.ZodMiniType<
  GetUserMetricsSummaryRequest$Outbound,
  GetUserMetricsSummaryRequest
>;
export declare function getUserMetricsSummaryRequestToJSON(
