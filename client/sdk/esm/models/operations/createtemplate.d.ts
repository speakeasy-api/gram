...
/** @internal */
export declare const CreateTemplateSecurityOption1$outboundSchema: z.ZodMiniType<
  CreateTemplateSecurityOption1$Outbound,
  CreateTemplateSecurityOption1
>;
export declare function createTemplateSecurityOption1ToJSON(
...
/** @internal */
export declare const CreateTemplateSecurityOption2$outboundSchema: z.ZodMiniType<
  CreateTemplateSecurityOption2$Outbound,
  CreateTemplateSecurityOption2
>;
export declare function createTemplateSecurityOption2ToJSON(
...
/** @internal */
export declare const CreateTemplateSecurity$outboundSchema: z.ZodMiniType<
  CreateTemplateSecurity$Outbound,
  CreateTemplateSecurity
>;
export declare function createTemplateSecurityToJSON(
...
/** @internal */
export declare const CreateTemplateRequest$outboundSchema: z.ZodMiniType<
  CreateTemplateRequest$Outbound,
  CreateTemplateRequest
>;
export declare function createTemplateRequestToJSON(
