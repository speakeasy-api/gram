...
/** @internal */
export const RevokeUserSessionSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const RevokeUserSessionSecurityOption2$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const RevokeUserSessionSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const RevokeUserSessionRequest$outboundSchema = z.pipe(
  z.object({
    id: z.string(),
