...
/** @internal */
export declare const UpsertOtelForwardingConfigSecurity$outboundSchema: z.ZodMiniType<
  UpsertOtelForwardingConfigSecurity$Outbound,
  UpsertOtelForwardingConfigSecurity
>;
export declare function upsertOtelForwardingConfigSecurityToJSON(
...
/** @internal */
export declare const UpsertOtelForwardingConfigRequest$outboundSchema: z.ZodMiniType<
  UpsertOtelForwardingConfigRequest$Outbound,
  UpsertOtelForwardingConfigRequest
>;
export declare function upsertOtelForwardingConfigRequestToJSON(
