...
/** @internal */
export declare const UpdateMarketplaceSettingsSecurity$outboundSchema: z.ZodMiniType<
  UpdateMarketplaceSettingsSecurity$Outbound,
  UpdateMarketplaceSettingsSecurity
>;
export declare function updateMarketplaceSettingsSecurityToJSON(
...
/** @internal */
export declare const UpdateMarketplaceSettingsRequest$outboundSchema: z.ZodMiniType<
  UpdateMarketplaceSettingsRequest$Outbound,
  UpdateMarketplaceSettingsRequest
>;
export declare function updateMarketplaceSettingsRequestToJSON(
