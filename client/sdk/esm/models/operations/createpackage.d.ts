...
} from "../components/createpackageform.js";
...
/** @internal */
export declare const CreatePackageSecurityOption1$outboundSchema: z.ZodMiniType<
  CreatePackageSecurityOption1$Outbound,
  CreatePackageSecurityOption1
>;
export declare function createPackageSecurityOption1ToJSON(
...
/** @internal */
export declare const CreatePackageSecurityOption2$outboundSchema: z.ZodMiniType<
  CreatePackageSecurityOption2$Outbound,
  CreatePackageSecurityOption2
>;
export declare function createPackageSecurityOption2ToJSON(
...
/** @internal */
export declare const CreatePackageSecurity$outboundSchema: z.ZodMiniType<
  CreatePackageSecurity$Outbound,
  CreatePackageSecurity
>;
export declare function createPackageSecurityToJSON(
...
/** @internal */
export declare const CreatePackageRequest$outboundSchema: z.ZodMiniType<
  CreatePackageRequest$Outbound,
  CreatePackageRequest
>;
export declare function createPackageRequestToJSON(
