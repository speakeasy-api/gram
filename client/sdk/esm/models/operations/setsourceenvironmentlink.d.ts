...
/** @internal */
export declare const SetSourceEnvironmentLinkSecurity$outboundSchema: z.ZodMiniType<
  SetSourceEnvironmentLinkSecurity$Outbound,
  SetSourceEnvironmentLinkSecurity
>;
export declare function setSourceEnvironmentLinkSecurityToJSON(
...
/** @internal */
export declare const SetSourceEnvironmentLinkRequest$outboundSchema: z.ZodMiniType<
  SetSourceEnvironmentLinkRequest$Outbound,
  SetSourceEnvironmentLinkRequest
>;
export declare function setSourceEnvironmentLinkRequestToJSON(
