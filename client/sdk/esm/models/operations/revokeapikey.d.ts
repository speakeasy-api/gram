...
/** @internal */
export declare const RevokeAPIKeySecurity$outboundSchema: z.ZodMiniType<
  RevokeAPIKeySecurity$Outbound,
  RevokeAPIKeySecurity
>;
export declare function revokeAPIKeySecurityToJSON(
...
/** @internal */
export declare const RevokeAPIKeyRequest$outboundSchema: z.ZodMiniType<
  RevokeAPIKeyRequest$Outbound,
  RevokeAPIKeyRequest
>;
export declare function revokeAPIKeyRequestToJSON(
