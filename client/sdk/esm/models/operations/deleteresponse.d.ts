...
/** @internal */
export declare const DeleteResponseSecurity$outboundSchema: z.ZodMiniType<
  DeleteResponseSecurity$Outbound,
  DeleteResponseSecurity
>;
export declare function deleteResponseSecurityToJSON(
...
/** @internal */
export declare const DeleteResponseRequest$outboundSchema: z.ZodMiniType<
  DeleteResponseRequest$Outbound,
  DeleteResponseRequest
>;
export declare function deleteResponseRequestToJSON(
