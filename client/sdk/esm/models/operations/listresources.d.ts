...
/** @internal */
export declare const ListResourcesSecurity$outboundSchema: z.ZodMiniType<
  ListResourcesSecurity$Outbound,
  ListResourcesSecurity
>;
export declare function listResourcesSecurityToJSON(
...
/** @internal */
export declare const ListResourcesRequest$outboundSchema: z.ZodMiniType<
  ListResourcesRequest$Outbound,
  ListResourcesRequest
>;
export declare function listResourcesRequestToJSON(
