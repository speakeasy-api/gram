...
/** @internal */
export declare const HooksNumberCursorSecurity$outboundSchema: z.ZodMiniType<
  HooksNumberCursorSecurity$Outbound,
  HooksNumberCursorSecurity
>;
export declare function hooksNumberCursorSecurityToJSON(
...
/** @internal */
export declare const HooksNumberCursorRequest$outboundSchema: z.ZodMiniType<
  HooksNumberCursorRequest$Outbound,
  HooksNumberCursorRequest
>;
export declare function hooksNumberCursorRequestToJSON(
