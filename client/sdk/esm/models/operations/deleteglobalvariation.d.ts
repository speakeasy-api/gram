...
/** @internal */
export declare const DeleteGlobalVariationSecurityOption1$outboundSchema: z.ZodMiniType<
  DeleteGlobalVariationSecurityOption1$Outbound,
  DeleteGlobalVariationSecurityOption1
>;
export declare function deleteGlobalVariationSecurityOption1ToJSON(
...
/** @internal */
export declare const DeleteGlobalVariationSecurityOption2$outboundSchema: z.ZodMiniType<
  DeleteGlobalVariationSecurityOption2$Outbound,
  DeleteGlobalVariationSecurityOption2
>;
export declare function deleteGlobalVariationSecurityOption2ToJSON(
...
/** @internal */
export declare const DeleteGlobalVariationSecurity$outboundSchema: z.ZodMiniType<
  DeleteGlobalVariationSecurity$Outbound,
  DeleteGlobalVariationSecurity
>;
export declare function deleteGlobalVariationSecurityToJSON(
...
/** @internal */
export declare const DeleteGlobalVariationRequest$outboundSchema: z.ZodMiniType<
  DeleteGlobalVariationRequest$Outbound,
  DeleteGlobalVariationRequest
>;
export declare function deleteGlobalVariationRequestToJSON(
