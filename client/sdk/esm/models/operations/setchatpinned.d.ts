...
/** @internal */
export declare const SetChatPinnedSecurity$outboundSchema: z.ZodMiniType<
  SetChatPinnedSecurity$Outbound,
  SetChatPinnedSecurity
>;
export declare function setChatPinnedSecurityToJSON(
...
/** @internal */
export declare const SetChatPinnedRequest$outboundSchema: z.ZodMiniType<
  SetChatPinnedRequest$Outbound,
  SetChatPinnedRequest
>;
export declare function setChatPinnedRequestToJSON(
