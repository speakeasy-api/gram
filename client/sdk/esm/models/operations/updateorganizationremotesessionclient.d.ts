...
/** @internal */
export declare const UpdateOrganizationRemoteSessionClientSecurity$outboundSchema: z.ZodMiniType<
  UpdateOrganizationRemoteSessionClientSecurity$Outbound,
  UpdateOrganizationRemoteSessionClientSecurity
>;
export declare function updateOrganizationRemoteSessionClientSecurityToJSON(
  updateOrganizationRemoteSessionClientSecurity: UpdateOrganizationRemoteSessionClientSecurity,
): string;
/** @internal */
...
/** @internal */
export declare const UpdateOrganizationRemoteSessionClientRequest$outboundSchema: z.ZodMiniType<
  UpdateOrganizationRemoteSessionClientRequest$Outbound,
  UpdateOrganizationRemoteSessionClientRequest
>;
export declare function updateOrganizationRemoteSessionClientRequestToJSON(
  updateOrganizationRemoteSessionClientRequest: UpdateOrganizationRemoteSessionClientRequest,
): string;
