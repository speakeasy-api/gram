...
/** @internal */
export declare const DenyRiskPolicyBypassRequestSecurityOption1$outboundSchema: z.ZodMiniType<
  DenyRiskPolicyBypassRequestSecurityOption1$Outbound,
  DenyRiskPolicyBypassRequestSecurityOption1
>;
export declare function denyRiskPolicyBypassRequestSecurityOption1ToJSON(
  denyRiskPolicyBypassRequestSecurityOption1: DenyRiskPolicyBypassRequestSecurityOption1,
): string;
/** @internal */
...
/** @internal */
export declare const DenyRiskPolicyBypassRequestSecurityOption2$outboundSchema: z.ZodMiniType<
  DenyRiskPolicyBypassRequestSecurityOption2$Outbound,
  DenyRiskPolicyBypassRequestSecurityOption2
>;
export declare function denyRiskPolicyBypassRequestSecurityOption2ToJSON(
  denyRiskPolicyBypassRequestSecurityOption2: DenyRiskPolicyBypassRequestSecurityOption2,
): string;
/** @internal */
...
/** @internal */
export declare const DenyRiskPolicyBypassRequestSecurity$outboundSchema: z.ZodMiniType<
  DenyRiskPolicyBypassRequestSecurity$Outbound,
  DenyRiskPolicyBypassRequestSecurity
>;
export declare function denyRiskPolicyBypassRequestSecurityToJSON(
...
/** @internal */
export declare const DenyRiskPolicyBypassRequestRequest$outboundSchema: z.ZodMiniType<
  DenyRiskPolicyBypassRequestRequest$Outbound,
  DenyRiskPolicyBypassRequestRequest
>;
export declare function denyRiskPolicyBypassRequestRequestToJSON(
