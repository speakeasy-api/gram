...
/** @internal */
export declare const FetchOpenAPIv3FromURLSecurityOption1$outboundSchema: z.ZodMiniType<
  FetchOpenAPIv3FromURLSecurityOption1$Outbound,
  FetchOpenAPIv3FromURLSecurityOption1
>;
export declare function fetchOpenAPIv3FromURLSecurityOption1ToJSON(
...
/** @internal */
export declare const FetchOpenAPIv3FromURLSecurityOption2$outboundSchema: z.ZodMiniType<
  FetchOpenAPIv3FromURLSecurityOption2$Outbound,
  FetchOpenAPIv3FromURLSecurityOption2
>;
export declare function fetchOpenAPIv3FromURLSecurityOption2ToJSON(
...
/** @internal */
export declare const FetchOpenAPIv3FromURLSecurity$outboundSchema: z.ZodMiniType<
  FetchOpenAPIv3FromURLSecurity$Outbound,
  FetchOpenAPIv3FromURLSecurity
>;
export declare function fetchOpenAPIv3FromURLSecurityToJSON(
...
/** @internal */
export declare const FetchOpenAPIv3FromURLRequest$outboundSchema: z.ZodMiniType<
  FetchOpenAPIv3FromURLRequest$Outbound,
  FetchOpenAPIv3FromURLRequest
>;
export declare function fetchOpenAPIv3FromURLRequestToJSON(
