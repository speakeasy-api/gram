...
/** @internal */
export const DeleteCustomDetectionRuleSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const DeleteCustomDetectionRuleSecurityOption2$outboundSchema = z.pipe(
  z.object({
    projectSlugHeaderGramProject: z.string(),
...
/** @internal */
export const DeleteCustomDetectionRuleSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const DeleteCustomDetectionRuleRequest$outboundSchema = z.pipe(
  z.object({
