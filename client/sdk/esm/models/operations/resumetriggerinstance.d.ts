...
/** @internal */
export declare const ResumeTriggerInstanceSecurity$outboundSchema: z.ZodMiniType<
  ResumeTriggerInstanceSecurity$Outbound,
  ResumeTriggerInstanceSecurity
>;
export declare function resumeTriggerInstanceSecurityToJSON(
...
/** @internal */
export declare const ResumeTriggerInstanceRequest$outboundSchema: z.ZodMiniType<
  ResumeTriggerInstanceRequest$Outbound,
  ResumeTriggerInstanceRequest
>;
export declare function resumeTriggerInstanceRequestToJSON(
