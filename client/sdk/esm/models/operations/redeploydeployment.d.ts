...
/** @internal */
export declare const RedeployDeploymentSecurityOption1$outboundSchema: z.ZodMiniType<
  RedeployDeploymentSecurityOption1$Outbound,
  RedeployDeploymentSecurityOption1
>;
export declare function redeployDeploymentSecurityOption1ToJSON(
...
/** @internal */
export declare const RedeployDeploymentSecurityOption2$outboundSchema: z.ZodMiniType<
  RedeployDeploymentSecurityOption2$Outbound,
  RedeployDeploymentSecurityOption2
>;
export declare function redeployDeploymentSecurityOption2ToJSON(
...
/** @internal */
export declare const RedeployDeploymentSecurity$outboundSchema: z.ZodMiniType<
  RedeployDeploymentSecurity$Outbound,
  RedeployDeploymentSecurity
>;
export declare function redeployDeploymentSecurityToJSON(
...
/** @internal */
export declare const RedeployDeploymentRequest$outboundSchema: z.ZodMiniType<
  RedeployDeploymentRequest$Outbound,
  RedeployDeploymentRequest
>;
export declare function redeployDeploymentRequestToJSON(
