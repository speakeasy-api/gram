...
/** @internal */
export declare const GetProjectMetricsSummarySecurityOption1$outboundSchema: z.ZodMiniType<
  GetProjectMetricsSummarySecurityOption1$Outbound,
  GetProjectMetricsSummarySecurityOption1
>;
export declare function getProjectMetricsSummarySecurityOption1ToJSON(
  getProjectMetricsSummarySecurityOption1: GetProjectMetricsSummarySecurityOption1,
): string;
/** @internal */
...
/** @internal */
export declare const GetProjectMetricsSummarySecurityOption2$outboundSchema: z.ZodMiniType<
  GetProjectMetricsSummarySecurityOption2$Outbound,
  GetProjectMetricsSummarySecurityOption2
>;
export declare function getProjectMetricsSummarySecurityOption2ToJSON(
  getProjectMetricsSummarySecurityOption2: GetProjectMetricsSummarySecurityOption2,
): string;
/** @internal */
...
/** @internal */
export declare const GetProjectMetricsSummarySecurity$outboundSchema: z.ZodMiniType<
  GetProjectMetricsSummarySecurity$Outbound,
  GetProjectMetricsSummarySecurity
>;
export declare function getProjectMetricsSummarySecurityToJSON(
...
/** @internal */
export declare const GetProjectMetricsSummaryRequest$outboundSchema: z.ZodMiniType<
  GetProjectMetricsSummaryRequest$Outbound,
  GetProjectMetricsSummaryRequest
>;
export declare function getProjectMetricsSummaryRequestToJSON(
