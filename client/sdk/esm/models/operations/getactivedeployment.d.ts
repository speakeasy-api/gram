...
/** @internal */
export declare const GetActiveDeploymentSecurityOption1$outboundSchema: z.ZodMiniType<
  GetActiveDeploymentSecurityOption1$Outbound,
  GetActiveDeploymentSecurityOption1
>;
export declare function getActiveDeploymentSecurityOption1ToJSON(
...
/** @internal */
export declare const GetActiveDeploymentSecurityOption2$outboundSchema: z.ZodMiniType<
  GetActiveDeploymentSecurityOption2$Outbound,
  GetActiveDeploymentSecurityOption2
>;
export declare function getActiveDeploymentSecurityOption2ToJSON(
...
/** @internal */
export declare const GetActiveDeploymentSecurity$outboundSchema: z.ZodMiniType<
  GetActiveDeploymentSecurity$Outbound,
  GetActiveDeploymentSecurity
>;
export declare function getActiveDeploymentSecurityToJSON(
...
/** @internal */
export declare const GetActiveDeploymentRequest$outboundSchema: z.ZodMiniType<
  GetActiveDeploymentRequest$Outbound,
  GetActiveDeploymentRequest
>;
export declare function getActiveDeploymentRequestToJSON(
