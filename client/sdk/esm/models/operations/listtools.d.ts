...
/** @internal */
export declare const ListToolsSecurity$outboundSchema: z.ZodMiniType<ListToolsSecurity$Outbound, ListToolsSecurity>;
export declare function listToolsSecurityToJSON(listToolsSecurity: ListToolsSecurity): string;
/** @internal */
...
/** @internal */
export declare const ListToolsRequest$outboundSchema: z.ZodMiniType<ListToolsRequest$Outbound, ListToolsRequest>;
export declare function listToolsRequestToJSON(listToolsRequest: ListToolsRequest): string;
