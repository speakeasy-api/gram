...
/** @internal */
export declare const ListTemplatesSecurityOption1$outboundSchema: z.ZodMiniType<
  ListTemplatesSecurityOption1$Outbound,
  ListTemplatesSecurityOption1
>;
export declare function listTemplatesSecurityOption1ToJSON(
...
/** @internal */
export declare const ListTemplatesSecurityOption2$outboundSchema: z.ZodMiniType<
  ListTemplatesSecurityOption2$Outbound,
  ListTemplatesSecurityOption2
>;
export declare function listTemplatesSecurityOption2ToJSON(
...
/** @internal */
export declare const ListTemplatesSecurity$outboundSchema: z.ZodMiniType<
  ListTemplatesSecurity$Outbound,
  ListTemplatesSecurity
>;
export declare function listTemplatesSecurityToJSON(
...
/** @internal */
export declare const ListTemplatesRequest$outboundSchema: z.ZodMiniType<
  ListTemplatesRequest$Outbound,
  ListTemplatesRequest
>;
export declare function listTemplatesRequestToJSON(
