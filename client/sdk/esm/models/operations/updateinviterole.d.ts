...
/** @internal */
export declare const UpdateInviteRoleSecurity$outboundSchema: z.ZodMiniType<
  UpdateInviteRoleSecurity$Outbound,
  UpdateInviteRoleSecurity
>;
export declare function updateInviteRoleSecurityToJSON(
...
/** @internal */
export declare const UpdateInviteRoleRequest$outboundSchema: z.ZodMiniType<
  UpdateInviteRoleRequest$Outbound,
  UpdateInviteRoleRequest
>;
export declare function updateInviteRoleRequestToJSON(
