...
/** @internal */
export declare const SendAssistantMessageSecurity$outboundSchema: z.ZodMiniType<
  SendAssistantMessageSecurity$Outbound,
  SendAssistantMessageSecurity
>;
export declare function sendAssistantMessageSecurityToJSON(
...
/** @internal */
export declare const SendAssistantMessageRequest$outboundSchema: z.ZodMiniType<
  SendAssistantMessageRequest$Outbound,
  SendAssistantMessageRequest
>;
export declare function sendAssistantMessageRequestToJSON(
