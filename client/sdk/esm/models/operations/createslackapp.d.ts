...
/** @internal */
export declare const CreateSlackAppSecurity$outboundSchema: z.ZodMiniType<
  CreateSlackAppSecurity$Outbound,
  CreateSlackAppSecurity
>;
export declare function createSlackAppSecurityToJSON(
...
/** @internal */
export declare const CreateSlackAppRequest$outboundSchema: z.ZodMiniType<
  CreateSlackAppRequest$Outbound,
  CreateSlackAppRequest
>;
export declare function createSlackAppRequestToJSON(
