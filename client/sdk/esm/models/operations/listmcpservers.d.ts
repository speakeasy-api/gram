...
/** @internal */
export declare const ListMcpServersSecurityOption1$outboundSchema: z.ZodMiniType<
  ListMcpServersSecurityOption1$Outbound,
  ListMcpServersSecurityOption1
>;
export declare function listMcpServersSecurityOption1ToJSON(
...
/** @internal */
export declare const ListMcpServersSecurityOption2$outboundSchema: z.ZodMiniType<
  ListMcpServersSecurityOption2$Outbound,
  ListMcpServersSecurityOption2
>;
export declare function listMcpServersSecurityOption2ToJSON(
...
/** @internal */
export declare const ListMcpServersSecurity$outboundSchema: z.ZodMiniType<
  ListMcpServersSecurity$Outbound,
  ListMcpServersSecurity
>;
export declare function listMcpServersSecurityToJSON(
...
/** @internal */
export declare const ListMcpServersRequest$outboundSchema: z.ZodMiniType<
  ListMcpServersRequest$Outbound,
  ListMcpServersRequest
>;
export declare function listMcpServersRequestToJSON(
