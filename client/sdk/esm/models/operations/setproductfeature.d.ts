...
/** @internal */
export declare const SetProductFeatureSecurity$outboundSchema: z.ZodMiniType<
  SetProductFeatureSecurity$Outbound,
  SetProductFeatureSecurity
>;
export declare function setProductFeatureSecurityToJSON(
...
/** @internal */
export declare const SetProductFeatureRequest$outboundSchema: z.ZodMiniType<
  SetProductFeatureRequest$Outbound,
  SetProductFeatureRequest
>;
export declare function setProductFeatureRequestToJSON(
