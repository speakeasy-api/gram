...
/** @internal */
export declare const SubmitRiskBlockFeedbackSecurity$outboundSchema: z.ZodMiniType<
  SubmitRiskBlockFeedbackSecurity$Outbound,
  SubmitRiskBlockFeedbackSecurity
>;
export declare function submitRiskBlockFeedbackSecurityToJSON(
...
/** @internal */
export declare const SubmitRiskBlockFeedbackRequest$outboundSchema: z.ZodMiniType<
  SubmitRiskBlockFeedbackRequest$Outbound,
  SubmitRiskBlockFeedbackRequest
>;
export declare function submitRiskBlockFeedbackRequestToJSON(
