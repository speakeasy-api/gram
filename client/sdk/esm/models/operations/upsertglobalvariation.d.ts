...
/** @internal */
export declare const UpsertGlobalVariationSecurityOption1$outboundSchema: z.ZodMiniType<
  UpsertGlobalVariationSecurityOption1$Outbound,
  UpsertGlobalVariationSecurityOption1
>;
export declare function upsertGlobalVariationSecurityOption1ToJSON(
...
/** @internal */
export declare const UpsertGlobalVariationSecurityOption2$outboundSchema: z.ZodMiniType<
  UpsertGlobalVariationSecurityOption2$Outbound,
  UpsertGlobalVariationSecurityOption2
>;
export declare function upsertGlobalVariationSecurityOption2ToJSON(
...
/** @internal */
export declare const UpsertGlobalVariationSecurity$outboundSchema: z.ZodMiniType<
  UpsertGlobalVariationSecurity$Outbound,
  UpsertGlobalVariationSecurity
>;
export declare function upsertGlobalVariationSecurityToJSON(
...
/** @internal */
export declare const UpsertGlobalVariationRequest$outboundSchema: z.ZodMiniType<
  UpsertGlobalVariationRequest$Outbound,
  UpsertGlobalVariationRequest
>;
export declare function upsertGlobalVariationRequestToJSON(
