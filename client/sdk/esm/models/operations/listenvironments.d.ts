...
/** @internal */
export declare const ListEnvironmentsSecurity$outboundSchema: z.ZodMiniType<
  ListEnvironmentsSecurity$Outbound,
  ListEnvironmentsSecurity
>;
export declare function listEnvironmentsSecurityToJSON(
...
/** @internal */
export declare const ListEnvironmentsRequest$outboundSchema: z.ZodMiniType<
  ListEnvironmentsRequest$Outbound,
  ListEnvironmentsRequest
>;
export declare function listEnvironmentsRequestToJSON(
