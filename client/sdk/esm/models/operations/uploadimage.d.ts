...
/** @internal */
export declare const UploadImageSecurityOption1$outboundSchema: z.ZodMiniType<
  UploadImageSecurityOption1$Outbound,
  UploadImageSecurityOption1
>;
export declare function uploadImageSecurityOption1ToJSON(
...
/** @internal */
export declare const UploadImageSecurityOption2$outboundSchema: z.ZodMiniType<
  UploadImageSecurityOption2$Outbound,
  UploadImageSecurityOption2
>;
export declare function uploadImageSecurityOption2ToJSON(
...
/** @internal */
export declare const UploadImageSecurity$outboundSchema: z.ZodMiniType<
  UploadImageSecurity$Outbound,
  UploadImageSecurity
>;
export declare function uploadImageSecurityToJSON(
...
/** @internal */
export declare const UploadImageRequest$outboundSchema: z.ZodMiniType<
  UploadImageRequest$Outbound,
  UploadImageRequest
>;
export declare function uploadImageRequestToJSON(
