...
/** @internal */
export const ListMCPCatalogSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const ListMCPCatalogSecurityOption2$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const ListMCPCatalogSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const ListMCPCatalogRequest$outboundSchema = z.pipe(
  z.object({
