...
/** @internal */
export declare const ListProjectsSecurity$outboundSchema: z.ZodMiniType<
  ListProjectsSecurity$Outbound,
  ListProjectsSecurity
>;
export declare function listProjectsSecurityToJSON(
...
/** @internal */
export declare const ListProjectsRequest$outboundSchema: z.ZodMiniType<
  ListProjectsRequest$Outbound,
  ListProjectsRequest
>;
export declare function listProjectsRequestToJSON(
