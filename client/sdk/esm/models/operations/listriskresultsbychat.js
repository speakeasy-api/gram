...
/** @internal */
export const ListRiskResultsByChatSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const ListRiskResultsByChatSecurityOption2$outboundSchema = z.pipe(
  z.object({
    projectSlugHeaderGramProject: z.string(),
...
/** @internal */
export const ListRiskResultsByChatSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const ListRiskResultsByChatRequest$outboundSchema = z.pipe(
  z.object({
