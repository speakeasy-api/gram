...
/** @internal */
export declare const CliAuthAuthorizeSecurity$outboundSchema: z.ZodMiniType<
  CliAuthAuthorizeSecurity$Outbound,
  CliAuthAuthorizeSecurity
>;
export declare function cliAuthAuthorizeSecurityToJSON(
...
/** @internal */
export declare const CliAuthAuthorizeRequest$outboundSchema: z.ZodMiniType<
  CliAuthAuthorizeRequest$Outbound,
  CliAuthAuthorizeRequest
>;
export declare function cliAuthAuthorizeRequestToJSON(
