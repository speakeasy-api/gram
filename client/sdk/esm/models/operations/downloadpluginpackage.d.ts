...
/** @internal */
export declare const DownloadPluginPackageSecurity$outboundSchema: z.ZodMiniType<
  DownloadPluginPackageSecurity$Outbound,
  DownloadPluginPackageSecurity
>;
export declare function downloadPluginPackageSecurityToJSON(
  downloadPluginPackageSecurity: DownloadPluginPackageSecurity,
): string;
/** @internal */
export declare const QueryParamPlatform$outboundSchema: z.ZodMiniEnum<
...
/** @internal */
export declare const DownloadPluginPackageRequest$outboundSchema: z.ZodMiniType<
  DownloadPluginPackageRequest$Outbound,
  DownloadPluginPackageRequest
>;
export declare function downloadPluginPackageRequestToJSON(
  downloadPluginPackageRequest: DownloadPluginPackageRequest,
): string;
/** @internal */
export declare const DownloadPluginPackageResponse$inboundSchema: z.ZodMiniType<
  DownloadPluginPackageResponse,
  unknown
>;
export declare function downloadPluginPackageResponseFromJSON(
  jsonString: string,
