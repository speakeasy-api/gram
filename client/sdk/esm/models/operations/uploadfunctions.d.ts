...
/** @internal */
export declare const UploadFunctionsSecurityOption1$outboundSchema: z.ZodMiniType<
  UploadFunctionsSecurityOption1$Outbound,
  UploadFunctionsSecurityOption1
>;
export declare function uploadFunctionsSecurityOption1ToJSON(
...
/** @internal */
export declare const UploadFunctionsSecurityOption2$outboundSchema: z.ZodMiniType<
  UploadFunctionsSecurityOption2$Outbound,
  UploadFunctionsSecurityOption2
>;
export declare function uploadFunctionsSecurityOption2ToJSON(
...
/** @internal */
export declare const UploadFunctionsSecurity$outboundSchema: z.ZodMiniType<
  UploadFunctionsSecurity$Outbound,
  UploadFunctionsSecurity
>;
export declare function uploadFunctionsSecurityToJSON(
...
/** @internal */
export declare const UploadFunctionsRequest$outboundSchema: z.ZodMiniType<
  UploadFunctionsRequest$Outbound,
  UploadFunctionsRequest
>;
export declare function uploadFunctionsRequestToJSON(
