...
/** @internal */
export declare const GetRiskPolicySecurityOption1$outboundSchema: z.ZodMiniType<
  GetRiskPolicySecurityOption1$Outbound,
  GetRiskPolicySecurityOption1
>;
export declare function getRiskPolicySecurityOption1ToJSON(
...
/** @internal */
export declare const GetRiskPolicySecurityOption2$outboundSchema: z.ZodMiniType<
  GetRiskPolicySecurityOption2$Outbound,
  GetRiskPolicySecurityOption2
>;
export declare function getRiskPolicySecurityOption2ToJSON(
...
/** @internal */
export declare const GetRiskPolicySecurity$outboundSchema: z.ZodMiniType<
  GetRiskPolicySecurity$Outbound,
  GetRiskPolicySecurity
>;
export declare function getRiskPolicySecurityToJSON(
...
/** @internal */
export declare const GetRiskPolicyRequest$outboundSchema: z.ZodMiniType<
  GetRiskPolicyRequest$Outbound,
  GetRiskPolicyRequest
>;
export declare function getRiskPolicyRequestToJSON(
