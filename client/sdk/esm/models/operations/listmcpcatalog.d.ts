...
/** @internal */
export declare const ListMCPCatalogSecurityOption1$outboundSchema: z.ZodMiniType<
  ListMCPCatalogSecurityOption1$Outbound,
  ListMCPCatalogSecurityOption1
>;
export declare function listMCPCatalogSecurityOption1ToJSON(
...
/** @internal */
export declare const ListMCPCatalogSecurityOption2$outboundSchema: z.ZodMiniType<
  ListMCPCatalogSecurityOption2$Outbound,
  ListMCPCatalogSecurityOption2
>;
export declare function listMCPCatalogSecurityOption2ToJSON(
...
/** @internal */
export declare const ListMCPCatalogSecurity$outboundSchema: z.ZodMiniType<
  ListMCPCatalogSecurity$Outbound,
  ListMCPCatalogSecurity
>;
export declare function listMCPCatalogSecurityToJSON(
...
/** @internal */
export declare const ListMCPCatalogRequest$outboundSchema: z.ZodMiniType<
  ListMCPCatalogRequest$Outbound,
  ListMCPCatalogRequest
>;
export declare function listMCPCatalogRequestToJSON(
