...
/** @internal */
export const ListChatsSecurityOption1$outboundSchema = z.pipe(z.object({
...
export function listChatsSecurityOption1ToJSON(listChatsSecurityOption1) {
    return JSON.stringify(ListChatsSecurityOption1$outboundSchema.parse(listChatsSecurityOption1));
}
/** @internal */
export const ListChatsSecurityOption2$outboundSchema = z.pipe(z.object({
...
export function listChatsSecurityOption2ToJSON(listChatsSecurityOption2) {
    return JSON.stringify(ListChatsSecurityOption2$outboundSchema.parse(listChatsSecurityOption2));
}
/** @internal */
export const ListChatsSecurity$outboundSchema = z.pipe(z.object({
...
export function listChatsSecurityToJSON(listChatsSecurity) {
    return JSON.stringify(ListChatsSecurity$outboundSchema.parse(listChatsSecurity));
}
/** @internal */
...
/** @internal */
export const ListChatsRequest$outboundSchema = z.pipe(z.object({
...
export function listChatsRequestToJSON(listChatsRequest) {
    return JSON.stringify(ListChatsRequest$outboundSchema.parse(listChatsRequest));
}
