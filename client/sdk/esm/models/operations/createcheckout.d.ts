...
/** @internal */
export declare const CreateCheckoutSecurity$outboundSchema: z.ZodMiniType<
  CreateCheckoutSecurity$Outbound,
  CreateCheckoutSecurity
>;
export declare function createCheckoutSecurityToJSON(
...
/** @internal */
export declare const CreateCheckoutRequest$outboundSchema: z.ZodMiniType<
  CreateCheckoutRequest$Outbound,
  CreateCheckoutRequest
>;
export declare function createCheckoutRequestToJSON(
