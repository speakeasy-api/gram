...
/** @internal */
export declare const UpdateMemberRoleSecurity$outboundSchema: z.ZodMiniType<
  UpdateMemberRoleSecurity$Outbound,
  UpdateMemberRoleSecurity
>;
export declare function updateMemberRoleSecurityToJSON(
...
/** @internal */
export declare const UpdateMemberRoleRequest$outboundSchema: z.ZodMiniType<
  UpdateMemberRoleRequest$Outbound,
  UpdateMemberRoleRequest
>;
export declare function updateMemberRoleRequestToJSON(
