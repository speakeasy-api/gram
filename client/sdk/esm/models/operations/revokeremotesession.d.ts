...
/** @internal */
export declare const RevokeRemoteSessionSecurityOption1$outboundSchema: z.ZodMiniType<
  RevokeRemoteSessionSecurityOption1$Outbound,
  RevokeRemoteSessionSecurityOption1
>;
export declare function revokeRemoteSessionSecurityOption1ToJSON(
...
/** @internal */
export declare const RevokeRemoteSessionSecurityOption2$outboundSchema: z.ZodMiniType<
  RevokeRemoteSessionSecurityOption2$Outbound,
  RevokeRemoteSessionSecurityOption2
>;
export declare function revokeRemoteSessionSecurityOption2ToJSON(
...
/** @internal */
export declare const RevokeRemoteSessionSecurity$outboundSchema: z.ZodMiniType<
  RevokeRemoteSessionSecurity$Outbound,
  RevokeRemoteSessionSecurity
>;
export declare function revokeRemoteSessionSecurityToJSON(
...
/** @internal */
export declare const RevokeRemoteSessionRequest$outboundSchema: z.ZodMiniType<
  RevokeRemoteSessionRequest$Outbound,
  RevokeRemoteSessionRequest
>;
export declare function revokeRemoteSessionRequestToJSON(
