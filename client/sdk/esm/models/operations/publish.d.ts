...
/** @internal */
export declare const PublishSecurityOption1$outboundSchema: z.ZodMiniType<
  PublishSecurityOption1$Outbound,
  PublishSecurityOption1
>;
export declare function publishSecurityOption1ToJSON(
...
/** @internal */
export declare const PublishSecurityOption2$outboundSchema: z.ZodMiniType<
  PublishSecurityOption2$Outbound,
  PublishSecurityOption2
>;
export declare function publishSecurityOption2ToJSON(
...
/** @internal */
export declare const PublishSecurity$outboundSchema: z.ZodMiniType<
  PublishSecurity$Outbound,
  PublishSecurity
>;
export declare function publishSecurityToJSON(
...
/** @internal */
export declare const PublishRequest$outboundSchema: z.ZodMiniType<
  PublishRequest$Outbound,
  PublishRequest
>;
export declare function publishRequestToJSON(
