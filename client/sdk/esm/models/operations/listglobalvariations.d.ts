...
/** @internal */
export declare const ListGlobalVariationsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListGlobalVariationsSecurityOption1$Outbound,
  ListGlobalVariationsSecurityOption1
>;
export declare function listGlobalVariationsSecurityOption1ToJSON(
...
/** @internal */
export declare const ListGlobalVariationsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListGlobalVariationsSecurityOption2$Outbound,
  ListGlobalVariationsSecurityOption2
>;
export declare function listGlobalVariationsSecurityOption2ToJSON(
...
/** @internal */
export declare const ListGlobalVariationsSecurity$outboundSchema: z.ZodMiniType<
  ListGlobalVariationsSecurity$Outbound,
  ListGlobalVariationsSecurity
>;
export declare function listGlobalVariationsSecurityToJSON(
...
/** @internal */
export declare const ListGlobalVariationsRequest$outboundSchema: z.ZodMiniType<
  ListGlobalVariationsRequest$Outbound,
  ListGlobalVariationsRequest
>;
export declare function listGlobalVariationsRequestToJSON(
