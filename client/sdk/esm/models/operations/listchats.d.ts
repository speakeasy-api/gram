...
/** @internal */
export declare const ListChatsSecurityOption1$outboundSchema: z.ZodMiniType<
  ListChatsSecurityOption1$Outbound,
  ListChatsSecurityOption1
>;
export declare function listChatsSecurityOption1ToJSON(
...
/** @internal */
export declare const ListChatsSecurityOption2$outboundSchema: z.ZodMiniType<
  ListChatsSecurityOption2$Outbound,
  ListChatsSecurityOption2
>;
export declare function listChatsSecurityOption2ToJSON(
...
/** @internal */
export declare const ListChatsSecurity$outboundSchema: z.ZodMiniType<
  ListChatsSecurity$Outbound,
  ListChatsSecurity
>;
export declare function listChatsSecurityToJSON(
  listChatsSecurity: ListChatsSecurity,
): string;
/** @internal */
export declare const HasRisk$outboundSchema: z.ZodMiniEnum<typeof HasRisk>;
/** @internal */
export declare const AccountType$outboundSchema: z.ZodMiniEnum<
  typeof AccountType
>;
/** @internal */
...
/** @internal */
export declare const ListChatsRequest$outboundSchema: z.ZodMiniType<
  ListChatsRequest$Outbound,
  ListChatsRequest
>;
export declare function listChatsRequestToJSON(
