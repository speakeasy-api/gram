...
/** @internal */
export declare const CreateToolsetSecurityOption1$outboundSchema: z.ZodMiniType<
  CreateToolsetSecurityOption1$Outbound,
  CreateToolsetSecurityOption1
>;
export declare function createToolsetSecurityOption1ToJSON(
...
/** @internal */
export declare const CreateToolsetSecurityOption2$outboundSchema: z.ZodMiniType<
  CreateToolsetSecurityOption2$Outbound,
  CreateToolsetSecurityOption2
>;
export declare function createToolsetSecurityOption2ToJSON(
...
/** @internal */
export declare const CreateToolsetSecurity$outboundSchema: z.ZodMiniType<
  CreateToolsetSecurity$Outbound,
  CreateToolsetSecurity
>;
export declare function createToolsetSecurityToJSON(
...
/** @internal */
export declare const CreateToolsetRequest$outboundSchema: z.ZodMiniType<
  CreateToolsetRequest$Outbound,
  CreateToolsetRequest
>;
export declare function createToolsetRequestToJSON(
