...
/** @internal */
export const DenyRiskPolicyBypassRequestSecurityOption1$outboundSchema = z.pipe(
  z.object({
...
/** @internal */
export const DenyRiskPolicyBypassRequestSecurityOption2$outboundSchema = z.pipe(
  z.object({
    projectSlugHeaderGramProject: z.string(),
...
/** @internal */
export const DenyRiskPolicyBypassRequestSecurity$outboundSchema = z.pipe(
  z.object({
    option1: z.optional(
...
/** @internal */
export const DenyRiskPolicyBypassRequestRequest$outboundSchema = z.pipe(
  z.object({
