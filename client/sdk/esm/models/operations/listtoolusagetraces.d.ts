...
/** @internal */
export declare const ListToolUsageTracesSecurityOption1$outboundSchema: z.ZodMiniType<
  ListToolUsageTracesSecurityOption1$Outbound,
  ListToolUsageTracesSecurityOption1
>;
export declare function listToolUsageTracesSecurityOption1ToJSON(
...
/** @internal */
export declare const ListToolUsageTracesSecurityOption2$outboundSchema: z.ZodMiniType<
  ListToolUsageTracesSecurityOption2$Outbound,
  ListToolUsageTracesSecurityOption2
>;
export declare function listToolUsageTracesSecurityOption2ToJSON(
...
/** @internal */
export declare const ListToolUsageTracesSecurity$outboundSchema: z.ZodMiniType<
  ListToolUsageTracesSecurity$Outbound,
  ListToolUsageTracesSecurity
>;
export declare function listToolUsageTracesSecurityToJSON(
...
/** @internal */
export declare const ListToolUsageTracesRequest$outboundSchema: z.ZodMiniType<
  ListToolUsageTracesRequest$Outbound,
  ListToolUsageTracesRequest
>;
export declare function listToolUsageTracesRequestToJSON(
