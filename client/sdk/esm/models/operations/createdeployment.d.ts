...
/** @internal */
export declare const CreateDeploymentSecurityOption1$outboundSchema: z.ZodMiniType<
  CreateDeploymentSecurityOption1$Outbound,
  CreateDeploymentSecurityOption1
>;
export declare function createDeploymentSecurityOption1ToJSON(
...
/** @internal */
export declare const CreateDeploymentSecurityOption2$outboundSchema: z.ZodMiniType<
  CreateDeploymentSecurityOption2$Outbound,
  CreateDeploymentSecurityOption2
>;
export declare function createDeploymentSecurityOption2ToJSON(
...
/** @internal */
export declare const CreateDeploymentSecurity$outboundSchema: z.ZodMiniType<
  CreateDeploymentSecurity$Outbound,
  CreateDeploymentSecurity
>;
export declare function createDeploymentSecurityToJSON(
...
/** @internal */
export declare const CreateDeploymentRequest$outboundSchema: z.ZodMiniType<
  CreateDeploymentRequest$Outbound,
  CreateDeploymentRequest
>;
export declare function createDeploymentRequestToJSON(
