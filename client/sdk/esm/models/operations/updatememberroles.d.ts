...
/** @internal */
export declare const UpdateMemberRolesSecurity$outboundSchema: z.ZodMiniType<
  UpdateMemberRolesSecurity$Outbound,
  UpdateMemberRolesSecurity
>;
export declare function updateMemberRolesSecurityToJSON(
...
/** @internal */
export declare const UpdateMemberRolesRequest$outboundSchema: z.ZodMiniType<
  UpdateMemberRolesRequest$Outbound,
  UpdateMemberRolesRequest
>;
export declare function updateMemberRolesRequestToJSON(
