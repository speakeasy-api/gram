...
/** @internal */
export declare const DeleteCollectionSecurity$outboundSchema: z.ZodMiniType<DeleteCollectionSecurity$Outbound, DeleteCollectionSecurity>;
export declare function deleteCollectionSecurityToJSON(deleteCollectionSecurity: DeleteCollectionSecurity): string;
/** @internal */
