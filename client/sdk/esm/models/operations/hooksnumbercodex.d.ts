...
/** @internal */
export declare const HooksNumberCodexSecurity$outboundSchema: z.ZodMiniType<
  HooksNumberCodexSecurity$Outbound,
  HooksNumberCodexSecurity
>;
export declare function hooksNumberCodexSecurityToJSON(
...
/** @internal */
export declare const HooksNumberCodexRequest$outboundSchema: z.ZodMiniType<
  HooksNumberCodexRequest$Outbound,
  HooksNumberCodexRequest
>;
export declare function hooksNumberCodexRequestToJSON(
