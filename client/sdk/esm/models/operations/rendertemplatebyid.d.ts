...
/** @internal */
export declare const RenderTemplateByIDSecurityOption1$outboundSchema: z.ZodMiniType<
  RenderTemplateByIDSecurityOption1$Outbound,
  RenderTemplateByIDSecurityOption1
>;
export declare function renderTemplateByIDSecurityOption1ToJSON(
...
/** @internal */
export declare const RenderTemplateByIDSecurityOption2$outboundSchema: z.ZodMiniType<
  RenderTemplateByIDSecurityOption2$Outbound,
  RenderTemplateByIDSecurityOption2
>;
export declare function renderTemplateByIDSecurityOption2ToJSON(
...
/** @internal */
export declare const RenderTemplateByIDSecurityOption3$outboundSchema: z.ZodMiniType<
  RenderTemplateByIDSecurityOption3$Outbound,
  RenderTemplateByIDSecurityOption3
>;
export declare function renderTemplateByIDSecurityOption3ToJSON(
...
/** @internal */
export declare const RenderTemplateByIDSecurity$outboundSchema: z.ZodMiniType<
  RenderTemplateByIDSecurity$Outbound,
  RenderTemplateByIDSecurity
>;
export declare function renderTemplateByIDSecurityToJSON(
...
/** @internal */
export declare const RenderTemplateByIDRequest$outboundSchema: z.ZodMiniType<
  RenderTemplateByIDRequest$Outbound,
  RenderTemplateByIDRequest
>;
export declare function renderTemplateByIDRequestToJSON(
