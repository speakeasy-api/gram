...
/** @internal */
export declare const ListAuditLogsSecurity$outboundSchema: z.ZodMiniType<
  ListAuditLogsSecurity$Outbound,
  ListAuditLogsSecurity
>;
export declare function listAuditLogsSecurityToJSON(
...
/** @internal */
export declare const ListAuditLogsRequest$outboundSchema: z.ZodMiniType<
  ListAuditLogsRequest$Outbound,
  ListAuditLogsRequest
>;
export declare function listAuditLogsRequestToJSON(
  listAuditLogsRequest: ListAuditLogsRequest,
): string;
/** @internal */
export declare const ListAuditLogsResponse$inboundSchema: z.ZodMiniType<
  ListAuditLogsResponse,
  unknown
>;
export declare function listAuditLogsResponseFromJSON(
  jsonString: string,
