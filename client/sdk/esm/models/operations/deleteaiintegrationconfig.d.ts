...
/** @internal */
export declare const DeleteAIIntegrationConfigSecurity$outboundSchema: z.ZodMiniType<
  DeleteAIIntegrationConfigSecurity$Outbound,
  DeleteAIIntegrationConfigSecurity
>;
export declare function deleteAIIntegrationConfigSecurityToJSON(
...
/** @internal */
export declare const DeleteAIIntegrationConfigRequest$outboundSchema: z.ZodMiniType<
  DeleteAIIntegrationConfigRequest$Outbound,
  DeleteAIIntegrationConfigRequest
>;
export declare function deleteAIIntegrationConfigRequestToJSON(
