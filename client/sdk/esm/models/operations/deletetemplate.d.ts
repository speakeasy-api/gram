...
/** @internal */
export declare const DeleteTemplateSecurityOption1$outboundSchema: z.ZodMiniType<
  DeleteTemplateSecurityOption1$Outbound,
  DeleteTemplateSecurityOption1
>;
export declare function deleteTemplateSecurityOption1ToJSON(
...
/** @internal */
export declare const DeleteTemplateSecurityOption2$outboundSchema: z.ZodMiniType<
  DeleteTemplateSecurityOption2$Outbound,
  DeleteTemplateSecurityOption2
>;
export declare function deleteTemplateSecurityOption2ToJSON(
...
/** @internal */
export declare const DeleteTemplateSecurity$outboundSchema: z.ZodMiniType<
  DeleteTemplateSecurity$Outbound,
  DeleteTemplateSecurity
>;
export declare function deleteTemplateSecurityToJSON(
...
/** @internal */
export declare const DeleteTemplateRequest$outboundSchema: z.ZodMiniType<
  DeleteTemplateRequest$Outbound,
  DeleteTemplateRequest
>;
export declare function deleteTemplateRequestToJSON(
