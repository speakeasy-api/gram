...
/** @internal */
export declare const CloneEnvironmentSecurity$outboundSchema: z.ZodMiniType<
  CloneEnvironmentSecurity$Outbound,
  CloneEnvironmentSecurity
>;
export declare function cloneEnvironmentSecurityToJSON(
...
/** @internal */
export declare const CloneEnvironmentRequest$outboundSchema: z.ZodMiniType<
  CloneEnvironmentRequest$Outbound,
  CloneEnvironmentRequest
>;
export declare function cloneEnvironmentRequestToJSON(
