...
/** @internal */
export declare const ResolveChallengeSecurity$outboundSchema: z.ZodMiniType<
  ResolveChallengeSecurity$Outbound,
  ResolveChallengeSecurity
>;
export declare function resolveChallengeSecurityToJSON(
...
/** @internal */
export declare const ResolveChallengeRequest$outboundSchema: z.ZodMiniType<
  ResolveChallengeRequest$Outbound,
  ResolveChallengeRequest
>;
export declare function resolveChallengeRequestToJSON(
