...
export declare function createPageIterator<V>(
  page: V & {
    next: Paginator<V>;
  },
  halt: (v: V) => boolean,
 ...
 */
export declare function haltIterator<V extends object>(
  v: V,
 ...
 */
export declare function unwrapResultIterator<V, PageState>(
