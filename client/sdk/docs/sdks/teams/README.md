...
import { teamsAcceptInvite } from "@gram/client/funcs/teamsAcceptInvite.js";
...
async function run() {
  const res = await teamsAcceptInvite(gram, {
    serveChatAttachmentSignedForm: {
      token: "<value>",
    },
  });
  if (res.ok) {
    ...
    console.log("teamsAcceptInvite failed:", res.error);
  }
}
...
} from "@gram/client/react-query/teamsAcceptInvite.js";
```
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.AcceptTeamInviteRequest](../../models/operations/acceptteaminviterequest.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.AcceptTeamInviteSecurity](../../models/operations/acceptteaminvitesecurity.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
...
**Promise\<[components.AcceptInviteResult](../../models/components/acceptinviteresult.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getTeamInviteInfo" method="get" path="/rpc/teams.getInviteInfo" -->
```typescript
import { Gram } from "@gram/client";
...
async function run() {
  const result = await gram.teams.getInviteInfo({
    token: "<value>",
  });
...
```typescript
import { GramCore } from "@gram/client/core.js";
import { teamsGetInviteInfo } from "@gram/client/funcs/teamsGetInviteInfo.js";
...
async function run() {
  const res = await teamsGetInviteInfo(gram, {
    token: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("teamsGetInviteInfo failed:", res.error);
  }
}
...
import {
  ...
  invalidateGetTeamInviteInfo,
  invalidateAllGetTeamInviteInfo,
} from "@gram/client/react-query/teamsGetInviteInfo.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetTeamInviteInfoRequest](../../models/operations/getteaminviteinforequest.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.GetTeamInviteInfoSecurity](../../models/operations/getteaminviteinfosecurity.md)                                                                                   | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.InviteInfoResult](../../models/components/inviteinforesult.md)\>**
