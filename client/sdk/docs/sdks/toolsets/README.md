...
* [updateSecurityVariableDisplayName](#updatesecurityvariabledisplayname) - updateSecurityVariableDisplayName toolsets
...
## updateSecurityVariableDisplayName

Update the display name of a security variable for user-friendly presentation

### Example Usage

<!-- UsageSnippet language="typescript" operationID="updateSecurityVariableDisplayName" method="post" path="/rpc/toolsets.updateSecurityVariableDisplayName" -->
```typescript
import { Gram } from "@gram/client";
...
async function run() {
  const result = await gram.toolsets.updateSecurityVariableDisplayName({
    updateSecurityVariableDisplayNameRequestBody: {
      displayName: "Linwood.Macejkovic78",
      securityKey: "<value>",
      toolsetSlug: "<value>",
    },
  });
...
```typescript
import { GramCore } from "@gram/client/core.js";
import { toolsetsUpdateSecurityVariableDisplayName } from "@gram/client/funcs/toolsetsUpdateSecurityVariableDisplayName.js";
...
async function run() {
  const res = await toolsetsUpdateSecurityVariableDisplayName(gram, {
    updateSecurityVariableDisplayNameRequestBody: {
      displayName: "Linwood.Macejkovic78",
      securityKey: "<value>",
      toolsetSlug: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("toolsetsUpdateSecurityVariableDisplayName failed:", res.error);
  }
}
...
} from "@gram/client/react-query/toolsetsUpdateSecurityVariableDisplayName.js";
```
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpdateSecurityVariableDisplayNameRequest](../../models/operations/updatesecurityvariabledisplaynamerequest.md)                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.UpdateSecurityVariableDisplayNameSecurity](../../models/operations/updatesecurityvariabledisplaynamesecurity.md)                                                   | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.SecurityVariable](../../models/components/securityvariable.md)\>**
