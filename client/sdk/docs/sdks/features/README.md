...
- [get](#get) - getProductFeatures features
...
<!-- UsageSnippet language="typescript" operationID="getProductFeatures" method="get" path="/rpc/productFeatures.get" -->
...
async function run() {
  const result = await gram.features.get();
...
import { featuresGet } from "@gram/client/funcs/featuresGet.js";
...
async function run() {
  const res = await featuresGet(gram);
  if (res.ok) {
...
import {
  ...
  invalidateProductFeatures,
  invalidateAllProductFeatures,
} from "@gram/client/react-query/featuresGet.js";
```
...
| ---------------------- | ---------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.GetProductFeaturesRequest](../../models/operations/getproductfeaturesrequest.md)   | :heavy_check_mark: | The request object to use for the request.                                                                                                                                     |
| `security`             | [operations.GetProductFeaturesSecurity](../../models/operations/getproductfeaturessecurity.md) | :heavy_check_mark: | The security requirements to use for the request.                                                                                                                              |
...
**Promise\<[components.GetProductFeaturesResponseBody](../../models/components/getproductfeaturesresponsebody.md)\>**
