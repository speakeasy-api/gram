...
```typescript
import { ListGlobalRemoteSessionClientsResponse } from "@gram/client/models/operations/listglobalremotesessionclients.js";

let value: ListGlobalRemoteSessionClientsResponse = {
  result: {
    items: [
      {
        clientId: "<id>",
