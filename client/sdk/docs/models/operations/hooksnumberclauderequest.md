...
| ------------------- | ---------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------- |
| `gramKey`           | _string_                                                                     | :heavy_minus_sign: | Optional API key for plugin-driven attribution.                                                            |
| `gramProject`       | _string_                                                                     | :heavy_minus_sign: | Optional project slug for plugin-driven attribution.                                                       |
