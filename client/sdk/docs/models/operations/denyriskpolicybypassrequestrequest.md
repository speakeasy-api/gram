...
```typescript
import { DenyRiskPolicyBypassRequestRequest } from "@gram/client/models/operations/denyriskpolicybypassrequest.js";

let value: DenyRiskPolicyBypassRequestRequest = {
  riskIDRequestBody: {
