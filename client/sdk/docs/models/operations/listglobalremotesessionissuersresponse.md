...
```typescript
import { ListGlobalRemoteSessionIssuersResponse } from "@gram/client/models/operations/listglobalremotesessionissuers.js";

let value: ListGlobalRemoteSessionIssuersResponse = {
  result: {
    items: [
      {
