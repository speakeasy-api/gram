...
| -------------------- | ------------------------------------------------------------------------ | ------------------ | -------------------------------------------------------------------------------- |
| `activeServersCount` | _number_                                                                 | :heavy_check_mark: | Number of MCP servers with at least one tool call in the time period             |
| `activeUsersCount`   | _number_                                                                 | :heavy_check_mark: | Number of unique users with activity in the time period                          |
