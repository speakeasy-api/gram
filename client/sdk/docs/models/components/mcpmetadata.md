...
| `externalDocumentationText`                                                                   | *string*                                                                                      | :heavy_minus_sign:                                                                            | Custom text for the external documentation link button                                        |
| `externalDocumentationUrl`                                                                    | *string*                                                                                      | :heavy_minus_sign:                                                                            | A link to external documentation for the MCP install page                                     |
| `headerDisplayNames`                                                                          | Record<string, *string*>                                                                      | :heavy_minus_sign:                                                                            | Maps security scheme keys to user-friendly display names                                      |
