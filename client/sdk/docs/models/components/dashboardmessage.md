...
| ----------- | --------------------------------------------------------------------------------------------- | ------------------ | -------------------------------------------------------------------------------- |
| `content`   | _string_                                                                                      | :heavy_check_mark: | Message content (Markdown).                                                      |
...
| `id`        | _string_                                                                                      | :heavy_check_mark: | Message id.                                                                      |
| `role`      | [components.DashboardMessageRole](../../models/components/dashboardmessagerole.md)            | :heavy_check_mark: | Message author.                                                                  |
| `seq`       | _number_                                                                                      | :heavy_check_mark: | Monotonic cursor; pass the latest value as after_seq to poll for newer messages. |
