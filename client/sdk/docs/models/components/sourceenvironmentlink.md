...
```typescript
import { SourceEnvironmentLink } from "@gram/client/models/components/sourceenvironmentlink.js";
...
| `id`            | _string_                                                                                                 | :heavy_check_mark: | The ID of the source environment link                   |
