...
| `impersonateServiceAccount` | _string_                                                                                      | :heavy_minus_sign: | The service account Gram impersonates (impersonation approach, or the WIF hop). |
...
| `wifPoolId`                 | _string_                                                                                      | :heavy_minus_sign: | Workload Identity Federation pool ID.                                           |
| `wifProjectNumber`          | _string_                                                                                      | :heavy_minus_sign: | GCP project number backing the WIF pool.                                        |
| `wifProviderId`             | _string_                                                                                      | :heavy_minus_sign: | Workload Identity Federation provider ID.                                       |
