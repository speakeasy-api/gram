...
| --------------------- | --------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------- |
| `clientName`          | _string_                                                                                      | :heavy_minus_sign: | Name of the MCP client that established the session, if known.                        |
...
| `id`                  | _string_                                                                                      | :heavy_check_mark: | The user_session id.                                                                  |
| `issuerSlug`          | _string_                                                                                      | :heavy_check_mark: | Slug of the user_session_issuer that gated this session.                              |
| `jti`                 | _string_                                                                                      | :heavy_check_mark: | Current access-token JTI; used by the revocation path.                                |
...
| `subjectDisplayName`  | _string_                                                                                      | :heavy_minus_sign: | Resolved human-readable name of the subject, if known.                                |
| `subjectType`         | _string_                                                                                      | :heavy_check_mark: | Subject kind: 'user', 'apikey', or 'anonymous'.                                       |
...
| `userSessionIssuerId` | _string_                                                                                      | :heavy_check_mark: | The issuing user_session_issuer id.                                                   |
