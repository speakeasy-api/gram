...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `activeConnectionCount`                                                                       | *number*                                                                                      | :heavy_check_mark:                                                                            | Number of active tunnel connections currently visible in Redis                                |
| `activeConsumerSessionCount`                                                                  | *number*                                                                                      | :heavy_check_mark:                                                                            | Total MCP consumer sessions currently pinned across active tunnel connections                 |
| `agentVersion`                                                                                | *string*                                                                                      | :heavy_minus_sign:                                                                            | Most recent agent version reported by the tunnel                                              |
...
| `keyPrefix`                                                                                   | *string*                                                                                      | :heavy_check_mark:                                                                            | Non-secret prefix of the tunnel key                                                           |
...
| `name`                                                                                        | *string*                                                                                      | :heavy_check_mark:                                                                            | Human-readable name for the tunneled MCP server                                               |
| `projectId`                                                                                   | *string*                                                                                      | :heavy_check_mark:                                                                            | The project ID this tunneled MCP server belongs to                                            |
