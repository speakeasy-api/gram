...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `eventCount`                                                         | *number*                                                             | :heavy_check_mark:                                                   | Total number of hook events for this server                          |
...
| `serverName`                                                         | *string*                                                             | :heavy_check_mark:                                                   | Server name (extracted from tool name, or 'local' for non-MCP tools) |
| `successCount`                                                       | *number*                                                             | :heavy_check_mark:                                                   | Number of successful tool completions (PostToolUse events)           |
| `uniqueTools`                                                        | *number*                                                             | :heavy_check_mark:                                                   | Number of unique tools used for this server                          |