...
```typescript
import { AllowedOrigin } from "@gram/client/models/components/allowedorigin.js";
...
| `id`        | _string_                                                                                      | :heavy_check_mark: | The ID of the allowed origin                |
| `origin`    | _string_                                                                                      | :heavy_check_mark: | The origin URL                              |
