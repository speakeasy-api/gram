...
```typescript
import { EnvironmentEntry } from "@gram/client/models/components/environmententry.js";
...
| `value`     | _string_                                                                                      | :heavy_check_mark: | Redacted values of the environment variable |
