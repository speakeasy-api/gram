...
| `id`            | _string_                                                                                      | :heavy_check_mark: | The review ID.                                                           |
| `policyId`      | _string_                                                                                      | :heavy_check_mark: | The prompt-based policy the verdict belongs to.                          |
| `policyVersion` | _number_                                                                                      | :heavy_check_mark: | The policy version in effect when the verdict was recorded (provenance). |
| `reviewedBy`    | _string_                                                                                      | :heavy_check_mark: | User id of the reviewer who recorded the verdict.                        |
