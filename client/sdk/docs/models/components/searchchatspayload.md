...
```typescript
import { SearchChatsPayload } from "@gram/client/models/components/searchchatspayload.js";
...
| `sort`                                                                                 | [components.SearchChatsPayloadSort](../../models/components/searchchatspayloadsort.md) | :heavy_minus_sign:                                                                     | Sort order                                                                             |