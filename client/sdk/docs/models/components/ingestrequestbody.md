...
| `raw`           | _any_                                                                        | :heavy_minus_sign: | Original provider payload for debugging. The backend does not use this for feature behavior.        |
| `schemaVersion` | _string_                                                                     | :heavy_check_mark: | Contract version. The current version is hook.ingest.v1.                                            |
