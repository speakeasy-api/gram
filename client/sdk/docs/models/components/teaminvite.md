...
| `email`     | _string_                                                                                      | :heavy_check_mark: | The invited email address            |
...
| `id`        | _string_                                                                                      | :heavy_check_mark: | The invite ID                        |
| `invitedBy` | _string_                                                                                      | :heavy_check_mark: | Name of the user who sent the invite |
