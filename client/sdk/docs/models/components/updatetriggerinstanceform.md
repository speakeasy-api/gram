...
| --------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------- |
| `config`        | Record<string, _any_>                                                                                            | :heavy_minus_sign: | The trigger config payload.           |
| `environmentId` | _string_                                                                                                         | :heavy_minus_sign: | The linked environment ID.            |
| `id`            | _string_                                                                                                         | :heavy_check_mark: | The trigger instance ID.              |
| `name`          | _string_                                                                                                         | :heavy_minus_sign: | The trigger instance name.            |
...
| `targetDisplay` | _string_                                                                                                         | :heavy_minus_sign: | The user-facing target display value. |
...
| `targetRef`     | _string_                                                                                                         | :heavy_minus_sign: | The opaque target reference.          |
