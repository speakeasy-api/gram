...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `clientId`                                                                                    | *string*                                                                                      | :heavy_check_mark:                                                                            | DCR-issued client_id.                                                                         |
...
| `clientName`                                                                                  | *string*                                                                                      | :heavy_check_mark:                                                                            | Display name from the registration request.                                                   |
...
| `redirectUris`                                                                                | *string*[]                                                                                    | :heavy_check_mark:                                                                            | Validated on every /authorize.                                                                |
| `updatedAt`                                                                                   | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_check_mark:                                                                            | N/A                                                                                           |
| `userSessionIssuerId`                                                                         | *string*                                                                                      | :heavy_check_mark:                                                                            | The owning user_session_issuer id.                                                            |