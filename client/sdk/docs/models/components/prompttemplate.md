...
| `historyId`     | _string_                                                                                      | :heavy_check_mark: | The revision tree ID for the prompt template                                           |
...
| `predecessorId` | _string_                                                                                      | :heavy_minus_sign: | The previous version of the prompt template to use as predecessor                      |
| `projectId`     | _string_                                                                                      | :heavy_check_mark: | The ID of the project                                                                  |
| `prompt`        | _string_                                                                                      | :heavy_check_mark: | The template content                                                                   |
...
| `toolsHint`     | _string_[]                                                                                    | :heavy_check_mark: | The suggested tool names associated with the prompt template                           |
