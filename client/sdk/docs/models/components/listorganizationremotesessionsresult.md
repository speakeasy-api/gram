...
```typescript
import { ListOrganizationRemoteSessionsResult } from "@gram/client/models/components/listorganizationremotesessionsresult.js";

let value: ListOrganizationRemoteSessionsResult = {
  items: [
    {
