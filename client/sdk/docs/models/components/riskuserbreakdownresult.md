...
| `externalUserId` | _string_                                                                                      | :heavy_check_mark: | External user the breakdown is scoped to.                              |
| `findings`       | _number_                                                                                      | :heavy_check_mark: | Total findings for this user in the window.                            |
