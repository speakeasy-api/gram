...
| ---------- | --------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------ |
| `category` | _string_                                                                                      | :heavy_check_mark: | Category the breakdown is scoped to.                         |
...
| `total`    | _number_                                                                                      | :heavy_check_mark: | Total findings across all rules in this category and window. |
