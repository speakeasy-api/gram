...
| `memoryMib`                                                                                         | *number*                                                                                            | :heavy_minus_sign:                                                                                  | The amount of memory in MiB to allocate for the function (1 MiB = 1024 * 1024 bytes).               |
...
| `scale`                                                                                             | *number*                                                                                            | :heavy_minus_sign:                                                                                  | The number of instances to scale the function to.                                                   |
