...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `challengeCount`                                                                              | *number*                                                                                      | :heavy_check_mark:                                                                            | Number of individual challenges in this bucket.                                               |
| `challengeIds`                                                                                | *string*[]                                                                                    | :heavy_check_mark:                                                                            | IDs of all challenges in this bucket.                                                         |
...
| `id`                                                                                          | *string*                                                                                      | :heavy_check_mark:                                                                            | ID of the most recent challenge in the bucket.                                                |
