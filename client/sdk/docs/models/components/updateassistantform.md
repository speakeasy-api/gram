...
| `instructions`   | _string_                                                                                     | :heavy_minus_sign: | The system instructions for the assistant.                                    |
| `maxConcurrency` | _number_                                                                                     | :heavy_minus_sign: | Maximum active warm runtimes.                                                 |
...
| `model`          | _string_                                                                                     | :heavy_minus_sign: | The model identifier used by the assistant.                                   |
| `name`           | _string_                                                                                     | :heavy_minus_sign: | The assistant name.                                                           |
...
| `warmTtlSeconds` | _number_                                                                                     | :heavy_minus_sign: | Warm runtime TTL in seconds.                                                  |
