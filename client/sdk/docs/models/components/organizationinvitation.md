...
| `id`                                                                                          | *string*                                                                                      | :heavy_check_mark:                                                                            | WorkOS invitation ID.                                                                         |
| `inviterUserId`                                                                               | *string*                                                                                      | :heavy_minus_sign:                                                                            | Gram user ID of the inviter, when known.                                                      |
...
| `roleSlug`                                                                                    | *string*                                                                                      | :heavy_minus_sign:                                                                            | WorkOS role slug assigned when the invite is accepted.                                        |
