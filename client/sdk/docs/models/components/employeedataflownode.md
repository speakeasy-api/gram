...
| ------------- | ---------------------------------------------------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------- |
| `id`          | _string_                                                         | :heavy_check_mark: | Stable node ID                                                                                                  |
| `label`       | _string_                                                         | :heavy_check_mark: | Display label                                                                                                   |
...
| `totalCalls`  | _number_                                                         | :heavy_check_mark: | Total calls involving this node                                                                                 |
