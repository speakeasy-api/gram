...
| `policyName` | _string_                                                                                      | :heavy_check_mark: | Name of the risk policy that blocked the call.                 |
| `projectId`  | _string_                                                                                      | :heavy_check_mark: | The project the block belongs to.                              |
| `reason`     | _string_                                                                                      | :heavy_check_mark: | Human-readable reason the tool call was blocked.               |
| `toolName`   | _string_                                                                                      | :heavy_minus_sign: | Name of the tool that was blocked, when known.                 |
