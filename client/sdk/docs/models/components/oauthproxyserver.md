...
```typescript
import { OAuthProxyServer } from "@gram/client/models/components/oauthproxyserver.js";
...
| `id`                  | _string_                                                                                      | :heavy_check_mark: | The ID of the OAuth proxy server                                |
...
| `projectId`           | _string_                                                                                      | :heavy_check_mark: | The project ID this OAuth proxy server belongs to               |
