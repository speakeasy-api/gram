...
| `hasActiveSubscription`                                                        | *boolean*                                                                      | :heavy_check_mark:                                                             | Whether the organization has an active billing subscription                    |
...
| `whitelisted`                                                                  | *boolean*                                                                      | :heavy_check_mark:                                                             | Whether the organization is whitelisted to access the platform                 |