...
| ---------------- | ------------------------------------------------------------------------------------------------------ | ------------------ | -------------------------------------------------------------------------------------------------------------- |
| `chatId`         | _string_                                                                                               | :heavy_check_mark: | The chat session that was replayed.                                                                            |
| `flagged`        | _boolean_                                                                                              | :heavy_check_mark: | True when the guardrail flagged at least one in-scope message.                                                 |
| `judgedCount`    | _number_                                                                                               | :heavy_check_mark: | Number of in-scope messages the judge evaluated.                                                               |
| `totalCostUsd`   | _number_                                                                                               | :heavy_check_mark: | Total OpenRouter cost across in-scope judge calls, in USD.                                                     |
| `totalLatencyMs` | _number_                                                                                               | :heavy_check_mark: | Aggregate judge latency overhead across in-scope messages, computed as the sum of per-message judge latencies. |
