...
| --------------------- | ---------------------------------------------------- | ------------------ | -------------------------------------------------------------------------------- |
| `acceptInvitationUrl` | _string_                                             | :heavy_check_mark: | URL to complete acceptance in WorkOS (may be empty when not actionable).         |
| `email`               | _string_                                             | :heavy_check_mark: | Invitee email address.                                                           |
| `organizationName`    | _string_                                             | :heavy_check_mark: | Gram organization display name when the org is linked in Gram; empty if unknown. |
