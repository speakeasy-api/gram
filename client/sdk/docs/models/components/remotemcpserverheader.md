...
| `id`                                                                                          | *string*                                                                                      | :heavy_check_mark:                                                                            | The ID of the header                                                                          |
| `isRequired`                                                                                  | *boolean*                                                                                     | :heavy_check_mark:                                                                            | Whether the header is required                                                                |
| `isSecret`                                                                                    | *boolean*                                                                                     | :heavy_check_mark:                                                                            | Whether the header value is a secret                                                          |
...
| `value`                                                                                       | *string*                                                                                      | :heavy_minus_sign:                                                                            | The header value (redacted if secret)                                                         |
| `valueFromRequestHeader`                                                                      | *string*                                                                                      | :heavy_minus_sign:                                                                            | Name of the inbound request header to pass through                                            |