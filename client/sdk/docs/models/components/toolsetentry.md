...
| `editingMode`                                                                                      | *string*                                                                                           | :heavy_check_mark:                                                                                 | The editing mode for this toolset: 'iteration' (direct edits) or 'staging' (explicit releases)     |
...
| `parentToolsetId`                                                                                  | *string*                                                                                           | :heavy_minus_sign:                                                                                 | The ID of the parent toolset if this is a staging toolset                                          |
