...
| `id`                                                                                          | *string*                                                                                      | :heavy_check_mark:                                                                            | The ID of the remote MCP server                                                               |
| `name`                                                                                        | *string*                                                                                      | :heavy_minus_sign:                                                                            | Optional human-readable name for the remote MCP server                                        |
| `projectId`                                                                                   | *string*                                                                                      | :heavy_check_mark:                                                                            | The project ID this remote MCP server belongs to                                              |
| `slug`                                                                                        | *string*                                                                                      | :heavy_minus_sign:                                                                            | URL-friendly slug derived from the URL and ID.                                                |
| `transportType`                                                                               | *string*                                                                                      | :heavy_check_mark:                                                                            | The transport type for the remote MCP server                                                  |
