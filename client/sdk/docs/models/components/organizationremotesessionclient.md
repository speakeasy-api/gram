...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| `activeSessionCount`                                                                  | *number*                                                                              | :heavy_check_mark:                                                                    | Number of non-deleted (active) remote_sessions minted against this client.            |
...
| `mcpServerCount`                                                                      | *number*                                                                              | :heavy_check_mark:                                                                    | Number of non-deleted MCP servers attached to this client (via user_session_issuers). |