...
```typescript
import { SearchToolCallsPayload } from "@gram/client/models/components/searchtoolcallspayload.js";
...
| `sort`                                                                                         | [components.SearchToolCallsPayloadSort](../../models/components/searchtoolcallspayloadsort.md) | :heavy_minus_sign:                                                                             | Sort order                                                                                     |