...
```typescript
import { ExternalOAuthServer } from "@gram/client/models/components/externaloauthserver.js";
...
| `id`        | _string_                                                                                      | :heavy_check_mark: | The ID of the external OAuth server                             |
| `metadata`  | _any_                                                                                         | :heavy_check_mark: | The metadata for the external OAuth server                      |
| `projectId` | _string_                                                                                      | :heavy_check_mark: | The project ID this external OAuth server belongs to            |
