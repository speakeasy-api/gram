...
| `enabled`                                                                                     | *boolean*                                                                                     | :heavy_check_mark:                                                                            | Whether forwarding to this destination is currently active.                                   |
| `endpointUrl`                                                                                 | *string*                                                                                      | :heavy_check_mark:                                                                            | URL each OTEL payload is POSTed to.                                                           |
...
| `organizationId`                                                                              | *string*                                                                                      | :heavy_check_mark:                                                                            | Organization the destination belongs to.                                                      |
| `projectId`                                                                                   | *string*                                                                                      | :heavy_minus_sign:                                                                            | Project the destination belongs to. Omitted for org-wide destinations.                        |
