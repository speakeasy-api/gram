...
```typescript
import { SearchChatsFilter } from "@gram/client/models/components/searchchatsfilter.js";
...
| `externalUserId` | _string_                                                                                      | :heavy_minus_sign: | External user ID filter                                      |                      |
...
| `userId`         | _string_                                                                                      | :heavy_minus_sign: | User ID filter                                               |                      |
