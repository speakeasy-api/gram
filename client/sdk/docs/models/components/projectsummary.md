...
| `avgChatResolutionScore`                                         | *number*                                                         | :heavy_check_mark:                                               | Average chat resolution score (0-100)                            |
...
| `chatResolutionAbandoned`                                        | *number*                                                         | :heavy_check_mark:                                               | Chats abandoned by user                                          |
| `chatResolutionFailure`                                          | *number*                                                         | :heavy_check_mark:                                               | Chats that failed to resolve                                     |
| `chatResolutionPartial`                                          | *number*                                                         | :heavy_check_mark:                                               | Chats partially resolved                                         |
| `chatResolutionSuccess`                                          | *number*                                                         | :heavy_check_mark:                                               | Chats resolved successfully                                      |
