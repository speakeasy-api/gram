...
| `latestUnixNano`                                                                                               | *string*                                                                                                       | :heavy_check_mark:                                                                                             | Highest time_unix_nano in this batch. Pass back as since_unix_nano on the next poll.                           |
| `totalCount`                                                                                                   | *number*                                                                                                       | :heavy_check_mark:                                                                                             | Total events received with time_unix_nano greater than since_unix_nano. May exceed len(events) when truncated. |