...
| --------------------- | -------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------- |
| `codeChallenge`       | _string_                                                                         | :heavy_check_mark: | PKCE code challenge: base64url(sha256(code_verifier)).                                                        |
...
| `projectSlug`         | _string_                                                                         | :heavy_minus_sign: | Optional project slug to scope the minted key to. Defaults to the org's default (first) project when omitted. |
