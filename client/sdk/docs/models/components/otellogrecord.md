...
| `observedTimeUnixNano`   | _string_                                                               | :heavy_minus_sign: | Observed timestamp in nanoseconds         |
| `spanId`                 | _string_                                                               | :heavy_minus_sign: | Span ID                                   |
| `timeUnixNano`           | _string_                                                               | :heavy_minus_sign: | Timestamp in nanoseconds since Unix epoch |
| `traceId`                | _string_                                                               | :heavy_minus_sign: | Trace ID                                  |
