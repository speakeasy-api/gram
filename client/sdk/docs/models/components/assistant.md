...
| `createdByUserId` | _string_                                                                                      | :heavy_minus_sign: | The ID of the user who created the assistant, if known.                       |
...
| `maxConcurrency`  | _number_                                                                                      | :heavy_check_mark: | Maximum active warm runtimes for the assistant.                               |
...
| `projectId`       | _string_                                                                                      | :heavy_check_mark: | The project ID owning the assistant.                                          |
...
| `warmTtlSeconds`  | _number_                                                                                      | :heavy_check_mark: | Warm runtime TTL in seconds.                                                  |
