...
| -------------- | --------------------------------------------------------------------------------------------- | ------------------ | --------------------------------------------------------------- |
| `assistantId`  | _string_                                                                                      | :heavy_check_mark: | The assistant ID owning the memory.                             |
| `content`      | _string_                                                                                      | :heavy_check_mark: | The memory content.                                             |
...
| `supersedesId` | _string_                                                                                      | :heavy_minus_sign: | The ID of the memory this one supersedes, if any.               |
| `tags`         | _string_[]                                                                                    | :heavy_check_mark: | Tags associated with the memory.                                |
