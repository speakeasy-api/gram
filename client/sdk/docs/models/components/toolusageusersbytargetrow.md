...
| -------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------- |
| `eventCount`   | _number_                                                                                                         | :heavy_check_mark: | Total number of tool usage events for the target and user identity  |
| `failureCount` | _number_                                                                                                         | :heavy_check_mark: | Number of failed tool usage events for the target and user identity |
