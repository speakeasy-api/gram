...
| [`gram-risk-v1-finding-bq-writer`](../infra/proto/gram/risk/v1/finding_bq_writer.proto) | `gram-risk-v1-finding`           | 1m  | —                               | —                                                                                 |
...
- Subscription `gram-risk-v1-finding-bq-writer` has no consumer in `server/` or `pystreams/`.
