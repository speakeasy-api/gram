...
| [`gram-risk-v1-judge-shadow-analyzer`](../infra/proto/gram/risk/v1/judge_shadow_analyzer.proto) | `gram-risk-v1-judge-shadow-analysis` | 1m | `gram-risk-v1-judge-shadow-analyzer-dlq` | [`server/cmd/gram/streams.go`](../server/cmd/gram/streams.go) |
