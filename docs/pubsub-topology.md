...
flowchart LR
  ...
  p10[/"📤<br/>server/internal/outbox/webhooks.go"/]:::go
  p10 --> t_gram_webhooks_v1_event
  ...
  c20[\"📥<br/>server/cmd/gram/streams.go<br/>svixRelayHandler"\]:::go
  s_gram_webhooks_v1_svix_relay --> c20
```
