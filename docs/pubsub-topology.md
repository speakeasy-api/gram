...
flowchart LR
  ...
  t_gram_risk_v1_judge_shadow_analysis(["gram-risk-v1-judge-shadow-analysis<br/>(topic)"]):::topic
  t_gram_risk_v1_judge_shadow_analyzer_dlq(["gram-risk-v1-judge-shadow-analyzer-dlq<br/>(dlq)"]):::dlq
  ...
  s_gram_networkingress_v1_reconciler["gram-networkingress-v1-reconciler<br/>(sub)"]:::sub
  s_gram_otel_v1_agent_event_log_ch_writer["gram-otel-v1-agent-event-log-ch-writer<br/>(sub)"]:::sub
  s_gram_otel_v1_agent_event_span_ch_writer["gram-otel-v1-agent-event-span-ch-writer<br/>(sub)"]:::sub
  ...
  s_gram_otel_v1_metric_relay["gram-otel-v1-metric-relay<br/>(sub)"]:::sub
  ...
  s_gram_risk_v1_judge_shadow_analyzer["gram-risk-v1-judge-shadow-analyzer<br/>(sub)"]:::sub
  ...
  p11[/"📤<br/>server/internal/scanners/judgeshadow/publisher.go"/]:::go
  p11 --> t_gram_risk_v1_judge_shadow_analysis
  p12[/"📤<br/>server/internal/background/activities/risk_analysis/scan_llm.go"/]:::go
  p12 --> t_gram_risk_v1_llm_analysis
  p13[/"📤<br/>server/internal/risk/enforcereply/dispatch.go"/]:::go
  p13 --> t_gram_risk_v1_llm_enforcement
  p14[/"📤<br/>server/internal/background/activities/risk_analysis/scan_presidio.go"/]:::go
  p14 --> t_gram_risk_v1_presidio_analysis
  p15[/"📤<br/>server/internal/risk/enforcereply/dispatch.go"/]:::go
  p15 --> t_gram_risk_v1_presidio_enforcement
  p16[/"📤<br/>server/internal/background/activities/risk_analysis/scan_prompt_injection.go"/]:::go
  p16 --> t_gram_risk_v1_prompt_injection_analysis
  p17[/"📤<br/>server/internal/background/activities/risk_analysis/prompt_judge_batch.go"/]:::go
  p17 --> t_gram_risk_v1_prompt_policy_analysis
  p18[/"📤<br/>server/internal/telemetry/log_publisher.go"/]:::go
  p18 --> t_gram_telemetry_v1_log_record
  p19[/"📤<br/>server/internal/outbox/webhooks.go"/]:::go
  p19 --> t_gram_webhooks_v1_event
  ...
  t_gram_risk_v1_judge_shadow_analysis --> s_gram_risk_v1_judge_shadow_analyzer
  s_gram_risk_v1_judge_shadow_analyzer -. dead-letter .-> t_gram_risk_v1_judge_shadow_analyzer_dlq
  ...
  c20[\"📥<br/>server/cmd/gram/streams.go<br/>authz.NewChallengeCHWriter<br/>(batch)"\]:::go
  s_gram_authz_v1_challenge_ch_writer --> c20
  c21[\"📥<br/>server/cmd/gram/streams.go<br/>metering.NewMeterReadingCHWriter<br/>(batch)"\]:::go
  s_gram_metering_v1_meter_reading_ch_writer --> c21
  c22[\"📥<br/>server/cmd/gram/streams.go<br/>metering.NewMeterReadingStripeExporter"\]:::go
  s_gram_metering_v1_meter_reading_stripe_exporter --> c22
  c23[\"📥<br/>server/cmd/gram/streams.go<br/>networkingress.NewReconcileHandler<br/>(batch)"\]:::go
  s_gram_networkingress_v1_reconciler --> c23
  c24[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewAgentEventLogCHWriter<br/>(batch)"\]:::go
  s_gram_otel_v1_agent_event_log_ch_writer --> c24
  c25[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewAgentEventSpanCHWriter<br/>(batch)"\]:::go
  s_gram_otel_v1_agent_event_span_ch_writer --> c25
  c26[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewLogTransformHandler"\]:::go
  s_gram_otel_v1_inbound_log_record_transformer --> c26
  c27[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewMetricTransformHandler"\]:::go
  s_gram_otel_v1_inbound_metric_transformer --> c27
  c28[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewSpanTransformHandler"\]:::go
  s_gram_otel_v1_inbound_span_transformer --> c28
  c29[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewLogEventCHWriter<br/>(batch)"\]:::go
  s_gram_otel_v1_log_event_ch_writer --> c29
  c30[\"📥<br/>server/cmd/gram/streams.go<br/>logRelayHandler<br/>(batch)"\]:::go
  s_gram_otel_v1_log_relay --> c30
  c31[\"📥<br/>server/cmd/gram/streams.go<br/>metricRelayHandler<br/>(batch)"\]:::go
  s_gram_otel_v1_metric_relay --> c31
  c32[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewSpanEventCHWriter<br/>(batch)"\]:::go
  s_gram_otel_v1_span_event_ch_writer --> c32
  c33[\"📥<br/>server/cmd/gram/streams.go<br/>spanRelayHandler<br/>(batch)"\]:::go
  s_gram_otel_v1_span_relay --> c33
  c34[\"📥<br/>server/cmd/gram/streams.go<br/>ping.NewHandler"\]:::go
  s_gram_ping_v2_processor --> c34
  c35[\"📥<br/>pystreams/src/pystreams/cmd/multi.py<br/>PingHandler.handle"\]:::python
  s_gram_ping_v2_py_processor --> c35
  c36[\"📥<br/>server/cmd/gram/streams.go<br/>customRulesHandler"\]:::go
  s_gram_risk_v1_custom_rules_analyzer --> c36
  c37[\"📥<br/>server/cmd/gram/streams.go<br/>risk.NewFindingCHWriter<br/>(batch)"\]:::go
  s_gram_risk_v1_finding_ch_writer --> c37
  c38[\"📥<br/>server/cmd/gram/streams.go<br/>riskFindingRelayHandler<br/>(batch)"\]:::go
  s_gram_risk_v1_finding_otel_relay --> c38
  c39[\"📥<br/>server/cmd/gram/streams.go<br/>gitleaksHandler"\]:::go
  s_gram_risk_v1_gitleaks_analyzer --> c39
  c40[\"📥<br/>server/cmd/gram/streams.go<br/>gitleaksEnforceHandler"\]:::go
  s_gram_risk_v1_gitleaks_enforcer --> c40
  c41[\"📥<br/>server/cmd/gram/streams.go<br/>shadowHandler"\]:::go
  s_gram_risk_v1_judge_shadow_analyzer --> c41
  c42[\"📥<br/>server/cmd/gram/streams.go<br/>llmAnalyzerHandler"\]:::go
  s_gram_risk_v1_llm_analyzer --> c42
  c43[\"📥<br/>server/cmd/gram/streams.go<br/>llmanalyzer.NewEnforceHandler"\]:::go
  s_gram_risk_v1_llm_enforcer --> c43
  c44[\"📥<br/>pystreams/src/pystreams/cmd/multi.py<br/>presidio_handler.handle"\]:::python
  s_gram_risk_v1_presidio_analyzer --> c44
  c45[\"📥<br/>pystreams/src/pystreams/cmd/multi.py<br/>enforce_handler.handle"\]:::python
  s_gram_risk_v1_presidio_enforcer --> c45
  c46[\"📥<br/>server/cmd/gram/streams.go<br/>promptInjectionHandler"\]:::go
  s_gram_risk_v1_prompt_injection_analyzer --> c46
  c47[\"📥<br/>server/cmd/gram/streams.go<br/>promptPolicyHandler"\]:::go
  s_gram_risk_v1_prompt_policy_analyzer --> c47
  c48[\"📥<br/>server/cmd/gram/streams.go<br/>new"\]:::go
  s_gram_telemetry_v1_noop --> c48
  c49[\"📥<br/>server/cmd/gram/streams.go<br/>toolCallLogRelayHandler<br/>(batch)"\]:::go
  s_gram_telemetry_v1_tool_call_log_relay --> c49
  c50[\"📥<br/>server/cmd/gram/streams.go<br/>webhookEventHandler"\]:::go
  s_gram_webhooks_v1_svix_relay --> c50
```
...
| [`gram-risk-v1-judge-shadow-analysis`](../infra/proto/gram/risk/v1/judge_shadow_analysis.proto) | topic | 1d | [`server/internal/scanners/judgeshadow/publisher.go`](../server/internal/scanners/judgeshadow/publisher.go) |
| [`gram-risk-v1-judge-shadow-analyzer-dlq`](../infra/proto/gram/risk/v1/judge_shadow_analyzer.proto) | DLQ | 1d | — |
...
| [`gram-risk-v1-judge-shadow-analyzer`](../infra/proto/gram/risk/v1/judge_shadow_analyzer.proto) | `gram-risk-v1-judge-shadow-analysis` | 30s | `gram-risk-v1-judge-shadow-analyzer-dlq` | [`server/cmd/gram/streams.go`](../server/cmd/gram/streams.go) |
