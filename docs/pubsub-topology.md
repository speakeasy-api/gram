...
flowchart LR
  ...
  c21[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewAgentEventLogCHWriter<br/>(batch)"\]:::go
  s_gram_otel_v1_agent_event_log_ch_writer --> c21
  c22[\"📥<br/>server/cmd/gram/streams.go<br/>otelsvc.NewAgentEventSpanCHWriter<br/>(batch)"\]:::go
  s_gram_otel_v1_agent_event_span_ch_writer --> c22
