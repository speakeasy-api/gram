...
| Open Slack workspaces under Organization Identity                                        | `org:admin`                                                                                                  | Organization ID                                                       | List, begin, callback, disconnect, sync and member reads independently enforce `org:admin`. Only browser sessions are accepted; support sessions and API keys cannot manage connections. The shared demo can list connections but cannot begin or complete authorization, disconnect or sync.                                                                                                                                                                                                                                                                                               |
