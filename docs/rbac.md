...
| Open Plugins                                                                             | `project:read` OR `project:write`                                                                            | Project ID                                                            | Plugin install, update, delete, or configuration actions require `project:write`. Rotating the Observability plugin credential (`plugins.rotateObservabilityCredential`) requires `org:admin`, matching the download path that mints the hooks-scoped ingest key.                                                                                                                                                                                                                                                          |
