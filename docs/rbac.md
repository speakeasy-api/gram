...
| Create, edit, or delete signals and sensors                                              | `project:write`                                                                                              | Active project ID                                                     | Read-only users can inspect all configuration. Mutation controls and submit handlers require write access; the API independently enforces the same project scope. The product feature gates dashboard access, not the existing API endpoints.                                                                                                                                                                                                                                                                                                                                               |
