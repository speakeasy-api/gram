...
Organization onboarding uses one workstreams board for customer and support sessions; presentation never grants permissions. The independent `/setup/wizard` remains admin-only. Legacy task paths redirect to `/setup?task=<key>` and preserve section/project context.
...
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Open onboarding and its sidebar link                                                     | `org:read`                                                                                                   | Active organization ID                                                | Independent of tier and assignment. The promotional setup CTA separately requires `org:admin` and a paid or enterprise tier.                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Update onboarding task status                                                            | `org:admin` or current task assignee                                                                         | Active organization and task                                          | Assignment allows tracking, not configuration. Fact-completed tasks remain locked in the UI.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Assign onboarding tasks                                                                  | `org:admin`                                                                                                  | Active organization ID                                                | Member and external-email assignment use the durable task API.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Show or hide onboarding tasks                                                            | Authenticated platform staff                                                                                 | Active organization ID                                                | A browser development override does not grant backend staff authorization.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
