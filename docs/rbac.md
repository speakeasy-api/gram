...
| Open Assistants                                                                                       | `project:read`                                                                                               | Project ID                                                            | Creating or editing assistants is gated by `project:write`, matching the `assistants.createAssistant` endpoint; admin-only assistant management sections are `org:admin`.                                                                                                                                                                                                                                                                                                                                                   |
