...
| Open Catalog                                                                             | `project:read` OR `mcp:write`                                                                                | Project ID or MCP selector, depending on entry point                  | Browsing from the main nav can be available to project readers. Adding a catalog server to a project is a write action and is gated at the add flow. Configuring User Identity additionally requires `project:write` because it can create a provider or OAuth client.                                                                                                                                                                                                                                                        |
