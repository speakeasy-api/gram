...
| Open Slack workspaces under Organization Identity                                        | `org:admin`                                                                                                  | Organization ID                                                       | Requires the staff-managed `claude_tag_support` organization product feature. List, begin, callback and disconnect independently enforce `org:admin`. Only browser sessions are accepted; support sessions and API keys cannot manage connections. The shared demo can list connections but cannot begin or complete authorization or disconnect.                                                                                                                                                                                                                                           |
