...
| Open Slack workspaces under Organization Identity                                        | `org:admin`                                                                                                  | Organization ID                                                       | Requires the `claude-tag-support` rollout. List, begin, callback and disconnect independently enforce `org:admin`. Only browser sessions are accepted; support sessions and API keys cannot manage connections.                                                                                                                                                                                                                                                                                                                                                                             |
