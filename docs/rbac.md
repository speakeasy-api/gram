...
| Hosted MCP OAuth consent for a private server                                            | `mcp:connect`                                                                                                | MCP server or toolset ID                                              | A subject without `mcp:connect` sees Request access instead of Give access. Submitting the form emails organization administrators (`scope=mcp:connect`) and does not consume the OAuth challenge. Public servers skip this check.                                                                                                                                                                                                                                                                                           |
| Platform MCP OAuth and runtime (organization member)                                     | live organization membership                                                                                 | Organization ID                                                       | Members may connect to Platform MCP and receive a catalogue-plus-`request_mcp` toolset. `request_mcp` emails administrators with `scope=mcp:write` and the requested server name. Dashboard setup, management, and the project assistant adapter stay `org:admin`.                                                                                                                                                                                                                                                           |
| Platform MCP dashboard setup, management, and project assistant                          | `org:admin`                                                                                                  | Organization ID                                                       | These surfaces still require a live organization administrator.                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
