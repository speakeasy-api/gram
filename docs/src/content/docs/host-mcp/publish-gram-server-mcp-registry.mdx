...
<Callout title="Manual publishing" type="info">
...
- **A [Gram Pro or Enterprise account](/pricing?product=mcp):** You need a custom domain to publish your MCP server to the registry.
