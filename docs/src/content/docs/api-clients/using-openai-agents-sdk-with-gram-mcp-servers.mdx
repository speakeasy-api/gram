...
If you're unsure which approach fits your needs, start with the [Responses API guide](api-clients/using-openai-api-with-gram-mcp-servers) for simpler implementations or try [ChatGPT Connectors](clients/using-chatgpt-developer-mode-with-gram) for a web UI solution.
