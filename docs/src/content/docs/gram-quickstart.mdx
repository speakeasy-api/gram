...
A [toolset](concepts/toolsets) is a curated bundle of tools for a specific use case or team. In the Gram interface, you can select which tools to include and which to ignore based on your needs.
...
[Try Gram now](/product/gram) and see how easy it is to host and share your MCP server.
