...
![TaskBoard interface showing kanban columns with tasks that users click and drag to manage](/img/guides/adding-ai-chat-to-your-app/taskboard-interface.png)
...
![TaskBoard interface with added floating chat popup](/img/guides/adding-ai-chat-to-your-app/taskboard-with-chat.png)
...
![Screenshot of TaskBoard chat interface showing user message requesting task deletion and AI agent's response](/img/guides/adding-ai-chat-to-your-app/taskboard-delete-task.png)
...
![Diagram of the MCP-powered chat integration architecture](/img/guides/adding-ai-chat-to-your-app/architecture-diagram.png)
...
![Gram MCP server dashboard showing Visibility settings with Public option selected and MCP Installation section showing the server URL](/img/guides/adding-ai-chat-to-your-app/gram-public-mcp-server.png)
...
![TaskBoard dialog for adding environment variables](/img/guides/adding-ai-chat-to-your-app/taskboard-env-var.png)
...
![Testing the TaskBoard MCP tools in the Gram Playground](/img/guides/adding-ai-chat-to-your-app/testing-mcp-taskboard.png)
...
![TaskBoard interface with chat functionality](/img/guides/adding-ai-chat-to-your-app/taskboard-with-chat.png)
...
![Chat service logs displayed in the terminal](/img/guides/adding-ai-chat-to-your-app/chat-service-logging.png)
