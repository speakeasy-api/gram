...
CLI](command-line/installation). Once uploaded, a deployment creates tool
...
generate API documentation, SDKs, and client libraries. Similarly, Gram
...
<Table
  data={[
    { api: "Asana", documentation: "[developers.asana.com](https://developers.asana.com/reference/rest-api-reference)", openapiDocument: "[asana_oas.yaml](https://raw.githubusercontent.com/Asana/openapi/master/defs/asana_oas.yaml)" },
    { api: "GitHub REST API", documentation: "[docs.github.com/en/rest](https://docs.github.com/en/rest)", openapiDocument: "[api.github.com.yaml](https://raw.githubusercontent.com/github/rest-api-description/main/descriptions/api.github.com/api.github.com.yaml)" },
    { api: "National Weather Service", documentation: "[weather.gov/documentation/services-web-api](https://www.weather.gov/documentation/services-web-api)", openapiDocument: "[openapi.json](https://api.weather.gov/openapi.json)" },
  ]}
  columns={[
    { key: "api", header: "API" },
...
If you are looking for more information on how to write, understand and manage OpenAPI documents we recommend checking out our [OpenAPI documentation](/openapi).

We also provide a comprehensive OpenAPI Editor and CLI that help you edit, save and lint OpenAPI documents. You can login [here](https://app.speakeasy.com) using the same credientials used to access the Gram platform.
</Callout>
