...
func newStreamsCommand() *cli.Command {
	...
	return &cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			promptInjectionScanner := promptinjection.NewScanner(logger, piopenrouter.New(logger, tracerProvider, meterProvider, completionsClient, judgeRateLimiter).Configure(piJudgeConfigFromEnv()).Classify)
