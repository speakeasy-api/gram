...
var SetResourceAudienceEntryModel = Type("SetResourceAudienceEntry", func() {
	...
	Attribute("level", String, "Access to give the principal on this resource. The \"blocked_\" levels take access away: \"blocked\" removes connect and everything above it, \"blocked_view\" removes view and manage, \"blocked_manage\" removes manage alone.", func() {
		Enum("use", "view", "manage", "blocked", "blocked_view", "blocked_manage")
	})
