...
var RoleGrantModel = Type("RoleGrant", func() {
	...
	Attribute("scope", String, func() {
		...
		Enum("org:read", "org:admin", "build:read", "build:write", "mcp:read", "mcp:write", "mcp:connect", "remote-mcp:read", "remote-mcp:write", "remote-mcp:connect")
	})
...
var ScopeModel = Type("ScopeDefinition", func() {
	...
	Attribute("resource_type", String, func() {
		...
		Enum("org", "project", "mcp", "remote-mcp")
	})
})
