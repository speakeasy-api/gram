...
var UpdateToolsetForm = Type("UpdateToolsetForm", func() {
	...
	Attribute("tool_urns", ArrayOf(String), "List of tool URNs to include in the toolset")
	Attribute("resource_urns", ArrayOf(String), "List of resource URNs to include in the toolset")
	Attribute("mcp_enabled", Boolean, "Deprecated: manage availability through the mcpServers API (visibility). Only accepted for toolsets that predate MCP servers.")
	Attribute("mcp_slug", shared.Slug, "Deprecated: manage addressing through the mcpEndpoints API. Only accepted for toolsets that predate MCP servers.")
	Attribute("mcp_is_public", Boolean, "Deprecated: manage visibility through the mcpServers API. Only accepted for toolsets that predate MCP servers.")
	Attribute("custom_domain_id", String, "Deprecated: manage custom-domain addressing through the mcpEndpoints API. Only accepted for toolsets that predate MCP servers.")
