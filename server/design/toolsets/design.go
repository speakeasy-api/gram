...
var UpdateToolsetForm = Type("UpdateToolsetForm", func() {
	...
	Attribute("tool_urns", ArrayOf(String), "List of tool URNs to include in the toolset")
	Attribute("resource_urns", ArrayOf(String), "List of resource URNs to include in the toolset")
	Attribute("mcp_enabled", Boolean, "Deprecated: no longer accepted; setting it fails the request. Manage availability through the mcpServers API (visibility).")
	Attribute("mcp_slug", shared.Slug, "Deprecated: no longer accepted; setting it fails the request. Manage addressing through the mcpEndpoints API.")
	Attribute("mcp_is_public", Boolean, "Deprecated: no longer accepted; setting it fails the request. Manage visibility through the mcpServers API.")
	Attribute("custom_domain_id", String, "Deprecated: no longer accepted; setting it fails the request. Manage custom-domain addressing through the mcpEndpoints API.")
