...
var TokensUnderManagement = Type("TokensUnderManagement", func() {
	...
	Attribute("tunnelled_mcp_server_limit", Int, "The contracted tunnelled MCP server source cap, if one has been configured")
...
var _ = Service("usage", func() {
	...
	Method("setBillingMetadata", func() {
		...
		Payload(func() {
			...
			Attribute("tunnelled_mcp_server_limit", Int, "The contracted tunnelled MCP server source cap. Omit to use the plan default.", func() {
				Minimum(0)
			})
