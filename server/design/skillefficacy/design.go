...
var _ = Service("skillEfficacy", func() {
	...
	Method("queryInsights", func() {
		...
		Payload(func() {
			...
			Attribute("include_session_cost", Boolean, "Calculate attributed session cost. Disable for surfaces that do not display it.")
			Attribute("include_regression_signal", Boolean, "Calculate the current-versus-predecessor efficacy regression signal.")
