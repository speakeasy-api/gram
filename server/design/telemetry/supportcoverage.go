...
// Platform MCP: intentionally omitted. Platform MCP serves an organization's
// own administrators and members, and this endpoint refuses them; the evidence
// behind it is already reachable via query_mcp_metrics,
// list_shadow_mcp_inventory and get_project_overview. Revisit if this view
...
func supportCoverageMethods() {
	Method("getSupportCoverage", func() {
		...
		// The handler additionally enforces the platform-admin flag: this is a
		// support view, not something an org's own members should read.
