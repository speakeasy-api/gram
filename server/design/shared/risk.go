...
var RiskPolicy = Type("RiskPolicy", func() {
	...
	Attribute("nl_prompt", String, "LLM judge prompt for natural-language evaluation. Present when nl_policy category is active.")
	Attribute("targets", ArrayOf(String), "Evaluation targets. When empty, all scopes are evaluated.")
