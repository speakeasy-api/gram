...
var RiskPolicy = Type("RiskPolicy", func() {
	...
	Attribute("input_scopes", ArrayOf(String), "Scopes this policy applies to. When empty or omitted, applies to all scopes. Valid values: user_message, tool_request, tool_response, assistant_message.")
