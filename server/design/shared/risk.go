...
var RiskPolicy = Type("RiskPolicy", func() {
	...
	Attribute("disabled_recommended_scopes", ArrayOf(String), "Category keys whose centrally recommended detection scope is not applied for this policy. Empty means every recommendation applies.")
