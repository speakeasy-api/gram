...
var RiskPolicy = Type("RiskPolicy", func() {
	...
	Attribute("input_types", ArrayOf(String), "Message types this policy applies to. When empty or omitted, applies to all types. Valid values: user_message, tool_request, tool_response, assistant_message.")
