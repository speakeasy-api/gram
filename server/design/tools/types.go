...
var HTTPToolDefinition = Type("HTTPToolDefinition", func() {
	...
	Attribute("security", String, "Security configuration in JSON format")
	...
	Required("id", "project_id", "deployment_id", "name", "summary", "description", "tags", "http_method", "path", "schema", "created_at", "updated_at")
})
