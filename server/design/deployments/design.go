...
var DeploymentSummary = Type("DeploymentSummary", func() {
	Required("id", "created_at", "user_id", "status", "openapi_asset_count", "openapi_tool_count", "functions_asset_count", "functions_tool_count")
	...
	Attribute("openapi_asset_count", Int64, func() {
		Description("The number of upstream OpenAPI assets.")
	})
	Attribute("openapi_tool_count", Int64, func() {
