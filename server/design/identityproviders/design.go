...
var IdentityProviderConnection = Type("IdentityProviderConnection", func() {
	...
	Attribute("sign_in_connection_id", String, "Identifier of the sign-in provider connection used for sign-in.")
...
var IdentityProviderSetupStep = Type("IdentityProviderSetupStep", func() {
	...
	Attribute("portal_intent", String, "Intent the dashboard should open in the setup portal for this step.", func() { Enum("sso", "dsync") })
