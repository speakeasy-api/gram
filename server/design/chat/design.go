...
var ChatOverview = Type("ChatOverview", func() {
	...
	Attribute("max_risk_score", Float64, "Highest CVSS-style severity score (0.1-10) among this chat's active risk findings' policies. Absent when the chat has no active findings. Only populated by endpoints that join risk data.")
