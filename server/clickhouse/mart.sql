...
SELECT
    ...
    if(
        hook_source IN ('claude-code', 'claude-code-web', 'claude-chat', 'claude-chat-web', 'chatgpt', 'chatgpt-work', 'codex', 'cowork', 'cursor', 'litellm', 'local', 'mcp', 'openclaw', 'opencode', 'pi'),
        hook_source,
        'other'
    ) AS surface,
