...
CREATE TABLE IF NOT EXISTS billing_meter_readings_by_time (
    ...
    billing_user_account_email String MATERIALIZED attributes['billing_user_account_email'] COMMENT 'Frozen reporting label for the billing user.',
    ...
    billing_user_rbac_roles LowCardinality(String) MATERIALIZED attributes['billing_user_rbac_roles'] COMMENT 'Frozen JSON RBAC role set for reporting.',
    custom_domain String MATERIALIZED attributes['custom_domain'] COMMENT 'Frozen reporting attribute for the custom domain.',
