CREATE TABLE IF NOT EXISTS telemetry_logs (
    ...
    hook_hostname String MATERIALIZED toString(attributes.gram.hook.hostname) COMMENT 'Client hostname collected from hook telemetry.',
...
CREATE INDEX IF NOT EXISTS idx_telemetry_logs_mat_hook_hostname ON telemetry_logs (hook_hostname) TYPE bloom_filter(0.01) GRANULARITY 1;
