...
CREATE TABLE `ai_detections` (
  ...
  `signal` Enum8('installed' = 1, 'running' = 2) COMMENT 'What the scan observed: installed or running.',
  `category` Enum8('harness' = 1, 'local_model' = 2) COMMENT 'Category of the target at write time: harness or local_model. From the server catalog for targets it knows, as reported otherwise.',
