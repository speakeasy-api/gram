...
ALTER TABLE `trace_summaries` DROP COLUMN `mcp_server_url`;
ALTER TABLE `trace_summaries` DROP COLUMN `mcp_match`;
ALTER TABLE `trace_summaries` DROP COLUMN `user_id`;
ALTER TABLE `trace_summaries` DROP COLUMN `external_user_id`;
ALTER TABLE `trace_summaries` DROP COLUMN `toolset_slug`;
