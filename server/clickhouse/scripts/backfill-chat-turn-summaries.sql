-- Backfill chat_turn_summaries from retained telemetry_logs rows.
--
-- This is intentionally not part of the schema migration. Operators can run it
-- manually after deploying the chat_turn_summaries table and MV. The upper
