...
-- CREATE TABLE IF NOT EXISTS fly_app_transitions (
--   id uuid NOT NULL DEFAULT generate_uuidv7(),
--   seq BIGINT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
--   function_id uuid NOT NULL,
...
--   -- reason for transition, e.g. deploy, upgrade, rollback, etc.
--   reason TEXT NOT NULL,
--   message TEXT,

--   fly_app_id uuid,
--   from_runner_vesion TEXT,
--   to_runner_version TEXT,

--   created_at timestamptz NOT NULL DEFAULT clock_timestamp(),

--   CONSTRAINT fly_app_transitions_pkey PRIMARY KEY (id),
--   CONSTRAINT fly_app_transitions_function_id_fkey FOREIGN KEY (function_id) REFERENCES deployments_functions (id) ON DELETE CASCADE
-- );

-- CREATE UNIQUE INDEX IF NOT EXISTS fly_app_transitions_seq_key ON fly_app_transitions (seq DESC);
-- CREATE INDEX IF NOT EXISTS fly_app_transitions_function_id_idx ON fly_app_transitions (function_id);
-- CREATE INDEX IF NOT EXISTS fly_app_to_status_from_status_idx ON fly_app_transitions (to_status, from_status);
