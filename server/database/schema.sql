...
CREATE TABLE IF NOT EXISTS organization_onboarding (
  ...
  organization_id TEXT NOT NULL,
  preset TEXT,
  directory_scim_base_url TEXT,
  directory_scim_token_encrypted TEXT,
  directory_scim_token_key_id uuid,
  directory_scim_token_fingerprint TEXT,
  directory_workos_id TEXT,
  directory_handoff_set_by_user_id TEXT,
  directory_handoff_updated_at timestamptz,
  created_at timestamptz NOT NULL DEFAULT clock_timestamp(),
  updated_at timestamptz NOT NULL DEFAULT clock_timestamp(),
...
CREATE TABLE IF NOT EXISTS okta_identity_provider_connections (
  ...
  sign_in_application_id TEXT,
  workos_connection_id TEXT,
  sign_in_state TEXT,
  groups_source TEXT,
  groups_claim_confirmed boolean NOT NULL DEFAULT false,
  sign_in_evidence JSONB,
  directory_application_id TEXT,
  directory_state TEXT,
  directory_group_count integer,
  directory_user_count integer,
