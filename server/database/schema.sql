...
CREATE TABLE IF NOT EXISTS organization_user_relationship (
  ...
  CONSTRAINT organization_user_relationship_pkey PRIMARY KEY (id),
  CONSTRAINT organization_user_relationship_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES organization_metadata (id) ON DELETE SET NULL,
  CONSTRAINT organization_user_relationship_user_id_fkey FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE SET NULL,
