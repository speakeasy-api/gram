...
CREATE TABLE IF NOT EXISTS explore_saved_queries (
  ...
  CONSTRAINT explore_saved_queries_pkey PRIMARY KEY (id),
  CONSTRAINT explore_saved_queries_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES organization_metadata (id) ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS explore_saved_queries_organization_id_updated_at_idx
ON explore_saved_queries (organization_id, updated_at DESC)
