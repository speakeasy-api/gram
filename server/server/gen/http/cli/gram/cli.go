...
import (
	...
	aboutc "github.com/speakeasy-api/gram/server/server/gen/http/about/client"
	accessc "github.com/speakeasy-api/gram/server/server/gen/http/access/client"
	adminc "github.com/speakeasy-api/gram/server/server/gen/http/admin/client"
	assetsc "github.com/speakeasy-api/gram/server/server/gen/http/assets/client"
	assistantsc "github.com/speakeasy-api/gram/server/server/gen/http/assistants/client"
	auditlogsc "github.com/speakeasy-api/gram/server/server/gen/http/auditlogs/client"
	authc "github.com/speakeasy-api/gram/server/server/gen/http/auth/client"
	chatc "github.com/speakeasy-api/gram/server/server/gen/http/chat/client"
	chatsessionsc "github.com/speakeasy-api/gram/server/server/gen/http/chat_sessions/client"
	collectionsc "github.com/speakeasy-api/gram/server/server/gen/http/collections/client"
	deploymentsc "github.com/speakeasy-api/gram/server/server/gen/http/deployments/client"
	domainsc "github.com/speakeasy-api/gram/server/server/gen/http/domains/client"
	environmentsc "github.com/speakeasy-api/gram/server/server/gen/http/environments/client"
	featuresc "github.com/speakeasy-api/gram/server/server/gen/http/features/client"
	functionsc "github.com/speakeasy-api/gram/server/server/gen/http/functions/client"
	hooksc "github.com/speakeasy-api/gram/server/server/gen/http/hooks/client"
	hooksservernamesc "github.com/speakeasy-api/gram/server/server/gen/http/hooks_server_names/client"
	instancesc "github.com/speakeasy-api/gram/server/server/gen/http/instances/client"
	integrationsc "github.com/speakeasy-api/gram/server/server/gen/http/integrations/client"
	keysc "github.com/speakeasy-api/gram/server/server/gen/http/keys/client"
	mcpendpointsc "github.com/speakeasy-api/gram/server/server/gen/http/mcp_endpoints/client"
	mcpmetadatac "github.com/speakeasy-api/gram/server/server/gen/http/mcp_metadata/client"
	mcpregistriesc "github.com/speakeasy-api/gram/server/server/gen/http/mcp_registries/client"
	mcpserversc "github.com/speakeasy-api/gram/server/server/gen/http/mcp_servers/client"
	mdmc "github.com/speakeasy-api/gram/server/server/gen/http/mdm/client"
	organizationsc "github.com/speakeasy-api/gram/server/server/gen/http/organizations/client"
	packagesc "github.com/speakeasy-api/gram/server/server/gen/http/packages/client"
	pluginsc "github.com/speakeasy-api/gram/server/server/gen/http/plugins/client"
	projectsc "github.com/speakeasy-api/gram/server/server/gen/http/projects/client"
	remotemcpc "github.com/speakeasy-api/gram/server/server/gen/http/remote_mcp/client"
	resourcesc "github.com/speakeasy-api/gram/server/server/gen/http/resources/client"
	riskc "github.com/speakeasy-api/gram/server/server/gen/http/risk/client"
	slackc "github.com/speakeasy-api/gram/server/server/gen/http/slack/client"
	telemetryc "github.com/speakeasy-api/gram/server/server/gen/http/telemetry/client"
	templatesc "github.com/speakeasy-api/gram/server/server/gen/http/templates/client"
	toolsc "github.com/speakeasy-api/gram/server/server/gen/http/tools/client"
	toolsetsc "github.com/speakeasy-api/gram/server/server/gen/http/toolsets/client"
	triggersc "github.com/speakeasy-api/gram/server/server/gen/http/triggers/client"
	usagec "github.com/speakeasy-api/gram/server/server/gen/http/usage/client"
	usersessionclientsc "github.com/speakeasy-api/gram/server/server/gen/http/user_session_clients/client"
	usersessionconsentsc "github.com/speakeasy-api/gram/server/server/gen/http/user_session_consents/client"
	usersessionissuersc "github.com/speakeasy-api/gram/server/server/gen/http/user_session_issuers/client"
	usersessionsc "github.com/speakeasy-api/gram/server/server/gen/http/user_sessions/client"
	variationsc "github.com/speakeasy-api/gram/server/server/gen/http/variations/client"
...
func UsageCommands() []string {
	return []string{
		...
		"mdm (get-install-script|generate-mdm-script|patch-claude-settings)",
...
func ParseEndpoint(
	...
	var (
		...
		mdmGenerateMDMScriptFlags            = flag.NewFlagSet("generate-mdm-script", flag.ExitOnError)
		mdmGenerateMDMScriptSessionTokenFlag = mdmGenerateMDMScriptFlags.String("session-token", "", "")
	...
	mdmGenerateMDMScriptFlags.Usage = mdmGenerateMDMScriptUsage
	...
	)
	{
		...
		case "mdm":
			...
			case "generate-mdm-script":
				epf = mdmGenerateMDMScriptFlags
	...
	)
	{
		...
		case "mdm":
			...
			case "generate-mdm-script":
				endpoint = c.GenerateMDMScript()
				data, err = mdmc.BuildGenerateMDMScriptPayload(*mdmGenerateMDMScriptSessionTokenFlag)
			case "patch-claude-settings":
...
func mdmUsage() {
	...
	fmt.Fprintln(os.Stderr, `    generate-mdm-script: Generates a ready-to-use MDM shell script with an embedded Hooks-scoped API key. The returned script can be uploaded directly to Jamf, Kandji, Mosyle, or any MDM that supports arbitrary shell script policies. Requires org admin access.`)
...
func mdmGenerateMDMScriptUsage() {
	// Header with flags
	fmt.Fprintf(os.Stderr, "%s [flags] mdm generate-mdm-script", os.Args[0])
	fmt.Fprint(os.Stderr, " -session-token STRING")
	fmt.Fprintln(os.Stderr)

	// Description
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, `Generates a ready-to-use MDM shell script with an embedded Hooks-scoped API key. The returned script can be uploaded directly to Jamf, Kandji, Mosyle, or any MDM that supports arbitrary shell script policies. Requires org admin access.`)
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "mdm generate-mdm-script --session-token \"abc123\"")
}
