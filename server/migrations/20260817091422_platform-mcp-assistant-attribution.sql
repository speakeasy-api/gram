...
ALTER TABLE "platform_mcp_catalog_registrations" ADD CONSTRAINT "platform_mcp_catalog_registrations_connection_pair_check" CHECK ((connection_id IS NULL) = (connection_generation IS NULL)) NOT VALID, ALTER COLUMN "connection_id" DROP NOT NULL, ALTER COLUMN "connection_generation" DROP NOT NULL, ADD COLUMN "user_id" text NULL, ADD COLUMN "acting_surface" text NULL;
ALTER TABLE "platform_mcp_catalog_registrations" VALIDATE CONSTRAINT "platform_mcp_catalog_registrations_connection_pair_check";
...
ALTER TABLE "platform_mcp_operation_receipts" VALIDATE CONSTRAINT "platform_mcp_operation_receipts_connection_pair_check";
