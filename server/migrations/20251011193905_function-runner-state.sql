...
CREATE TABLE "fly_apps" ("id" uuid NOT NULL DEFAULT generate_uuidv7(), "seq" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "project_id" uuid NOT NULL, "deployment_id" uuid NOT NULL, "function_id" uuid NOT NULL, "fly_org_id" text NOT NULL, "fly_org_slug" text NOT NULL, "app_name" text NOT NULL, "app_url" text NOT NULL, "runner_version" text NOT NULL, "primary_region" text NOT NULL, "status" text NOT NULL, "reaped_at" timestamptz NULL, "created_at" timestamptz NOT NULL DEFAULT clock_timestamp(), "updated_at" timestamptz NOT NULL DEFAULT clock_timestamp(), PRIMARY KEY ("id"), CONSTRAINT "fly_apps_deployment_id_fkey" FOREIGN KEY ("deployment_id") REFERENCES "deployments" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "fly_apps_function_id_fkey" FOREIGN KEY ("function_id") REFERENCES "deployments_functions" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "fly_apps_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
