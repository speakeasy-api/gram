...
CREATE TABLE "organization_invitations" (
  ...
  CONSTRAINT "organization_invitations_token_hash_check" CHECK (token_hash <> ''::text)
);
...
-- Create index "organization_invitations_token_hash_key" to table: "organization_invitations"
