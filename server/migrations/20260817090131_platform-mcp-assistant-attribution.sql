...
ALTER TABLE "platform_mcp_catalog_registrations" ALTER COLUMN "connection_id" DROP NOT NULL, ALTER COLUMN "connection_generation" DROP NOT NULL, ADD COLUMN "user_id" text NULL, ADD COLUMN "acting_surface" text NULL;
-- Modify "platform_mcp_operation_receipts" table
ALTER TABLE "platform_mcp_operation_receipts" ALTER COLUMN "connection_id" DROP NOT NULL, ALTER COLUMN "connection_generation" DROP NOT NULL, ADD COLUMN "user_id" text NULL, ADD COLUMN "acting_surface" text NULL;
