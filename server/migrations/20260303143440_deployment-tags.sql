...
-- Create index "idx_deployment_tags_project_name" to table: "deployment_tags"
CREATE INDEX "idx_deployment_tags_project_name" ON "deployment_tags" ("project_id", "name");
