...
-- Drop index "risk_policies_project_id_idx" from table: "risk_policies"
DROP INDEX CONCURRENTLY "risk_policies_project_id_idx";
-- Modify "risk_policies" table
ALTER TABLE "risk_policies" DROP CONSTRAINT "risk_policies_organization_id_fkey", DROP CONSTRAINT "risk_policies_project_id_fkey", DROP COLUMN "deleted";
-- Create index "risk_policies_project_id_idx" to table: "risk_policies"
CREATE INDEX CONCURRENTLY "risk_policies_project_id_idx" ON "risk_policies" ("project_id") WHERE (deleted_at IS NULL);
