...
-- Create "mcp_registry_grants" table
CREATE TABLE "mcp_registry_grants" (
  "id" uuid NOT NULL DEFAULT generate_uuidv7(),
  "registry_id" uuid NOT NULL,
  "organization_id" text NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT clock_timestamp(),
  PRIMARY KEY ("id"),
  CONSTRAINT "mcp_registry_grants_org_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization_metadata" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "mcp_registry_grants_registry_fkey" FOREIGN KEY ("registry_id") REFERENCES "mcp_registries" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "mcp_registry_grants_registry_org_key" to table: "mcp_registry_grants"
CREATE UNIQUE INDEX "mcp_registry_grants_registry_org_key" ON "mcp_registry_grants" ("registry_id", "organization_id");
...
-- Create "peered_organizations" table
CREATE TABLE "peered_organizations" (
  "id" uuid NOT NULL DEFAULT generate_uuidv7(),
  "super_organization_id" text NOT NULL,
  "sub_organization_id" text NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT clock_timestamp(),
  PRIMARY KEY ("id"),
  CONSTRAINT "peered_organizations_sub_fkey" FOREIGN KEY ("sub_organization_id") REFERENCES "organization_metadata" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "peered_organizations_super_fkey" FOREIGN KEY ("super_organization_id") REFERENCES "organization_metadata" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "peered_organizations_sub_organization_id_idx" to table: "peered_organizations"
CREATE INDEX "peered_organizations_sub_organization_id_idx" ON "peered_organizations" ("sub_organization_id");
-- Create index "peered_organizations_super_sub_key" to table: "peered_organizations"
CREATE UNIQUE INDEX "peered_organizations_super_sub_key" ON "peered_organizations" ("super_organization_id", "sub_organization_id");
