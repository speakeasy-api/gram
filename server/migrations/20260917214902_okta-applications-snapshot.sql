...
ALTER TABLE "okta_identity_provider_connections" ADD CONSTRAINT "okta_identity_provider_connections_sync_interval_check" CHECK (applications_sync_interval_seconds >= 300), ADD COLUMN "applications_sync_interval_seconds" integer NOT NULL DEFAULT 21600, ADD COLUMN "applications_synced_at" timestamptz NULL;
...
CREATE TABLE "okta_applications" (
  ...
  CONSTRAINT "okta_applications_connection_tenant_fkey" FOREIGN KEY ("organization_id", "identity_provider_connection_id") REFERENCES "identity_provider_connections" ("organization_id", "id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE "okta_application_reconcile_runs" (
  ...
  "updated_at" timestamptz NOT NULL DEFAULT clock_timestamp(),
  PRIMARY KEY ("id"),
  CONSTRAINT "okta_application_reconcile_runs_connection_tenant_fkey" FOREIGN KEY ("organization_id", "identity_provider_connection_id") REFERENCES "identity_provider_connections" ("organization_id", "id") ON UPDATE NO ACTION ON DELETE CASCADE,
