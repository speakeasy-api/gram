...
CREATE TABLE "xaa_resource_readiness" (
  ...
  CONSTRAINT "xaa_resource_readiness_audience_check" CHECK (audience <> ''::text),
  ...
  CONSTRAINT "xaa_resource_readiness_okta_application_id_check" CHECK ((okta_application_id IS NULL) OR (okta_application_id <> ''::text)),
