...
ALTER TABLE "mcp_servers" ADD CONSTRAINT "mcp_servers_issuer_required_check" CHECK (deleted OR ((remote_mcp_server_id IS NULL) AND (tunneled_mcp_server_id IS NULL)) OR (user_session_issuer_id IS NOT NULL)) NOT VALID;
