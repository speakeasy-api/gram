...
CREATE TABLE "okta_identity_provider_connections" (
  ...
  CONSTRAINT "okta_identity_provider_connections_client_tenant_fkey" FOREIGN KEY ("organization_id", "remote_session_client_id") REFERENCES "remote_session_clients" ("organization_id", "id") ON UPDATE NO ACTION ON DELETE NO ACTION,
  ...
  CONSTRAINT "okta_identity_provider_connections_issuer_tenant_fkey" FOREIGN KEY ("organization_id", "remote_session_issuer_id") REFERENCES "remote_session_issuers" ("organization_id", "id") ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE UNIQUE INDEX "okta_identity_provider_connections_issuer_url_key" ON "okta_identity_provider_connections" ("issuer_url") WHERE ((deleted IS FALSE) AND (issuer_url_override_reason IS NULL));
