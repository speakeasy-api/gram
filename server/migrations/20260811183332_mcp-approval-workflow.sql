...
-- Create index "mcp_approval_requests_id_project_id_key" to table: "mcp_approval_requests"
CREATE UNIQUE INDEX "mcp_approval_requests_id_project_id_key" ON "mcp_approval_requests" ("id", "project_id");
...
-- Create index "mcp_approval_requests_project_id_target_key" to table: "mcp_approval_requests"
CREATE UNIQUE INDEX "mcp_approval_requests_project_id_target_key" ON "mcp_approval_requests" ("project_id", "target_kind", "target_key") WHERE (deleted IS FALSE);
-- Create index "mcp_approval_requests_project_status_updated_idx" to table: "mcp_approval_requests"
CREATE INDEX "mcp_approval_requests_project_status_updated_idx" ON "mcp_approval_requests" ("project_id", "status", "updated_at" DESC) WHERE (deleted IS FALSE);
...
CREATE TABLE "mcp_research_reports" (
  ...
  CONSTRAINT "mcp_research_reports_request_id_fkey" FOREIGN KEY ("mcp_approval_request_id", "project_id") REFERENCES "mcp_approval_requests" ("id", "project_id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE "mcp_approval_decisions" (
  ...
  CONSTRAINT "mcp_approval_decisions_request_id_fkey" FOREIGN KEY ("mcp_approval_request_id", "project_id") REFERENCES "mcp_approval_requests" ("id", "project_id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE "mcp_approval_request_requesters" (
  ...
  CONSTRAINT "mcp_approval_request_requesters_request_id_fkey" FOREIGN KEY ("mcp_approval_request_id", "project_id") REFERENCES "mcp_approval_requests" ("id", "project_id") ON UPDATE NO ACTION ON DELETE CASCADE
);
