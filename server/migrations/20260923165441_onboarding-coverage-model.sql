...
-- Create "onboarding_product_plans" table
CREATE TABLE "onboarding_product_plans" (
  "product_id" uuid NOT NULL,
  "plan_id" uuid NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT clock_timestamp(),
  PRIMARY KEY ("product_id", "plan_id"),
  CONSTRAINT "onboarding_product_plans_plan_id_fkey" FOREIGN KEY ("plan_id") REFERENCES "onboarding_plans" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "onboarding_product_plans_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "onboarding_products" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "organization_onboarding_products" (
  ...
  CONSTRAINT "organization_onboarding_products_plan_id_fkey" FOREIGN KEY ("plan_id") REFERENCES "onboarding_plans" ("id") ON UPDATE NO ACTION ON DELETE SET NULL,
