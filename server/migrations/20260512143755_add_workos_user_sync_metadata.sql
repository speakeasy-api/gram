...
-- Modify "users" table
ALTER TABLE "users" ADD COLUMN "workos_created_at" timestamptz NULL, ADD COLUMN "workos_updated_at" timestamptz NULL, ADD COLUMN "workos_deleted_at" timestamptz NULL, ADD COLUMN "workos_deleted" boolean NOT NULL GENERATED ALWAYS AS (workos_deleted_at IS NOT NULL) STORED, ADD COLUMN "workos_last_event_id" text NULL;
