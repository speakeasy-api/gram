...
-- Create "workos_syncs" table
CREATE TABLE "workos_syncs" (
  "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "last_event_id" text NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT clock_timestamp(),
  PRIMARY KEY ("id")
);
-- Create index "workos_syncs_last_event_id_desc_idx" to table: "workos_syncs"
CREATE INDEX "workos_syncs_last_event_id_desc_idx" ON "workos_syncs" ("last_event_id" DESC);
...
CREATE UNIQUE INDEX "organization_roles_organization_id_workos_id_key" ON "organization_roles" ("organization_id", "workos_id") WHERE (deleted IS FALSE);
-- Drop "roles" table
DROP TABLE "roles";
