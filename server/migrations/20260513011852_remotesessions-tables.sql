...
-- Create index "remote_sessions_principal_client_key" to table: "remote_sessions"
CREATE UNIQUE INDEX "remote_sessions_principal_client_key" ON "remote_sessions" ("principal_urn", "remote_session_client_id") WHERE (deleted IS FALSE);
