...
-- Create index "organization_mcp_collection_registries_collection_id_key" to table: "organization_mcp_collection_registries"
CREATE UNIQUE INDEX CONCURRENTLY "organization_mcp_collection_registries_collection_id_key" ON "organization_mcp_collection_registries" ("collection_id") WHERE (deleted IS FALSE);
