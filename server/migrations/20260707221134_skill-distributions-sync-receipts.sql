...
-- Create index "skill_sync_receipts_project_id_skill_id_user_id_hostname_key" to table: "skill_sync_receipts"
CREATE UNIQUE INDEX "skill_sync_receipts_project_id_skill_id_user_id_hostname_key" ON "skill_sync_receipts" ("project_id", "skill_id", "user_id", "hostname");
