...
-- Prevent two projects from writing to the same GitHub repo under the same App installation.
CREATE UNIQUE INDEX "plugin_github_connections_installation_repo_key" ON "plugin_github_connections" ("installation_id", "repo_owner", "repo_name");
