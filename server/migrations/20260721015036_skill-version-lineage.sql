...
CREATE TABLE "skill_version_lineages" (
  ...
  CONSTRAINT "skill_version_lineages_skill_id_derived_from_version_id_fkey" FOREIGN KEY ("skill_id", "derived_from_version_id") REFERENCES "skill_versions" ("skill_id", "id") ON UPDATE NO ACTION ON DELETE CASCADE,
