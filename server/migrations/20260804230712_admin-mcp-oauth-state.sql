...
CREATE TABLE "admin_mcp_onboarding_milestones" (
  ...
  "created_at" timestamptz NOT NULL DEFAULT clock_timestamp(),
  PRIMARY KEY ("id"),
  CONSTRAINT "admin_mcp_onboarding_milestones_organization_connection_fkey" FOREIGN KEY ("organization_id", "connection_id") REFERENCES "admin_mcp_connections" ("organization_id", "id") ON UPDATE NO ACTION ON DELETE NO ACTION,
  ...
  CONSTRAINT "admin_mcp_onboarding_milestones_organization_project_fkey" FOREIGN KEY ("organization_id", "project_id") REFERENCES "projects" ("organization_id", "id") ON UPDATE NO ACTION ON DELETE NO ACTION,
