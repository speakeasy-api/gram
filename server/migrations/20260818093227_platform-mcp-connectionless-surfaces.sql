...
-- Drop index "platform_mcp_readiness_binding_key" from table: "platform_mcp_readiness"
...
CREATE UNIQUE INDEX CONCURRENTLY "platform_mcp_readiness_binding_key" ON "platform_mcp_readiness" ("registration_id", "connection_id", "connection_generation", "provider_authorization_fingerprint") NULLS NOT DISTINCT;
-- Drop index "platform_mcp_setup_handoffs_active_binding_key" from table: "platform_mcp_setup_handoffs"
...
CREATE UNIQUE INDEX CONCURRENTLY "platform_mcp_setup_handoffs_active_binding_key" ON "platform_mcp_setup_handoffs" ("registration_id", "connection_id", "connection_generation", "intent") NULLS NOT DISTINCT WHERE ((redeemed_at IS NULL) AND (invalidated_at IS NULL));
