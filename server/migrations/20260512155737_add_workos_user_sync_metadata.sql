...
-- Modify "users" table
ALTER TABLE "users" ADD COLUMN "workos_created_at" timestamptz NULL, ADD COLUMN "workos_updated_at" timestamptz NULL, ADD COLUMN "workos_deleted_at" timestamptz NULL;
