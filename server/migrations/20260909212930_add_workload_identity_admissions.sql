...
-- Create index "workload_identity_admissions_key" to table: "workload_identity_admissions"
CREATE UNIQUE INDEX "workload_identity_admissions_key" ON "workload_identity_admissions" ("organization_id", "workload_issuer_id", "subject") WHERE (deleted IS FALSE);
