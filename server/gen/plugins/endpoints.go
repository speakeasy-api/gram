...
type Endpoints struct {
	...
	RotateObservabilityCredential goa.Endpoint
...
func NewEndpoints(s Service) *Endpoints {
	...
	return &Endpoints{
		...
		RotateObservabilityCredential: NewRotateObservabilityCredentialEndpoint(s, a.APIKeyAuth),
...
func (e *Endpoints) Use(m func(goa.Endpoint) goa.Endpoint) {
	...
	e.RotateObservabilityCredential = m(e.RotateObservabilityCredential)
...
// "listAudiences" of service "plugins".
func NewListAudiencesEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
...
// NewRotateObservabilityCredentialEndpoint returns an endpoint function that
// calls the method "rotateObservabilityCredential" of service "plugins".
func NewRotateObservabilityCredentialEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*RotateObservabilityCredentialPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
		...
		return s.RotateObservabilityCredential(ctx, p)
	}
}
