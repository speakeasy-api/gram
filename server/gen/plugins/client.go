...
type Client struct {
	...
	SetDefaultPluginEndpoint            goa.Endpoint
...
func NewClient(listPlugins, getPlugin, createPlugin, updatePlugin, setDefaultPlugin, deletePlugin, addPluginServer, updatePluginServer, removePluginServer, setPluginAssignments, downloadPluginPackage, downloadObservabilityPlugin, downloadCodexInstallScript, getPublishStatus, publishPlugins, getMarketplaceSettings, updateMarketplaceSettings goa.Endpoint) *Client {
	return &Client{
		...
		SetDefaultPluginEndpoint:            setDefaultPlugin,
...
// SetDefaultPlugin calls the "setDefaultPlugin" endpoint of the "plugins"
// service.
// SetDefaultPlugin may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): unauthorized access
//   - "forbidden" (type *goa.ServiceError): permission denied
//   - "bad_request" (type *goa.ServiceError): request is invalid
//   - "not_found" (type *goa.ServiceError): resource not found
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) SetDefaultPlugin(ctx context.Context, p *SetDefaultPluginPayload) (res *Plugin, err error) {
	var ires any
	ires, err = c.SetDefaultPluginEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*Plugin), nil
