...
func BuildVscodeCopilotPayload(hooksVscodeCopilotBody string, hooksVscodeCopilotApikeyToken string, hooksVscodeCopilotProjectSlugInput string) (*hooks.VscodeCopilotPayload, error) {
	var err error
