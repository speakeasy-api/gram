...
// BuildDeleteGrantPayload builds the payload for the access deleteGrant
// endpoint from CLI flags.
func BuildDeleteGrantPayload(accessDeleteGrantID string, accessDeleteGrantSessionToken string) (*access.DeleteGrantPayload, error) {
	var err error
	var id string
	{
		id = accessDeleteGrantID
	...
	var sessionToken *string
	{
		if accessDeleteGrantSessionToken != "" {
			sessionToken = &accessDeleteGrantSessionToken
		}
	}
