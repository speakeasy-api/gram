...
func ValidateScopeDefinitionResponseBody(body *ScopeDefinitionResponseBody) (err error) {
	...
	if body.Slug != nil {
		if !(*body.Slug == "org:read" || *body.Slug == "org:admin" || *body.Slug == "project:read" || *body.Slug == "project:write" || *body.Slug == "mcp:read" || *body.Slug == "mcp:write" || *body.Slug == "mcp:connect" || *body.Slug == "remote-mcp:read" || *body.Slug == "remote-mcp:write" || *body.Slug == "remote-mcp:connect") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.slug", *body.Slug, []any{"org:read", "org:admin", "project:read", "project:write", "mcp:read", "mcp:write", "mcp:connect", "remote-mcp:read", "remote-mcp:write", "remote-mcp:connect"}))
		}
	}
	if body.ResourceType != nil {
...
func ValidateListRoleGrantResponseBody(body *ListRoleGrantResponseBody) (err error) {
	...
	for _, e := range body.SubScopes {
		if !(e == "org:read" || e == "org:admin" || e == "project:read" || e == "project:write" || e == "mcp:read" || e == "mcp:write" || e == "mcp:connect" || e == "remote-mcp:read" || e == "remote-mcp:write" || e == "remote-mcp:connect") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.sub_scopes[*]", e, []any{"org:read", "org:admin", "project:read", "project:write", "mcp:read", "mcp:write", "mcp:connect", "remote-mcp:read", "remote-mcp:write", "remote-mcp:connect"}))
		}
	}
	return
}
