...
func ValidateSelectorResponseBody(body *SelectorResponseBody) (err error) {
	...
	if body.ResourceKind != nil {
		if !(*body.ResourceKind == "project" || *body.ResourceKind == "mcp" || *body.ResourceKind == "org" || *body.ResourceKind == "environment" || *body.ResourceKind == "risk_policy" || *body.ResourceKind == "chat" || *body.ResourceKind == "telemetry" || *body.ResourceKind == "*") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.resource_kind", *body.ResourceKind, []any{"project", "mcp", "org", "environment", "risk_policy", "chat", "telemetry", "*"}))
		}
	}
	if body.Disposition != nil {
...
func ValidateScopeDefinitionResponseBody(body *ScopeDefinitionResponseBody) (err error) {
	...
	if body.ResourceType != nil {
		if !(*body.ResourceType == "org" || *body.ResourceType == "project" || *body.ResourceType == "mcp" || *body.ResourceType == "environment" || *body.ResourceType == "risk_policy" || *body.ResourceType == "chat" || *body.ResourceType == "telemetry") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.resource_type", *body.ResourceType, []any{"org", "project", "mcp", "environment", "risk_policy", "chat", "telemetry"}))
		}
	}
	if body.Visibility != nil {
