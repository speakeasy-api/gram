...
func ValidateSelectorResponseBody(body *SelectorResponseBody) (err error) {
	...
	if body.ResourceKind != nil {
		if !(*body.ResourceKind == "project" || *body.ResourceKind == "mcp" || *body.ResourceKind == "org" || *body.ResourceKind == "role" || *body.ResourceKind == "environment" || *body.ResourceKind == "skill" || *body.ResourceKind == "risk_policy" || *body.ResourceKind == "chat" || *body.ResourceKind == "*") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.resource_kind", *body.ResourceKind, []any{"project", "mcp", "org", "role", "environment", "skill", "risk_policy", "chat", "*"}))
		}
	}
	if body.Disposition != nil {
...
func ValidateScopeDefinitionResponseBody(body *ScopeDefinitionResponseBody) (err error) {
	...
	if body.ResourceType != nil {
		if !(*body.ResourceType == "org" || *body.ResourceType == "project" || *body.ResourceType == "mcp" || *body.ResourceType == "role" || *body.ResourceType == "environment" || *body.ResourceType == "skill" || *body.ResourceType == "risk_policy" || *body.ResourceType == "chat") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.resource_type", *body.ResourceType, []any{"org", "project", "mcp", "role", "environment", "skill", "risk_policy", "chat"}))
		}
	}
	if body.Visibility != nil {
