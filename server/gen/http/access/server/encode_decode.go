...
// EncodeListMemberGrantsResponse returns an encoder for responses returned by
// the access listMemberGrants endpoint.
func EncodeListMemberGrantsResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*access.ListUserGrantsResult)
		enc := encoder(ctx, w)
		body := NewListMemberGrantsResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeListMemberGrantsRequest returns a decoder for requests sent to the
// access listMemberGrants endpoint.
func DecodeListMemberGrantsRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*access.ListMemberGrantsPayload, error) {
	return func(r *http.Request) (*access.ListMemberGrantsPayload, error) {
		var payload *access.ListMemberGrantsPayload
		var (
			userID       string
			apikeyToken  *string
			sessionToken *string
		...
		payload = NewListMemberGrantsPayload(userID, apikeyToken, sessionToken)
		if payload.ApikeyToken != nil {
			if strings.Contains(*payload.ApikeyToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.ApikeyToken, " ", 2)[1]
...
// EncodeListMemberGrantsError returns an encoder for errors returned by the
// listMemberGrants access endpoint.
func EncodeListMemberGrantsError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewListMemberGrantsGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
