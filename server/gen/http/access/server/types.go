...
func ValidateRoleGrantRequestBody(body *RoleGrantRequestBody) (err error) {
	...
	if body.Scope != nil {
		if !(*body.Scope == "org:read" || *body.Scope == "org:admin" || *body.Scope == "project:read" || *body.Scope == "project:write" || *body.Scope == "mcp:read" || *body.Scope == "mcp:write" || *body.Scope == "mcp:connect" || *body.Scope == "remote-mcp:read" || *body.Scope == "remote-mcp:write" || *body.Scope == "remote-mcp:connect") {
			err = goa.MergeErrors(err, goa.InvalidEnumValueError("body.scope", *body.Scope, []any{"org:read", "org:admin", "project:read", "project:write", "mcp:read", "mcp:write", "mcp:connect", "remote-mcp:read", "remote-mcp:write", "remote-mcp:connect"}))
		}
	}
	return
}
