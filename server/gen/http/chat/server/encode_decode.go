...
// EncodeGetAssistantSessionSummaryResponse returns an encoder for responses
// returned by the chat getAssistantSessionSummary endpoint.
func EncodeGetAssistantSessionSummaryResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*chat.AssistantSessionSummary)
		enc := encoder(ctx, w)
		body := NewGetAssistantSessionSummaryResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeGetAssistantSessionSummaryRequest returns a decoder for requests sent
// to the chat getAssistantSessionSummary endpoint.
func DecodeGetAssistantSessionSummaryRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*chat.GetAssistantSessionSummaryPayload, error) {
	return func(r *http.Request) (*chat.GetAssistantSessionSummaryPayload, error) {
		var payload *chat.GetAssistantSessionSummaryPayload
		var (
			assistantID      string
			from             string
			to               string
		...
		payload = NewGetAssistantSessionSummaryPayload(assistantID, from, to, sessionToken, projectSlugInput)
		if payload.SessionToken != nil {
			if strings.Contains(*payload.SessionToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.SessionToken, " ", 2)[1]
...
// EncodeGetAssistantSessionSummaryError returns an encoder for errors returned
// by the getAssistantSessionSummary chat endpoint.
func EncodeGetAssistantSessionSummaryError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewGetAssistantSessionSummaryGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
...
// EncodeGetWorkUnitsTrendResponse returns an encoder for responses returned by
// the chat getWorkUnitsTrend endpoint.
func EncodeGetWorkUnitsTrendResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*chat.WorkUnitsTrendResult)
		enc := encoder(ctx, w)
		body := NewGetWorkUnitsTrendResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeGetWorkUnitsTrendRequest returns a decoder for requests sent to the
// chat getWorkUnitsTrend endpoint.
func DecodeGetWorkUnitsTrendRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*chat.GetWorkUnitsTrendPayload, error) {
...
// EncodeGetWorkUnitsTrendError returns an encoder for errors returned by the
// getWorkUnitsTrend chat endpoint.
func EncodeGetWorkUnitsTrendError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewGetWorkUnitsTrendGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
...
func DecodeLoadChatRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*chat.LoadChatPayload, error) {
	return func(r *http.Request) (*chat.LoadChatPayload, error) {
		...
		payload = NewLoadChatPayload(id, generation, limit, beforeSeq, afterSeq, fromStart, riskOnly, query, sessionToken, projectSlugInput, chatSessionsToken, apikeyToken)
		if payload.SessionToken != nil {
			if strings.Contains(*payload.SessionToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.SessionToken, " ", 2)[1]
...
// EncodeSummarizeResponse returns an encoder for responses returned by the
// chat summarize endpoint.
func EncodeSummarizeResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*chat.SummarizeChatResult)
		enc := encoder(ctx, w)
		body := NewSummarizeResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeSummarizeRequest returns a decoder for requests sent to the chat
// summarize endpoint.
func DecodeSummarizeRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*chat.SummarizePayload, error) {
	return func(r *http.Request) (*chat.SummarizePayload, error) {
		var payload *chat.SummarizePayload
		var (
		...
		err = ValidateSummarizeRequestBody(&body)
		if err != nil {
			return payload, err
		}
		...
		payload = NewSummarizePayload(&body, sessionToken, projectSlugInput)
		if payload.SessionToken != nil {
			if strings.Contains(*payload.SessionToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.SessionToken, " ", 2)[1]
...
// EncodeSummarizeError returns an encoder for errors returned by the summarize
// chat endpoint.
func EncodeSummarizeError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewSummarizeForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		...
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewSummarizeBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewSummarizeNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewSummarizeConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewSummarizeUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewSummarizeInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewSummarizeInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewSummarizeUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewSummarizeGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
...
// EncodeSummarizeToolCallResponse returns an encoder for responses returned by
// the chat summarizeToolCall endpoint.
func EncodeSummarizeToolCallResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*chat.SummarizeToolCallResult)
		enc := encoder(ctx, w)
		body := NewSummarizeToolCallResponseBody(res)
		w.WriteHeader(http.StatusOK)
		return enc.Encode(body)
	}
}

// DecodeSummarizeToolCallRequest returns a decoder for requests sent to the
// chat summarizeToolCall endpoint.
func DecodeSummarizeToolCallRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*chat.SummarizeToolCallPayload, error) {
	return func(r *http.Request) (*chat.SummarizeToolCallPayload, error) {
		var payload *chat.SummarizeToolCallPayload
		var (
		...
		err = ValidateSummarizeToolCallRequestBody(&body)
		if err != nil {
			return payload, err
		}
		...
		payload = NewSummarizeToolCallPayload(&body, sessionToken, projectSlugInput)
		if payload.SessionToken != nil {
			if strings.Contains(*payload.SessionToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.SessionToken, " ", 2)[1]
...
// EncodeSummarizeToolCallError returns an encoder for errors returned by the
// summarizeToolCall chat endpoint.
func EncodeSummarizeToolCallError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		...
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewSummarizeToolCallGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
...
func EncodeListSourcesResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*chat.ListSourcesResult)
		enc := encoder(ctx, w)
...
// DecodeListSourcesRequest returns a decoder for requests sent to the chat
// listSources endpoint.
func DecodeListSourcesRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*chat.ListSourcesPayload, error) {
	return func(r *http.Request) (*chat.ListSourcesPayload, error) {
		var payload *chat.ListSourcesPayload
		var (
			sessionToken      *string
			projectSlugInput  *string
			chatSessionsToken *string
		...
		payload = NewListSourcesPayload(sessionToken, projectSlugInput, chatSessionsToken)
		if payload.SessionToken != nil {
			if strings.Contains(*payload.SessionToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.SessionToken, " ", 2)[1]
...
// EncodeListSourcesError returns an encoder for errors returned by the
// listSources chat endpoint.
func EncodeListSourcesError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewListSourcesUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewListSourcesForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewListSourcesBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewListSourcesNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewListSourcesConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewListSourcesUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewListSourcesInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewListSourcesInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewListSourcesUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewListSourcesGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
...
// marshalChatWorkUnitsTrendBucketToWorkUnitsTrendBucketResponseBody builds a
// value of type *WorkUnitsTrendBucketResponseBody from a value of type
// *chat.WorkUnitsTrendBucket.
func marshalChatWorkUnitsTrendBucketToWorkUnitsTrendBucketResponseBody(v *chat.WorkUnitsTrendBucket) *WorkUnitsTrendBucketResponseBody {
	res := &WorkUnitsTrendBucketResponseBody{
