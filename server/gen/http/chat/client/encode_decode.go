...
// BuildGenerateFollowOnSuggestionsRequest instantiates a HTTP request object
// with method and path set to call the "chat" service
// "generateFollowOnSuggestions" endpoint
func (c *Client) BuildGenerateFollowOnSuggestionsRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: GenerateFollowOnSuggestionsChatPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("chat", "generateFollowOnSuggestions", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeGenerateFollowOnSuggestionsRequest returns an encoder for requests
// sent to the chat generateFollowOnSuggestions server.
func EncodeGenerateFollowOnSuggestionsRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*chat.GenerateFollowOnSuggestionsPayload)
		if !ok {
			return goahttp.ErrInvalidType("chat", "generateFollowOnSuggestions", "*chat.GenerateFollowOnSuggestionsPayload", v)
		}
		if p.SessionToken != nil {
			head := *p.SessionToken
			req.Header.Set("Gram-Session", head)
		...
		body := NewGenerateFollowOnSuggestionsRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("chat", "generateFollowOnSuggestions", err)
		}
		return nil
	}
}

// DecodeGenerateFollowOnSuggestionsResponse returns a decoder for responses
// returned by the chat generateFollowOnSuggestions endpoint. restoreBody
// controls whether the response body should be restored after having been read.
// DecodeGenerateFollowOnSuggestionsResponse may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): http.StatusUnauthorized
//   - "forbidden" (type *goa.ServiceError): http.StatusForbidden
//   - "bad_request" (type *goa.ServiceError): http.StatusBadRequest
//   - "not_found" (type *goa.ServiceError): http.StatusNotFound
...
//   - "gateway_error" (type *goa.ServiceError): http.StatusBadGateway
//   - error: internal error
func DecodeGenerateFollowOnSuggestionsResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("chat", "generateFollowOnSuggestions", err)
			}
			err = ValidateGenerateFollowOnSuggestionsResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			res := NewGenerateFollowOnSuggestionsResultOK(&body)
			return res, nil
		case http.StatusUnauthorized:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsUnauthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsUnauthorized(&body)
		case http.StatusForbidden:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsForbidden(&body)
		case http.StatusBadRequest:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsBadRequest(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsNotFound(&body)
		case http.StatusConflict:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsConflictResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsConflict(&body)
		case http.StatusUnsupportedMediaType:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsUnsupportedMediaResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsUnsupportedMedia(&body)
		case http.StatusUnprocessableEntity:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsInvalidResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsInvalid(&body)
		case http.StatusInternalServerError:
			en := resp.Header.Get("goa-error")
			switch en {
			case "invariant_violation":
				...
				err = ValidateGenerateFollowOnSuggestionsInvariantViolationResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
				}
				return nil, NewGenerateFollowOnSuggestionsInvariantViolation(&body)
			case "unexpected":
				var (
				...
				err = ValidateGenerateFollowOnSuggestionsUnexpectedResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
				}
				return nil, NewGenerateFollowOnSuggestionsUnexpected(&body)
			default:
				body, _ := io.ReadAll(resp.Body)
				return nil, goahttp.ErrInvalidResponse("chat", "generateFollowOnSuggestions", resp.StatusCode, string(body))
			}
		case http.StatusBadGateway:
			var (
			...
			err = ValidateGenerateFollowOnSuggestionsGatewayErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "generateFollowOnSuggestions", err)
			}
			return nil, NewGenerateFollowOnSuggestionsGatewayError(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("chat", "generateFollowOnSuggestions", resp.StatusCode, string(body))
		}
...
// marshalChatSuggestionMessageToSuggestionMessageRequestBody builds a value of
// type *SuggestionMessageRequestBody from a value of type
// *chat.SuggestionMessage.
func marshalChatSuggestionMessageToSuggestionMessageRequestBody(v *chat.SuggestionMessage) *SuggestionMessageRequestBody {
	res := &SuggestionMessageRequestBody{
		Role:    v.Role,
		Content: v.Content,
	}
...
// marshalSuggestionMessageRequestBodyToChatSuggestionMessage builds a value of
// type *chat.SuggestionMessage from a value of type
// *SuggestionMessageRequestBody.
func marshalSuggestionMessageRequestBodyToChatSuggestionMessage(v *SuggestionMessageRequestBody) *chat.SuggestionMessage {
	res := &chat.SuggestionMessage{
		Role:    v.Role,
		Content: v.Content,
	}
