...
// BuildSummarizeToolActivityRequest instantiates a HTTP request object with
// method and path set to call the "chat" service "summarizeToolActivity"
// endpoint
func (c *Client) BuildSummarizeToolActivityRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: SummarizeToolActivityChatPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("chat", "summarizeToolActivity", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeSummarizeToolActivityRequest returns an encoder for requests sent to
// the chat summarizeToolActivity server.
func EncodeSummarizeToolActivityRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*chat.SummarizeToolActivityPayload)
		if !ok {
			return goahttp.ErrInvalidType("chat", "summarizeToolActivity", "*chat.SummarizeToolActivityPayload", v)
		}
		if p.SessionToken != nil {
			head := *p.SessionToken
			req.Header.Set("Gram-Session", head)
		...
		body := NewSummarizeToolActivityRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("chat", "summarizeToolActivity", err)
		}
		return nil
	}
}

// DecodeSummarizeToolActivityResponse returns a decoder for responses returned
// by the chat summarizeToolActivity endpoint. restoreBody controls whether the
// response body should be restored after having been read.
// DecodeSummarizeToolActivityResponse may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): http.StatusUnauthorized
//   - "forbidden" (type *goa.ServiceError): http.StatusForbidden
//   - "bad_request" (type *goa.ServiceError): http.StatusBadRequest
//   - "not_found" (type *goa.ServiceError): http.StatusNotFound
...
//   - "gateway_error" (type *goa.ServiceError): http.StatusBadGateway
//   - error: internal error
func DecodeSummarizeToolActivityResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("chat", "summarizeToolActivity", err)
			}
			err = ValidateSummarizeToolActivityResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			res := NewSummarizeToolActivityResultOK(&body)
			return res, nil
		case http.StatusUnauthorized:
			var (
			...
			err = ValidateSummarizeToolActivityUnauthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityUnauthorized(&body)
		case http.StatusForbidden:
			var (
			...
			err = ValidateSummarizeToolActivityForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityForbidden(&body)
		case http.StatusBadRequest:
			var (
			...
			err = ValidateSummarizeToolActivityBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityBadRequest(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateSummarizeToolActivityNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityNotFound(&body)
		case http.StatusConflict:
			var (
			...
			err = ValidateSummarizeToolActivityConflictResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityConflict(&body)
		case http.StatusUnsupportedMediaType:
			var (
			...
			err = ValidateSummarizeToolActivityUnsupportedMediaResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityUnsupportedMedia(&body)
		case http.StatusUnprocessableEntity:
			var (
			...
			err = ValidateSummarizeToolActivityInvalidResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityInvalid(&body)
		case http.StatusInternalServerError:
			en := resp.Header.Get("goa-error")
			switch en {
			case "invariant_violation":
				...
				err = ValidateSummarizeToolActivityInvariantViolationResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
				}
				return nil, NewSummarizeToolActivityInvariantViolation(&body)
			case "unexpected":
				var (
				...
				err = ValidateSummarizeToolActivityUnexpectedResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
				}
				return nil, NewSummarizeToolActivityUnexpected(&body)
			default:
				body, _ := io.ReadAll(resp.Body)
				return nil, goahttp.ErrInvalidResponse("chat", "summarizeToolActivity", resp.StatusCode, string(body))
			}
		case http.StatusBadGateway:
			var (
			...
			err = ValidateSummarizeToolActivityGatewayErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("chat", "summarizeToolActivity", err)
			}
			return nil, NewSummarizeToolActivityGatewayError(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("chat", "summarizeToolActivity", resp.StatusCode, string(body))
		}
...
// marshalChatToolActivityCallToToolActivityCallRequestBody builds a value of
// type *ToolActivityCallRequestBody from a value of type
...
// marshalToolActivityCallRequestBodyToChatToolActivityCall builds a value of
// type *chat.ToolActivityCall from a value of type
