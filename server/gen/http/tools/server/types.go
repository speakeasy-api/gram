...
func NewListToolsPayload(cursor *string, limit *int32, deploymentID *string, sourceSlug *string, sessionToken *string, projectSlugInput *string) *tools.ListToolsPayload {
