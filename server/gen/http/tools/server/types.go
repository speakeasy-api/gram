...
func NewListToolsPayload(cursor *string, limit *int32, deploymentID *string, urnPrefix *string, includeHidden bool, sessionToken *string, projectSlugInput *string) *tools.ListToolsPayload {
