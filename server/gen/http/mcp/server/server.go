...
// New instantiates HTTP handlers for all the mcp service endpoints using the
...
func (s *Server) Service() string { return "mcp" }
...
func (s *Server) MethodNames() []string { return mcp.MethodNames[:] }
