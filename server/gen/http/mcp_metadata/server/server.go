...
func MountGetMcpMetadataHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/mcpMetadata.get", otelhttp.WithRouteTag("/rpc/mcpMetadata.get", f).ServeHTTP)
}
...
func MountSetMcpMetadataHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/mcpMetadata.set", otelhttp.WithRouteTag("/rpc/mcpMetadata.set", f).ServeHTTP)
}
