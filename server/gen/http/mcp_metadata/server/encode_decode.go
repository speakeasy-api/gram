...
func DecodeSetMcpMetadataRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*mcpmetadata.SetMcpMetadataPayload, error) {
	return func(r *http.Request) (*mcpmetadata.SetMcpMetadataPayload, error) {
		var payload *mcpmetadata.SetMcpMetadataPayload
		var (
...
// EncodeDetachMcpEnvironmentResponse returns an encoder for responses returned
// by the mcpMetadata detachMcpEnvironment endpoint.
func EncodeDetachMcpEnvironmentResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		w.WriteHeader(http.StatusOK)
		return nil
	}
...
// DecodeDetachMcpEnvironmentRequest returns a decoder for requests sent to the
// mcpMetadata detachMcpEnvironment endpoint.
func DecodeDetachMcpEnvironmentRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*mcpmetadata.DetachMcpEnvironmentPayload, error) {
	return func(r *http.Request) (*mcpmetadata.DetachMcpEnvironmentPayload, error) {
		var payload *mcpmetadata.DetachMcpEnvironmentPayload
		var (
			toolsetSlug      string
			apikeyToken      *string
			sessionToken     *string
		...
		payload = NewDetachMcpEnvironmentPayload(toolsetSlug, apikeyToken, sessionToken, projectSlugInput)
		if payload.ApikeyToken != nil {
			if strings.Contains(*payload.ApikeyToken, " ") {
				// Remove authorization scheme prefix (e.g. "Bearer")
				cred := strings.SplitN(*payload.ApikeyToken, " ", 2)[1]
...
// EncodeDetachMcpEnvironmentError returns an encoder for errors returned by
// the detachMcpEnvironment mcpMetadata endpoint.
func EncodeDetachMcpEnvironmentError(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder, formatter func(ctx context.Context, err error) goahttp.Statuser) func(context.Context, http.ResponseWriter, error) error {
	encodeError := goahttp.ErrorEncoder(encoder, formatter)
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		var en goa.GoaErrorNamer
		if !errors.As(v, &en) {
		...
		case "unauthorized":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentUnauthorizedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnauthorized)
			return enc.Encode(body)
		case "forbidden":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentForbiddenResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
		case "bad_request":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentBadRequestResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadRequest)
			return enc.Encode(body)
		case "not_found":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentNotFoundResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusNotFound)
			return enc.Encode(body)
		case "conflict":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentConflictResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusConflict)
			return enc.Encode(body)
		case "unsupported_media":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentUnsupportedMediaResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnsupportedMediaType)
			return enc.Encode(body)
		case "invalid":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentInvalidResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusUnprocessableEntity)
			return enc.Encode(body)
		case "invariant_violation":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentInvariantViolationResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "unexpected":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentUnexpectedResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusInternalServerError)
			return enc.Encode(body)
		case "gateway_error":
			...
			if formatter != nil {
				...
				body = NewDetachMcpEnvironmentGatewayErrorResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusBadGateway)
			return enc.Encode(body)
...
func DecodeExportMcpMetadataRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*mcpmetadata.ExportMcpMetadataPayload, error) {
	return func(r *http.Request) (*mcpmetadata.ExportMcpMetadataPayload, error) {
		var payload *mcpmetadata.ExportMcpMetadataPayload
		var (
