	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "logs_disabled":
			...
			if formatter != nil {
				...
				body = NewGetMcpMetadataLogsDisabledResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "logs_disabled":
			...
			if formatter != nil {
				...
				body = NewSetMcpMetadataLogsDisabledResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
	...
	return func(ctx context.Context, w http.ResponseWriter, v error) error {
		...
		case "logs_disabled":
			...
			if formatter != nil {
				...
				body = NewExportMcpMetadataLogsDisabledResponseBody(res)
			}
			w.Header().Set("goa-error", res.GoaErrorName())
			w.WriteHeader(http.StatusForbidden)
			return enc.Encode(body)
