...
//
// otelForwarding client HTTP transport
//
// Command:
...
// Client lists the otelForwarding service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the otelForwarding service
// servers.
func NewClient(
	scheme string,
	host string,
...
// GetConfig returns an endpoint that makes HTTP requests to the otelForwarding
...
func (c *Client) GetConfig() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("otelForwarding", "getConfig", err)
		}
...
// otelForwarding service upsertConfig server.
func (c *Client) UpsertConfig() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("otelForwarding", "upsertConfig", err)
		}
		return decodeResponse(resp)
	}
}
...
// otelForwarding service deleteConfig server.
func (c *Client) DeleteConfig() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("otelForwarding", "deleteConfig", err)
		}
		return decodeResponse(resp)
	}
}
