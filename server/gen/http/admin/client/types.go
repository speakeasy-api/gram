...
// NewGetOrganizationFeaturesAdminOrganizationFeaturesOK builds a "admin"
// service "getOrganizationFeatures" endpoint result from a HTTP "OK" response.
func NewGetOrganizationFeaturesAdminOrganizationFeaturesOK(body *GetOrganizationFeaturesResponseBody) *admin.AdminOrganizationFeatures {
	v := &admin.AdminOrganizationFeatures{
...
// ValidateGetOrganizationFeaturesResponseBody runs the validations defined on
// GetOrganizationFeaturesResponseBody
func ValidateGetOrganizationFeaturesResponseBody(body *GetOrganizationFeaturesResponseBody) (err error) {
