...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"never\",\n      \"confirm_prompt\": \"Voluptas veritatis et voluptatem temporibus vel.\",\n      \"description\": \"Consequatur ipsa consectetur et et mollitia non.\",\n      \"name\": \"Accusamus ad non tempore consequatur voluptas.\",\n      \"src_tool_name\": \"Odio non incidunt.\",\n      \"src_tool_urn\": \"Repellat at voluptates consectetur est maxime facilis.\",\n      \"summarizer\": \"Et impedit beatae eveniet alias.\",\n      \"summary\": \"Commodi vel dolorem architecto debitis repellendus aut.\",\n      \"tags\": [\n         \"Tempore maxime.\",\n         \"Aperiam blanditiis et aut enim non iure.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
