...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"session\",\n      \"confirm_prompt\": \"Repudiandae praesentium beatae ut.\",\n      \"description\": \"Placeat aspernatur necessitatibus qui accusamus ipsam accusamus.\",\n      \"name\": \"Sapiente possimus harum libero non.\",\n      \"src_tool_name\": \"Recusandae nobis dolor.\",\n      \"src_tool_urn\": \"Sunt quaerat qui doloribus.\",\n      \"summarizer\": \"Repellat ad vel.\",\n      \"summary\": \"Facere ratione impedit voluptatibus quae ut.\",\n      \"tags\": [\n         \"Minus et.\",\n         \"Non id quae commodi.\",\n         \"Voluptas veniam hic omnis in occaecati alias.\",\n         \"Voluptatibus cupiditate nostrum quia non voluptatem.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
