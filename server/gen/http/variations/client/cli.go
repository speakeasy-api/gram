...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"session\",\n      \"confirm_prompt\": \"Optio rem quae.\",\n      \"description\": \"Magni repellendus nostrum vitae laborum dolorum repellat.\",\n      \"name\": \"Delectus quam qui laborum dolor.\",\n      \"src_tool_name\": \"Et consequuntur eligendi dolorem unde maxime nesciunt.\",\n      \"src_tool_urn\": \"Rerum maxime nisi sit eos.\",\n      \"summarizer\": \"Iure voluptas suscipit alias ex nulla consequuntur.\",\n      \"summary\": \"Rem repudiandae commodi iusto.\",\n      \"tags\": [\n         \"Velit et.\",\n         \"Perspiciatis quasi qui rerum perferendis temporibus.\",\n         \"Soluta odio quis.\",\n         \"Qui qui odio.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
