...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"session\",\n      \"confirm_prompt\": \"Ducimus ducimus dolor ea ut.\",\n      \"description\": \"Aut impedit aperiam explicabo praesentium consequatur.\",\n      \"name\": \"Quae eos sed incidunt in.\",\n      \"src_tool_name\": \"Qui et.\",\n      \"src_tool_urn\": \"Rerum soluta labore debitis est consectetur rerum.\",\n      \"summarizer\": \"Ut molestias est corrupti rerum nihil magnam.\",\n      \"summary\": \"Iste quasi velit ab qui.\",\n      \"tags\": [\n         \"Vel impedit.\",\n         \"Neque excepturi.\",\n         \"Eveniet sint.\",\n         \"Dignissimos quasi ipsum voluptatem accusamus voluptas tempore.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
