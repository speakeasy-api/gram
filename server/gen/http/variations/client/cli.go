...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"never\",\n      \"confirm_prompt\": \"Officia fuga possimus.\",\n      \"description\": \"Illum rerum voluptatibus provident illo at.\",\n      \"name\": \"Odit at natus porro saepe.\",\n      \"src_tool_name\": \"Modi ad minima qui et cumque reiciendis.\",\n      \"src_tool_urn\": \"Possimus molestias.\",\n      \"summarizer\": \"Velit occaecati voluptatem aut ad nihil.\",\n      \"summary\": \"Culpa dolores voluptatem consectetur suscipit provident.\",\n      \"tags\": [\n         \"Quos corporis nihil sit in.\",\n         \"Ratione sequi voluptatem quis omnis.\",\n         \"Vel vel ut commodi.\",\n         \"Id dignissimos culpa molestias et beatae.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
