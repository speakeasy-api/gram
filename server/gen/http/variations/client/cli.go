...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"never\",\n      \"confirm_prompt\": \"At voluptates consectetur est maxime facilis corrupti.\",\n      \"description\": \"Accusamus ad non tempore consequatur voluptas.\",\n      \"name\": \"Non incidunt hic.\",\n      \"src_tool_name\": \"Dignissimos sed eos voluptas suscipit.\",\n      \"src_tool_urn\": \"Est dolorem necessitatibus sequi.\",\n      \"summarizer\": \"Mollitia non.\",\n      \"summary\": \"Voluptas veritatis et voluptatem temporibus vel.\",\n      \"tags\": [\n         \"Vel dolorem architecto debitis repellendus.\",\n         \"Sequi consequatur ipsa consectetur et.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
