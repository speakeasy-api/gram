...
func BuildUpsertGlobalPayload(variationsUpsertGlobalBody string, variationsUpsertGlobalSessionToken string, variationsUpsertGlobalApikeyToken string, variationsUpsertGlobalProjectSlugInput string) (*variations.UpsertGlobalPayload, error) {
	...
	var body UpsertGlobalRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"confirm\": \"never\",\n      \"confirm_prompt\": \"Non hic dolor.\",\n      \"description\": \"Sit et voluptas optio deserunt quis.\",\n      \"name\": \"Deleniti quam dignissimos perspiciatis dignissimos voluptatem.\",\n      \"src_tool_name\": \"Est dignissimos cupiditate amet.\",\n      \"src_tool_urn\": \"Quasi natus deserunt et.\",\n      \"summarizer\": \"Mollitia et tempora.\",\n      \"summary\": \"Sint nam nihil eaque corrupti qui.\",\n      \"tags\": [\n         \"Delectus et rerum et et aut cumque.\",\n         \"Tempore reiciendis voluptas quo consequatur aperiam.\",\n         \"Dolor quae.\"\n      ]\n   }'")
		}
		if body.Confirm != nil {
