...
func BuildCreateToolsetPayload(toolsetsCreateToolsetBody string, toolsetsCreateToolsetSessionToken string, toolsetsCreateToolsetApikeyToken string, toolsetsCreateToolsetProjectSlugInput string) (*toolsets.CreateToolsetPayload, error) {
	...
	var body CreateToolsetRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"default_environment_slug\": \"iwk\",\n      \"description\": \"Ut eius modi quaerat veritatis aut.\",\n      \"name\": \"Porro aspernatur ut quo est.\",\n      \"resource_urns\": [\n         \"Temporibus quia laboriosam nihil libero.\",\n         \"Dolorum repellendus.\"\n      ],\n      \"tool_urns\": [\n         \"Quasi nostrum et.\",\n         \"Eos quasi.\"\n      ]\n   }'")
		}
...
func BuildUpdateToolsetPayload(toolsetsUpdateToolsetBody string, toolsetsUpdateToolsetSlug string, toolsetsUpdateToolsetSessionToken string, toolsetsUpdateToolsetApikeyToken string, toolsetsUpdateToolsetProjectSlugInput string) (*toolsets.UpdateToolsetPayload, error) {
	...
	var body UpdateToolsetRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"custom_domain_id\": \"Occaecati deserunt.\",\n      \"default_environment_slug\": \"0xi\",\n      \"description\": \"Enim quasi perferendis voluptas.\",\n      \"mcp_enabled\": true,\n      \"mcp_is_public\": true,\n      \"mcp_slug\": \"ohm\",\n      \"name\": \"Laudantium aut sed aperiam accusamus.\",\n      \"prompt_template_names\": [\n         \"Et quis rerum veniam ipsum.\",\n         \"Et in maxime pariatur laudantium.\"\n      ],\n      \"resource_urns\": [\n         \"Molestiae soluta.\",\n         \"Suscipit qui repudiandae vero vero dolorem autem.\",\n         \"Eius molestiae.\"\n      ],\n      \"tool_selection_mode\": \"Placeat vero non maiores sapiente id.\",\n      \"tool_urns\": [\n         \"Totam consequatur.\",\n         \"Non voluptates.\",\n         \"Cupiditate voluptas sint libero.\",\n         \"Quisquam voluptate in dolorem enim.\"\n      ]\n   }'")
		}
		if body.DefaultEnvironmentSlug != nil {
			err = goa.MergeErrors(err, goa.ValidatePattern("body.default_environment_slug", *body.DefaultEnvironmentSlug, "^[a-z0-9_-]{1,128}$"))
		}
