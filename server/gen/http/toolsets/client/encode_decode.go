...
// BuildListToolsetsForOrgRequest instantiates a HTTP request object with
// method and path set to call the "toolsets" service "listToolsetsForOrg"
// endpoint
func (c *Client) BuildListToolsetsForOrgRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: ListToolsetsForOrgToolsetsPath()}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("toolsets", "listToolsetsForOrg", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeListToolsetsForOrgRequest returns an encoder for requests sent to the
// toolsets listToolsetsForOrg server.
func EncodeListToolsetsForOrgRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*toolsets.ListToolsetsForOrgPayload)
		if !ok {
			return goahttp.ErrInvalidType("toolsets", "listToolsetsForOrg", "*toolsets.ListToolsetsForOrgPayload", v)
		}
		if p.SessionToken != nil {
			head := *p.SessionToken
			req.Header.Set("Gram-Session", head)
...
// DecodeListToolsetsForOrgResponse returns a decoder for responses returned by
// the toolsets listToolsetsForOrg endpoint. restoreBody controls whether the
// response body should be restored after having been read.
// DecodeListToolsetsForOrgResponse may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): http.StatusUnauthorized
//   - "forbidden" (type *goa.ServiceError): http.StatusForbidden
//   - "bad_request" (type *goa.ServiceError): http.StatusBadRequest
//   - "not_found" (type *goa.ServiceError): http.StatusNotFound
...
//   - "gateway_error" (type *goa.ServiceError): http.StatusBadGateway
//   - error: internal error
func DecodeListToolsetsForOrgResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("toolsets", "listToolsetsForOrg", err)
			}
			err = ValidateListToolsetsForOrgResponseBody(&body)
			if err != nil {
		...
		case http.StatusUnauthorized:
			...
			err = ValidateListToolsetsForOrgUnauthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgUnauthorized(&body)
		case http.StatusForbidden:
			var (
			...
			err = ValidateListToolsetsForOrgForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgForbidden(&body)
		case http.StatusBadRequest:
			var (
			...
			err = ValidateListToolsetsForOrgBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgBadRequest(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateListToolsetsForOrgNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgNotFound(&body)
		case http.StatusConflict:
			var (
			...
			err = ValidateListToolsetsForOrgConflictResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgConflict(&body)
		case http.StatusUnsupportedMediaType:
			var (
			...
			err = ValidateListToolsetsForOrgUnsupportedMediaResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgUnsupportedMedia(&body)
		case http.StatusUnprocessableEntity:
			var (
			...
			err = ValidateListToolsetsForOrgInvalidResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgInvalid(&body)
		case http.StatusInternalServerError:
			en := resp.Header.Get("goa-error")
			switch en {
			case "invariant_violation":
				...
				err = ValidateListToolsetsForOrgInvariantViolationResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
				}
				return nil, NewListToolsetsForOrgInvariantViolation(&body)
			case "unexpected":
				var (
				...
				err = ValidateListToolsetsForOrgUnexpectedResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
				}
				return nil, NewListToolsetsForOrgUnexpected(&body)
			default:
				body, _ := io.ReadAll(resp.Body)
				return nil, goahttp.ErrInvalidResponse("toolsets", "listToolsetsForOrg", resp.StatusCode, string(body))
			}
		case http.StatusBadGateway:
			var (
			...
			err = ValidateListToolsetsForOrgGatewayErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "listToolsetsForOrg", err)
			}
			return nil, NewListToolsetsForOrgGatewayError(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("toolsets", "listToolsetsForOrg", resp.StatusCode, string(body))
		}
...
// BuildClearUserSessionIssuerRequest instantiates a HTTP request object with
// method and path set to call the "toolsets" service "clearUserSessionIssuer"
// endpoint
func (c *Client) BuildClearUserSessionIssuerRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: ClearUserSessionIssuerToolsetsPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("toolsets", "clearUserSessionIssuer", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeClearUserSessionIssuerRequest returns an encoder for requests sent to
// the toolsets clearUserSessionIssuer server.
func EncodeClearUserSessionIssuerRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*toolsets.ClearUserSessionIssuerPayload)
		if !ok {
			return goahttp.ErrInvalidType("toolsets", "clearUserSessionIssuer", "*toolsets.ClearUserSessionIssuerPayload", v)
		}
		if p.SessionToken != nil {
			head := *p.SessionToken
			req.Header.Set("Gram-Session", head)
...
// DecodeClearUserSessionIssuerResponse returns a decoder for responses
// returned by the toolsets clearUserSessionIssuer endpoint. restoreBody
// controls whether the response body should be restored after having been read.
// DecodeClearUserSessionIssuerResponse may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): http.StatusUnauthorized
//   - "forbidden" (type *goa.ServiceError): http.StatusForbidden
//   - "bad_request" (type *goa.ServiceError): http.StatusBadRequest
//   - "not_found" (type *goa.ServiceError): http.StatusNotFound
...
//   - "gateway_error" (type *goa.ServiceError): http.StatusBadGateway
//   - error: internal error
func DecodeClearUserSessionIssuerResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("toolsets", "clearUserSessionIssuer", err)
			}
			err = ValidateClearUserSessionIssuerResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			res := NewClearUserSessionIssuerToolsetOK(&body)
			return res, nil
		case http.StatusUnauthorized:
			var (
			...
			err = ValidateClearUserSessionIssuerUnauthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerUnauthorized(&body)
		case http.StatusForbidden:
			var (
			...
			err = ValidateClearUserSessionIssuerForbiddenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerForbidden(&body)
		case http.StatusBadRequest:
			var (
			...
			err = ValidateClearUserSessionIssuerBadRequestResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerBadRequest(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateClearUserSessionIssuerNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerNotFound(&body)
		case http.StatusConflict:
			var (
			...
			err = ValidateClearUserSessionIssuerConflictResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerConflict(&body)
		case http.StatusUnsupportedMediaType:
			var (
			...
			err = ValidateClearUserSessionIssuerUnsupportedMediaResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerUnsupportedMedia(&body)
		case http.StatusUnprocessableEntity:
			var (
			...
			err = ValidateClearUserSessionIssuerInvalidResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerInvalid(&body)
		case http.StatusInternalServerError:
			en := resp.Header.Get("goa-error")
			switch en {
			case "invariant_violation":
				...
				err = ValidateClearUserSessionIssuerInvariantViolationResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
				}
				return nil, NewClearUserSessionIssuerInvariantViolation(&body)
			case "unexpected":
				var (
				...
				err = ValidateClearUserSessionIssuerUnexpectedResponseBody(&body)
				if err != nil {
					return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
				}
				return nil, NewClearUserSessionIssuerUnexpected(&body)
			default:
				body, _ := io.ReadAll(resp.Body)
				return nil, goahttp.ErrInvalidResponse("toolsets", "clearUserSessionIssuer", resp.StatusCode, string(body))
			}
		case http.StatusBadGateway:
			var (
			...
			err = ValidateClearUserSessionIssuerGatewayErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("toolsets", "clearUserSessionIssuer", err)
			}
			return nil, NewClearUserSessionIssuerGatewayError(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("toolsets", "clearUserSessionIssuer", resp.StatusCode, string(body))
		}
...
func unmarshalToolsetEntryResponseBodyToTypesToolsetEntry(v *ToolsetEntryResponseBody) *types.ToolsetEntry {
	...
	if v.ExternalMcpHeaderDefinitions != nil {
		res.ExternalMcpHeaderDefinitions = make([]*types.ExternalMCPHeaderDefinition, len(v.ExternalMcpHeaderDefinitions))
		for i, val := range v.ExternalMcpHeaderDefinitions {
			if val == nil {
				res.ExternalMcpHeaderDefinitions[i] = nil
				continue
			}
			res.ExternalMcpHeaderDefinitions[i] = unmarshalExternalMCPHeaderDefinitionResponseBodyToTypesExternalMCPHeaderDefinition(val)
		}
	}
