...
type ExternalMCPToolDefinitionResponseBody struct {
	...
	Slug string `form:"slug" json:"slug" xml:"slug"`
	// The SSE URL to connect to the MCP server
	...
	// The WWW-Authenticate header value from the external MCP server
	AuthenticateHeader *string `form:"authenticate_header,omitempty" json:"authenticate_header,omitempty" xml:"authenticate_header,omitempty"`
