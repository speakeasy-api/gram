...
type GetDeploymentResponseBody struct {
	...
	OpenapiToolCount *int64 `form:"openapi_tool_count,omitempty" json:"openapi_tool_count,omitempty" xml:"openapi_tool_count,omitempty"`
...
type DeploymentSummaryResponseBody struct {
	...
	OpenapiAssetCount *int64 `form:"openapi_asset_count,omitempty" json:"openapi_asset_count,omitempty" xml:"openapi_asset_count,omitempty"`
	// The number of tools in the deployment generated from OpenAPI documents.
	OpenapiToolCount *int64 `form:"openapi_tool_count,omitempty" json:"openapi_tool_count,omitempty" xml:"openapi_tool_count,omitempty"`
...
func NewGetDeploymentResultOK(body *GetDeploymentResponseBody) *deployments.GetDeploymentResult {
	v := &deployments.GetDeploymentResult{
		...
		OpenapiToolCount:   *body.OpenapiToolCount,
...
func ValidateGetDeploymentResponseBody(body *GetDeploymentResponseBody) (err error) {
	...
	if body.OpenapiToolCount == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("openapi_tool_count", "body"))
	}
...
func ValidateDeploymentSummaryResponseBody(body *DeploymentSummaryResponseBody) (err error) {
	...
	if body.OpenapiAssetCount == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("openapi_asset_count", "body"))
	}
	if body.OpenapiToolCount == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("openapi_tool_count", "body"))
	}
