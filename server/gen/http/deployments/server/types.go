...
type GetDeploymentResponseBody struct {
	...
	OpenapiToolCount int64 `form:"openapi_tool_count" json:"openapi_tool_count" xml:"openapi_tool_count"`
...
type DeploymentSummaryResponseBody struct {
	...
	OpenapiAssetCount int64 `form:"openapi_asset_count" json:"openapi_asset_count" xml:"openapi_asset_count"`
	// The number of tools in the deployment generated from OpenAPI documents.
	OpenapiToolCount int64 `form:"openapi_tool_count" json:"openapi_tool_count" xml:"openapi_tool_count"`
...
func NewGetDeploymentResponseBody(res *deployments.GetDeploymentResult) *GetDeploymentResponseBody {
	body := &GetDeploymentResponseBody{
		...
		OpenapiToolCount:   res.OpenapiToolCount,
