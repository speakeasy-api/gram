...
// Server lists the gram service endpoint HTTP handlers.
type Server struct {
	Mounts           []*MountPoint
...
// New instantiates HTTP handlers for all the gram service endpoints using the
...
func (s *Server) Service() string { return "gram" }
...
func (s *Server) MethodNames() []string { return gram.MethodNames[:] }

// Mount configures the mux to serve the gram endpoints.
...
// MountCreateDeploymentHandler configures the mux to serve the "gram" service
...
// request and calls the "gram" service "createDeployment" endpoint.
func NewCreateDeploymentHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "gram")
