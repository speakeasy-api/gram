...
// result of the "createDeployment" endpoint of the "gram" service.
func NewCreateDeploymentResponseBody(res *gram.DeploymentCreateResult) *CreateDeploymentResponseBody {
...
// NewCreateDeploymentDeploymentCreateForm builds a gram service
// createDeployment endpoint payload.
func NewCreateDeploymentDeploymentCreateForm(body *CreateDeploymentRequestBody) *gram.DeploymentCreateForm {
	...
	if body.Openapi3p1Tools != nil {
		...
		for i, val := range body.Openapi3p1Tools {
			v.Openapi3p1Tools[i] = unmarshalOpenAPI3P1ToolFormRequestBodyToGramOpenAPI3P1ToolForm(val)
		}
	}
