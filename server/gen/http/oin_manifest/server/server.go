...
// Server lists the oinManifest service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Export http.Handler
}
...
// New instantiates HTTP handlers for all the oinManifest service endpoints
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Export", "GET", "/rpc/oinManifest.export"},
		},
...
func (s *Server) Service() string { return "oinManifest" }
...
func (s *Server) MethodNames() []string { return oinmanifest.MethodNames[:] }

// Mount configures the mux to serve the oinManifest endpoints.
...
// MountExportHandler configures the mux to serve the "oinManifest" service
// "export" endpoint.
func MountExportHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/oinManifest.export", f)
}

// NewExportHandler creates a HTTP handler which loads the HTTP request and
// calls the "oinManifest" service "export" endpoint.
func NewExportHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "oinManifest")
		...
		o := res.(*oinmanifest.ExportResponseData)
		defer o.Body.Close()
