...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Resolve", "GET", "/rpc/identity.resolve"},
		},
...
// MountResolveHandler configures the mux to serve the "identity" service
// "resolve" endpoint.
func MountResolveHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/identity.resolve", f)
}

// NewResolveHandler creates a HTTP handler which loads the HTTP request and
// calls the "identity" service "resolve" endpoint.
