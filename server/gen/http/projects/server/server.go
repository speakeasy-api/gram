...
func MountGetProjectHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/projects.get", f)
}
...
func MountCreateProjectHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/projects.create", f)
}
...
func MountListProjectsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/projects.list", f)
}
...
func MountSetLogoHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/projects.setLogo", f)
}
...
func MountListAllowedOriginsHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/projects.listAllowedOrigins", f)
}
...
func MountUpsertAllowedOriginHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/projects.upsertAllowedOrigin", f)
}
...
func MountDeleteProjectHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/rpc/projects.delete", f)
}
