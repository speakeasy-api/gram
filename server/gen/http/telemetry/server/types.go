...
// ListEventLogRequestBody is the type of the "telemetry" service
// "listEventLog" endpoint HTTP request body.
...
// GetEventVolumeRequestBody is the type of the "telemetry" service
// "getEventVolume" endpoint HTTP request body.
...
// GetEventFacetsRequestBody is the type of the "telemetry" service
// "getEventFacets" endpoint HTTP request body.
...
// ListEventLogResponseBody is the type of the "telemetry" service
// "listEventLog" endpoint HTTP response body.
...
// GetEventVolumeResponseBody is the type of the "telemetry" service
...
// GetEventFacetsResponseBody is the type of the "telemetry" service
...
// ListEventLogUnauthorizedResponseBody is the type of the "telemetry" service
...
// ListEventLogForbiddenResponseBody is the type of the "telemetry" service
...
// ListEventLogBadRequestResponseBody is the type of the "telemetry" service
...
// ListEventLogNotFoundResponseBody is the type of the "telemetry" service
...
// ListEventLogConflictResponseBody is the type of the "telemetry" service
...
// ListEventLogUnsupportedMediaResponseBody is the type of the "telemetry"
// service "listEventLog" endpoint HTTP response body for the
// "unsupported_media" error.
...
// ListEventLogInvalidResponseBody is the type of the "telemetry" service
...
// ListEventLogInvariantViolationResponseBody is the type of the "telemetry"
// service "listEventLog" endpoint HTTP response body for the
// "invariant_violation" error.
...
// ListEventLogUnexpectedResponseBody is the type of the "telemetry" service
...
// ListEventLogGatewayErrorResponseBody is the type of the "telemetry" service
...
// GetEventVolumeUnauthorizedResponseBody is the type of the "telemetry"
// service "getEventVolume" endpoint HTTP response body for the "unauthorized"
// error.
...
// GetEventVolumeForbiddenResponseBody is the type of the "telemetry" service
...
// GetEventVolumeBadRequestResponseBody is the type of the "telemetry" service
...
// GetEventVolumeNotFoundResponseBody is the type of the "telemetry" service
...
// GetEventVolumeConflictResponseBody is the type of the "telemetry" service
...
// GetEventVolumeUnsupportedMediaResponseBody is the type of the "telemetry"
...
// GetEventVolumeInvalidResponseBody is the type of the "telemetry" service
...
// GetEventVolumeInvariantViolationResponseBody is the type of the "telemetry"
// service "getEventVolume" endpoint HTTP response body for the
// "invariant_violation" error.
...
// GetEventVolumeUnexpectedResponseBody is the type of the "telemetry" service
...
// GetEventVolumeGatewayErrorResponseBody is the type of the "telemetry"
// service "getEventVolume" endpoint HTTP response body for the "gateway_error"
// error.
...
// GetEventFacetsUnauthorizedResponseBody is the type of the "telemetry"
// service "getEventFacets" endpoint HTTP response body for the "unauthorized"
// error.
...
// GetEventFacetsForbiddenResponseBody is the type of the "telemetry" service
...
// GetEventFacetsBadRequestResponseBody is the type of the "telemetry" service
...
// GetEventFacetsNotFoundResponseBody is the type of the "telemetry" service
...
// GetEventFacetsConflictResponseBody is the type of the "telemetry" service
...
// GetEventFacetsUnsupportedMediaResponseBody is the type of the "telemetry"
...
// GetEventFacetsInvalidResponseBody is the type of the "telemetry" service
...
// GetEventFacetsInvariantViolationResponseBody is the type of the "telemetry"
// service "getEventFacets" endpoint HTTP response body for the
// "invariant_violation" error.
...
// GetEventFacetsUnexpectedResponseBody is the type of the "telemetry" service
...
// GetEventFacetsGatewayErrorResponseBody is the type of the "telemetry"
// service "getEventFacets" endpoint HTTP response body for the "gateway_error"
// error.
...
type EventLogEntryResponseBody struct {
	...
	RecordID string `form:"record_id" json:"record_id" xml:"record_id"`
...
// the "listEventLog" endpoint of the "telemetry" service.
func NewListEventLogResponseBody(res *telemetry.ListEventLogResult) *ListEventLogResponseBody {
	...
	if res.Events != nil {
		...
		for i, val := range res.Events {
			...
			body.Events[i] = marshalTelemetryEventLogEntryToEventLogEntryResponseBody(val)
		}
	} else {
...
// of the "getEventVolume" endpoint of the "telemetry" service.
func NewGetEventVolumeResponseBody(res *telemetry.GetEventVolumeResult) *GetEventVolumeResponseBody {
	...
	if res.Buckets != nil {
		...
		for i, val := range res.Buckets {
			...
			body.Buckets[i] = marshalTelemetryEventVolumeBucketToEventVolumeBucketResponseBody(val)
		}
	} else {
...
// of the "getEventFacets" endpoint of the "telemetry" service.
func NewGetEventFacetsResponseBody(res *telemetry.GetEventFacetsResult) *GetEventFacetsResponseBody {
...
// the result of the "listEventLog" endpoint of the "telemetry" service.
...
// result of the "listEventLog" endpoint of the "telemetry" service.
...
// from the result of the "listEventLog" endpoint of the "telemetry" service.
...
// the result of the "getEventVolume" endpoint of the "telemetry" service.
...
// result of the "getEventVolume" endpoint of the "telemetry" service.
...
// from the result of the "getEventVolume" endpoint of the "telemetry" service.
...
// body from the result of the "getEventVolume" endpoint of the "telemetry"
// service.
...
// the result of the "getEventFacets" endpoint of the "telemetry" service.
...
// result of the "getEventFacets" endpoint of the "telemetry" service.
...
// from the result of the "getEventFacets" endpoint of the "telemetry" service.
...
// body from the result of the "getEventFacets" endpoint of the "telemetry"
// service.
...
// NewListEventLogPayload builds a telemetry service listEventLog endpoint
// payload.
func NewListEventLogPayload(body *ListEventLogRequestBody, sessionToken *string) *telemetry.ListEventLogPayload {
	v := &telemetry.ListEventLogPayload{
		From:   *body.From,
		To:     *body.To,
		Search: body.Search,
		Cursor: body.Cursor,
...
// NewGetEventVolumePayload builds a telemetry service getEventVolume endpoint
// payload.
func NewGetEventVolumePayload(body *GetEventVolumeRequestBody, sessionToken *string) *telemetry.GetEventVolumePayload {
	v := &telemetry.GetEventVolumePayload{
		From:   *body.From,
		To:     *body.To,
		Search: body.Search,
	}
...
// NewGetEventFacetsPayload builds a telemetry service getEventFacets endpoint
// payload.
func NewGetEventFacetsPayload(body *GetEventFacetsRequestBody, sessionToken *string) *telemetry.GetEventFacetsPayload {
	v := &telemetry.GetEventFacetsPayload{
		From: *body.From,
		To:   *body.To,
	}
	if body.Kinds != nil {
