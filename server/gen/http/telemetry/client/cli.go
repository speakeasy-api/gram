...
func BuildSearchLogsPayload(telemetrySearchLogsBody string, telemetrySearchLogsApikeyToken string, telemetrySearchLogsSessionToken string, telemetrySearchLogsProjectSlugInput string) (*telemetry.SearchLogsPayload, error) {
	...
	var body SearchLogsRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"cursor\": \"Odit dolorem omnis quia consequatur.\",\n      \"filter\": {\n         \"deployment_id\": \"54d51955-f335-40b6-be63-347c0ef6e8ac\",\n         \"from\": \"2025-12-19T10:00:00Z\",\n         \"function_id\": \"4fe12eb9-9954-4789-af1c-d49eabe110f4\",\n         \"gram_urn\": \"Qui molestiae id sit.\",\n         \"gram_urns\": [\n            \"Ipsum hic et vitae voluptatibus adipisci.\",\n            \"Praesentium eos consequuntur delectus.\"\n         ],\n         \"http_method\": \"PUT\",\n         \"http_route\": \"Vitae dolores itaque quos dicta veniam.\",\n         \"http_status_code\": 1184111712,\n         \"service_name\": \"Consequatur quo deserunt ab eveniet commodi.\",\n         \"severity_text\": \"WARN\",\n         \"to\": \"2025-12-19T11:00:00Z\",\n         \"trace_id\": \"9d489d33fa450ff2916c6aec9c94de61\"\n      },\n      \"limit\": 373,\n      \"sort\": \"asc\"\n   }'")
		}
	}
