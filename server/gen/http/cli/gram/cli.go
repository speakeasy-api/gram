...
func UsageCommands() []string {
	return []string{
		...
		"tools list-tools",
		"toolsets (create-toolset|list-toolsets|update-toolset|delete-toolset|get-toolset|check-mcp-slug-availability|clone-toolset|add-externaloauth-server|removeoauth-server|addoauth-proxy-server|updateoauth-proxy-server)",
...
func toolsetsUsage() {
	...
	fmt.Fprintln(os.Stderr, `    updateoauth-proxy-server: Update an existing OAuth proxy server associated with a toolset (admin only)`)
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Additional help:")
...
func toolsetsUpdateOAuthProxyServerUsage() {
	...
	// Description
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, `Update an existing OAuth proxy server associated with a toolset (admin only)`)
