...
func UsageCommands() []string {
	return []string{
		"about openapi",
		"access (list-grants|upsert-grants|remove-grants|remove-principal-grants|list-roles|get-role|create-role|update-role|delete-role|list-scopes|list-members|update-member-role)",
