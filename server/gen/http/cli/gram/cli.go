...
func ParseEndpoint(
	...
	var (
		...
		riskListBuiltinPresetsFlags                = flag.NewFlagSet("list-builtin-presets", flag.ExitOnError)
		riskListBuiltinPresetsApikeyTokenFlag      = riskListBuiltinPresetsFlags.String("apikey-token", "", "")
		riskListBuiltinPresetsSessionTokenFlag     = riskListBuiltinPresetsFlags.String("session-token", "", "")
		riskListBuiltinPresetsProjectSlugInputFlag = riskListBuiltinPresetsFlags.String("project-slug-input", "", "")
	...
	riskListBuiltinPresetsFlags.Usage = riskListBuiltinPresetsUsage
	...
	)
	{
		...
		case "risk":
			...
			case "list-builtin-presets":
				epf = riskListBuiltinPresetsFlags
	...
	)
	{
		...
		case "risk":
			...
			case "list-builtin-presets":
				endpoint = c.ListBuiltinPresets()
				data, err = riskc.BuildListBuiltinPresetsPayload(*riskListBuiltinPresetsApikeyTokenFlag, *riskListBuiltinPresetsSessionTokenFlag, *riskListBuiltinPresetsProjectSlugInputFlag)
			case "get-risk-policy":
...
func riskUsage() {
	...
	fmt.Fprintln(os.Stderr, `    list-builtin-presets: List the built-in preset exclusion library (known-safe values suppressed before they reach exclusions), grouped by category.`)
...
func riskListBuiltinPresetsUsage() {
	// Header with flags
	fmt.Fprintf(os.Stderr, "%s [flags] risk list-builtin-presets", os.Args[0])
	fmt.Fprint(os.Stderr, " -apikey-token STRING")
	fmt.Fprint(os.Stderr, " -session-token STRING")
	fmt.Fprint(os.Stderr, " -project-slug-input STRING")
	fmt.Fprintln(os.Stderr)
	...
	// Description
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, `List the built-in preset exclusion library (known-safe values suppressed before they reach exclusions), grouped by category.`)
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "risk list-builtin-presets --apikey-token \"abc123\" --session-token \"abc123\" --project-slug-input \"abc123\"")
}
