...
func UsageExamples() string {
	return os.Args[0] + ` about openapi` + "\n" +
		os.Args[0] + ` assets serve-image --id "Et eos." --session-token "Velit itaque." --apikey-token "Sed nostrum eius aut."` + "\n" +
		os.Args[0] + ` auth callback --code "Sunt nisi velit ullam enim facilis aut."` + "\n" +
...
Example:
    %[1]s assets serve-image --id "Et eos." --session-token "Velit itaque." --apikey-token "Sed nostrum eius aut."
`, os.Args[0])
}
...
Example:
    %[1]s assets upload-image --content-type "Qui eveniet ut." --content-length 380900596527889694 --apikey-token "Unde provident sed beatae sint." --project-slug-input "Placeat et incidunt." --session-token "Voluptatibus laborum est quo modi." --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s assets upload-open-ap-iv3 --content-type "Consequuntur eaque necessitatibus pariatur quia unde." --content-length 1219446558387826704 --apikey-token "Alias qui dolor quae." --project-slug-input "Ipsum voluptatem eveniet non commodi autem." --session-token "Quidem perspiciatis molestiae." --stream "goa.png"
`, os.Args[0])
}
...
Example:
    %[1]s assets serve-open-ap-iv3 --id "Explicabo voluptatem." --project-id "Omnis odio et maiores beatae." --apikey-token "Atque eius nesciunt amet molestias sapiente quisquam." --session-token "Autem repellat incidunt porro."
`, os.Args[0])
}
...
Example:
    %[1]s assets list-assets --session-token "Ut vero quisquam officiis enim non." --project-slug-input "Ratione animi et quia officia ut rerum." --apikey-token "Deleniti iste consequatur velit non dolores."
`, os.Args[0])
}
...
Example:
    %[1]s auth callback --code "Sunt nisi velit ullam enim facilis aut."
`, os.Args[0])
}
...
Example:
    %[1]s auth switch-scopes --organization-id "At omnis quidem et sed odit." --project-id "Deleniti doloribus harum voluptas tenetur aperiam." --session-token "Accusantium nesciunt tenetur sed voluptas odit sint."
`, os.Args[0])
}
...
Example:
    %[1]s auth logout --session-token "Eaque aliquid veritatis nihil illo repellendus."
`, os.Args[0])
}
...
Example:
    %[1]s auth info --session-token "Est temporibus doloremque necessitatibus."
`, os.Args[0])
}
...
Example:
    %[1]s usage create-customer-session --session-token "Dolores quos est." --project-slug-input "Quibusdam aut sequi delectus."
`, os.Args[0])
}
...
Example:
    %[1]s usage create-checkout --session-token "Beatae delectus aut assumenda iusto alias dolor." --project-slug-input "Odit eveniet qui sit recusandae dolore ipsa."
`, os.Args[0])
}
...
Example:
   ...
   }' --session-token "Debitis ipsa rem blanditiis temporibus perferendis." --apikey-token "Fugiat maxime amet veniam maiores aut veritatis." --project-slug-input "Ut consequatur ea rem deserunt."
`, os.Args[0])
}
...
Example:
    %[1]s variations delete-global --variation-id "Quidem eaque rerum sunt vero iste." --session-token "Libero aut ipsa qui quis ea quis." --apikey-token "Ut pariatur est iusto." --project-slug-input "Mollitia cupiditate repellendus aspernatur ad amet."
`, os.Args[0])
}
...
Example:
    %[1]s variations list-global --session-token "Rerum quae voluptas eveniet ut enim." --apikey-token "Velit impedit est similique." --project-slug-input "Ut vel non nemo rerum sed."
`, os.Args[0])
}
