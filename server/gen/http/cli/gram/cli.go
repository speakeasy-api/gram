...
func UsageCommands() []string {
	return []string{
		...
		"user-sessions (list-user-sessions|roast-user-session|revoke-user-session)",
...
func ParseEndpoint(
	...
	userSessionsRoastUserSessionFlags.Usage = userSessionsRoastUserSessionUsage
	...
	)
	{
		...
		case "user-sessions":
			...
			case "roast-user-session":
				epf = userSessionsRoastUserSessionFlags
...
func userSessionsUsage() {
	...
	fmt.Fprintln(os.Stderr, `    roast-user-session: Return a hand-curated roast for the given session. Strictly informational; does not affect session state.`)
...
func userSessionsRoastUserSessionUsage() {
	// Header with flags
	...
	// Description
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, `Return a hand-curated roast for the given session. Strictly informational; does not affect session state.`)
