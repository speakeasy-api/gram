...
func ParseEndpoint(
	...
	var (
		...
		riskCompileCelApikeyTokenFlag      = riskCompileCelFlags.String("apikey-token", "", "")
		riskCompileCelSessionTokenFlag     = riskCompileCelFlags.String("session-token", "", "")
		riskCompileCelProjectSlugInputFlag = riskCompileCelFlags.String("project-slug-input", "", "")
...
func riskCompileCelUsage() {
	// Header with flags
	fmt.Fprintf(os.Stderr, "%s [flags] risk compile-cel", os.Args[0])
	fmt.Fprint(os.Stderr, " -cel STRING")
	fmt.Fprint(os.Stderr, " -apikey-token STRING")
	fmt.Fprint(os.Stderr, " -session-token STRING")
	fmt.Fprint(os.Stderr, " -project-slug-input STRING")
	fmt.Fprintln(os.Stderr)
	...
	// Flags list
	fmt.Fprintln(os.Stderr, `    -cel STRING: `)
	fmt.Fprintln(os.Stderr, `    -apikey-token STRING: `)
	fmt.Fprintln(os.Stderr, `    -session-token STRING: `)
	fmt.Fprintln(os.Stderr, `    -project-slug-input STRING: `)
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "risk compile-cel --cel \"abc123\" --apikey-token \"abc123\" --session-token \"abc123\" --project-slug-input \"abc123\"")
}
