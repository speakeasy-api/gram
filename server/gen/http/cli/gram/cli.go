...
func assetsUploadImageUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `assets upload-image --content-type "Et dolor nisi aut doloremque animi assumenda." --content-length 5254674163527820156 --apikey-token "Aliquid omnis saepe et." --project-slug-input "Sunt debitis harum et nihil rerum reprehenderit." --session-token "Omnis alias repellat dolores." --stream "goa.png"`)
}
...
func assetsUploadFunctionsUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `assets upload-functions --content-type "Dolor ad rerum." --content-length 5429330018467874146 --apikey-token "Ullam officiis non id." --project-slug-input "Praesentium sit incidunt consequuntur nihil consequuntur." --session-token "Dicta tempore earum illum." --stream "goa.png"`)
}
...
func assetsUploadOpenAPIv3Usage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `assets upload-open-ap-iv3 --content-type "Inventore nostrum cumque qui repudiandae." --content-length 8385747314717237283 --apikey-token "Ea delectus facere." --project-slug-input "Facilis repellat soluta reiciendis quia vel." --session-token "Odio enim culpa qui." --stream "goa.png"`)
}
...
func assetsServeOpenAPIv3Usage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `assets serve-open-ap-iv3 --id "Dolor cupiditate sint facilis alias ut." --project-id "Sit quam ut error eveniet placeat autem." --apikey-token "Delectus autem placeat rem nihil." --session-token "Quasi quia et consequatur et."`)
}
...
func assetsListAssetsUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `assets list-assets --session-token "Minima laboriosam ipsam qui non." --project-slug-input "Quam recusandae ipsum." --apikey-token "Ut sint nihil rerum repellat qui."`)
}
...
func authSwitchScopesUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `auth switch-scopes --organization-id "Ut molestiae." --project-id "Quasi et omnis nihil repudiandae aut." --session-token "Aliquam sint velit qui quasi."`)
}
...
func authLogoutUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `auth logout --session-token "Adipisci aliquam."`)
}
...
func authRegisterUsage() {
   ...
   }' --session-token "Aut magni aut natus rerum."`)
}
...
func authInfoUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `auth info --session-token "Ut porro ut repudiandae iure qui."`)
}
...
func chatLoadChatUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `chat load-chat --id "Repellendus cupiditate iste inventore." --session-token "Accusamus aut." --project-slug-input "Tempore facere minus ratione qui facilis laudantium."`)
}
...
func chatCreditUsageUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `chat credit-usage --session-token "Officiis consectetur velit ipsa." --project-slug-input "Laboriosam ut voluptatem dolorem."`)
}
...
func deploymentsGetLatestDeploymentUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `deployments get-latest-deployment --apikey-token "Ducimus cumque amet a id." --session-token "Placeat quasi ut rem." --project-slug-input "Aliquam laudantium in id sit vel praesentium."`)
}
...
func deploymentsGetActiveDeploymentUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `deployments get-active-deployment --apikey-token "Dolor iste." --session-token "Ex nihil ex eligendi." --project-slug-input "Sed laudantium voluptatum qui est."`)
}
...
func mcpMetadataGetMcpMetadataUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `mcp-metadata get-mcp-metadata --toolset-slug "s0e" --session-token "Voluptate illo expedita quis dolore." --project-slug-input "Distinctio maiores et eum laboriosam."`)
}
...
func mcpMetadataSetMcpMetadataUsage() {
	...
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `mcp-metadata set-mcp-metadata --body '{
      ...
      "toolset_slug": "xy3"
   }' --session-token "Voluptatem dolor aliquid accusamus quia." --project-slug-input "Reiciendis vel."`)
}
...
func packagesCreatePackageUsage() {
	...
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `packages create-package --body '{
      ...
      "title": "pp2",
      "url": "4p2"
   }' --apikey-token "Et incidunt eaque quam numquam sit est." --session-token "Hic et sed." --project-slug-input "Optio non reiciendis."`)
}
...
func packagesListPackagesUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `packages list-packages --apikey-token "Voluptatem sit in quod iste doloremque." --session-token "Maiores distinctio voluptas omnis quae enim." --project-slug-input "Dicta voluptatem qui."`)
}
...
func packagesListVersionsUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `packages list-versions --name "Labore qui sequi qui aut enim sit." --apikey-token "Magni eveniet." --session-token "Qui est mollitia." --project-slug-input "Reiciendis voluptatem quas laborum sint."`)
}
...
func packagesPublishUsage() {
	...
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `packages publish --body '{
      ...
      "visibility": "private"
   }' --apikey-token "Quo aspernatur laboriosam vero." --session-token "Illum ut quos quis velit." --project-slug-input "Sit qui sapiente et natus sit porro."`)
}
...
func projectsCreateProjectUsage() {
   ...
   }' --apikey-token "Et qui quia et necessitatibus iure non." --session-token "Sunt modi est corrupti amet numquam excepturi."`)
}
...
func projectsListProjectsUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `projects list-projects --organization-id "Mollitia eaque quibusdam et rerum illo dolore." --apikey-token "Possimus beatae ex ut." --session-token "Dolores odit."`)
}
...
func projectsSetLogoUsage() {
   ...
   }' --apikey-token "Maxime voluptate hic quia eius et vel." --session-token "Quis repudiandae ipsam." --project-slug-input "Sunt architecto laudantium atque pariatur velit."`)
}
...
func slackCallbackUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `slack callback --state "Nulla in officiis ea voluptas cum pariatur." --code "Ullam sed explicabo enim consequuntur dignissimos deserunt."`)
}
...
func slackLoginUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `slack login --project-slug "Dolores ut sed et ipsum magnam quam." --return-url "Et sit distinctio ratione nulla exercitationem temporibus." --session-token "Quasi a numquam."`)
}
...
func slackGetSlackConnectionUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `slack get-slack-connection --session-token "Odio placeat." --project-slug-input "Sunt cum nesciunt tempora qui ipsa."`)
}
...
func slackUpdateSlackConnectionUsage() {
   ...
   }' --session-token "Ad aut id accusamus eligendi." --project-slug-input "Aut quasi delectus totam ut."`)
}
...
func slackDeleteSlackConnectionUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], `slack delete-slack-connection --session-token "Expedita minima dolor necessitatibus numquam et." --project-slug-input "Qui repellendus porro eius occaecati et."`)
}
