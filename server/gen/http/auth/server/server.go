...
func MountLoginHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/rpc/auth.login", f)
}
...
func MountRefreshHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/auth.refresh", f)
}
...
func MountLogoutHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/auth.logout", f)
}
...
func MountRegisterHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/rpc/auth.register", f)
}
