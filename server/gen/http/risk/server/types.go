...
// ReleaseSessionQuarantineRequestBody is the type of the "risk" service
// "releaseSessionQuarantine" endpoint HTTP request body.
type ReleaseSessionQuarantineRequestBody struct {
...
type MarkRiskResultsFalsePositiveRequestBody struct {
	...
	ResultIds []string `form:"result_ids,omitempty" json:"result_ids,omitempty" xml:"result_ids,omitempty"`
	// Optional free-text reason for the dismissal.
	Reason *string `form:"reason,omitempty" json:"reason,omitempty" xml:"reason,omitempty"`
}

// UnmarkRiskResultsFalsePositiveRequestBody is the type of the "risk" service
// "unmarkRiskResultsFalsePositive" endpoint HTTP request body.
type UnmarkRiskResultsFalsePositiveRequestBody struct {
	// IDs of the risk results to restore.
	ResultIds []string `form:"result_ids,omitempty" json:"result_ids,omitempty" xml:"result_ids,omitempty"`
}

// SuggestRiskPolicyRequestBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP request body.
type SuggestRiskPolicyRequestBody struct {
...
// "acknowledgeRiskPolicyChallenge" endpoint HTTP request body.
type AcknowledgeRiskPolicyChallengeRequestBody struct {
	// Acknowledgement token generated when a warn policy challenged the action.
	AckToken *string `form:"ack_token,omitempty" json:"ack_token,omitempty" xml:"ack_token,omitempty"`
}

// GetRiskPolicyChallengeRequestBody is the type of the "risk" service
// "getRiskPolicyChallenge" endpoint HTTP request body.
type GetRiskPolicyChallengeRequestBody struct {
	// Acknowledgement token generated when a warn policy challenged the action.
	AckToken *string `form:"ack_token,omitempty" json:"ack_token,omitempty" xml:"ack_token,omitempty"`
}

// DeclineRiskPolicyChallengeRequestBody is the type of the "risk" service
// "declineRiskPolicyChallenge" endpoint HTTP request body.
type DeclineRiskPolicyChallengeRequestBody struct {
	// Acknowledgement token generated when a warn policy challenged the action.
	AckToken *string `form:"ack_token,omitempty" json:"ack_token,omitempty" xml:"ack_token,omitempty"`
}
...
// ListSessionQuarantinesResponseBody is the type of the "risk" service
// "listSessionQuarantines" endpoint HTTP response body.
type ListSessionQuarantinesResponseBody struct {
	// Active session quarantines.
	Quarantines []*SessionQuarantineResponseBody `form:"quarantines" json:"quarantines" xml:"quarantines"`
}

// ReleaseSessionQuarantineResponseBody is the type of the "risk" service
// "releaseSessionQuarantine" endpoint HTTP response body.
type ReleaseSessionQuarantineResponseBody struct {
	// The session quarantine ID.
	ID string `form:"id" json:"id" xml:"id"`
	// The organization ID.
	...
	RiskPolicyName string `form:"risk_policy_name" json:"risk_policy_name" xml:"risk_policy_name"`
	...
	ReleasedAt *string `form:"released_at,omitempty" json:"released_at,omitempty" xml:"released_at,omitempty"`
	// The user who released the quarantine.
	ReleasedBy *string `form:"released_by,omitempty" json:"released_by,omitempty" xml:"released_by,omitempty"`
}
...
// ListDismissedRiskResultsResponseBody is the type of the "risk" service
// "listDismissedRiskResults" endpoint HTTP response body.
...
// ListRiskPresetsResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body.
type ListRiskPresetsResponseBody struct {
	// Presets in display order.
	Presets []*RiskPresetResponseBody `form:"presets" json:"presets" xml:"presets"`
}

// SuggestRiskPolicyResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body.
type SuggestRiskPolicyResponseBody struct {
	// Matched preset identifier; empty when the draft is a bespoke prompt-based
	// guardrail.
	PresetID string `form:"preset_id" json:"preset_id" xml:"preset_id"`
	...
	PresidioEntities []string `form:"presidio_entities" json:"presidio_entities" xml:"presidio_entities"`
	...
	// none.
	UserMessage string `form:"user_message" json:"user_message" xml:"user_message"`
	...
	Alternatives []*RiskPresetMatchResponseBody `form:"alternatives" json:"alternatives" xml:"alternatives"`
}
...
// GetRiskSignalsResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body.
type GetRiskSignalsResponseBody struct {
	...
	OrgRiskScore float64 `form:"org_risk_score" json:"org_risk_score" xml:"org_risk_score"`
	...
	CriticalSignals int64 `form:"critical_signals" json:"critical_signals" xml:"critical_signals"`
	// Distinct users with at least one finding in the window.
	UsersExposed int64 `form:"users_exposed" json:"users_exposed" xml:"users_exposed"`
	// Distinct users with at least one finding in the equal-length window
	// immediately before from.
	PreviousUsersExposed int64 `form:"previous_users_exposed" json:"previous_users_exposed" xml:"previous_users_exposed"`
...
// "acknowledgeRiskPolicyChallenge" endpoint HTTP response body.
type AcknowledgeRiskPolicyChallengeResponseBody struct {
...
// GetRiskPolicyChallengeResponseBody is the type of the "risk" service
// "getRiskPolicyChallenge" endpoint HTTP response body.
type GetRiskPolicyChallengeResponseBody struct {
	// The policy that issued the warning.
	PolicyName *string `form:"policy_name,omitempty" json:"policy_name,omitempty" xml:"policy_name,omitempty"`
...
// DeclineRiskPolicyChallengeResponseBody is the type of the "risk" service
// "declineRiskPolicyChallenge" endpoint HTTP response body.
type DeclineRiskPolicyChallengeResponseBody struct {
	// Whether the challenge is now declined.
	Declined bool `form:"declined" json:"declined" xml:"declined"`
}
...
// SuggestExclusionResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body.
type SuggestExclusionResponseBody struct {
...
// ListSessionQuarantinesUnauthorizedResponseBody is the type of the "risk"
// service "listSessionQuarantines" endpoint HTTP response body for the
// "unauthorized" error.
type ListSessionQuarantinesUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesForbiddenResponseBody is the type of the "risk"
// service "listSessionQuarantines" endpoint HTTP response body for the
// "forbidden" error.
type ListSessionQuarantinesForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesBadRequestResponseBody is the type of the "risk"
// service "listSessionQuarantines" endpoint HTTP response body for the
// "bad_request" error.
type ListSessionQuarantinesBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesNotFoundResponseBody is the type of the "risk" service
// "listSessionQuarantines" endpoint HTTP response body for the "not_found"
// error.
type ListSessionQuarantinesNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesConflictResponseBody is the type of the "risk" service
// "listSessionQuarantines" endpoint HTTP response body for the "conflict"
// error.
type ListSessionQuarantinesConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesUnsupportedMediaResponseBody is the type of the "risk"
// service "listSessionQuarantines" endpoint HTTP response body for the
// "unsupported_media" error.
type ListSessionQuarantinesUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesInvalidResponseBody is the type of the "risk" service
// "listSessionQuarantines" endpoint HTTP response body for the "invalid" error.
type ListSessionQuarantinesInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesInvariantViolationResponseBody is the type of the
// "risk" service "listSessionQuarantines" endpoint HTTP response body for the
// "invariant_violation" error.
type ListSessionQuarantinesInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesUnexpectedResponseBody is the type of the "risk"
// service "listSessionQuarantines" endpoint HTTP response body for the
// "unexpected" error.
type ListSessionQuarantinesUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListSessionQuarantinesGatewayErrorResponseBody is the type of the "risk"
// service "listSessionQuarantines" endpoint HTTP response body for the
// "gateway_error" error.
type ListSessionQuarantinesGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineUnauthorizedResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "unauthorized" error.
type ReleaseSessionQuarantineUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineForbiddenResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "forbidden" error.
type ReleaseSessionQuarantineForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineBadRequestResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "bad_request" error.
type ReleaseSessionQuarantineBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineNotFoundResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "not_found" error.
type ReleaseSessionQuarantineNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineConflictResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "conflict" error.
type ReleaseSessionQuarantineConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineUnsupportedMediaResponseBody is the type of the
// "risk" service "releaseSessionQuarantine" endpoint HTTP response body for
// the "unsupported_media" error.
type ReleaseSessionQuarantineUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineInvalidResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "invalid" error.
type ReleaseSessionQuarantineInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineInvariantViolationResponseBody is the type of the
// "risk" service "releaseSessionQuarantine" endpoint HTTP response body for
// the "invariant_violation" error.
type ReleaseSessionQuarantineInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineUnexpectedResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "unexpected" error.
type ReleaseSessionQuarantineUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ReleaseSessionQuarantineGatewayErrorResponseBody is the type of the "risk"
// service "releaseSessionQuarantine" endpoint HTTP response body for the
// "gateway_error" error.
type ReleaseSessionQuarantineGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveUnauthorizedResponseBody is the type of the
// "risk" service "markRiskResultsFalsePositive" endpoint HTTP response body
// for the "unauthorized" error.
type MarkRiskResultsFalsePositiveUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveForbiddenResponseBody is the type of the "risk"
// service "markRiskResultsFalsePositive" endpoint HTTP response body for the
// "forbidden" error.
type MarkRiskResultsFalsePositiveForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveBadRequestResponseBody is the type of the "risk"
// service "markRiskResultsFalsePositive" endpoint HTTP response body for the
// "bad_request" error.
type MarkRiskResultsFalsePositiveBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveNotFoundResponseBody is the type of the "risk"
// service "markRiskResultsFalsePositive" endpoint HTTP response body for the
// "not_found" error.
type MarkRiskResultsFalsePositiveNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveConflictResponseBody is the type of the "risk"
// service "markRiskResultsFalsePositive" endpoint HTTP response body for the
// "conflict" error.
type MarkRiskResultsFalsePositiveConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveUnsupportedMediaResponseBody is the type of the
// "risk" service "markRiskResultsFalsePositive" endpoint HTTP response body
// for the "unsupported_media" error.
type MarkRiskResultsFalsePositiveUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveInvalidResponseBody is the type of the "risk"
// service "markRiskResultsFalsePositive" endpoint HTTP response body for the
// "invalid" error.
type MarkRiskResultsFalsePositiveInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveInvariantViolationResponseBody is the type of
// the "risk" service "markRiskResultsFalsePositive" endpoint HTTP response
// body for the "invariant_violation" error.
type MarkRiskResultsFalsePositiveInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveUnexpectedResponseBody is the type of the "risk"
// service "markRiskResultsFalsePositive" endpoint HTTP response body for the
// "unexpected" error.
type MarkRiskResultsFalsePositiveUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// MarkRiskResultsFalsePositiveGatewayErrorResponseBody is the type of the
// "risk" service "markRiskResultsFalsePositive" endpoint HTTP response body
// for the "gateway_error" error.
type MarkRiskResultsFalsePositiveGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveUnauthorizedResponseBody is the type of the
// "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response body
// for the "unauthorized" error.
type UnmarkRiskResultsFalsePositiveUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveForbiddenResponseBody is the type of the
// "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response body
// for the "forbidden" error.
type UnmarkRiskResultsFalsePositiveForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveBadRequestResponseBody is the type of the
// "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response body
// for the "bad_request" error.
type UnmarkRiskResultsFalsePositiveBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveNotFoundResponseBody is the type of the "risk"
// service "unmarkRiskResultsFalsePositive" endpoint HTTP response body for the
// "not_found" error.
type UnmarkRiskResultsFalsePositiveNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveConflictResponseBody is the type of the "risk"
// service "unmarkRiskResultsFalsePositive" endpoint HTTP response body for the
// "conflict" error.
type UnmarkRiskResultsFalsePositiveConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveUnsupportedMediaResponseBody is the type of
// the "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response
// body for the "unsupported_media" error.
type UnmarkRiskResultsFalsePositiveUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveInvalidResponseBody is the type of the "risk"
// service "unmarkRiskResultsFalsePositive" endpoint HTTP response body for the
// "invalid" error.
type UnmarkRiskResultsFalsePositiveInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveInvariantViolationResponseBody is the type of
// the "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response
// body for the "invariant_violation" error.
type UnmarkRiskResultsFalsePositiveInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveUnexpectedResponseBody is the type of the
// "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response body
// for the "unexpected" error.
type UnmarkRiskResultsFalsePositiveUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// UnmarkRiskResultsFalsePositiveGatewayErrorResponseBody is the type of the
// "risk" service "unmarkRiskResultsFalsePositive" endpoint HTTP response body
// for the "gateway_error" error.
type UnmarkRiskResultsFalsePositiveGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsUnauthorizedResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "unauthorized" error.
type ListDismissedRiskResultsUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsForbiddenResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "forbidden" error.
type ListDismissedRiskResultsForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsBadRequestResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "bad_request" error.
type ListDismissedRiskResultsBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsNotFoundResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "not_found" error.
type ListDismissedRiskResultsNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsConflictResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "conflict" error.
type ListDismissedRiskResultsConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsUnsupportedMediaResponseBody is the type of the
// "risk" service "listDismissedRiskResults" endpoint HTTP response body for
// the "unsupported_media" error.
type ListDismissedRiskResultsUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsInvalidResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "invalid" error.
type ListDismissedRiskResultsInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsInvariantViolationResponseBody is the type of the
// "risk" service "listDismissedRiskResults" endpoint HTTP response body for
// the "invariant_violation" error.
type ListDismissedRiskResultsInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsUnexpectedResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "unexpected" error.
type ListDismissedRiskResultsUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListDismissedRiskResultsGatewayErrorResponseBody is the type of the "risk"
// service "listDismissedRiskResults" endpoint HTTP response body for the
// "gateway_error" error.
type ListDismissedRiskResultsGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsUnauthorizedResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "unauthorized" error.
type ListRiskPresetsUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsForbiddenResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "forbidden" error.
type ListRiskPresetsForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsBadRequestResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "bad_request" error.
type ListRiskPresetsBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsNotFoundResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "not_found" error.
type ListRiskPresetsNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsConflictResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "conflict" error.
type ListRiskPresetsConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsUnsupportedMediaResponseBody is the type of the "risk"
// service "listRiskPresets" endpoint HTTP response body for the
// "unsupported_media" error.
type ListRiskPresetsUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsInvalidResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "invalid" error.
type ListRiskPresetsInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsInvariantViolationResponseBody is the type of the "risk"
// service "listRiskPresets" endpoint HTTP response body for the
// "invariant_violation" error.
type ListRiskPresetsInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsUnexpectedResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "unexpected" error.
type ListRiskPresetsUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// ListRiskPresetsGatewayErrorResponseBody is the type of the "risk" service
// "listRiskPresets" endpoint HTTP response body for the "gateway_error" error.
type ListRiskPresetsGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyUnauthorizedResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "unauthorized" error.
type SuggestRiskPolicyUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyForbiddenResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "forbidden" error.
type SuggestRiskPolicyForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyBadRequestResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "bad_request" error.
type SuggestRiskPolicyBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyNotFoundResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "not_found" error.
type SuggestRiskPolicyNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyConflictResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "conflict" error.
type SuggestRiskPolicyConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyUnsupportedMediaResponseBody is the type of the "risk"
// service "suggestRiskPolicy" endpoint HTTP response body for the
// "unsupported_media" error.
type SuggestRiskPolicyUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyInvalidResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "invalid" error.
type SuggestRiskPolicyInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyInvariantViolationResponseBody is the type of the "risk"
// service "suggestRiskPolicy" endpoint HTTP response body for the
// "invariant_violation" error.
type SuggestRiskPolicyInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyUnexpectedResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "unexpected" error.
type SuggestRiskPolicyUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestRiskPolicyGatewayErrorResponseBody is the type of the "risk" service
// "suggestRiskPolicy" endpoint HTTP response body for the "gateway_error"
// error.
type SuggestRiskPolicyGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsUnauthorizedResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "unauthorized" error.
type GetRiskSignalsUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsForbiddenResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "forbidden" error.
type GetRiskSignalsForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsBadRequestResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "bad_request" error.
type GetRiskSignalsBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsNotFoundResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "not_found" error.
type GetRiskSignalsNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsConflictResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "conflict" error.
type GetRiskSignalsConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsUnsupportedMediaResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "unsupported_media"
// error.
type GetRiskSignalsUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsInvalidResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "invalid" error.
type GetRiskSignalsInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsInvariantViolationResponseBody is the type of the "risk"
// service "getRiskSignals" endpoint HTTP response body for the
// "invariant_violation" error.
type GetRiskSignalsInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskSignalsUnexpectedResponseBody is the type of the "risk" service
// "getRiskSignals" endpoint HTTP response body for the "unexpected" error.
type GetRiskSignalsUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeUnauthorizedResponseBody is the type of the
// "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body
// for the "unauthorized" error.
type AcknowledgeRiskPolicyChallengeUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeForbiddenResponseBody is the type of the
// "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body
// for the "forbidden" error.
type AcknowledgeRiskPolicyChallengeForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeBadRequestResponseBody is the type of the
// "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body
// for the "bad_request" error.
type AcknowledgeRiskPolicyChallengeBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeNotFoundResponseBody is the type of the "risk"
// service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body for the
// "not_found" error.
type AcknowledgeRiskPolicyChallengeNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeConflictResponseBody is the type of the "risk"
// service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body for the
// "conflict" error.
type AcknowledgeRiskPolicyChallengeConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeUnsupportedMediaResponseBody is the type of
// the "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response
// body for the "unsupported_media" error.
type AcknowledgeRiskPolicyChallengeUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeInvalidResponseBody is the type of the "risk"
// service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body for the
// "invalid" error.
type AcknowledgeRiskPolicyChallengeInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeInvariantViolationResponseBody is the type of
// the "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response
// body for the "invariant_violation" error.
type AcknowledgeRiskPolicyChallengeInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeUnexpectedResponseBody is the type of the
// "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body
// for the "unexpected" error.
type AcknowledgeRiskPolicyChallengeUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// AcknowledgeRiskPolicyChallengeGatewayErrorResponseBody is the type of the
// "risk" service "acknowledgeRiskPolicyChallenge" endpoint HTTP response body
// for the "gateway_error" error.
type AcknowledgeRiskPolicyChallengeGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeUnauthorizedResponseBody is the type of the "risk"
// service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "unauthorized" error.
type GetRiskPolicyChallengeUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeForbiddenResponseBody is the type of the "risk"
// service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "forbidden" error.
type GetRiskPolicyChallengeForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeBadRequestResponseBody is the type of the "risk"
// service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "bad_request" error.
type GetRiskPolicyChallengeBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeNotFoundResponseBody is the type of the "risk" service
// "getRiskPolicyChallenge" endpoint HTTP response body for the "not_found"
// error.
type GetRiskPolicyChallengeNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeConflictResponseBody is the type of the "risk" service
// "getRiskPolicyChallenge" endpoint HTTP response body for the "conflict"
// error.
type GetRiskPolicyChallengeConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeUnsupportedMediaResponseBody is the type of the "risk"
// service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "unsupported_media" error.
type GetRiskPolicyChallengeUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeInvalidResponseBody is the type of the "risk" service
// "getRiskPolicyChallenge" endpoint HTTP response body for the "invalid" error.
type GetRiskPolicyChallengeInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeInvariantViolationResponseBody is the type of the
// "risk" service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "invariant_violation" error.
type GetRiskPolicyChallengeInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeUnexpectedResponseBody is the type of the "risk"
// service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "unexpected" error.
type GetRiskPolicyChallengeUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// GetRiskPolicyChallengeGatewayErrorResponseBody is the type of the "risk"
// service "getRiskPolicyChallenge" endpoint HTTP response body for the
// "gateway_error" error.
type GetRiskPolicyChallengeGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeUnauthorizedResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "unauthorized" error.
type DeclineRiskPolicyChallengeUnauthorizedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeForbiddenResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "forbidden" error.
type DeclineRiskPolicyChallengeForbiddenResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeBadRequestResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "bad_request" error.
type DeclineRiskPolicyChallengeBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeNotFoundResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "not_found" error.
type DeclineRiskPolicyChallengeNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeConflictResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "conflict" error.
type DeclineRiskPolicyChallengeConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeUnsupportedMediaResponseBody is the type of the
// "risk" service "declineRiskPolicyChallenge" endpoint HTTP response body for
// the "unsupported_media" error.
type DeclineRiskPolicyChallengeUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeInvalidResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "invalid" error.
type DeclineRiskPolicyChallengeInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeInvariantViolationResponseBody is the type of the
// "risk" service "declineRiskPolicyChallenge" endpoint HTTP response body for
// the "invariant_violation" error.
type DeclineRiskPolicyChallengeInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeUnexpectedResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "unexpected" error.
type DeclineRiskPolicyChallengeUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// DeclineRiskPolicyChallengeGatewayErrorResponseBody is the type of the "risk"
// service "declineRiskPolicyChallenge" endpoint HTTP response body for the
// "gateway_error" error.
type DeclineRiskPolicyChallengeGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionBadRequestResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body for the "bad_request" error.
type SuggestExclusionBadRequestResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionNotFoundResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body for the "not_found" error.
type SuggestExclusionNotFoundResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionConflictResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body for the "conflict" error.
type SuggestExclusionConflictResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionUnsupportedMediaResponseBody is the type of the "risk"
// service "suggestExclusion" endpoint HTTP response body for the
// "unsupported_media" error.
type SuggestExclusionUnsupportedMediaResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionInvalidResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body for the "invalid" error.
type SuggestExclusionInvalidResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionInvariantViolationResponseBody is the type of the "risk"
// service "suggestExclusion" endpoint HTTP response body for the
// "invariant_violation" error.
type SuggestExclusionInvariantViolationResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionUnexpectedResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body for the "unexpected" error.
type SuggestExclusionUnexpectedResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SuggestExclusionGatewayErrorResponseBody is the type of the "risk" service
// "suggestExclusion" endpoint HTTP response body for the "gateway_error" error.
type SuggestExclusionGatewayErrorResponseBody struct {
	// Name is the name of this class of errors.
	Name string `form:"name" json:"name" xml:"name"`
	// ID is a unique identifier for this particular occurrence of the problem.
	ID string `form:"id" json:"id" xml:"id"`
...
// SessionQuarantineResponseBody is used to define fields on response body
// types.
type SessionQuarantineResponseBody struct {
	// The session quarantine ID.
	ID string `form:"id" json:"id" xml:"id"`
	// The organization ID.
	OrganizationID string `form:"organization_id" json:"organization_id" xml:"organization_id"`
...
// RiskPresetResponseBody is used to define fields on response body types.
type RiskPresetResponseBody struct {
	...
	RequiresApprovedEmailDomains bool `form:"requires_approved_email_domains" json:"requires_approved_email_domains" xml:"requires_approved_email_domains"`
}

// RiskPresetMatchResponseBody is used to define fields on response body types.
type RiskPresetMatchResponseBody struct {
	// Preset identifier.
	PresetID string `form:"preset_id" json:"preset_id" xml:"preset_id"`
	// Preset label.
	Label string `form:"label" json:"label" xml:"label"`
...
// RiskExposureSliceResponseBody is used to define fields on response body
// types.
type RiskExposureSliceResponseBody struct {
	...
	Share float64 `form:"share" json:"share" xml:"share"`
}

// RiskSignalResponseBody is used to define fields on response body types.
type RiskSignalResponseBody struct {
	...
	// prompt_injection, ...).
	DetectionSources []string `form:"detection_sources" json:"detection_sources" xml:"detection_sources"`
	// Source apps (chat surfaces) the findings were observed in. Empty until app
	// attribution is recorded on findings.
	Apps []string `form:"apps" json:"apps" xml:"apps"`
	...
	PreviousFindings int64 `form:"previous_findings" json:"previous_findings" xml:"previous_findings"`
	// Distinct users with at least one finding in the window.
	Users int64 `form:"users" json:"users" xml:"users"`
	// Distinct teams with at least one finding in the window. Zero until team
	// attribution is recorded on findings.
	Teams int64 `form:"teams" json:"teams" xml:"teams"`
	...
	Sparkline []int64 `form:"sparkline" json:"sparkline" xml:"sparkline"`
}

// RiskSignalTopUserResponseBody is used to define fields on response body
// types.
type RiskSignalTopUserResponseBody struct {
	// User email, or Unknown user when unavailable.
	Email string `form:"email" json:"email" xml:"email"`
	// External user identifier as recorded on chats, when known. Empty when the
	// finding cannot be attributed to an external user.
...
// NewListSessionQuarantinesResponseBody builds the HTTP response body from the
// result of the "listSessionQuarantines" endpoint of the "risk" service.
func NewListSessionQuarantinesResponseBody(res *risk.ListSessionQuarantinesResult) *ListSessionQuarantinesResponseBody {
	body := &ListSessionQuarantinesResponseBody{}
	if res.Quarantines != nil {
		body.Quarantines = make([]*SessionQuarantineResponseBody, len(res.Quarantines))
		for i, val := range res.Quarantines {
			if val == nil {
				body.Quarantines[i] = nil
				continue
			}
			body.Quarantines[i] = marshalRiskSessionQuarantineToSessionQuarantineResponseBody(val)
		}
	} else {
		body.Quarantines = []*SessionQuarantineResponseBody{}
	}
	return body
}

// NewReleaseSessionQuarantineResponseBody builds the HTTP response body from
// the result of the "releaseSessionQuarantine" endpoint of the "risk" service.
func NewReleaseSessionQuarantineResponseBody(res *risk.SessionQuarantine) *ReleaseSessionQuarantineResponseBody {
	body := &ReleaseSessionQuarantineResponseBody{
		...
		RiskPolicyName: res.RiskPolicyName,
		UserID:         res.UserID,
		Reason:         res.Reason,
		CreatedAt:      res.CreatedAt,
		ReleasedAt:     res.ReleasedAt,
		ReleasedBy:     res.ReleasedBy,
	}
	return body
}
...
// NewListDismissedRiskResultsResponseBody builds the HTTP response body from
// the result of the "listDismissedRiskResults" endpoint of the "risk" service.
func NewListDismissedRiskResultsResponseBody(res *risk.ListRiskResultsResult) *ListDismissedRiskResultsResponseBody {
	body := &ListDismissedRiskResultsResponseBody{
		TotalCount: res.TotalCount,
		NextCursor: res.NextCursor,
	}
	if res.Results != nil {
...
// NewListRiskPresetsResponseBody builds the HTTP response body from the result
// of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsResponseBody(res *risk.RiskPresetsResult) *ListRiskPresetsResponseBody {
	body := &ListRiskPresetsResponseBody{}
	if res.Presets != nil {
		body.Presets = make([]*RiskPresetResponseBody, len(res.Presets))
		for i, val := range res.Presets {
			if val == nil {
				body.Presets[i] = nil
				continue
			}
			body.Presets[i] = marshalRiskRiskPresetToRiskPresetResponseBody(val)
		}
	} else {
		body.Presets = []*RiskPresetResponseBody{}
	}
	return body
}

// NewSuggestRiskPolicyResponseBody builds the HTTP response body from the
// result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyResponseBody(res *risk.SuggestRiskPolicyResult) *SuggestRiskPolicyResponseBody {
	body := &SuggestRiskPolicyResponseBody{
	...
	if res.PresidioEntities != nil {
		...
		body.PresidioEntities = []string{}
	}
	if res.Alternatives != nil {
		body.Alternatives = make([]*RiskPresetMatchResponseBody, len(res.Alternatives))
		for i, val := range res.Alternatives {
			if val == nil {
				body.Alternatives[i] = nil
				continue
			}
			body.Alternatives[i] = marshalRiskRiskPresetMatchToRiskPresetMatchResponseBody(val)
		}
	} else {
		body.Alternatives = []*RiskPresetMatchResponseBody{}
	}
	return body
}
...
// NewGetRiskSignalsResponseBody builds the HTTP response body from the result
// of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsResponseBody(res *risk.RiskSignalsResult) *GetRiskSignalsResponseBody {
	body := &GetRiskSignalsResponseBody{
		From:                 res.From,
		To:                   res.To,
		...
		PreviousUsersExposed: res.PreviousUsersExposed,
	}
	if res.Exposure != nil {
		body.Exposure = make([]*RiskExposureSliceResponseBody, len(res.Exposure))
		for i, val := range res.Exposure {
			if val == nil {
				body.Exposure[i] = nil
				continue
			}
			body.Exposure[i] = marshalRiskRiskExposureSliceToRiskExposureSliceResponseBody(val)
		}
	} else {
		body.Exposure = []*RiskExposureSliceResponseBody{}
	}
	if res.Signals != nil {
		body.Signals = make([]*RiskSignalResponseBody, len(res.Signals))
		for i, val := range res.Signals {
			if val == nil {
				body.Signals[i] = nil
				continue
			}
			body.Signals[i] = marshalRiskRiskSignalToRiskSignalResponseBody(val)
		}
	} else {
...
// NewAcknowledgeRiskPolicyChallengeResponseBody builds the HTTP response body
// from the result of the "acknowledgeRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewAcknowledgeRiskPolicyChallengeResponseBody(res *risk.AcknowledgeRiskPolicyChallengeResult) *AcknowledgeRiskPolicyChallengeResponseBody {
...
// NewGetRiskPolicyChallengeResponseBody builds the HTTP response body from the
// result of the "getRiskPolicyChallenge" endpoint of the "risk" service.
func NewGetRiskPolicyChallengeResponseBody(res *risk.GetRiskPolicyChallengeResult) *GetRiskPolicyChallengeResponseBody {
...
// NewDeclineRiskPolicyChallengeResponseBody builds the HTTP response body from
// the result of the "declineRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewDeclineRiskPolicyChallengeResponseBody(res *risk.DeclineRiskPolicyChallengeResult) *DeclineRiskPolicyChallengeResponseBody {
...
// NewSuggestExclusionResponseBody builds the HTTP response body from the
// result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionResponseBody(res *risk.SuggestExclusionResult) *SuggestExclusionResponseBody {
...
// NewListSessionQuarantinesUnauthorizedResponseBody builds the HTTP response
// body from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesUnauthorizedResponseBody(res *goa.ServiceError) *ListSessionQuarantinesUnauthorizedResponseBody {
...
// NewListSessionQuarantinesForbiddenResponseBody builds the HTTP response body
// from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesForbiddenResponseBody(res *goa.ServiceError) *ListSessionQuarantinesForbiddenResponseBody {
...
// NewListSessionQuarantinesBadRequestResponseBody builds the HTTP response
// body from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesBadRequestResponseBody(res *goa.ServiceError) *ListSessionQuarantinesBadRequestResponseBody {
...
// NewListSessionQuarantinesNotFoundResponseBody builds the HTTP response body
// from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesNotFoundResponseBody(res *goa.ServiceError) *ListSessionQuarantinesNotFoundResponseBody {
...
// NewListSessionQuarantinesConflictResponseBody builds the HTTP response body
// from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesConflictResponseBody(res *goa.ServiceError) *ListSessionQuarantinesConflictResponseBody {
...
// NewListSessionQuarantinesUnsupportedMediaResponseBody builds the HTTP
// response body from the result of the "listSessionQuarantines" endpoint of
// the "risk" service.
func NewListSessionQuarantinesUnsupportedMediaResponseBody(res *goa.ServiceError) *ListSessionQuarantinesUnsupportedMediaResponseBody {
...
// NewListSessionQuarantinesInvalidResponseBody builds the HTTP response body
// from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesInvalidResponseBody(res *goa.ServiceError) *ListSessionQuarantinesInvalidResponseBody {
...
// NewListSessionQuarantinesInvariantViolationResponseBody builds the HTTP
// response body from the result of the "listSessionQuarantines" endpoint of
// the "risk" service.
func NewListSessionQuarantinesInvariantViolationResponseBody(res *goa.ServiceError) *ListSessionQuarantinesInvariantViolationResponseBody {
...
// NewListSessionQuarantinesUnexpectedResponseBody builds the HTTP response
// body from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesUnexpectedResponseBody(res *goa.ServiceError) *ListSessionQuarantinesUnexpectedResponseBody {
...
// NewListSessionQuarantinesGatewayErrorResponseBody builds the HTTP response
// body from the result of the "listSessionQuarantines" endpoint of the "risk"
// service.
func NewListSessionQuarantinesGatewayErrorResponseBody(res *goa.ServiceError) *ListSessionQuarantinesGatewayErrorResponseBody {
...
// NewReleaseSessionQuarantineUnauthorizedResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineUnauthorizedResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineUnauthorizedResponseBody {
...
// NewReleaseSessionQuarantineForbiddenResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineForbiddenResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineForbiddenResponseBody {
...
// NewReleaseSessionQuarantineBadRequestResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineBadRequestResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineBadRequestResponseBody {
...
// NewReleaseSessionQuarantineNotFoundResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineNotFoundResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineNotFoundResponseBody {
...
// NewReleaseSessionQuarantineConflictResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineConflictResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineConflictResponseBody {
...
// NewReleaseSessionQuarantineUnsupportedMediaResponseBody builds the HTTP
// response body from the result of the "releaseSessionQuarantine" endpoint of
// the "risk" service.
func NewReleaseSessionQuarantineUnsupportedMediaResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineUnsupportedMediaResponseBody {
...
// NewReleaseSessionQuarantineInvalidResponseBody builds the HTTP response body
// from the result of the "releaseSessionQuarantine" endpoint of the "risk"
// service.
func NewReleaseSessionQuarantineInvalidResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineInvalidResponseBody {
...
// NewReleaseSessionQuarantineInvariantViolationResponseBody builds the HTTP
// response body from the result of the "releaseSessionQuarantine" endpoint of
// the "risk" service.
func NewReleaseSessionQuarantineInvariantViolationResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineInvariantViolationResponseBody {
...
// NewReleaseSessionQuarantineUnexpectedResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineUnexpectedResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineUnexpectedResponseBody {
...
// NewReleaseSessionQuarantineGatewayErrorResponseBody builds the HTTP response
// body from the result of the "releaseSessionQuarantine" endpoint of the
// "risk" service.
func NewReleaseSessionQuarantineGatewayErrorResponseBody(res *goa.ServiceError) *ReleaseSessionQuarantineGatewayErrorResponseBody {
...
// NewMarkRiskResultsFalsePositiveUnauthorizedResponseBody builds the HTTP
// response body from the result of the "markRiskResultsFalsePositive" endpoint
// of the "risk" service.
func NewMarkRiskResultsFalsePositiveUnauthorizedResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveUnauthorizedResponseBody {
	body := &MarkRiskResultsFalsePositiveUnauthorizedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveForbiddenResponseBody builds the HTTP
// response body from the result of the "markRiskResultsFalsePositive" endpoint
// of the "risk" service.
func NewMarkRiskResultsFalsePositiveForbiddenResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveForbiddenResponseBody {
	body := &MarkRiskResultsFalsePositiveForbiddenResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveBadRequestResponseBody builds the HTTP
// response body from the result of the "markRiskResultsFalsePositive" endpoint
// of the "risk" service.
func NewMarkRiskResultsFalsePositiveBadRequestResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveBadRequestResponseBody {
	body := &MarkRiskResultsFalsePositiveBadRequestResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveNotFoundResponseBody builds the HTTP response
// body from the result of the "markRiskResultsFalsePositive" endpoint of the
// "risk" service.
func NewMarkRiskResultsFalsePositiveNotFoundResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveNotFoundResponseBody {
	body := &MarkRiskResultsFalsePositiveNotFoundResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveConflictResponseBody builds the HTTP response
// body from the result of the "markRiskResultsFalsePositive" endpoint of the
// "risk" service.
func NewMarkRiskResultsFalsePositiveConflictResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveConflictResponseBody {
	body := &MarkRiskResultsFalsePositiveConflictResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveUnsupportedMediaResponseBody builds the HTTP
// response body from the result of the "markRiskResultsFalsePositive" endpoint
// of the "risk" service.
func NewMarkRiskResultsFalsePositiveUnsupportedMediaResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveUnsupportedMediaResponseBody {
	body := &MarkRiskResultsFalsePositiveUnsupportedMediaResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveInvalidResponseBody builds the HTTP response
// body from the result of the "markRiskResultsFalsePositive" endpoint of the
// "risk" service.
func NewMarkRiskResultsFalsePositiveInvalidResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveInvalidResponseBody {
	body := &MarkRiskResultsFalsePositiveInvalidResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveInvariantViolationResponseBody builds the
// HTTP response body from the result of the "markRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewMarkRiskResultsFalsePositiveInvariantViolationResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveInvariantViolationResponseBody {
	body := &MarkRiskResultsFalsePositiveInvariantViolationResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveUnexpectedResponseBody builds the HTTP
// response body from the result of the "markRiskResultsFalsePositive" endpoint
// of the "risk" service.
func NewMarkRiskResultsFalsePositiveUnexpectedResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveUnexpectedResponseBody {
	body := &MarkRiskResultsFalsePositiveUnexpectedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewMarkRiskResultsFalsePositiveGatewayErrorResponseBody builds the HTTP
// response body from the result of the "markRiskResultsFalsePositive" endpoint
// of the "risk" service.
func NewMarkRiskResultsFalsePositiveGatewayErrorResponseBody(res *goa.ServiceError) *MarkRiskResultsFalsePositiveGatewayErrorResponseBody {
	body := &MarkRiskResultsFalsePositiveGatewayErrorResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveUnauthorizedResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveUnauthorizedResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveUnauthorizedResponseBody {
	body := &UnmarkRiskResultsFalsePositiveUnauthorizedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveForbiddenResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveForbiddenResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveForbiddenResponseBody {
	body := &UnmarkRiskResultsFalsePositiveForbiddenResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveBadRequestResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveBadRequestResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveBadRequestResponseBody {
	body := &UnmarkRiskResultsFalsePositiveBadRequestResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveNotFoundResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveNotFoundResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveNotFoundResponseBody {
	body := &UnmarkRiskResultsFalsePositiveNotFoundResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveConflictResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveConflictResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveConflictResponseBody {
	body := &UnmarkRiskResultsFalsePositiveConflictResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveUnsupportedMediaResponseBody builds the
// HTTP response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveUnsupportedMediaResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveUnsupportedMediaResponseBody {
	body := &UnmarkRiskResultsFalsePositiveUnsupportedMediaResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveInvalidResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveInvalidResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveInvalidResponseBody {
	body := &UnmarkRiskResultsFalsePositiveInvalidResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveInvariantViolationResponseBody builds the
// HTTP response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveInvariantViolationResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveInvariantViolationResponseBody {
	body := &UnmarkRiskResultsFalsePositiveInvariantViolationResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveUnexpectedResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveUnexpectedResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveUnexpectedResponseBody {
	body := &UnmarkRiskResultsFalsePositiveUnexpectedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewUnmarkRiskResultsFalsePositiveGatewayErrorResponseBody builds the HTTP
// response body from the result of the "unmarkRiskResultsFalsePositive"
// endpoint of the "risk" service.
func NewUnmarkRiskResultsFalsePositiveGatewayErrorResponseBody(res *goa.ServiceError) *UnmarkRiskResultsFalsePositiveGatewayErrorResponseBody {
	body := &UnmarkRiskResultsFalsePositiveGatewayErrorResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsUnauthorizedResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsUnauthorizedResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsUnauthorizedResponseBody {
	body := &ListDismissedRiskResultsUnauthorizedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsForbiddenResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsForbiddenResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsForbiddenResponseBody {
	body := &ListDismissedRiskResultsForbiddenResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsBadRequestResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsBadRequestResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsBadRequestResponseBody {
	body := &ListDismissedRiskResultsBadRequestResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsNotFoundResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsNotFoundResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsNotFoundResponseBody {
	body := &ListDismissedRiskResultsNotFoundResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsConflictResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsConflictResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsConflictResponseBody {
	body := &ListDismissedRiskResultsConflictResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsUnsupportedMediaResponseBody builds the HTTP
// response body from the result of the "listDismissedRiskResults" endpoint of
// the "risk" service.
func NewListDismissedRiskResultsUnsupportedMediaResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsUnsupportedMediaResponseBody {
	body := &ListDismissedRiskResultsUnsupportedMediaResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsInvalidResponseBody builds the HTTP response body
// from the result of the "listDismissedRiskResults" endpoint of the "risk"
// service.
func NewListDismissedRiskResultsInvalidResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsInvalidResponseBody {
	body := &ListDismissedRiskResultsInvalidResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsInvariantViolationResponseBody builds the HTTP
// response body from the result of the "listDismissedRiskResults" endpoint of
// the "risk" service.
func NewListDismissedRiskResultsInvariantViolationResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsInvariantViolationResponseBody {
	body := &ListDismissedRiskResultsInvariantViolationResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsUnexpectedResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsUnexpectedResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsUnexpectedResponseBody {
	body := &ListDismissedRiskResultsUnexpectedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListDismissedRiskResultsGatewayErrorResponseBody builds the HTTP response
// body from the result of the "listDismissedRiskResults" endpoint of the
// "risk" service.
func NewListDismissedRiskResultsGatewayErrorResponseBody(res *goa.ServiceError) *ListDismissedRiskResultsGatewayErrorResponseBody {
	body := &ListDismissedRiskResultsGatewayErrorResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsUnauthorizedResponseBody builds the HTTP response body
// from the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsUnauthorizedResponseBody(res *goa.ServiceError) *ListRiskPresetsUnauthorizedResponseBody {
	body := &ListRiskPresetsUnauthorizedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsForbiddenResponseBody builds the HTTP response body from
// the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsForbiddenResponseBody(res *goa.ServiceError) *ListRiskPresetsForbiddenResponseBody {
	body := &ListRiskPresetsForbiddenResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsBadRequestResponseBody builds the HTTP response body from
// the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsBadRequestResponseBody(res *goa.ServiceError) *ListRiskPresetsBadRequestResponseBody {
	body := &ListRiskPresetsBadRequestResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsNotFoundResponseBody builds the HTTP response body from
// the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsNotFoundResponseBody(res *goa.ServiceError) *ListRiskPresetsNotFoundResponseBody {
	body := &ListRiskPresetsNotFoundResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsConflictResponseBody builds the HTTP response body from
// the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsConflictResponseBody(res *goa.ServiceError) *ListRiskPresetsConflictResponseBody {
	body := &ListRiskPresetsConflictResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsUnsupportedMediaResponseBody builds the HTTP response body
// from the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsUnsupportedMediaResponseBody(res *goa.ServiceError) *ListRiskPresetsUnsupportedMediaResponseBody {
	body := &ListRiskPresetsUnsupportedMediaResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsInvalidResponseBody builds the HTTP response body from the
// result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsInvalidResponseBody(res *goa.ServiceError) *ListRiskPresetsInvalidResponseBody {
	body := &ListRiskPresetsInvalidResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsInvariantViolationResponseBody builds the HTTP response
// body from the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsInvariantViolationResponseBody(res *goa.ServiceError) *ListRiskPresetsInvariantViolationResponseBody {
	body := &ListRiskPresetsInvariantViolationResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsUnexpectedResponseBody builds the HTTP response body from
// the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsUnexpectedResponseBody(res *goa.ServiceError) *ListRiskPresetsUnexpectedResponseBody {
	body := &ListRiskPresetsUnexpectedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewListRiskPresetsGatewayErrorResponseBody builds the HTTP response body
// from the result of the "listRiskPresets" endpoint of the "risk" service.
func NewListRiskPresetsGatewayErrorResponseBody(res *goa.ServiceError) *ListRiskPresetsGatewayErrorResponseBody {
	body := &ListRiskPresetsGatewayErrorResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyUnauthorizedResponseBody builds the HTTP response body
// from the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyUnauthorizedResponseBody(res *goa.ServiceError) *SuggestRiskPolicyUnauthorizedResponseBody {
	body := &SuggestRiskPolicyUnauthorizedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyForbiddenResponseBody builds the HTTP response body from
// the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyForbiddenResponseBody(res *goa.ServiceError) *SuggestRiskPolicyForbiddenResponseBody {
	body := &SuggestRiskPolicyForbiddenResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyBadRequestResponseBody builds the HTTP response body
// from the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyBadRequestResponseBody(res *goa.ServiceError) *SuggestRiskPolicyBadRequestResponseBody {
	body := &SuggestRiskPolicyBadRequestResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyNotFoundResponseBody builds the HTTP response body from
// the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyNotFoundResponseBody(res *goa.ServiceError) *SuggestRiskPolicyNotFoundResponseBody {
	body := &SuggestRiskPolicyNotFoundResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyConflictResponseBody builds the HTTP response body from
// the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyConflictResponseBody(res *goa.ServiceError) *SuggestRiskPolicyConflictResponseBody {
	body := &SuggestRiskPolicyConflictResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyUnsupportedMediaResponseBody builds the HTTP response
// body from the result of the "suggestRiskPolicy" endpoint of the "risk"
// service.
func NewSuggestRiskPolicyUnsupportedMediaResponseBody(res *goa.ServiceError) *SuggestRiskPolicyUnsupportedMediaResponseBody {
	body := &SuggestRiskPolicyUnsupportedMediaResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyInvalidResponseBody builds the HTTP response body from
// the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyInvalidResponseBody(res *goa.ServiceError) *SuggestRiskPolicyInvalidResponseBody {
	body := &SuggestRiskPolicyInvalidResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyInvariantViolationResponseBody builds the HTTP response
// body from the result of the "suggestRiskPolicy" endpoint of the "risk"
// service.
func NewSuggestRiskPolicyInvariantViolationResponseBody(res *goa.ServiceError) *SuggestRiskPolicyInvariantViolationResponseBody {
	body := &SuggestRiskPolicyInvariantViolationResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyUnexpectedResponseBody builds the HTTP response body
// from the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyUnexpectedResponseBody(res *goa.ServiceError) *SuggestRiskPolicyUnexpectedResponseBody {
	body := &SuggestRiskPolicyUnexpectedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewSuggestRiskPolicyGatewayErrorResponseBody builds the HTTP response body
// from the result of the "suggestRiskPolicy" endpoint of the "risk" service.
func NewSuggestRiskPolicyGatewayErrorResponseBody(res *goa.ServiceError) *SuggestRiskPolicyGatewayErrorResponseBody {
	body := &SuggestRiskPolicyGatewayErrorResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsUnauthorizedResponseBody builds the HTTP response body from
// the result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsUnauthorizedResponseBody(res *goa.ServiceError) *GetRiskSignalsUnauthorizedResponseBody {
	body := &GetRiskSignalsUnauthorizedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsForbiddenResponseBody builds the HTTP response body from
// the result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsForbiddenResponseBody(res *goa.ServiceError) *GetRiskSignalsForbiddenResponseBody {
	body := &GetRiskSignalsForbiddenResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsBadRequestResponseBody builds the HTTP response body from
// the result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsBadRequestResponseBody(res *goa.ServiceError) *GetRiskSignalsBadRequestResponseBody {
	body := &GetRiskSignalsBadRequestResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsNotFoundResponseBody builds the HTTP response body from the
// result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsNotFoundResponseBody(res *goa.ServiceError) *GetRiskSignalsNotFoundResponseBody {
	body := &GetRiskSignalsNotFoundResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsConflictResponseBody builds the HTTP response body from the
// result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsConflictResponseBody(res *goa.ServiceError) *GetRiskSignalsConflictResponseBody {
	body := &GetRiskSignalsConflictResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsUnsupportedMediaResponseBody builds the HTTP response body
// from the result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsUnsupportedMediaResponseBody(res *goa.ServiceError) *GetRiskSignalsUnsupportedMediaResponseBody {
	body := &GetRiskSignalsUnsupportedMediaResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsInvalidResponseBody builds the HTTP response body from the
// result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsInvalidResponseBody(res *goa.ServiceError) *GetRiskSignalsInvalidResponseBody {
	body := &GetRiskSignalsInvalidResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsInvariantViolationResponseBody builds the HTTP response
// body from the result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsInvariantViolationResponseBody(res *goa.ServiceError) *GetRiskSignalsInvariantViolationResponseBody {
	body := &GetRiskSignalsInvariantViolationResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsUnexpectedResponseBody builds the HTTP response body from
// the result of the "getRiskSignals" endpoint of the "risk" service.
func NewGetRiskSignalsUnexpectedResponseBody(res *goa.ServiceError) *GetRiskSignalsUnexpectedResponseBody {
	body := &GetRiskSignalsUnexpectedResponseBody{
		Name:      res.Name,
		ID:        res.ID,
		Message:   res.Message,
		Temporary: res.Temporary,
...
// NewGetRiskSignalsGatewayErrorResponseBody builds the HTTP response body from
// the result of the "getRiskSignals" endpoint of the "risk" service.
...
// NewAcknowledgeRiskPolicyChallengeUnauthorizedResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeUnauthorizedResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeUnauthorizedResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeForbiddenResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeForbiddenResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeForbiddenResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeBadRequestResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeBadRequestResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeBadRequestResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeNotFoundResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeNotFoundResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeNotFoundResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeConflictResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeConflictResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeConflictResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeUnsupportedMediaResponseBody builds the
// HTTP response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeUnsupportedMediaResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeUnsupportedMediaResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeInvalidResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeInvalidResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeInvalidResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeInvariantViolationResponseBody builds the
// HTTP response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeInvariantViolationResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeInvariantViolationResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeUnexpectedResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeUnexpectedResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeUnexpectedResponseBody {
...
// NewAcknowledgeRiskPolicyChallengeGatewayErrorResponseBody builds the HTTP
// response body from the result of the "acknowledgeRiskPolicyChallenge"
// endpoint of the "risk" service.
func NewAcknowledgeRiskPolicyChallengeGatewayErrorResponseBody(res *goa.ServiceError) *AcknowledgeRiskPolicyChallengeGatewayErrorResponseBody {
...
// NewGetRiskPolicyChallengeUnauthorizedResponseBody builds the HTTP response
// body from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeUnauthorizedResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeUnauthorizedResponseBody {
...
// NewGetRiskPolicyChallengeForbiddenResponseBody builds the HTTP response body
// from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeForbiddenResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeForbiddenResponseBody {
...
// NewGetRiskPolicyChallengeBadRequestResponseBody builds the HTTP response
// body from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeBadRequestResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeBadRequestResponseBody {
...
// NewGetRiskPolicyChallengeNotFoundResponseBody builds the HTTP response body
// from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeNotFoundResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeNotFoundResponseBody {
...
// NewGetRiskPolicyChallengeConflictResponseBody builds the HTTP response body
// from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeConflictResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeConflictResponseBody {
...
// NewGetRiskPolicyChallengeUnsupportedMediaResponseBody builds the HTTP
// response body from the result of the "getRiskPolicyChallenge" endpoint of
// the "risk" service.
func NewGetRiskPolicyChallengeUnsupportedMediaResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeUnsupportedMediaResponseBody {
...
// NewGetRiskPolicyChallengeInvalidResponseBody builds the HTTP response body
// from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeInvalidResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeInvalidResponseBody {
...
// NewGetRiskPolicyChallengeInvariantViolationResponseBody builds the HTTP
// response body from the result of the "getRiskPolicyChallenge" endpoint of
// the "risk" service.
func NewGetRiskPolicyChallengeInvariantViolationResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeInvariantViolationResponseBody {
...
// NewGetRiskPolicyChallengeUnexpectedResponseBody builds the HTTP response
// body from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeUnexpectedResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeUnexpectedResponseBody {
...
// NewGetRiskPolicyChallengeGatewayErrorResponseBody builds the HTTP response
// body from the result of the "getRiskPolicyChallenge" endpoint of the "risk"
// service.
func NewGetRiskPolicyChallengeGatewayErrorResponseBody(res *goa.ServiceError) *GetRiskPolicyChallengeGatewayErrorResponseBody {
...
// NewDeclineRiskPolicyChallengeUnauthorizedResponseBody builds the HTTP
// response body from the result of the "declineRiskPolicyChallenge" endpoint
// of the "risk" service.
func NewDeclineRiskPolicyChallengeUnauthorizedResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeUnauthorizedResponseBody {
...
// NewDeclineRiskPolicyChallengeForbiddenResponseBody builds the HTTP response
// body from the result of the "declineRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewDeclineRiskPolicyChallengeForbiddenResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeForbiddenResponseBody {
...
// NewDeclineRiskPolicyChallengeBadRequestResponseBody builds the HTTP response
// body from the result of the "declineRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewDeclineRiskPolicyChallengeBadRequestResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeBadRequestResponseBody {
...
// NewDeclineRiskPolicyChallengeNotFoundResponseBody builds the HTTP response
// body from the result of the "declineRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewDeclineRiskPolicyChallengeNotFoundResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeNotFoundResponseBody {
...
// NewDeclineRiskPolicyChallengeConflictResponseBody builds the HTTP response
// body from the result of the "declineRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewDeclineRiskPolicyChallengeConflictResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeConflictResponseBody {
...
// NewDeclineRiskPolicyChallengeUnsupportedMediaResponseBody builds the HTTP
// response body from the result of the "declineRiskPolicyChallenge" endpoint
// of the "risk" service.
func NewDeclineRiskPolicyChallengeUnsupportedMediaResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeUnsupportedMediaResponseBody {
...
// NewDeclineRiskPolicyChallengeInvalidResponseBody builds the HTTP response
// body from the result of the "declineRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewDeclineRiskPolicyChallengeInvalidResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeInvalidResponseBody {
...
// NewDeclineRiskPolicyChallengeInvariantViolationResponseBody builds the HTTP
// response body from the result of the "declineRiskPolicyChallenge" endpoint
// of the "risk" service.
func NewDeclineRiskPolicyChallengeInvariantViolationResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeInvariantViolationResponseBody {
...
// NewDeclineRiskPolicyChallengeUnexpectedResponseBody builds the HTTP response
// body from the result of the "declineRiskPolicyChallenge" endpoint of the
// "risk" service.
func NewDeclineRiskPolicyChallengeUnexpectedResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeUnexpectedResponseBody {
...
// NewDeclineRiskPolicyChallengeGatewayErrorResponseBody builds the HTTP
// response body from the result of the "declineRiskPolicyChallenge" endpoint
// of the "risk" service.
func NewDeclineRiskPolicyChallengeGatewayErrorResponseBody(res *goa.ServiceError) *DeclineRiskPolicyChallengeGatewayErrorResponseBody {
...
// NewSuggestExclusionForbiddenResponseBody builds the HTTP response body from
...
// NewSuggestExclusionBadRequestResponseBody builds the HTTP response body from
// the result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionBadRequestResponseBody(res *goa.ServiceError) *SuggestExclusionBadRequestResponseBody {
...
// NewSuggestExclusionNotFoundResponseBody builds the HTTP response body from
// the result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionNotFoundResponseBody(res *goa.ServiceError) *SuggestExclusionNotFoundResponseBody {
...
// NewSuggestExclusionConflictResponseBody builds the HTTP response body from
// the result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionConflictResponseBody(res *goa.ServiceError) *SuggestExclusionConflictResponseBody {
...
// NewSuggestExclusionUnsupportedMediaResponseBody builds the HTTP response
// body from the result of the "suggestExclusion" endpoint of the "risk"
// service.
func NewSuggestExclusionUnsupportedMediaResponseBody(res *goa.ServiceError) *SuggestExclusionUnsupportedMediaResponseBody {
...
// NewSuggestExclusionInvalidResponseBody builds the HTTP response body from
// the result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionInvalidResponseBody(res *goa.ServiceError) *SuggestExclusionInvalidResponseBody {
...
// NewSuggestExclusionInvariantViolationResponseBody builds the HTTP response
// body from the result of the "suggestExclusion" endpoint of the "risk"
// service.
func NewSuggestExclusionInvariantViolationResponseBody(res *goa.ServiceError) *SuggestExclusionInvariantViolationResponseBody {
...
// NewSuggestExclusionUnexpectedResponseBody builds the HTTP response body from
// the result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionUnexpectedResponseBody(res *goa.ServiceError) *SuggestExclusionUnexpectedResponseBody {
...
// NewSuggestExclusionGatewayErrorResponseBody builds the HTTP response body
// from the result of the "suggestExclusion" endpoint of the "risk" service.
func NewSuggestExclusionGatewayErrorResponseBody(res *goa.ServiceError) *SuggestExclusionGatewayErrorResponseBody {
...
// NewListSessionQuarantinesPayload builds a risk service
// listSessionQuarantines endpoint payload.
func NewListSessionQuarantinesPayload(apikeyToken *string, sessionToken *string, projectSlugInput *string) *risk.ListSessionQuarantinesPayload {
...
// NewReleaseSessionQuarantinePayload builds a risk service
// releaseSessionQuarantine endpoint payload.
func NewReleaseSessionQuarantinePayload(body *ReleaseSessionQuarantineRequestBody, apikeyToken *string, sessionToken *string, projectSlugInput *string) *risk.ReleaseSessionQuarantinePayload {
...
// NewMarkRiskResultsFalsePositivePayload builds a risk service
// markRiskResultsFalsePositive endpoint payload.
func NewMarkRiskResultsFalsePositivePayload(body *MarkRiskResultsFalsePositiveRequestBody, apikeyToken *string, sessionToken *string, projectSlugInput *string) *risk.MarkRiskResultsFalsePositivePayload {
...
// NewUnmarkRiskResultsFalsePositivePayload builds a risk service
// unmarkRiskResultsFalsePositive endpoint payload.
func NewUnmarkRiskResultsFalsePositivePayload(body *UnmarkRiskResultsFalsePositiveRequestBody, apikeyToken *string, sessionToken *string, projectSlugInput *string) *risk.UnmarkRiskResultsFalsePositivePayload {
...
// NewListRiskPresetsPayload builds a risk service listRiskPresets endpoint
// payload.
func NewListRiskPresetsPayload(apikeyToken *string, sessionToken *string, projectSlugInput *string) *risk.ListRiskPresetsPayload {
...
// NewSuggestRiskPolicyPayload builds a risk service suggestRiskPolicy endpoint
// payload.
func NewSuggestRiskPolicyPayload(body *SuggestRiskPolicyRequestBody, apikeyToken *string, sessionToken *string, projectSlugInput *string) *risk.SuggestRiskPolicyPayload {
...
// NewAcknowledgeRiskPolicyChallengePayload builds a risk service
// acknowledgeRiskPolicyChallenge endpoint payload.
func NewAcknowledgeRiskPolicyChallengePayload(body *AcknowledgeRiskPolicyChallengeRequestBody, sessionToken *string) *risk.AcknowledgeRiskPolicyChallengePayload {
...
// NewGetRiskPolicyChallengePayload builds a risk service
// getRiskPolicyChallenge endpoint payload.
func NewGetRiskPolicyChallengePayload(body *GetRiskPolicyChallengeRequestBody, sessionToken *string) *risk.GetRiskPolicyChallengePayload {
...
// NewDeclineRiskPolicyChallengePayload builds a risk service
// declineRiskPolicyChallenge endpoint payload.
func NewDeclineRiskPolicyChallengePayload(body *DeclineRiskPolicyChallengeRequestBody, sessionToken *string) *risk.DeclineRiskPolicyChallengePayload {
...
// NewSuggestExclusionPayload builds a risk service suggestExclusion endpoint
// payload.
...
// ValidateReleaseSessionQuarantineRequestBody runs the validations defined on
// ReleaseSessionQuarantineRequestBody
func ValidateReleaseSessionQuarantineRequestBody(body *ReleaseSessionQuarantineRequestBody) (err error) {
	if body.ID == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("id", "body"))
	}
	if body.ID != nil {
...
// ValidateMarkRiskResultsFalsePositiveRequestBody runs the validations defined
// on MarkRiskResultsFalsePositiveRequestBody
func ValidateMarkRiskResultsFalsePositiveRequestBody(body *MarkRiskResultsFalsePositiveRequestBody) (err error) {
...
// ValidateUnmarkRiskResultsFalsePositiveRequestBody runs the validations
// defined on UnmarkRiskResultsFalsePositiveRequestBody
func ValidateUnmarkRiskResultsFalsePositiveRequestBody(body *UnmarkRiskResultsFalsePositiveRequestBody) (err error) {
	if body.ResultIds == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("result_ids", "body"))
	}
	if len(body.ResultIds) < 1 {
...
// ValidateSuggestRiskPolicyRequestBody runs the validations defined on
// SuggestRiskPolicyRequestBody
func ValidateSuggestRiskPolicyRequestBody(body *SuggestRiskPolicyRequestBody) (err error) {
	if body.Prompt == nil {
...
// ValidateAcknowledgeRiskPolicyChallengeRequestBody runs the validations
// defined on AcknowledgeRiskPolicyChallengeRequestBody
func ValidateAcknowledgeRiskPolicyChallengeRequestBody(body *AcknowledgeRiskPolicyChallengeRequestBody) (err error) {
	if body.AckToken == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("ack_token", "body"))
	}
	return
}

// ValidateGetRiskPolicyChallengeRequestBody runs the validations defined on
// GetRiskPolicyChallengeRequestBody
func ValidateGetRiskPolicyChallengeRequestBody(body *GetRiskPolicyChallengeRequestBody) (err error) {
	if body.AckToken == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("ack_token", "body"))
	}
	return
...
// ValidateDeclineRiskPolicyChallengeRequestBody runs the validations defined
// on DeclineRiskPolicyChallengeRequestBody
func ValidateDeclineRiskPolicyChallengeRequestBody(body *DeclineRiskPolicyChallengeRequestBody) (err error) {
	if body.AckToken == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("ack_token", "body"))
	}
	return
