...
type Server struct {
	...
	ListDismissedRiskResults       http.Handler
	GetRiskOverview                http.Handler
	ListRiskCategories             http.Handler
	ListRiskPresets                http.Handler
	SuggestRiskPolicy              http.Handler
	...
	GetRiskPolicyChallenge         http.Handler
	DeclineRiskPolicyChallenge     http.Handler
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			...
			{"ListDismissedRiskResults", "GET", "/rpc/risk.listDismissedResults"},
			{"GetRiskOverview", "GET", "/rpc/risk.getOverview"},
			{"ListRiskCategories", "GET", "/rpc/risk.listCategories"},
			{"ListRiskPresets", "GET", "/rpc/risk.listPresets"},
			{"SuggestRiskPolicy", "POST", "/rpc/risk.suggestPolicy"},
			...
			{"GetRiskPolicyChallenge", "POST", "/rpc/risk.getPolicyChallenge"},
			{"DeclineRiskPolicyChallenge", "POST", "/rpc/risk.declinePolicyChallenge"},
		...
		ListDismissedRiskResults:       NewListDismissedRiskResultsHandler(e.ListDismissedRiskResults, mux, decoder, encoder, errhandler, formatter),
		...
		ListRiskPresets:                NewListRiskPresetsHandler(e.ListRiskPresets, mux, decoder, encoder, errhandler, formatter),
		SuggestRiskPolicy:              NewSuggestRiskPolicyHandler(e.SuggestRiskPolicy, mux, decoder, encoder, errhandler, formatter),
		...
		GetRiskPolicyChallenge:         NewGetRiskPolicyChallengeHandler(e.GetRiskPolicyChallenge, mux, decoder, encoder, errhandler, formatter),
		DeclineRiskPolicyChallenge:     NewDeclineRiskPolicyChallengeHandler(e.DeclineRiskPolicyChallenge, mux, decoder, encoder, errhandler, formatter),
...
func (s *Server) Use(m func(http.Handler) http.Handler) {
	...
	s.ListDismissedRiskResults = m(s.ListDismissedRiskResults)
	s.GetRiskOverview = m(s.GetRiskOverview)
	s.ListRiskCategories = m(s.ListRiskCategories)
	s.ListRiskPresets = m(s.ListRiskPresets)
	s.SuggestRiskPolicy = m(s.SuggestRiskPolicy)
	...
	s.GetRiskPolicyChallenge = m(s.GetRiskPolicyChallenge)
	s.DeclineRiskPolicyChallenge = m(s.DeclineRiskPolicyChallenge)
...
func Mount(mux goahttp.Muxer, h *Server) {
	...
	MountListDismissedRiskResultsHandler(mux, h.ListDismissedRiskResults)
	MountGetRiskOverviewHandler(mux, h.GetRiskOverview)
	MountListRiskCategoriesHandler(mux, h.ListRiskCategories)
	MountListRiskPresetsHandler(mux, h.ListRiskPresets)
	MountSuggestRiskPolicyHandler(mux, h.SuggestRiskPolicy)
	...
	MountGetRiskPolicyChallengeHandler(mux, h.GetRiskPolicyChallenge)
	MountDeclineRiskPolicyChallengeHandler(mux, h.DeclineRiskPolicyChallenge)
...
// MountListBuiltinExclusionsHandler configures the mux to serve the "risk"
// service "listBuiltinExclusions" endpoint.
func MountListBuiltinExclusionsHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/rpc/risk.listBuiltinExclusions", f)
}

// NewListBuiltinExclusionsHandler creates a HTTP handler which loads the HTTP
// request and calls the "risk" service "listBuiltinExclusions" endpoint.
func NewListBuiltinExclusionsHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeListBuiltinExclusionsRequest(mux, decoder)
		encodeResponse = EncodeListBuiltinExclusionsResponse(encoder)
		encodeError    = EncodeListBuiltinExclusionsError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "listBuiltinExclusions")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountMarkRiskResultsFalsePositiveHandler configures the mux to serve the
// "risk" service "markRiskResultsFalsePositive" endpoint.
func MountMarkRiskResultsFalsePositiveHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/risk.markResultsFalsePositive", f)
}

// NewMarkRiskResultsFalsePositiveHandler creates a HTTP handler which loads
// the HTTP request and calls the "risk" service "markRiskResultsFalsePositive"
// endpoint.
func NewMarkRiskResultsFalsePositiveHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeMarkRiskResultsFalsePositiveRequest(mux, decoder)
		encodeResponse = EncodeMarkRiskResultsFalsePositiveResponse(encoder)
		encodeError    = EncodeMarkRiskResultsFalsePositiveError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "markRiskResultsFalsePositive")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountUnmarkRiskResultsFalsePositiveHandler configures the mux to serve the
// "risk" service "unmarkRiskResultsFalsePositive" endpoint.
func MountUnmarkRiskResultsFalsePositiveHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/risk.unmarkResultsFalsePositive", f)
}

// NewUnmarkRiskResultsFalsePositiveHandler creates a HTTP handler which loads
// the HTTP request and calls the "risk" service
// "unmarkRiskResultsFalsePositive" endpoint.
func NewUnmarkRiskResultsFalsePositiveHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeUnmarkRiskResultsFalsePositiveRequest(mux, decoder)
		encodeResponse = EncodeUnmarkRiskResultsFalsePositiveResponse(encoder)
		encodeError    = EncodeUnmarkRiskResultsFalsePositiveError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "unmarkRiskResultsFalsePositive")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountListDismissedRiskResultsHandler configures the mux to serve the "risk"
// service "listDismissedRiskResults" endpoint.
func MountListDismissedRiskResultsHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/rpc/risk.listDismissedResults", f)
}

// NewListDismissedRiskResultsHandler creates a HTTP handler which loads the
// HTTP request and calls the "risk" service "listDismissedRiskResults"
// endpoint.
func NewListDismissedRiskResultsHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeListDismissedRiskResultsRequest(mux, decoder)
		encodeResponse = EncodeListDismissedRiskResultsResponse(encoder)
		encodeError    = EncodeListDismissedRiskResultsError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "listDismissedRiskResults")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountListRiskPresetsHandler configures the mux to serve the "risk" service
// "listRiskPresets" endpoint.
func MountListRiskPresetsHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/rpc/risk.listPresets", f)
}

// NewListRiskPresetsHandler creates a HTTP handler which loads the HTTP
// request and calls the "risk" service "listRiskPresets" endpoint.
func NewListRiskPresetsHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeListRiskPresetsRequest(mux, decoder)
		encodeResponse = EncodeListRiskPresetsResponse(encoder)
		encodeError    = EncodeListRiskPresetsError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "listRiskPresets")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountSuggestRiskPolicyHandler configures the mux to serve the "risk" service
// "suggestRiskPolicy" endpoint.
func MountSuggestRiskPolicyHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/risk.suggestPolicy", f)
}

// NewSuggestRiskPolicyHandler creates a HTTP handler which loads the HTTP
// request and calls the "risk" service "suggestRiskPolicy" endpoint.
func NewSuggestRiskPolicyHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeSuggestRiskPolicyRequest(mux, decoder)
		encodeResponse = EncodeSuggestRiskPolicyResponse(encoder)
		encodeError    = EncodeSuggestRiskPolicyError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "suggestRiskPolicy")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountGetRiskSignalsHandler configures the mux to serve the "risk" service
// "getRiskSignals" endpoint.
func MountGetRiskSignalsHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("GET", "/rpc/risk.getSignals", f)
}

// NewGetRiskSignalsHandler creates a HTTP handler which loads the HTTP request
// and calls the "risk" service "getRiskSignals" endpoint.
func NewGetRiskSignalsHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeGetRiskSignalsRequest(mux, decoder)
		encodeResponse = EncodeGetRiskSignalsResponse(encoder)
		encodeError    = EncodeGetRiskSignalsError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
...
// MountGetRiskPolicyChallengeHandler configures the mux to serve the "risk"
// service "getRiskPolicyChallenge" endpoint.
func MountGetRiskPolicyChallengeHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/risk.getPolicyChallenge", f)
}

// NewGetRiskPolicyChallengeHandler creates a HTTP handler which loads the HTTP
// request and calls the "risk" service "getRiskPolicyChallenge" endpoint.
func NewGetRiskPolicyChallengeHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeGetRiskPolicyChallengeRequest(mux, decoder)
		encodeResponse = EncodeGetRiskPolicyChallengeResponse(encoder)
		encodeError    = EncodeGetRiskPolicyChallengeError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "getRiskPolicyChallenge")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountDeclineRiskPolicyChallengeHandler configures the mux to serve the
// "risk" service "declineRiskPolicyChallenge" endpoint.
func MountDeclineRiskPolicyChallengeHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/rpc/risk.declinePolicyChallenge", f)
}

// NewDeclineRiskPolicyChallengeHandler creates a HTTP handler which loads the
// HTTP request and calls the "risk" service "declineRiskPolicyChallenge"
// endpoint.
func NewDeclineRiskPolicyChallengeHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeDeclineRiskPolicyChallengeRequest(mux, decoder)
		encodeResponse = EncodeDeclineRiskPolicyChallengeResponse(encoder)
		encodeError    = EncodeDeclineRiskPolicyChallengeError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "declineRiskPolicyChallenge")
		ctx = context.WithValue(ctx, goa.ServiceKey, "risk")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
