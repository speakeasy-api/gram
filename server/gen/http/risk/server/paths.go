...
// ListRiskResultsByUserRiskPath returns the URL path to the risk service listRiskResultsByUser HTTP endpoint.
func ListRiskResultsByUserRiskPath() string {
	return "/rpc/risk.results.byUser"
}
