...
// ClusterRiskResultsRiskPath returns the URL path to the risk service clusterRiskResults HTTP endpoint.
func ClusterRiskResultsRiskPath() string {
	return "/rpc/risk.results.cluster"
}
