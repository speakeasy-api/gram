...
func NewEndpoints(s Service) *Endpoints {
	...
	return &Endpoints{
		...
		ListChatSources:          NewListChatSourcesEndpoint(s, a.APIKeyAuth, a.JWTAuth),
...
func (e *Endpoints) Use(m func(goa.Endpoint) goa.Endpoint) {
	...
	e.ListChatSources = m(e.ListChatSources)
...
// NewListChatSourcesEndpoint returns an endpoint function that calls the
// method "listChatSources" of service "chat".
func NewListChatSourcesEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc, authJWTFn security.AuthJWTFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*ListChatSourcesPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
		...
		return s.ListChatSources(ctx, p)
	}
}
