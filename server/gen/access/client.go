...
func NewClient(listGrants, upsertGrants, removeGrants, removePrincipalGrants, listRoles, getRole, createRole, updateRole, deleteRole, listScopes, listMembers, updateMemberRole goa.Endpoint) *Client {
	return &Client{
