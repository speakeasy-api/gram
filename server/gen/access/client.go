...
type Client struct {
	...
	ListMemberGrantsEndpoint                   goa.Endpoint
...
func NewClient(listRoles, getRole, createRole, updateRole, deleteRole, listScopes, listMembers, listGrants, listMemberGrants, updateMemberRoles, listShadowMCPInventory, getShadowMCPInventoryServer, updateShadowMCPInventoryServerName, listShadowMCPInventoryUsers, resolveShadowMCPInventoryRequest, requestAccess, listChallenges, listChallengeBuckets, resolveChallenge goa.Endpoint) *Client {
	return &Client{
		...
		ListMemberGrantsEndpoint:                   listMemberGrants,
...
// ListMemberGrants calls the "listMemberGrants" endpoint of the "access"
// service.
// ListMemberGrants may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): unauthorized access
//   - "forbidden" (type *goa.ServiceError): permission denied
//   - "bad_request" (type *goa.ServiceError): request is invalid
//   - "not_found" (type *goa.ServiceError): resource not found
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) ListMemberGrants(ctx context.Context, p *ListMemberGrantsPayload) (res *ListUserGrantsResult, err error) {
	var ires any
	ires, err = c.ListMemberGrantsEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*ListUserGrantsResult), nil
