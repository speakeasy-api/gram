...
func NewClient(get, sendInvite, revokeInvite, updateInviteRole, listInvites, listUsers, removeUser, enableWebhooks, disableWebhooks, createPortalSession, getOnboardingStatus, verifyOnboardingHooksSetup, sendEnterpriseAdminOnboardingEmail, generateWorkOSAdminPortalLink, listSetupTasks, assignSetupWorkstream, updateSetupTask goa.Endpoint) *Client {
	return &Client{
		GetEndpoint:                                get,
...
// UpdateInviteRole calls the "updateInviteRole" endpoint of the
// "organizations" service.
// UpdateInviteRole may return the following errors:
//   - "unauthorized" (type *goa.ServiceError): unauthorized access
//   - "forbidden" (type *goa.ServiceError): permission denied
//   - "bad_request" (type *goa.ServiceError): request is invalid
//   - "not_found" (type *goa.ServiceError): resource not found
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) UpdateInviteRole(ctx context.Context, p *UpdateInviteRolePayload) (res *OrganizationInvitation, err error) {
	var ires any
	ires, err = c.UpdateInviteRoleEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*OrganizationInvitation), nil
