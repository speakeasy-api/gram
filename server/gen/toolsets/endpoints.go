...
type Endpoints struct {
	...
	UpdateSecurityVariableDisplayName goa.Endpoint
}
...
func NewEndpoints(s Service) *Endpoints {
	...
	return &Endpoints{
		...
		UpdateSecurityVariableDisplayName: NewUpdateSecurityVariableDisplayNameEndpoint(s, a.APIKeyAuth),
	}
}
...
func (e *Endpoints) Use(m func(goa.Endpoint) goa.Endpoint) {
	...
	e.UpdateSecurityVariableDisplayName = m(e.UpdateSecurityVariableDisplayName)
}
...
// NewAddOAuthProxyServerEndpoint returns an endpoint function that calls the
// method "addOAuthProxyServer" of service "toolsets".
func NewAddOAuthProxyServerEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*AddOAuthProxyServerPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
...
// NewUpdateSecurityVariableDisplayNameEndpoint returns an endpoint function
// that calls the method "updateSecurityVariableDisplayName" of service
// "toolsets".
func NewUpdateSecurityVariableDisplayNameEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*UpdateSecurityVariableDisplayNamePayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
		...
		return s.UpdateSecurityVariableDisplayName(ctx, p)
	}
}
