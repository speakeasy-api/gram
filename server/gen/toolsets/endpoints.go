...
type Endpoints struct {
	...
	ClearUserSessionIssuer   goa.Endpoint
}
...
func NewEndpoints(s Service) *Endpoints {
	...
	return &Endpoints{
		...
		ClearUserSessionIssuer:   NewClearUserSessionIssuerEndpoint(s, a.APIKeyAuth),
	}
}
...
func (e *Endpoints) Use(m func(goa.Endpoint) goa.Endpoint) {
	...
	e.ClearUserSessionIssuer = m(e.ClearUserSessionIssuer)
}
...
// NewClearUserSessionIssuerEndpoint returns an endpoint function that calls
// the method "clearUserSessionIssuer" of service "toolsets".
func NewClearUserSessionIssuerEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*ClearUserSessionIssuerPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
		...
		return s.ClearUserSessionIssuer(ctx, p)
	}
}
