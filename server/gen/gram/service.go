...
// MethodKey key.
var MethodNames = [1]string{"createDeployment"}

// DeploymentCreateForm is the payload type of the gram service
...
// DeploymentCreateResult is the result type of the gram service
// createDeployment method.
