...
func (c *Client) CreateAgentDefinition(ctx context.Context, p *CreateAgentDefinitionPayload) (res *types.AgentDefinition, err error) {
	var ires any
	ires, err = c.CreateAgentDefinitionEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*types.AgentDefinition), nil
}
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) GetAgentDefinition(ctx context.Context, p *GetAgentDefinitionPayload) (res *types.AgentDefinition, err error) {
	var ires any
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) UpdateAgentDefinition(ctx context.Context, p *UpdateAgentDefinitionPayload) (res *types.AgentDefinition, err error) {
	var ires any
