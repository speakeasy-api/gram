...
func NewEndpoints(s Service) *Endpoints {
	...
	return &Endpoints{
		...
		QueryChatTurns:            NewQueryChatTurnsEndpoint(s, a.APIKeyAuth),
...
func (e *Endpoints) Use(m func(goa.Endpoint) goa.Endpoint) {
	...
	e.Query = m(e.Query)
	e.QueryChatTurns = m(e.QueryChatTurns)
...
// NewQueryChatTurnsEndpoint returns an endpoint function that calls the method
// "queryChatTurns" of service "telemetry".
func NewQueryChatTurnsEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*QueryChatTurnsPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
