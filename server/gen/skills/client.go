...
func NewClient(create, addVersion, list, get, listVersions, archive, distribute, undistribute, listDistributions, getDistributionStatus, listDistributionAudienceGroups, sync goa.Endpoint) *Client {
	return &Client{
...
// Sync calls the "sync" endpoint of the "skills" service.
...
//   - "gateway_error" (type *goa.ServiceError): an unexpected error occurred
//   - error: internal error
func (c *Client) Sync(ctx context.Context, p *SyncPayload) (res *SyncSkillsResult, err error) {
	var ires any
	ires, err = c.SyncEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*SyncSkillsResult), nil
}
