...
// NewGetDistributionStatusEndpoint returns an endpoint function that calls the
// method "getDistributionStatus" of service "skills".
func NewGetDistributionStatusEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*GetDistributionStatusPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
		...
		return s.GetDistributionStatus(ctx, p)
	}
}

// NewListDistributionAudienceGroupsEndpoint returns an endpoint function that
// calls the method "listDistributionAudienceGroups" of service "skills".
func NewListDistributionAudienceGroupsEndpoint(s Service, authAPIKeyFn security.AuthAPIKeyFunc) goa.Endpoint {
	return func(ctx context.Context, req any) (any, error) {
		p := req.(*ListDistributionAudienceGroupsPayload)
		var err error
		sc := security.APIKeyScheme{
			Name:           "session",
			Scopes:         []string{},
