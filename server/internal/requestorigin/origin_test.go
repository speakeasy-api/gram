...
func TestCanonicalHost(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "leading whitespace", raw: " example.com", wantErr: true},
		{name: "trailing whitespace", raw: "example.com ", wantErr: true},
		{name: "surrounding whitespace", raw: " example.com ", wantErr: true},
