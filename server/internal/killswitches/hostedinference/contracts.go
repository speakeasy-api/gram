...
const (
	...
	IdentityContractKeyAuthenticatedUserAIAccess killswitches.IdentityContractKey = "authenticated_user_ai_access"
...
const (
	...
	CallCategoryAPIKeyChat                      CallCategory = "api_key_chat"
	...
	CallCategoryAPIKeyChatSummary               CallCategory = "api_key_chat_summary"
	CallCategoryAPIKeyToolCallSummary           CallCategory = "api_key_tool_call_summary"
	CallCategoryAPIKeyRiskAuthoring             CallCategory = "api_key_risk_authoring"
...
func withBypass(ctx context.Context, category CallCategory, class CallClass) (context.Context, error) {
	...
	return context.WithValue(ctx, classificationContextKey{}, Classification{class: class, category: category}), nil
}
