...
// chat-session provenance are deliberately unsupported. The separate agent adapter
// handles agent provenance without contributing a user candidate. A stamped identity with a zero or
