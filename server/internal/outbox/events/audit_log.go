...
var (
	...
	OrganizationTrialV1                    = outbox.NewEventDef[AuditLogCreatedPayloadV1]("audit_log.organization_trial_event_v1", "Emitted when the organization's trial is demoted after it expires")
