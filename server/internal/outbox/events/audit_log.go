...
var (
	...
	IdentityProviderConnectionV1           = outbox.NewEventDef[AuditLogCreatedPayloadV1]("audit_log.identity_provider_connection_event_v1", "Emitted when an organization creates, verifies, annotates, or revokes an identity provider connection")
	...
	OrganizationOnboardingV1               = outbox.NewEventDef[AuditLogCreatedPayloadV1]("audit_log.organization_onboarding_event_v1", "Emitted when an organization's onboarding selection or answers are saved, or an onboarding step is verified")
