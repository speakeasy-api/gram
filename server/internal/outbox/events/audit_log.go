...
var (
	...
	SessionCaptureExclusionV1 = outbox.NewEventDef[AuditLogCreatedPayloadV1]("audit_log.session_capture_exclusion_event_v1", "Emitted when session capture exclusions are added or removed")
