...
var (
	...
	AccessDirectoryMappingV1               = outbox.NewEventDef[AuditLogCreatedPayloadV1]("audit_log.access_directory_mapping_event_v1", "Emitted when changes to directory permission mappings are made")
