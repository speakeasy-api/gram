...
func TestSkillsRBACRejectsMissingAndOtherProjectGrants(t *testing.T) {
	...
	requireOopsCode(t, err, oops.CodeForbidden)
	_, err = ti.service.Distribute(noGrants, &gen.DistributePayload{ID: uuid.NewString(), PinnedVersionID: nil, AudienceGroupIds: nil, SessionToken: nil, ApikeyToken: nil, ProjectSlugInput: nil})
	requireOopsCode(t, err, oops.CodeForbidden)
	err = ti.service.Undistribute(noGrants, &gen.UndistributePayload{ID: uuid.NewString(), SessionToken: nil, ApikeyToken: nil, ProjectSlugInput: nil})
	requireOopsCode(t, err, oops.CodeForbidden)
	...
	requireOopsCode(t, err, oops.CodeForbidden)
	_, err = ti.service.GetDistributionStatus(noGrants, &gen.GetDistributionStatusPayload{ID: uuid.NewString(), SessionToken: nil, ApikeyToken: nil, ProjectSlugInput: nil})
	requireOopsCode(t, err, oops.CodeForbidden)
	_, err = ti.service.ListDistributionAudienceGroups(noGrants, &gen.ListDistributionAudienceGroupsPayload{SessionToken: nil, ApikeyToken: nil, ProjectSlugInput: nil})
	requireOopsCode(t, err, oops.CodeForbidden)
...
func TestSkillsFeatureDisabledRejectsEveryEndpoint(t *testing.T) {
	...
	requireOopsCode(t, err, oops.CodeForbidden)
	_, err = ti.service.ListDistributionAudienceGroups(ctx, &gen.ListDistributionAudienceGroupsPayload{SessionToken: nil, ApikeyToken: nil, ProjectSlugInput: nil})
	requireOopsCode(t, err, oops.CodeForbidden)
}
