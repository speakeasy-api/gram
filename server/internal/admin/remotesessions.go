...
func convertGlobalRemoteSessionIssuer(v *adminrsgen.GlobalRemoteSessionIssuer) *gen.GlobalRemoteSessionIssuer {
	...
	out := &gen.GlobalRemoteSessionIssuer{EmaBindingCount: v.EmaBindingCount, Issuer: v.Issuer, GlobalClientCount: v.GlobalClientCount, TenantClientCount: v.TenantClientCount, TrustedUserSessionIssuerCount: v.TrustedUserSessionIssuerCount}
	return out
}
