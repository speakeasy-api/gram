...
func (s *stubRuntimeBackend) RunTurn(_ context.Context, _ assistantRuntimeRecord, _ uuid.UUID, _ string, _ string, _ string, _ []runtimeContentPart, _ []runtimeMCPServer) error {
	s.runTurnCount++
	return nil
}
