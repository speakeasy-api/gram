...
func TestServiceCoreAdmitPendingThreadsUsesFlyBackend(t *testing.T) {
	...
	core := NewServiceCore(testenv.NewLogger(t), testenv.NewTracerProvider(t), conn, testRuntimeBackend{backend: runtimeBackendFlyIO, runTurnErr: nil}, nil, nil, nil, telemetry.NewStub(testenv.NewLogger(t)), nil, nil)
...
func TestServiceCoreExpireThreadRuntimeRevertsWhenTurnInFlight(t *testing.T) {
	...
	core := NewServiceCore(logger, testenv.NewTracerProvider(t), conn, backend, nil, nil, nil, telemetry.NewStub(logger), nil, nil)
...
func TestServiceCoreExpireThreadRuntimeRetryAfterStopFailureIsIdempotent(t *testing.T) {
	...
	core := NewServiceCore(logger, testenv.NewTracerProvider(t), conn, failingBackend, nil, nil, nil, telemetry.NewStub(logger), nil, nil)
	...
	core = NewServiceCore(logger, testenv.NewTracerProvider(t), conn, healingBackend, nil, nil, nil, telemetry.NewStub(logger), nil, nil)
...
func TestServiceCoreReapStuckRuntimesLeavesFreshExpiring(t *testing.T) {
	...
	core := NewServiceCore(testenv.NewLogger(t), testenv.NewTracerProvider(t), conn, testRuntimeBackend{backend: runtimeBackendFlyIO}, nil, nil, nil, telemetry.NewStub(testenv.NewLogger(t)), nil, nil)
...
func TestServiceCoreProcessThreadEventsCompletesEvent(t *testing.T) {
	...
	core := NewServiceCore(logger, testenv.NewTracerProvider(t), conn, testRuntimeBackend{backend: runtimeBackendFlyIO, runTurnErr: nil}, nil, tokens, nil, telemetry.NewStub(logger), nil, nil)
...
func TestServiceCoreProcessThreadEventsRequeuesOnTurnFailure(t *testing.T) {
	...
	core := NewServiceCore(logger, testenv.NewTracerProvider(t), conn, backend, nil, tokens, nil, telemetry.NewStub(logger), nil, nil)
...
func TestServiceCoreProcessThreadEventsMarksRuntimeFailedOnUnhealthyTurn(t *testing.T) {
	...
	core := NewServiceCore(logger, testenv.NewTracerProvider(t), conn, backend, nil, tokens, mustParseURLForServiceTest(t, "https://gram.example.com"), telemetry.NewStub(logger), nil, nil)
...
func TestServiceCoreDeleteAssistantReapsRuntimes(t *testing.T) {
	...
	core := NewServiceCore(testenv.NewLogger(t), testenv.NewTracerProvider(t), conn, backend, nil, nil, nil, telemetry.NewStub(testenv.NewLogger(t)), nil, nil)
