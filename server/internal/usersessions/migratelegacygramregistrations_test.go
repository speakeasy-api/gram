...
// attachToolsetToProxyServer seeds an MCP-published toolset (wrapper
// mcp_server + Gram-hosted endpoint under the given MCP slug) routed through
// the given oauth_proxy_server.
