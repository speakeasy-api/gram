...
RETURNING id, user_session_issuer_id, client_id, client_secret_hash, client_name, redirect_uris, client_id_issued_at, client_secret_expires_at, created_at, updated_at, deleted_at, deleted
`
...
RETURNING id, subject_urn, user_session_client_id, remote_set_hash, consented_at, created_at, updated_at, deleted_at, deleted
`
...
SELECT c.id, c.subject_urn, c.user_session_client_id, c.remote_set_hash, c.consented_at, c.created_at, c.updated_at, c.deleted_at, c.deleted, cli.user_session_issuer_id AS user_session_issuer_id
...
WHERE c.id = $1
  ...
  AND iss.project_id = $2
  AND c.deleted IS FALSE
RETURNING c.id, c.subject_urn, c.user_session_client_id, c.remote_set_hash, c.consented_at, c.created_at, c.updated_at, c.deleted_at, c.deleted, cli.user_session_issuer_id AS user_session_issuer_id
`
...
WHERE c.user_session_client_id = cli.id
  ...
  AND c.deleted IS FALSE
RETURNING c.id, c.subject_urn, c.user_session_client_id, c.remote_set_hash, c.consented_at, c.created_at, c.updated_at, c.deleted_at, c.deleted
`
