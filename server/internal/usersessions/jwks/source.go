...
func NewInlineSource(keySet json.RawMessage) (Source, error) {
	if len(keySet) == 0 {
		return Source{kind: "", inline: nil, uri: "", origin: "", cacheKey: "", fetchScope: ""}, errors.New("inline key set is empty")
	}
	return Source{kind: sourceInline, inline: keySet, uri: "", origin: "", cacheKey: "", fetchScope: ""}, nil
}
...
func NewRemoteSource(jwksURI string) (Source, error) {
	...
	if err != nil {
		return Source{kind: "", inline: nil, uri: "", origin: "", cacheKey: "", fetchScope: ""}, err
	}
	return Source{kind: sourceRemote, inline: nil, uri: jwksURI, origin: parsed.Host, cacheKey: "", fetchScope: ""}, nil
}
