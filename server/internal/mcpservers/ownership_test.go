...
func TestUpdateMcpServer_RejectsCrossTenantToolset(t *testing.T) {
	t.Parallel()
...
func TestCreateMcpServer_RejectsCrossTenantRemoteMcpServer(t *testing.T) {
	t.Parallel()
...
func TestUpdateMcpServer_RejectsCrossTenantRemoteMcpServer(t *testing.T) {
	t.Parallel()
