...
WHERE project_id = @project_id
  ...
  AND (sqlc.narg('tunneled_mcp_server_id')::uuid IS NULL OR tunnelled_mcp_server_id = sqlc.narg('tunneled_mcp_server_id')::uuid)
...
SET
    ...
    tunnelled_mcp_server_id = @tunneled_mcp_server_id,
