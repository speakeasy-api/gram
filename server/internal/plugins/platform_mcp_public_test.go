...
func TestPublicPlatformMCPFiles(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"README.md",
		"LICENSE",
		"platform-mcp/.mcp.json",
		"platform-mcp/.claude-plugin/plugin.json",
		"cursor-plugins/platform-mcp-cursor/.cursor-plugin/plugin.json",
		"platform-mcp-codex/.codex-plugin/plugin.json",
	} {
