...
export default { id: "speakeasy.observability", setup, server: legacy }
`
...
// .opencode/.
//
// OpenCode 2 loads the default {id, setup}; OpenCode 1 calls server() for the
// legacy config hook. Headers whose ${env:VAR} is unset are dropped.
