...
SELECT 
    ...
    om.id, om.name, om.slug, om.gram_account_type, om.workos_id, om.whitelisted, om.free_trial_started_at, om.free_trial_ends_at, om.created_at, om.updated_at, om.disabled_at
