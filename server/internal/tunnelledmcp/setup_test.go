...
func newTestService(t *testing.T) (context.Context, *testInstance) {
	...
	conn, err := infra.CloneTestDatabase(t, "tunnelledmcptest")
	...
	sessionManager := testenv.NewTestManager(t, logger, tracerProvider, conn, redisClient, cache.Suffix("gram-tunnelledmcp-test"), billingClient)
