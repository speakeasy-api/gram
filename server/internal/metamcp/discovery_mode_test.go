...
func TestGatewayCapabilitiesDoNotRequireOrganizationRead(t *testing.T) {
	...
	require.NotNil(t, got.FrozenToolsetsEnabled)
	require.True(t, *got.FrozenToolsetsEnabled)
	...
	require.Equal(t, got.FrozenToolsetsEnabled, listed.MetaMcpServers[0].FrozenToolsetsEnabled)
	...
	require.NotNil(t, updated.FrozenToolsetsEnabled)
	require.True(t, *updated.FrozenToolsetsEnabled)
