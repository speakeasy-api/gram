...
func TestService_ServeSkill_Success(t *testing.T) {
	t.Parallel()
	...
	// Call ServeSkill
	result, body, err := ti.service.ServeSkill(ctx, &assets.ServeSkillForm{
		SessionToken: nil,
		ApikeyToken:  nil,
...
func TestService_ServeSkill_Unauthorized(t *testing.T) {
	t.Parallel()
	...
	_, _, err := ti.service.ServeSkill(ctx, &assets.ServeSkillForm{
		SessionToken: nil,
		ApikeyToken:  nil,
		ProjectID:    "",
		ID:           uuid.New().String(),
...
func TestService_ServeSkill_InvalidAssetID(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_EmptyAssetID(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_AssetNotFound(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_WrongProject(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_FileNotInStorage(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_InvalidAssetURL(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_CrossProjectAccess(t *testing.T) {
	t.Parallel()
	...
	result, body, err := ti.service.ServeSkill(ctx1, &assets.ServeSkillForm{
		SessionToken: nil,
		ApikeyToken:  nil,
	...
	_, _, err = ti.service.ServeSkill(ctx2, &assets.ServeSkillForm{
		SessionToken: nil,
		ApikeyToken:  nil,
...
func TestService_ServeSkill_InvalidProjectID(t *testing.T) {
	t.Parallel()
...
func TestService_ServeSkill_EmptyProjectID(t *testing.T) {
	t.Parallel()
