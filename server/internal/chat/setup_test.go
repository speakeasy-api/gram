...
func newTestChatServiceWithOptions(t *testing.T, completionClient openrouter.CompletionClient) *chatTestInstance {
	...
	svc := chat.NewService(logger, tp, conn, mgr, chatSessions, nil, completionClient, nil, posthogClient, nil, assetStorage, authzEngine, nil, billingClient, audit.NewLogger())
