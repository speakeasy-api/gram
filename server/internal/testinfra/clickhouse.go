...
//
// Mirrors testenv.NewTestClickhouse but lives in testinfra so it can be used by
// packages (e.g. internal/authz) that cannot import internal/testenv because of
