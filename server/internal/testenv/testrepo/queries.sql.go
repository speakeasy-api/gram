...
SELECT id, tool_urn, project_id, deployment_id, function_id, runtime, name, description, input_schema, variables, auth_input, meta, annotations, created_at, updated_at, deleted_at, deleted
