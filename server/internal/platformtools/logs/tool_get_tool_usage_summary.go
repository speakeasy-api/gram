...
type getToolUsageSummaryInput struct {
	...
	TargetTypes        []string `json:"target_types,omitempty" jsonschema:"Target types to include: hosted_mcp_server, tunnelled_mcp_server, shadow_mcp_server, local_tool, skill. Use tunnelled_mcp_server for tunnelled MCP servers."`
...
func (s *GetToolUsageSummary) Descriptor() core.ToolDescriptor {
	return core.ToolDescriptor{
		...
		Description: "Summarize target-aware tool usage for hosted MCP, tunnelled MCP, shadow MCP, local tools, and skills in the current project. Use target_types=[\"tunnelled_mcp_server\"] for questions like which tunnelled MCPs the team uses.",
