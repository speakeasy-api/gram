...
type LinearApp struct {
	CreatedAt           pgtype.Timestamptz
	DeletedAt           pgtype.Timestamptz
	UpdatedAt           pgtype.Timestamptz
	LinearWorkspaceName pgtype.Text
	LinearWorkspaceID   pgtype.Text
	LinearClientSecret  pgtype.Text
	LinearSigningSecret pgtype.Text
	LinearAccessToken   pgtype.Text
	LinearClientID      pgtype.Text
	OrganizationID      string
	ActorMode           string
...
type LinearAppToolset struct {
	ID          uuid.UUID
	LinearAppID uuid.UUID
	ToolsetID   uuid.UUID
	CreatedAt   pgtype.Timestamptz
}

type LinearRegistration struct {
	ID              uuid.UUID
	LinearAppID     uuid.UUID
