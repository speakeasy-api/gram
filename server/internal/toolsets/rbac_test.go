...
func TestToolsets_RBAC_List_FiltersToGrantedToolsets(t *testing.T) {
	...
	ctx = authztest.WithExactGrants(t, ctx, authz.NewGrant(authz.ScopeMCPRead, toolset.ID))
...
func TestToolsets_RBAC_Create_DeniedWithReadOnlyGrant(t *testing.T) {
	...
	ctx = authztest.WithExactGrants(t, ctx, authz.NewGrant(authz.ScopeMCPRead, authCtx.ProjectID.String()))
...
func TestToolsets_RBAC_Create_AllowedWithProjectWriteGrant(t *testing.T) {
	...
	ctx = authztest.WithExactGrants(t, ctx, authz.NewGrant(authz.ScopeMCPWrite, authCtx.ProjectID.String()))
...
func TestToolsets_RBAC_WriteOps_AllowedWithToolsetWriteGrant(t *testing.T) {
	...
	ctx = authztest.WithExactGrants(t, ctx, authz.NewGrant(authz.ScopeMCPWrite, toolset.ID))
