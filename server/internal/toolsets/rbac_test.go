...
func TestToolsets_RBAC_List_FiltersToGrantedToolsets(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeMCPRead, toolset.ID))
...
func TestToolsets_RBAC_List_ReturnsEmptyWithWrongResourceGrant(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeMCPRead, uuid.NewString()))
...
func TestToolsets_RBAC_Create_DeniedWithReadOnlyGrant(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeMCPRead, authCtx.ProjectID.String()))
...
func TestToolsets_RBAC_Create_AllowedWithProjectWriteGrant(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeMCPWrite, authCtx.ProjectID.String()))
...
func TestToolsets_RBAC_WriteOps_AllowedWithToolsetWriteGrant(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeMCPWrite, toolset.ID))
