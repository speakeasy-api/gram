...
type testInstance struct {
	...
	variationsSvc  *variations.Service
	toolsetsSvc    *toolsets.Service
	conn           *pgxpool.Pool
	sessionManager *sessions.Manager
}

func newTestInsightsService(t *testing.T) (context.Context, *testInstance) {
	t.Helper()
	...
	svc := insights.NewService(logger, tracerProvider, conn, sessionManager, authzEngine, variationsSvc, toolsetsSvc)

	return ctx, &testInstance{
		service:        svc,
		variationsSvc:  variationsSvc,
