...
func WorkOSDirectoryAttributesEntityType(v string) attribute.KeyValue {
	return WorkOSDirectoryAttributesEntityTypeKey.String(v)
}
func SlogWorkOSDirectoryAttributesEntityType(v string) slog.Attr {
	return slog.String(string(WorkOSDirectoryAttributesEntityTypeKey), v)
}

func WorkOSDirectoryAttributesEntityID(v string) attribute.KeyValue {
	return WorkOSDirectoryAttributesEntityIDKey.String(v)
}
func SlogWorkOSDirectoryAttributesEntityID(v string) slog.Attr {
	return slog.String(string(WorkOSDirectoryAttributesEntityIDKey), v)
}
...
func RemoteSessionClientID(v string) attribute.KeyValue { return RemoteSessionClientIDKey.String(v) }
