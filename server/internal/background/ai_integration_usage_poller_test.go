...
func TestAIUsagePollerWorkflowAcceptsLegacyStringInput(t *testing.T) {
	...
	env.SetStartWorkflowOptions(client.StartWorkflowOptions{
		ID:        buildAIUsagePollerWorkflowID("acme", configID, aiintegrations.ProviderAnthropicCompliance),
	...
	// This is the exact argument type used by the old workflow caller. The
	// default Temporal converter encodes it as a JSON string payload.
