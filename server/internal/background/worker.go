...
type WorkerOptions struct {
	...
	PromptInjectionClassifier risk_analysis.PromptInjectionClassifier
...
func NewTemporalWorker(
	...
	for _, o := range options {
		opts = &WorkerOptions{
			...
			PromptInjectionClassifier: conv.Default(o.PromptInjectionClassifier, opts.PromptInjectionClassifier),
	...
	activities := NewActivities(
		...
		opts.AssistantsCore,
		opts.PIIScanner,
		opts.PromptInjectionClassifier,
