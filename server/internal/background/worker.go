...
func NewTemporalWorker(
	...
	temporalWorker.RegisterActivity(activities.DeactivateUnhealthyCustomDomain)
	temporalWorker.RegisterActivity(activities.NotifyCustomDomainDisabled)
	...
	temporalWorker.RegisterWorkflow(CustomDomainAutoDisableWorkflow)
