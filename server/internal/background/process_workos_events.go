...
func ExecuteProcessWorkOSEventsWorkflow(ctx context.Context, temporalEnv *tenv.Environment, params ProcessWorkOSEventsParams) (client.WorkflowRun, error) {
	id := fmt.Sprintf("v1:process-workos-org-events:%s", params.WorkOSOrganizationID)
	...
	}, ProcessWorkOSEventsWorkflow, params)
}

func ProcessWorkOSEventsWorkflow(ctx workflow.Context, params ProcessWorkOSEventsParams) (*ProcessWorkOSEventsResult, error) {
