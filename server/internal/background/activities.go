...
type Activities struct {
	...
	syncWorkOSOrganization          *activities.SyncWorkOSOrganization
}
...
func NewActivities(
	...
	return &Activities{
		...
		syncWorkOSOrganization:          activities.NewSyncWorkOSOrg(logger, db, workosClient),
	}
}
...
func (a *Activities) SyncWorkOSOrganization(ctx context.Context, orgID string) (*activities.SyncWorkOSOrgResult, error) {
	return a.syncWorkOSOrganization.Do(ctx, orgID)
}
