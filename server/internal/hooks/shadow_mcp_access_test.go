...
func TestEnforceShadowMCPToolAccess_DenyRuleOverridesValidToolsetCall(t *testing.T) {
	...
	_, err := accessrepo.New(ti.conn).CreateShadowMCPAccessRule(ctx, accessrepo.CreateShadowMCPAccessRuleParams{
		OrganizationID:         authCtx.ActiveOrganizationID,
		ProjectID:              uuid.NullUUID{},
		AccessScope:            "organization",
		Disposition:            "denied",
		MatchBreadth:           shadowmcp.MatchBreadthServerIdentity,
