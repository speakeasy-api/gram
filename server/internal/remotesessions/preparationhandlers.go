...
func (s *Service) preparationAPIInput(ctx context.Context, userID, issuerID, resource string, write bool) (PreparationInput, error) {
	...
	if err := s.authz.Require(ctx, authz.Check{Scope: scope, ResourceID: authCtx.ProjectID.String()}); err != nil {
	...
	return PreparationInput{UserSessionIssuerID: user, RemoteSessionIssuerID: issuer, Resource: resource}, nil
}
