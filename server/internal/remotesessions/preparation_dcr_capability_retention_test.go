...
func TestPreparationDCR_CapabilityRefreshDuringPOSTRetainsConfirmedCredentials(t *testing.T) {
	t.Parallel()
	...
	upstream := fakeIssuerServer(t, func(doc map[string]any) {
		...
		doc["grant_types_supported"] = []string{"authorization_code", oauthwire.GrantTypeJWTBearer}
