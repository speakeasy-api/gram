...
func (s *Service) ListScopes(ctx context.Context, _ *gen.ListScopesPayload) (*gen.ListScopesResult, error) {
	...
	scopes := []scopeDefinitionInput{
		...
		{scope: authz.ScopeRiskPolicyRead, description: "View risk policies, detection rules, findings, and the risk dashboards. Read-only: creating, editing, and deleting policies, and acting on findings, all require org:admin.", resourceType: "risk_policy"},
...
func userVisibleScopeGrants() []*gen.ListRoleGrant {
	return []*gen.ListRoleGrant{
		...
		{Scope: string(authz.ScopeRiskPolicyRead), Selectors: nil},
