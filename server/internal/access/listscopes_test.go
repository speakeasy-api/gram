...
func TestService_ListScopes(t *testing.T) {
	...
	require.Equal(t, "role", bySlug[string(authz.ScopeRoleWrite)].ResourceType)
	require.Equal(t, authz.ScopeVisibilityUserVisible, bySlug[string(authz.ScopeRoleWrite)].Visibility)
	require.Nil(t, bySlug[string(authz.ScopeRoleWrite)].ExclusionScope)
	...
	require.Equal(t, authz.ScopeVisibilityUserVisible, bySlug[string(authz.ScopeSkillWrite)].Visibility)
