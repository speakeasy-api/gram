...
func TestService_ListRoles_AllowsOrgReadGrant(t *testing.T) {
	...
	ctx, ti := newTestAccessService(t)
	ctx = withRBACGrants(t, ctx, authz.NewGrant(authz.ScopeOrgRead, testAccessAuthContext(t, ctx).ActiveOrganizationID))
...
func TestService_GetRole_AllowsOrgReadGrant(t *testing.T) {
	...
	ctx = withRBACGrants(t, ctx, authz.NewGrant(authz.ScopeOrgRead, authCtx.ActiveOrganizationID))
...
func TestService_CreateRole_AllowsOrgAdminGrant(t *testing.T) {
	...
	ctx, ti := newTestAccessService(t)
	ctx = withRBACGrants(t, ctx, authz.NewGrant(authz.ScopeOrgAdmin, testAccessAuthContext(t, ctx).ActiveOrganizationID))
...
func TestService_UpdateRole_AllowsOrgAdminGrant(t *testing.T) {
	...
	ctx, ti := newTestAccessService(t)
	authCtx := testAccessAuthContext(t, ctx)
	ctx = withRBACGrants(t, ctx, authz.NewGrant(authz.ScopeOrgAdmin, authCtx.ActiveOrganizationID))
	name := "Updated"
