...
func (h *Headers) ListHeaders(ctx context.Context, serverID uuid.UUID, redacted bool) ([]repo.TunneledMcpServerHeader, error) {
...
func (h *Headers) ListServerHeaders(ctx context.Context, serverID uuid.UUID, projectID uuid.UUID, redacted bool) ([]repo.TunneledMcpServerHeader, error) {
...
func (h *Headers) GetServerHeader(ctx context.Context, id uuid.UUID, projectID uuid.UUID, redacted bool) (repo.TunneledMcpServerHeader, error) {
...
func (h *Headers) CreateServerHeader(ctx context.Context, params repo.CreateServerHeaderParams) (repo.TunneledMcpServerHeader, error) {
	...
	if err != nil {
		return repo.TunneledMcpServerHeader{}, fmt.Errorf("encrypt header %s: %w", params.Name, err)
	}
	params.Value = value

	header, err := repo.New(h.db).CreateServerHeader(ctx, params)
	if err != nil {
		return repo.TunneledMcpServerHeader{}, fmt.Errorf("create server header %s: %w", params.Name, err)
	}
...
func (h *Headers) UpdateServerHeader(ctx context.Context, params repo.UpdateServerHeaderParams) (repo.TunneledMcpServerHeader, error) {
	...
	if err != nil {
		return repo.TunneledMcpServerHeader{}, fmt.Errorf("update server header %s: %w", params.Name, err)
	}
...
func (h *Headers) revealHeaders(headers []repo.TunneledMcpServerHeader, redacted bool) ([]repo.TunneledMcpServerHeader, error) {
	result := make([]repo.TunneledMcpServerHeader, len(headers))
