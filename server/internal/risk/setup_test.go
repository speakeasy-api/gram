...
func newTestRiskService(t *testing.T) (context.Context, *testInstance) {
	...
	svc := risk.NewService(logger, tracerProvider, conn, sessionManager, authzEngine, sig, nil, nil, shadowMCPClient, accessStore, auditLogger, "test-jwt-secret", false, nil, nil)
