...
func TestListRiskResults_ByPolicy(t *testing.T) {
	...
	policy, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Results Test")})
	require.NoError(t, err)
...
func TestListRiskResults_ByChatID(t *testing.T) {
	...
	policy, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Chat Filter Test")})
	require.NoError(t, err)
...
func TestListRiskResults_ExcludesNotFound(t *testing.T) {
	...
	policy, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Found Filter")})
	require.NoError(t, err)
...
func TestGetRiskPolicyStatus_WithAnalyzedMessages(t *testing.T) {
	...
	policy, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Status Detail")})
	require.NoError(t, err)
...
func TestGetRiskPolicyStatus_AllAnalyzed(t *testing.T) {
	...
	policy, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Complete")})
	require.NoError(t, err)
