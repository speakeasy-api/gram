...
func TestListRiskPolicies_ReturnsPolicies(t *testing.T) {
	...
	_, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Policy A")})
	require.NoError(t, err)
	_, err = ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Policy B")})
	require.NoError(t, err)
...
func TestGetRiskPolicy_Success(t *testing.T) {
	...
	created, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Get Me")})
	require.NoError(t, err)
...
func TestDeleteRiskPolicy_Success(t *testing.T) {
	...
	created, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Delete Me")})
	require.NoError(t, err)
...
func TestGetRiskPolicyStatus_Success(t *testing.T) {
	...
	created, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Status Test")})
	require.NoError(t, err)
...
func TestTriggerRiskAnalysis_BumpsVersion(t *testing.T) {
	...
	created, err := ti.service.CreateRiskPolicy(ctx, &gen.CreateRiskPolicyPayload{Name: strPtr("Trigger Test")})
	require.NoError(t, err)
