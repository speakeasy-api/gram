...
func (s *Service) CreateTemplate(ctx context.Context, payload *gen.CreateTemplatePayload) (*gen.CreatePromptTemplateResult, error) {
	...
	if err := s.access.Require(ctx, access.Check{Scope: access.ScopeProjectWrite, ResourceID: projectID.String()}); err != nil {
		return nil, err
	}
...
func (s *Service) GetTemplate(ctx context.Context, payload *gen.GetTemplatePayload) (*gen.GetPromptTemplateResult, error) {
	...
	if err := s.access.Require(ctx, access.Check{Scope: access.ScopeProjectRead, ResourceID: projectID.String()}); err != nil {
		return nil, err
	}
