...
func (s *Service) CreateTemplate(ctx context.Context, payload *gen.CreateTemplatePayload) (*gen.CreatePromptTemplateResult, error) {
	...
	if err := s.authz.Require(ctx, authz.Check{Scope: authz.ScopeProjectWrite, ResourceKind: "", ResourceID: projectID.String(), Conditions: nil}); err != nil {
		return nil, err
	}
...
func (s *Service) GetTemplate(ctx context.Context, payload *gen.GetTemplatePayload) (*gen.GetPromptTemplateResult, error) {
	...
	if err := s.authz.Require(ctx, authz.Check{Scope: authz.ScopeProjectRead, ResourceKind: "", ResourceID: projectID.String(), Conditions: nil}); err != nil {
		return nil, err
	}
