...
type HookTraceSummary struct {
	...
	SkillScope            *string `ch:"skill_scope"`             // String - skill scope from materialized column
	SkillDiscoveryRoot    *string `ch:"skill_discovery_root"`    // String - skill discovery root from materialized column
	SkillSourceType       *string `ch:"skill_source_type"`       // String - skill source type from materialized column
	SkillID               *string `ch:"skill_id"`                // String - skill ID from materialized column
	SkillVersionID        *string `ch:"skill_version_id"`        // String - skill version ID from materialized column
	SkillResolutionStatus *string `ch:"skill_resolution_status"` // String - skill resolution status from materialized column
}
