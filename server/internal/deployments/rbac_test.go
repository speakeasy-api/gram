...
func TestDeployments_RBAC_ReadOps_AllowedWithBuildReadGrant(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.Grant{Scope: access.ScopeBuildRead, Selector: access.ForResource(projectID)})
...
func TestDeployments_RBAC_ReadOps_AllowedWithBuildWriteGrant(t *testing.T) {
	...
	projectID := authCtx.ProjectID.String()
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.Grant{Scope: access.ScopeBuildWrite, Selector: access.ForResource(projectID)})
