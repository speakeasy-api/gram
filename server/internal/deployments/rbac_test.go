...
func TestDeployments_RBAC_ReadOps_AllowedWithBuildReadGrant(t *testing.T) {
	...
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeBuildRead, projectID))
...
func TestDeployments_RBAC_ReadOps_AllowedWithBuildWriteGrant(t *testing.T) {
	...
	projectID := authCtx.ProjectID.String()
	ctx = rbactest.WithExactAccessGrants(t, ctx, access.NewGrant(access.ScopeBuildWrite, projectID))
