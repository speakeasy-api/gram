...
// allScopes includes the internal relation scopes (risk_policy:*, shadow_mcp:*)
// that are not user-facing RBAC capabilities and are not seeded into system roles.
var allScopes = append(append([]Scope(nil), adminScopes...),
