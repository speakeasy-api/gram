...
// drop a device under mid-pull churn (offset pagination) mis-marks it for at
// most one sync interval. Providers relying on this tolerance must say so at
// their pagination logic; anyone strengthening what a completed pull implies
// (partial-pull marking, same-cycle alerting or evidence export) must
// revisit those providers first.
