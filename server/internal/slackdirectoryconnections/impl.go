...
func (s *Service) saveAuthorization(ctx context.Context, ac *contextvalues.AuthContext, state oauthState, authorization *Authorization) error {
	...
	default:
		...
		previous = mv.BuildSlackDirectoryConnectionView(before)
