...
1. list_servers — what is reachable, what each system is for, and whether any is degraded.
...
If a call fails, re-check list_servers before retrying. A member may be degraded, in which case its tools are unavailable rather than missing.`
