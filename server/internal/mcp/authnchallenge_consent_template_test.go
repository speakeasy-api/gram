...
func TestConsentScriptClosesOnlyMarkedPages(t *testing.T) {
	...
	require.Contains(t, script, `form.elements.namedItem("agent_id")`)
...
func TestConsentTemplateAgentSelectionShowsFixedPolicyAndSetupOnly(t *testing.T) {
	...
	require.Contains(t, html, "Myself — user@example.com")
	require.Contains(t, html, "Agent — Build agent")
	require.Contains(t, html, "endpoint-scoped")
