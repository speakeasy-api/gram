...
func TestConsentTemplateShowsConnectedIdentity(t *testing.T) {
	...
	require.Contains(t, html, `Authenticated as <span class="-mx-0.5 rounded-sm px-0.5 py-px box-decoration-clone" data-identity-text>grant-owner@example.com`)
	...
	require.Contains(t, html, `Authenticated as <span class="-mx-0.5 rounded-sm px-0.5 py-px box-decoration-clone" data-identity-text>&lt;img src=x&gt;`)
