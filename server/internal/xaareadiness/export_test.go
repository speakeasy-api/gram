...
func TestRenderCSV_QuotesEverythingAndNeutralizesFormulas(t *testing.T) {
	...
	rows := []exportRow{
		...
		{Server: `Notion "prod", east`, Project: "+plus", State: "connected", ResourceIndicator: "-dash", Audience: "https://auth.example", ClientID: "@at", Scopes: "\ttab", DeepLink: ""},
	}
	...
	want := "\"Server\",\"Project\",\"State\",\"Resource indicator\",\"Audience\",\"Client ID at resource\",\"Scopes\",\"Add resource connection\"\r\n" +
		...
		"\"Notion \"\"prod\"\", east\",\"'+plus\",\"connected\",\"'-dash\",\"https://auth.example\",\"'@at\",\"'\ttab\",\"\"\r\n"
...
func TestRenderMarkdown_EscapesTableLinkAndHTMLSyntax(t *testing.T) {
	...
	require.Equal(t, `| a \| b \[c\](x) next | p\|q | needs_agent | &lt;https://evil.example&gt; | https://auth.example\|x | &lt;a href=x&gt;id&lt;/a&gt; | read &amp; write | https://t-admin.okta.com/admin/ai-agents/\[x\] |`, lines[2])
}
