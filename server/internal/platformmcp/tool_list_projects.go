...
func registerListProjectsTool(reg *Registrar, reader Reader) {
	addTool(reg, &mcp.Tool{
		Name:        "list_projects",
		Title:       "List Projects",
		Description: "List the projects in this organization that the caller may read. A project is where MCP servers and skills are kept. Constraints: results carry only project identifiers, names, and slugs; filtered is true when other organization projects were withheld by RBAC.",
