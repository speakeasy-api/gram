...
//
// The choice runs through HasConnection rather than reading a half of the pair
// directly, so a caller is classified the same way here as everywhere else: a
// half-populated identity is a connection claim, and fails closed in
// parseConnection instead of being metered as two different callers by two
// different helpers.
