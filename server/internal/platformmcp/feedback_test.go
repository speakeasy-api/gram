...
func TestValidateFeedbackInputAcceptsRegisteredTools(t *testing.T) {
	...
	for _, toolName := range []string{"attach_platform_mcp_identity_provider", "list_plugin_assignments", "get_my_mcp_access", "get_my_mcp_connection_status", operationAssignMCPAccessRole} {
