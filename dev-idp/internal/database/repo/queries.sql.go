...
func (q *Queries) ConsumeAuthCode(ctx context.Context, arg ConsumeAuthCodeParams) (AuthCode, error) {
	row := q.db.QueryRowContext(ctx, consumeAuthCode, arg.Code, arg.Mode)
	var i AuthCode
	err := row.Scan(
		&i.Code,
		&i.Mode,
...
func (q *Queries) GetActiveToken(ctx context.Context, arg GetActiveTokenParams) (Token, error) {
	row := q.db.QueryRowContext(ctx, getActiveToken, arg.Token, arg.Mode)
	var i Token
	err := row.Scan(
		&i.Token,
		&i.Mode,
...
// mutates it. The id is generated by the database using random bytes
// formatted as UUID v4.
func (q *Queries) UpsertUserByEmail(ctx context.Context, arg UpsertUserByEmailParams) (User, error) {
	row := q.db.QueryRowContext(ctx, upsertUserByEmail, arg.Email, arg.DisplayName)
	var i User
	err := row.Scan(
		&i.ID,
		&i.Email,
