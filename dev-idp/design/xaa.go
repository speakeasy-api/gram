...
var ListXaaAppsResult = Type("ListXaaAppsResult", func() {
	Attribute("items", ArrayOf(XaaApp), "Apps on this page.")
	PaginationResult()
	Required("items")
})

var ListXaaResourcesResult = Type("ListXaaResourcesResult", func() {
	Attribute("items", ArrayOf(XaaResource), "Resources on this page.")
	PaginationResult()
	Required("items")
})

var ListXaaAppAssignmentsResult = Type("ListXaaAppAssignmentsResult", func() {
	Attribute("items", ArrayOf(XaaAppAssignment), "Assignments on this page.")
	PaginationResult()
	Required("items")
})

var ListXaaTrustRulesResult = Type("ListXaaTrustRulesResult", func() {
	Attribute("items", ArrayOf(XaaTrustRule), "Trust rules on this page.")
	PaginationResult()
	Required("items")
})

var ListXaaIssuedJagsResult = Type("ListXaaIssuedJagsResult", func() {
	Attribute("items", ArrayOf(XaaIssuedJag), "Grants, newest first.")
	Required("items")
})

var _ = Service("xaaApps", func() {
	Description("Cross-app access requesting apps: the clients allowed to ask the IdP for an ID-JAG. Permanently unauthenticated.")
	...
	Method("list", func() {
		...
		Result(ListXaaAppsResult)

		HTTP(func() {
			POST("/rpc/xaaApps.list")
			Response(StatusOK)
		})
	})
	...
	Method("delete", func() {
		...
		HTTP(func() {
			POST("/rpc/xaaApps.delete")
			Response(StatusNoContent)
		})
	})
})

var _ = Service("xaaResources", func() {
	Description("Cross-app access resource apps. Each is one resource authorization server mounted at /resource-as/<slug>. Permanently unauthenticated.")
	...
	Method("list", func() {
		...
		Result(ListXaaResourcesResult)

		HTTP(func() {
			POST("/rpc/xaaResources.list")
			Response(StatusOK)
		})
	})
	...
	Method("delete", func() {
		...
		HTTP(func() {
			POST("/rpc/xaaResources.delete")
			Response(StatusNoContent)
		})
	})
})

var _ = Service("xaaAppAssignments", func() {
	...
	Method("create", func() {
		...
		Result(XaaAppAssignment)

		HTTP(func() {
			POST("/rpc/xaaAppAssignments.create")
			Response(StatusOK)
		})
	})
	...
	Method("update", func() {
		...
		HTTP(func() {
			POST("/rpc/xaaAppAssignments.update")
			Response(StatusOK)
		})
	})
	...
	Method("list", func() {
		...
		Result(ListXaaAppAssignmentsResult)

		HTTP(func() {
			POST("/rpc/xaaAppAssignments.list")
			Response(StatusOK)
		})
	})
	...
	Method("delete", func() {
		...
		HTTP(func() {
			POST("/rpc/xaaAppAssignments.delete")
			Response(StatusNoContent)
		})
	})
})

var _ = Service("xaaTrustRules", func() {
	...
	Method("list", func() {
		...
		Result(ListXaaTrustRulesResult)

		HTTP(func() {
			POST("/rpc/xaaTrustRules.list")
			Response(StatusOK)
		})
	})
	...
	Method("listIssuedGrants", func() {
		...
		Result(ListXaaIssuedJagsResult)

		HTTP(func() {
			POST("/rpc/xaaTrustRules.listIssuedGrants")
			Response(StatusOK)
		})
	})
})
