...
var _ = Service("users", func() {
	Description("Dev-idp users CRUD. The local-mode currentUser (mock-workos / oauth2-1 / oauth2) references rows in this table by id (idp-design.md §3, §5). Permanently unauthenticated.")
